...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg412982(v=OCS.15)
ms:contentKeyID: 49314674
ms.date: 05/19/2016
...
Enables an administrator to unlock the personal identification number (PIN) for a specified user. 此 cmdlet 是在 Lync Server 2010 中引入的。
