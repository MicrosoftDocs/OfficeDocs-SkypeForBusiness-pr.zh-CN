...
---
# <a name="toll-free-dialing-restrictions-in-bulgaria"></a>在保加利亚的免费电话拨号限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> |00800 XXX XXXX  <br/> |
|国家/地区的 ISO 代码  <br/> |BG  <br/> |
|涵盖岛/区域  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |不适用  <br/> |
|有线固定行的可用性  <br/> |是  <br/> |
|移动网络的可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |Vivacom &amp; Globul Mobile 提供移动访问。  <br/> |
