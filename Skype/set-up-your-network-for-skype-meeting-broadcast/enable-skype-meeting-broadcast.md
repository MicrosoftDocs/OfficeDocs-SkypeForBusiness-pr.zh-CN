...
您的组织中的人员可以使用 Skype 会议广播之前，您需要启用它。 若要执行此操作，您需要了解如何使用 Windows PowerShell。 如果您不知道 Windows PowerShell，考虑雇用[的 Microsoft 合作伙伴](https://go.microsoft.com/fwlink/?linkid=391089)为您执行此步骤。
...
2. 在 Office 365 管理中心转到**管理中心** > **业务的 Skype**。
