...
使用此表查找有关获取和管理适用于 Skype for Business Online 的西班牙电话号码的信息。 
  
有关详细信息，请参阅[为你的组织管理电话号码](manage-phone-numbers-for-your-organization.md)。
  
|**你要做什么？**|**下载正确的表单**|
|:-----|:-----|
|你需要获取未在 Skype for Business 管理中心列出的用户号码。  <br/> | 下载[西班牙的新电话号码请求（地理号码）(v.3.0)(es.es)](../../downloads/new-number-request-forms/new-phone-number-request-for-spain-(geographic-numbers)-(v.3.0)-(es.es).pdf) <br/>  填写此请求并[将其发送给我们](mailto:ptneu@microsoft.com)。  <br/> |
