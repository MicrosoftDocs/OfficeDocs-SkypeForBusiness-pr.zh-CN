...
|prinGuid  <br/> |GUID，不为 null  <br/> |主体 GUID。 这广泛用作备用主键，因为它的含义会跨越到 Active Directory 域服务空间。  (缓存主体的 GUID 等于对应的 Active Directory 对象 GUID.)   <br/> |
...
|prinDisabled  <br/> |smallint，不为 null  <br/> | 0：主体处于活动状态。 <br/>  1：主体被禁用，因为用户的 SIP 功能已禁用。 <br/>  2：删除主体，因为关联的 AD 对象已被删除。 <br/> |
|prinTypeID  <br/> |smallint，不为 null  <br/> |主体类型（来自 tblPrincipalType 表）。  <br/> |
|prinPoolID  <br/> |Int  <br/> |主体的 Skype for Business 客户端池分配。  <br/> |
