...
|**VsEntryCauses** <br/> |smallint  <br/> | <br/> |语音开关是一种具有更低中断能力的半双工模式。 语音切换条目的原因：  <br/> ENTER_VS_BADTS 0x01  <br/> ENTER_VS_ECHO 0x02  <br/> ENTER_VS_FORCEORCONVERGENCE 0x04  <br/> ENTER_VS_DNLP 0x08  <br/> 原因可能是这些个别原因的组合。 只有注册用途的 regkey 才能启用 ENTER_VS_FORCEORCONVERGENCE。  <br/> 在 Microsoft Lync Server 2013 中，此列的数据类型已更改。  <br/> |
