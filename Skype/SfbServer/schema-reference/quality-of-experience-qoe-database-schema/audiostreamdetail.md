...
|CallerInside  <br/> |bit  <br/> |指示呼叫者是否在间隔网络内：1表示呼叫方位于企业网络内，0表示呼叫方位于网络外部。  <br/> |
|CalleeIPAddr  <br/> |var （50）  <br/> |被呼叫方的 IP 地址。 这可能是 IPv4 地址或 IPv6 地址。  <br/> |
|CalleePort  <br/> |int  <br/> |被呼叫方使用的端口。  <br/> |
|CalleeInside  <br/> |bit  <br/> |指示被调用方是否在间隔网络内：1表示被呼叫方位于企业网络内，0表示被呼叫方位于网络外部。  <br/> |
...
|CallerVPN  <br/> |bit  <br/> |指示呼叫者是否通过虚拟专用网络连接：1是虚拟专用网（VPN），0是非 VPN。  <br/> |
...
|CalleeVPN  <br/> |bit  <br/> |指示呼叫者是否通过虚拟专用网络连接：1是虚拟专用网（VPN），0是非 VPN。  <br/> |
