...
|CallerRxAGCGain  <br/> |int  <br/> |自动增益 (应用于) 音频的中介服务器端的 AGC 控制。  <br/> |
...
|CalleeTimestampDriftRateMic  <br/> |decimal (9，2)   <br/> |被叫方麦克风设备时钟的偏移量，相对于 CPU 时钟。  <br/> |
...
|CalleeRxAGCGain  <br/> |int  <br/> |自动增益 (应用到) 音频的中介服务器端的 AGC 设置。  <br/> |
