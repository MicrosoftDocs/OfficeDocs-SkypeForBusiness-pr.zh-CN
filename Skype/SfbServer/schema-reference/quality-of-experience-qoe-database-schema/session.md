...
|**列**|**数据类型**|**键/索引**|**详细信息**|
|:-----|:-----|:-----|:-----|
|**ConferenceDateTime** <br/> |datetime  <br/> |主  <br/> |从 Dialog 表中 [引用](dialog.md)。  <br/> |
|**SessionSeq** <br/> |int  <br/> |主  <br/> |从 Dialog 表中 [引用](dialog.md)。  <br/> |
|**ConferenceKey** <br/> |int  <br/> |Foreign  <br/> |会议密钥。 从 Conference 表中 [引用](conference.md)。  <br/> |
|**CorrelationKey** <br/> |int  <br/> |Foreign  <br/> |相关键。 从 [SessionCorrelation 表中引用](sessioncorrelation.md)。  <br/> |
...
|**CallerPool** <br/> |int  <br/> |Foreign  <br/> |呼叫者池。 从 Pool 表中 [引用](pool.md)。  <br/> |
|**CalleePool** <br/> |int  <br/> |Foreign  <br/> |呼叫接收器的池。 从 Pool 表中 [引用](pool.md)。  <br/> |
|**CalleePAI** <br/> |int  <br/> |Foreign  <br/> |接收终结点的 SIP p 断言标识 (PAI) SIP URI。 从 User 表中 [引用](user-0.md)。  <br/> |
|**CallerURI** <br/> |int  <br/> |Foreign  <br/> |呼叫者的 URI。 从 User 表中 [引用](user-0.md)。  <br/> |
|**CallerEndpoint** <br/> |int  <br/> |Foreign  <br/> |呼叫者的终结点。 从 Endpoint 表中 [引用](endpoint.md)。  <br/> |
|**CallerUserAgent** <br/> |bit  <br/> |Foreign  <br/> |呼叫者的用户代理。 从 [UserAgent 表中引用](useragent.md)。  <br/> |
