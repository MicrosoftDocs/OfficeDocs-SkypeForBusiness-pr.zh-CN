...
|**列**|**数据类型**|**键/索引**|**详细信息**|
|:-----|:-----|:-----|:-----|
|**ConferenceDateTime** <br/> |datetime  <br/> |主  <br/> |从会话表中 [引用](session.md)。  <br/> |
|**SessionSeq** <br/> |int  <br/> |主  <br/> |从会话表中 [引用](session.md)。  <br/> |
...
|**CallerIceWarningFlags** <br/> |int  <br/> | <br/> |位标志中所述的交互式连接 (ICE) 过程的信息。 有关详细信息，请参阅可下载的用户体验  *质量监控服务器*  协议规范。 <br/> |
...
|**CallerMacAddress** <br/> |int  <br/> |Foreign  <br/> |呼叫者的 mac 地址，从 [MacAddress 表中引用](macaddress.md)。  <br/> |
...
|**CallerRenderDevDriver** <br/> |int  <br/> |Foreign  <br/> |调用方的呈现设备的驱动程序，从 [DeviceDriver 表引用](devicedriver.md)。  <br/> |
...
|**CallerBssid** <br/> |int  <br/> |Foreign  <br/> |呼叫者的 BSSID（如果使用无线）。 从 [MacAddress 表中引用](macaddress.md)。  <br/> |
...
|**CalleeMacAddress** <br/> |int  <br/> |Foreign  <br/> |被叫方 Mac 地址。 从 [MacAddress 表中引用](macaddress.md)。  <br/> |
...
|**CalleeCaptureDevDriver** <br/> |int  <br/> |Foreign  <br/> |呼叫接收者捕获设备的驱动程序。 从 [DeviceDriver 表中引用](devicedriver.md)。  <br/> |
|**CalleeRenderDevDriver** <br/> |varchar (256)   <br/> |Foreign  <br/> |呼叫接收者呈现设备的驱动程序。 从 [DeviceDriver 表中引用](devicedriver.md)。  <br/> |
...
|**CalleeBssid** <br/> |int  <br/> |Foreign  <br/> |被叫方 BSSID（如果使用无线）。 从 [MacAddress 表中引用](macaddress.md)。  <br/> |
...
|**AppliedBandwidthSourceKey** <br/> |smallint  <br/> ||这是所设定的带宽限制的来源。 它描述带宽限制来自 (策略服务器"、"TURN 服务器"、"形式"等) 。 从 [AppliedBandwidthSource 表中引用](appliedbandwidthsource.md)。  <br/> |
...
|**ClassifiedPoorCall** <br/> |bit  <br/> ||指示呼叫被分类为质量欠佳 (值 1) 0 表示为 (质量) 。  <br/> 此列是在 Microsoft Lync Server 2013 中引入的。  <br/> |
