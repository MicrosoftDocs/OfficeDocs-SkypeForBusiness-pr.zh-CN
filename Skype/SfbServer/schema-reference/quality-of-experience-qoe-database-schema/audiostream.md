...
|**BurstDensity** <br/> |decimal (9，4)   <br/> | <br/> |呼叫过程中丢失突发丢失的平均数据包密度。  <br/> |
|**BurstDuration** <br/> |int  <br/> | <br/> |呼叫期间突发丢失数据包的平均持续时间。  <br/> |
...
|**DegradationJitterAvg** <br/> |decimal (3，2)   <br/> | <br/> |抖动导致网络 MOS 下降。  <br/> |
|**DegradationPacketLossAvg** <br/> |decimal (3，2)   <br/> | <br/> |数据包丢失导致网络 MOS 下降。  <br/> |
|**AudioPayloadDescription** <br/> |int  <br/> |Foreign  <br/> |用于呼叫的音频编解码器，从 PayloadDescription 表引用。  <br/> |
|**AudioSampleRate** <br/> |int  <br/> | <br/> |音频流的采样率。  <br/> |
|**RoundTrip** <br/> |int  <br/> | <br/> |RTCP 统计信息中的来回行程时间。 对于可接受的质量，应小于 100 毫秒。  <br/> |
|**RoundTripMax** <br/> |int  <br/> | <br/> |音频流的最大来回行程时间。  <br/> |
|**OverallAvgNetworkMOS** <br/> |decimal (3，2)   <br/> | <br/> |呼叫的平均宽带网络 MOS。 此指标取决于数据包丢失、抖动和使用的编解码器。 范围为 [1.0 至 5.0]。  <br/> |
|**OverallMinNetworkMOS** <br/> |decimal (3，2)   <br/> | <br/> |呼叫的最小宽带网络 MOS。  <br/> |
|**SendListenMOS** <br/> |decimal (3，2)   <br/> | <br/> |已发送音频的平均预计宽带侦听 MOS 得分，包括语音级别、噪音级别和捕获设备特征。  <br/> |
...
|**AudioFECUsed** <br/> |bit  <br/> ||指示呼叫是否使用了音频 FEC 的标志。  <br/> |
...
|**入站** <br/> |bit  <br/> | <br/> |接收接收器端上的流数据。  <br/> |
...
|**HealerFECPacketUsedRatio** <br/> |float  <br/> ||已用前向错误更正数据包与收到的数据包总数的比率。  <br/> 此列是在 Microsoft Lync Server 2013 中引入的。  <br/> |
|**MaxCompressedSamples** <br/> |float  <br/> ||修复程序压缩的最大音频数据包数。  <br/> 此列是在 Microsoft Lync Server 2013 中引入的。  <br/> |
|**LossCongestionPercent** <br/> |float  <br/> ||指示呼叫丢失拥塞状态的时间百分比。  <br/> 此列是在 Microsoft Lync Server 2013 中引入的。  <br/> |
|**DelayCongestionPercent** <br/> |float  <br/> ||指示因网络数据包延迟到达导致拥塞的呼叫所占的百分比。  <br/> 此列是在 Microsoft Lync Server 2013 中引入的。  <br/> |
...
|**AecRenderStereoPercent** <br/> |float  <br/> ||回声消除器呈现为立体声的呼叫的百分比。  <br/> 此列是在 Microsoft Lync Server 2013 中引入的。  <br/> |
...
|**AecCaptureStereoPercent** <br/> |float  <br/> ||回声消除器捕获为立体声的呼叫的百分比。  <br/> 此列是在 Microsoft Lync Server 2013 中引入的。  <br/> |
