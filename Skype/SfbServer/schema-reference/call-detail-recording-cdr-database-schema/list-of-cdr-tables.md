...
|**表格**|**说明**|
|:-----|:-----|
|[Skype for Business Server 2015 中的 "位置" 表](locations.md) <br/> |对于每个紧急呼叫 (如增强的 9-1-1 (E9-1-1) 通话, 存储有关呼叫的位置信息。 指电话开始/结束时间和响应代码的[SessionDetails 表](sessiondetails.md)。 <br/> |
