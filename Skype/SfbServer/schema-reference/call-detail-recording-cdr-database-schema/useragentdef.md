...
ms.locfileid: "60761890"
---
# <a name="useragentdef-table"></a>UserAgentDef 表
 
UserAgentDef 表将用户代理标识符映射到代理的描述性名称。 用户代理是用于连接到 Skype for Business Server 2015 的软件客户端。 此表在 Microsoft Lync Server 2013 中引入。
