...
UserAgentDef 表将用户代理标识符映射到代理的描述性名称。 用户代理是用来连接的业务服务器 2015 Skype 的软件客户端。 在 Microsoft Lync Server 2013 引入了此表。
...
|1040  <br/> |Response_Group_Service Announcement_Service  <br/> |作为  <br/> |
