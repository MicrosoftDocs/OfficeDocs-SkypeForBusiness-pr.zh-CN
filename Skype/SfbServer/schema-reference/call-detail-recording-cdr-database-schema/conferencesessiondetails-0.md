...
|**列**|**数据类型**|**键/索引**|**详细信息**|
|:-----|:-----|:-----|:-----|
|**SessionIdTime** <br/> |Datetime  <br/> |主、外  <br/> |会话请求的时间；与 **SessionIdSeq** 结合使用来唯一地标识会议会话。 有关详细信息[，请参阅 Skype for Business Server 2015 中的 Dialogs](dialogs.md) 表。 <br/> |
|**SessionIdSeq** <br/> |int  <br/> |主、外  <br/> |用于标识会话的 ID 号。 与 **SessionIdTime** 结合使用来唯一地标识会议会话。 有关详细信息[，请参阅 Skype for Business Server 2015 中的 Dialogs](dialogs.md) 表。 * <br/> |
...
|**GatewayId** <br/> |int  <br/> |Foreign  <br/> |呼叫使用的网关。 有关详细信息[，请参阅 Skype for Business Server 2015 中的 Gateways](gateways.md) 表。 <br/> |
...
|**UriTypeId** <br/> |tinyint  <br/> |Foreign  <br/> |包含 [UriTypes 表中的 MCU URI 类型值](uritypes.md)。 此字段用于改进查询性能。  <br/> 此字段在 Microsoft Lync Server 2013 中引入。  <br/> |
