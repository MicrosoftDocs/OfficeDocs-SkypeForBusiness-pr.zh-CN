...
|退出  <br/> |结束您的 Skype for Business 会话并在您的计算机上关闭 Skype for business。 退出后，如果要重新启动，请选择 "**启动** > **所有程序**> Skype for business"。 <br/> |在 Skype for business 主窗口中，选择 "**选项**" 按钮，然后选择 "**文件** > **退出**"。  <br/> |
