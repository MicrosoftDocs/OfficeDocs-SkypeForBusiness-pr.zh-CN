...
---
# <a name="modify-an-existing-pin-policy-in-skype-for-business-server-2015"></a>在 Skype for Business Server 2015 中修改现有 PIN 策略
 
**摘要：**修改现有的 PIN 策略在 Skype 业务服务器 2015年。
  
**PIN 策略**选项卡可用于连接到与 IP 电话业务的 Skype 为用户提供个人身份验证号码 (PIN) 身份验证。 要使用 PIN 身份验证，请确保在 Web 服务设置中选中“启用 PIN 身份验证”****。
