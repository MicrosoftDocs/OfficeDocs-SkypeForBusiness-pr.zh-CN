...
7. 在“设置 PIN”对话框中，执行下列操作之一：
   ...
   - 若要允许 Skype for Business Server 生成用户的 PIN，请选择"使用默认密码自动生成 (**PIN**) 。
