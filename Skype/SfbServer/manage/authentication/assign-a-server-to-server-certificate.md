...
---
# <a name="assign-a-server-to-server-authentication-certificate-to-skype-for-business-server"></a>将服务器到服务器身份验证证书分配给 Skype for Business Server
...
1. 单击"开始"，单击"所有程序"，单击 **"Skype for Business Server"，** 然后单击 **"Skype for Business Server 部署向导"。**
    
2. 在部署向导中，单击 **"安装或更新 Skype for Business Server 系统"。**
    
3. 在 Skype for Business Server页面上，单击标题为"步骤 3： 请求、安装或分配证书 **"下的"运行"按钮**。  (注意：如果已在此计算机上安装证书，则"运行"按钮将标记为"再次运行 **")**
