...
Lync Server 2013 的累积更新: 7 月2013桌面客户端和 Skype for Business 客户端是唯一支持双因素身份验证的客户端。
...
用户应在 Skype for Business 客户端中使用 "**删除我的登录信息**" 选项, 然后在尝试使用双因素首次登录时从%Localappdata%\Microsoft\Office\15.0\Skype for business 中删除其 SIP 配置文件文件夹身份验证.
