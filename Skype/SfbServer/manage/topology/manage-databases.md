---
title: 使用 AlwaysOn 可用性组管理Skype for Business Server
ms.reviewer: ''
...
---
# <a name="manage-databases-with-an-alwayson-availability-group-in-skype-for-business-server"></a>使用 AlwaysOn 可用性组管理Skype for Business Server
