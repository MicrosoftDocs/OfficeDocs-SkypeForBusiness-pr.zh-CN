...
description: 摘要：了解设备报告中Skype for Business Server。
...
> [!NOTE]
> 请记住，如果你运行的是本地化版本的设备名称，则捕获设备Skype for Business Server。 美国英语中名为 Aastra 6725ip 麦克风 (Aastra 6725ip)-V0 的设备在法语和西班牙语中可能会有不同的名称。 
