...
- [报告中的Skype for Business Server](top-failures-report.md)
...
从故障分布报告中，您可以单击以下任何指标以查看故障列表报告[Skype for Business Server](failure-list-report.md)：
...
|**名称**|**是否可按此项排序？**|**说明**|
|:-----|:-----|:-----|
|**Rank** <br/> |否  <br/> |失败会话的相对等级，根据诊断 ID 确定。诊断 ID 是附加到 SIP 消息的唯一标识符（采用 ms-diagnostics 标头的形式），提供的信息在排查错误时通常很有帮助。  <br/> |
|**主要诊断原因** <br/> |否  <br/> |会话中生成的诊断 ID。  <br/> |
|**会话** <br/> |否  <br/> |生成了指定诊断 ID 的失败会话总数。  <br/> |
...
|**名称**|**是否可按此项排序？**|**说明**|
|:-----|:-----|:-----|
|**Rank** <br/> |否  <br/> |失败会话的相对等级，根据会话类型（例如，音频/视频会议或点对点文件传输会话）确定。  <br/> |
|**主要形式** <br/> |否  <br/> |会话类型。  <br/> |
|**会话** <br/> |否  <br/> |涉及指定形式的失败会话总数。  <br/> |
...
|**名称**|**是否可按此项排序？**|**说明**|
|:-----|:-----|:-----|
|**Rank** <br/> |否  <br/> |失败会话的相对等级，根据计算机确定。  <br/> |
|**主要来源** <br/> |否  <br/> |失败会话所涉及的计算机的名称。  <br/> |
|**会话** <br/> |否  <br/> |每台计算机的失败会话总数。  <br/> |
   
## <a name="metrics-for-top-components"></a>主要组件的指标

下表列出了故障分布报告中基于故障最多的组件提供的信息。
...
|**名称**|**是否可按此项排序？**|**说明**|
|:-----|:-----|:-----|
|**Rank** <br/> |否  <br/> |失败会话的相对等级，根据受邀加入会话的用户确定。  <br/> |
|**主要来源用户** <br/> |否  <br/> |受邀加入会话的用户的 SIP 地址。  <br/> |
|**会话** <br/> |否  <br/> |每个用户的失败会话总数。  <br/> |
...
|**名称**|**是否可按此项排序？**|**说明**|
|:-----|:-----|:-----|
|**Rank** <br/> |否  <br/> |失败会话的相对等级，根据发起会话的用户确定。  <br/> |
...
|**名称**|**是否可按此项排序？**|**说明**|
|:-----|:-----|:-----|
|**Rank** <br/> |否  <br/> |失败会话的相对等级，根据会话所涉及的用户代理（软件）确定。例如：RTCC/4.0.0.0 Inbound Routing/4.0.0.0。  <br/> |
|**主要用户代理** <br/> |否  <br/> |失败会话所涉及的用户代理的名称。  <br/> |
|**会话** <br/> |否  <br/> |每个用户代理的失败会话总数。  <br/> |
