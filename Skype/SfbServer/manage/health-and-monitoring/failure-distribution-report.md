...
---
# <a name="failure-distribution-report-in-skype-for-business-server-2015"></a>Skype for Business Server 2015 中的故障分布报告
 
**摘要：**了解故障分布在 Skype 报告业务服务器 2015年。
...
- [在 Skype 业务服务器 2015年的 top 错误报告](top-failures-report.md)
    
- [会议在 Skype 业务服务器 2015年的诊断报告](conference-diagnostic-report.md)
    
- [对等活动在 Skype 业务服务器 2015年的诊断报告](peer-to-peer-activity-diagnostic-report.md)
    
从故障分发报告中，可单击任何查看[故障列表报告中的业务服务器 2015 Skype](failure-list-report.md)的下列指标：
...
|**名称** - 按 WAN 链路进行筛选（筛选器位于图形右侧）。|**可以在此项上进行排序？**|**说明**|
|:-----|:-----|:-----|
|**等级** <br/> |否  <br/> |根据注册池或边缘服务器会话执行其中的失败会话的有关级别。  <br/> |
|**主要池** <br/> |否  <br/> |注册器池或边缘服务器的名称。  <br/> |
|**会话数** <br/> |否  <br/> |每个注册池或边缘服务器失败的会话总数。  <br/> |
...
|**名称** - 按 WAN 链路进行筛选（筛选器位于图形右侧）。|**可以在此项上进行排序？**|**说明**|
|:-----|:-----|:-----|
|**等级** <br/> |否  <br/> |失败的会话的基于组件 （例如，ExumRouting、 群聊或 MediationServer） 的有关级别。  <br/> |
