...
---
# <a name="conference-summary-report-in-skype-for-business-server-2015"></a>Skype for Business Server 2015 中的会议摘要报告
 
**摘要：**了解会议摘要报告在 Skype 业务服务器 2015年。
  
会议摘要报告提供了联机会议会话的整体视图。 会议通常涉及 2 个以上的用户，并需要会议服务的使用。 比较而言，对等会话通常涉及只需 2 个用户并不需要使用 Skype 业务服务器会议服务。 [对等活动摘要报告中的业务服务器 2015 Skype](peer-to-peer-activity-summary-report.md)报告对等活动。
  
会议摘要报告不仅告诉您多少会议都保存在给定的时间段内 （每小时、 每天、 每周、 每月一次） 而且还将告诉您总人数参加这些会议，以及唯一的会议总数组织者。
  
"独特"的组织者是人安排至少一个会议。 例如，如果 Pilar Ackerman 计划了一场会议，则她将算为一个唯一组织者。 如果 Ken Myer 计划了 148 场会议，则他也将算为一个唯一组织者。 例如，下表显示了计划的 8 场会议，但仅 3 个唯一组织者（Ken Myer、Pilar Ackerman 和 David Ahs）。
...
|**A/V 会议总分钟数** <br/> |否  <br/> |音频/视频会议的总分钟数。  <br/> 总的 A / V 会议分钟指标汇总了所有音频/视频会议类型，包括： A / V 会议;IM 会议;应用程序共享会议;数据会议;和 PSTN 会议。  <br/> |
