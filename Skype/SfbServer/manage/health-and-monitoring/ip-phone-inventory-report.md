...
---
# <a name="ip-phone-inventory-report-in-skype-for-business-server"></a>Skype for Business Server 中的 IP 电话清单报告
 
**摘要：** 了解 Skype for Business Server 中的 IP 电话清单报告。
...
值得注意的是，此报告在用作真正的清单报告时存在几点限制。 首先，IP 电话报告仅列出指定时段内登录到 Skype for Business Server 的所有电话（按其上次登录时间排序）。 如果某个电话在指定的时间段内未登录，那么就不会在清单报告中列出。 这包括在该时间段开始前已登录并且在指定的时间间隔内仍保持登录的电话。 例如，假设你想要查看 2015 年 7 月的所有电话清单。 还假定 2015 年 6 月 30 日，多个电话登录到 Skype for Business Server，截至 7 月 1 日仍登录。 这些电话将不会在 7 月 1 日的清单报告上出现。
  
还必须注意的是，清单报告可能包括您的组织不再使用的电话。 例如，假设许多 Fabrikam 电话在 2015 年 7 月 1 日登录到系统;5 天后，贵组织清除了所有这些 Fabrikam 电话，并替换为较新的 Contoso 模型。 Fabrikam 电话仍会显示在“清单”报告中，原因很简单，就是它们在 7 月份已登录到系统。
...
|**此天数前的最后一次活动** <br/> | 选择下列值之一： <br/>  [全部] <br/>  10  <br/>  20 <br/>  30 <br/> |
|**此天数前的最后注销时间** <br/> | 选择下列值之一： <br/>  [全部] <br/>  10  <br/>  20 <br/>  30 <br/> |
...
|**上次登录时间** <br/> |是  <br/> |IP 电话上次登录到 Skype for Business Server 的日期和时间。  <br/> |
|**上次注销时间** <br/> |是  <br/> |IP 电话上次从 Skype for Business Server 注销的日期和时间。  <br/> |
