...
会议加入时间摘要使您能够确定用户加入会议所花的时间。 该报告显示平均加入时间 (毫秒) ，并提供了一个细目，让您知道有多少用户在 2 秒或更少时间就能加入会议，有多少用户需要 2 到 5 秒才能加入会议，等等。
...
|**会议会话** <br/> | 会话类型。 允许的值包括： <br/>  [All] <br/>  焦点 (中心会话是联机会议的中心策略和状态管理器，协调会议的各个方面 <br/>  应用程序共享 <br/>  A/V 会议 <br/>  如果选择"[所有]"，则总会议加入时间将显示在报告的顶部。 请注意，这些总数仅适用于使用 Microsoft Exchange 或 Microsoft Outlook 安排的会议。 <br/> |
