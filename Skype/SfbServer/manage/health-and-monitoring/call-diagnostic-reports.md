...
- [呼叫诊断摘要报告Skype for Business Server](summary-report.md)提供失败的对等会话和会议会话的整体摘要。 对等会话是仅涉及两个参与者的会话。 会议会话涉及三个或多个参与者。
    
- [Skype for Business Server 中的对等活动诊断Skype for Business Server](peer-to-peer-activity-diagnostic-report.md)提供失败的对等会话的整体趋势视图。 对等会话仅涉及两个参与者。
...
- [诊断报告中Skype for Business Server](diagnostic-report.md)提供诊断和疑难解答 (包括 SIP 响应代码以及失败会话的诊断) 和 ID。
