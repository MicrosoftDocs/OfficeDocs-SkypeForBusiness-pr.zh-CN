...
点对点活动摘要报告提供点对点通信会话的整体视图。 对等会话通常仅涉及两个用户，不需要使用 Skype for Business Server 会议服务。 相比之下，会议通常涉及两名以上用户，并且要求使用Skype for Business Server会议服务。 会议活动在会议摘要报告上进行报告。
...
可从监视报告主页访问点对点活动摘要报告。 通过单击[以下指标](im-report.md)之一，Skype for Business Server中打开对等 IM 报告：
...
|**名称**|**是否可按此项排序？**|**说明**|
|:-----|:-----|:-----|
|**每小时** <br/> **每天** <br/> **每周** <br/> **每月一次** <br/> |否  <br/> |指示在筛选器工具栏上选择的时间间隔。 如果适用，可单击某一给定的时间间隔以查看该间隔的详细信息。 例如，如果使用"每天"间隔并单击 7/17/12015，则会看到该日期的用户注册活动的每小时细分信息。  <br/> |
