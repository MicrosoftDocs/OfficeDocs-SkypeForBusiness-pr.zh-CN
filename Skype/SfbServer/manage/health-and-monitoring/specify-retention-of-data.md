---
title: 指定 CDR 数据的保留时间Skype for Business Server
ms.reviewer: null
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
# <a name="specify-retention-of-cdr-data-in-skype-for-business-server"></a>指定 CDR 数据的保留时间Skype for Business Server
