...
这些选项包括以下类型的外部访问：
  ...
  - **启用与联合用户的通信**   如果想要支持用户访问联合合作伙伴域，请启用此功能。 此设置配置用户与其他 SIP 联合域以及托管提供商（如 Microsoft 365 或 Office 365）通信的能力。 


  - **启用与远程用户的通信**  如果希望组织中防火墙外部的用户（例如远程通勤者和正在旅行的用户）能够通过 Internet 连接到Skype for Business Server，请启用此选项。
