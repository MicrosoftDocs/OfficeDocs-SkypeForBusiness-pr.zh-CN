---
title: 在会议环境中管理会议Skype for Business Server
ms.reviewer: ''
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
---
# <a name="manage-meeting-configuration-settings-in-skype-for-business-server"></a>在会议环境中管理会议Skype for Business Server
...
会议配置设置规定用户可创建的会议类型，以及控制 (甚至) 匿名用户和电话拨入式会议用户能否加入这些会议的方式。 请注意，这些设置仅影响安排的会议;它们不会影响通过单击"会议"中的"现在开会"选项创建Skype for Business。
