...
若要管理 DTMF 命令使用的密钥, 请使用 Skype for Business Server Management Shell 以及**CsDialinConferencingDtmfConfiguration**、 **CsDialinConferencingDtmfConfiguration**和**CsDialinConferencingDtmfConfiguration** cmdlet。
