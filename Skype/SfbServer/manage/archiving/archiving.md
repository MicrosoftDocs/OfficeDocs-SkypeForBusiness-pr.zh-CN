...
在阅读本主题之前，请确保您熟悉在 Skype for Business Server 中规划存档和[](../../plan-your-deployment/archiving/archiving.md)为 Skype for Business Server 部署[存档中Skype for Business Server。](../../deploy/deploy-archiving/deploy-archiving.md)
...
## <a name="manage-archiving-by-using-the-control-panel-or-by-using-windows-powershell"></a>使用控制面板或自动管理存档Windows PowerShell
...
|New-CsArchivingConfiguration  <br/> |创建一组新的即时消息 (IM) 设置，这些设置可用于启用或禁用 IM 会话的自动保存，以及阻止任何无法存档的即时消息。  <br/> |
