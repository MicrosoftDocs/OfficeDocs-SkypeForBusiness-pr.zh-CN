...
在阅读本主题之前，请确保您熟悉在 Skype for Business Server 中[规划存档和](../../plan-your-deployment/archiving/archiving.md)部署存档[中Skype for Business Server](../../deploy/deploy-archiving/deploy-archiving.md)。
...
|Set-CsArchivingConfiguration  <br/> |修改即时消息和 IM 的现有集合 (存档) 选项。  <br/> |
