...
---
# <a name="manage-archiving-options-in-skype-for-business-server"></a>在 Skype for Business Server 中管理存档选项

**摘要：** 了解如何为 Skype for Business Server 配置存档选项。
...
您可以删除站点配置或池配置，但无法删除全局配置。 如果删除全局配置，该配置将自动重置为默认值。 有关如何实施存档配置以及存档配置的层次结构的详细信息，请参阅 Plan for [archiving in Skype for Business Server。](../../plan-your-deployment/archiving/archiving.md)
  
## <a name="configure-archiving-options-by-using-the-control-panel"></a>使用控制面板配置存档选项

您可以使用控制面板配置存档选项，如下所示：
...
您还可以使用下表中列出的 Windows PowerShell cmdlet 配置存档选项。 有关语法的详细信息，包括所有可用参数，请参阅 Skype [for Business Server 命令行管理程序](../management-shell.md)。
