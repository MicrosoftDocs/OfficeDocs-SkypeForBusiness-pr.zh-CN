...
---
# <a name="delete-an-existing-archiving-policy-in-skype-for-business-server-2015"></a>在 Skype for Business Server 2015 中删除现有存档策略

**摘要：**了解如何删除业务服务器 2015年的 Skype 的存档策略。
...
有关详细信息，请参阅[删除 CsArchivingPolicy](https://docs.microsoft.com/powershell/module/skype/remove-csarchivingpolicy?view=skype-ps) cmdlet 的帮助主题。