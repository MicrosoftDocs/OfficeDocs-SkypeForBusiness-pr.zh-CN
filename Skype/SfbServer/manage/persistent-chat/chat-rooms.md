...
- 加载项。 允许您将以前配置的外接程序与聊天室关联，从而允许成员在参与时查看 URL 内容。
...
您可以使用 **New-CsPersistentChatRoom** cmdlet 创建新聊天室。 例如，以下命令在池池上新建一个名为 ITChatRoom 的 atl-cs-001.contoso.com。 此示例将聊天室添加到 IT 类别：
