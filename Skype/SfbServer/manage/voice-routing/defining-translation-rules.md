...
Skype for Business Server 企业语音根据规范化为 E.164 格式的电话号码路由呼叫。 这意味着，必须将所有拨打的字符串规范化为 E.164 格式，以便执行反向号码查找 (RNL) 以便可以将其转换为匹配的 SIP URI。 Skype for Business Server 提供了操作被叫 ID 和呼叫者 ID 演示文稿的能力。
