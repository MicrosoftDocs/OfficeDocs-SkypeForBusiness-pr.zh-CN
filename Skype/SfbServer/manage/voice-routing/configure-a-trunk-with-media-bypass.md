---
title: 在客户端中配置具有媒体旁路Skype for Business Server
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
> [!NOTE]
> 媒体旁路功能不会与 SBC (中每个公用电话交换网) IP-PBX 和会话边界控制器 (交互) 。 Microsoft 已经与认证合作伙伴一起测试了一组 PSTN 网关和 SDC，并且已经使用 Cisco IP-PBX 进行了一些测试。 媒体旁路仅在"电话基础结构 for [Skype for Business Server"页上列出的产品和版本](../../../SfbPartnerCertification/certification/infra-gateways.md)受支持。 
...
配置中继后，继续通过选择全局媒体旁路选项来配置媒体旁路，如在 Skype for Business Server 中[部署媒体旁路](../../deploy/deploy-enterprise-voice/deploy-media-bypass.md)中所述。