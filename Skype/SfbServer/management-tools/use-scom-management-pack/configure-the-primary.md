...
> [!IMPORTANT]
> 安装 Operations Manager[2012](https://www.microsoft.com/download/details.aspx?id=6442)之前，需要安装"Microsoft Report Viewer 2010 可再发行软件包"System Center。
...
导入管理包是一个关键步骤。 如果未导入管理包，您将不能使用 Operations Manager 监视事件Skype for Business Server或运行Skype for Business Server事务。
...
- **Operations Manager 外壳** 可以使用 Operations Manager 外壳直接导入，或解决在使用 System Center Operations Manager 控制台导入管理包时遇到的任何问题。
