...
description: 摘要：了解如何在 2015 年 3 月 (集中日志记录服务) CLS Skype for Business Server记录器。
ms.openlocfilehash: bd468818335125e764dc6094ad32f7c7cad7f72e
ms.sourcegitcommit: 65a10f80e5dfd67b2778e09f5f92c21ef09ce36a
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/04/2021
ms.locfileid: "60739078"
---
...
- 您是在作为运行集中日志记录服务或 CLS (域) 的计算机上使用此工具。 远程 PowerShell 会话中当前不支持该工具。
...
1. 在" **编辑方案"** 选项卡中，单击" **创建方案"** 按钮。
    ...
    > [!NOTE]
    > 创建新方案将克隆当前所选方案的配置。 如果在创建新方案 **设置** 单击"清除"，它将在未选择任何组件和标志的情况下开始。
