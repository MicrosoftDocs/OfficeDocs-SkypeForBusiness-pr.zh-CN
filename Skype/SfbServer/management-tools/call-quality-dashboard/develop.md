---
title: 开发呼叫质量仪表板Skype for Business Server
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
可以使用自定义开发将 CQD 扩展并集成到报告环境。 
  
有两组 Web API 可用，一组用于通过数据 API (访问多维数据集) ，另一组用于通过存储库 API (访问报告元数据) 。 
  
- [通话质量仪表板数据 API (CQD) 中Skype for Business Server](data-api.md)
    
- [通话质量仪表板的存储库 API (中) CQD Skype for Business Server](repository-api.md)
