...
**摘要：** 了解有关获取最后一个集成数据操作，它是用于呼叫的质量仪表板的数据 API 的一部分。 呼叫质量仪表板是用于业务服务器 2015年的 Skype 的工具。
...
默认情况下禁用此功能，并且它需要启用通过配置数据 API。
  

|**方法**|**请求 URI**|**HTTP 版本**|
|:-----|:-----|:-----|
|获取  <br/> |https://\<门户\>/QoEDataService/IntegrationLog/Status  <br/> |HTTP/1.1  <br/> |
