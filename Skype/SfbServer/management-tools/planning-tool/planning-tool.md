...
the Skype for Business Server 2015 Planning Tool is a wizard driven， interview-like tool that asks questions about the Skype for Business Server 2015 topology that you are designing. 规划工具使用所提供的信息以及拓扑设计和容量的首选做法，根据提供的答案提供建议的拓扑。 可以从 Skype for Business Server [2015 规划工具 下载规划工具](https://go.microsoft.com/fwlink/p/?LinkID=282725)。
