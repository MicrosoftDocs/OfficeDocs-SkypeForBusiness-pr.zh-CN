...
4. 在 **2015 Skype for Business Server规划工具安装向导的**"欢迎"页上，单击"下一步 **"**。
...
将设计导出到 Microsoft Visio会创建一个图表，以用于所配置拓扑和基础结构的文档目的。 可以编辑和重新排列导入的图表以满足文档需求。 典型的Visio包括：
