...
## <a name="create-users-and-contacts"></a><span data-ttu-id="6f03e-110">创建用户和联系人</span><span class="sxs-lookup"><span data-stu-id="6f03e-110">Create Users and Contacts</span></span>
...
<span data-ttu-id="6f03e-124">您必须使用 Skype for Business 服务器用户预配工具为负载模拟创建用户和联系人。</span><span class="sxs-lookup"><span data-stu-id="6f03e-124">You have to use the Skype for Business Server User Provisioning Tool to create users and contacts for load simulation.</span></span>
...
3. <span data-ttu-id="6f03e-138">在 "**密码**" 字段中, 键入将跨所有测试用户帐户使用的密码。</span><span class="sxs-lookup"><span data-stu-id="6f03e-138">In the **Password** field, type a password that will be used across all the test user accounts.</span></span>
...
#### <a name="create-users-button"></a><span data-ttu-id="6f03e-148">"创建用户" 按钮</span><span class="sxs-lookup"><span data-stu-id="6f03e-148">Create Users button</span></span>
...
### <a name="to-configure-users-contacts-do-the-following"></a><span data-ttu-id="6f03e-176">若要配置用户的联系人, 请执行下列操作:</span><span class="sxs-lookup"><span data-stu-id="6f03e-176">To configure users' contacts, do the following:</span></span>
...
#### <a name="distribution-list"></a><span data-ttu-id="6f03e-194">通讯组列表</span><span class="sxs-lookup"><span data-stu-id="6f03e-194">Distribution List</span></span>
...
<span data-ttu-id="6f03e-215">如果你选择测试此功能, 请填写表单中的值, 然后单击 "生成 IIS 配置文件" 按钮 (将创建该按钮)。名为的 CSV 文件:</span><span class="sxs-lookup"><span data-stu-id="6f03e-215">If you choose to test this feature, fill in the values in the form and click the Generate LIS Config Files button, which will create .CSV files called:</span></span>
...
11. <span data-ttu-id="6f03e-256">在 "**端口**" 字段中, 输入希望用户用于 SIP 的端口 (此处的默认值为 5061)。</span><span class="sxs-lookup"><span data-stu-id="6f03e-256">In the **Port** field, enter the port that you want users to use for SIP (the default here is 5061).</span></span>
...
- <span data-ttu-id="6f03e-266">**即时消息-** 这包括对等和会议;为负载级别选择适当的值。</span><span class="sxs-lookup"><span data-stu-id="6f03e-266">**Instant Messaging -** This includes peer-to-peer and conferencing; choose the appropriate value for Load Level.</span></span>
...
- <span data-ttu-id="6f03e-284">选择\*\* "临时" 将允许工具生成将在整个时间内创建的会议模拟。</span><span class="sxs-lookup"><span data-stu-id="6f03e-284">Choosing  *Ad-hoc*  will allow the tool to generate simulation of conferences that will be created throughout the hour.</span></span>
...
- <span data-ttu-id="6f03e-332">**状态和 P2P 即时消息/音频-** 选择 "负载级别" 的值以启用移动模拟。</span><span class="sxs-lookup"><span data-stu-id="6f03e-332">**Presence and P2P Instant Messaging/Audio -** Select a value for Load Level to enable the Mobility simulation.</span></span>
...
<span data-ttu-id="6f03e-338">"摘要" 选项卡指示要针对每个方案使用的用户。</span><span class="sxs-lookup"><span data-stu-id="6f03e-338">The Summary tab indicates which users to use for each of the scenarios.</span></span> 
...
<span data-ttu-id="6f03e-364">若要*结束*进程, 请按 Ctrl + C。</span><span class="sxs-lookup"><span data-stu-id="6f03e-364">To  *end*  the process, press Ctrl+C.</span></span>
...
<span data-ttu-id="6f03e-383">下面是关键性能计数器的列表:</span><span class="sxs-lookup"><span data-stu-id="6f03e-383">Here's a list of key performance counters:</span></span>
...
|<span data-ttu-id="6f03e-414">ABS 完整/增量文件下载成功</span><span class="sxs-lookup"><span data-stu-id="6f03e-414">ABS Full/Delta File Downloads Succeeded</span></span>  <br/> |<span data-ttu-id="6f03e-415">已尝试的完整或增量文件下载请求的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-415">Total number of full or delta file download requests attempted.</span></span>  <br/> |
|<span data-ttu-id="6f03e-416">通讯簿 Web 查询服务相关计数器</span><span class="sxs-lookup"><span data-stu-id="6f03e-416">Address Book Web Query service related counters</span></span>  <br/> |<span data-ttu-id="6f03e-417">通讯簿文件下载相关计数器。</span><span class="sxs-lookup"><span data-stu-id="6f03e-417">Address book file download related counters.</span></span>  <br/> |
|<span data-ttu-id="6f03e-418">尝试进行 ABS WS 呼叫</span><span class="sxs-lookup"><span data-stu-id="6f03e-418">ABS WS Calls attempted</span></span>  <br/> |<span data-ttu-id="6f03e-419">尝试的通讯簿 Web 查询服务请求总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-419">Total number of Address Book Web Query service requests attempted.</span></span>  <br/> |
|<span data-ttu-id="6f03e-420">ABS WS 呼叫成功</span><span class="sxs-lookup"><span data-stu-id="6f03e-420">ABS WS Calls Succeeded</span></span>  <br/> |<span data-ttu-id="6f03e-421">返回成功响应代码的通讯簿 Web 查询服务请求的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-421">Total number of Address Book Web Query service requests that returned a successful response code.</span></span>  <br/> |
|<span data-ttu-id="6f03e-422">ABS WS 呼叫失败</span><span class="sxs-lookup"><span data-stu-id="6f03e-422">ABS WS Calls Failed</span></span>  <br/> |<span data-ttu-id="6f03e-423">返回错误响应代码的通讯簿 Web 查询服务请求的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-423">Total number of Address Book Web Query service requests that returned an error response code.</span></span>  <br/> |
   
> [!NOTE]
> <span data-ttu-id="6f03e-424">此类别包括用于监视通讯簿服务 (ABS) 文件下载和通讯簿 Web 查询服务请求的计数器。</span><span class="sxs-lookup"><span data-stu-id="6f03e-424">This category includes counters used to monitor Address Book service (ABS) file downloads and Address Book Web Query service requests.</span></span> 
  
<span data-ttu-id="6f03e-425">**通讯组列表 (DL) 信息**</span><span class="sxs-lookup"><span data-stu-id="6f03e-425">**Distribution List (DL) Information**</span></span>

|<span data-ttu-id="6f03e-426">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-426">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-427">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-427">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-428">已尝试呼叫</span><span class="sxs-lookup"><span data-stu-id="6f03e-428">Calls Attempted</span></span>  <br/> |<span data-ttu-id="6f03e-429">尝试的通讯组列表展开 (DLX) web 服务请求的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-429">Total number of distribution list expansion (DLX) web service requests attempted.</span></span>  <br/> |
|<span data-ttu-id="6f03e-430">通话成功</span><span class="sxs-lookup"><span data-stu-id="6f03e-430">Calls Succeeded</span></span>  <br/> |<span data-ttu-id="6f03e-431">返回成功响应代码的 DLX web 服务请求的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-431">Total number of DLX web service requests that returned a successful response code.</span></span>  <br/> |
|<span data-ttu-id="6f03e-432">呼叫失败</span><span class="sxs-lookup"><span data-stu-id="6f03e-432">Calls Failed</span></span>  <br/> |<span data-ttu-id="6f03e-433">返回了错误响应代码的 DLX web 服务请求的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-433">Total number of DLX web service requests that returned an error response code.</span></span>  <br/> |
   

  
> [!NOTE]
> <span data-ttu-id="6f03e-434">以下列出的性能计数器将在启用这些方案时针对所有 IP 语音 (VoIP) 呼叫 (包括中介服务器、A/V 会议服务器、边缘服务器、响应组应用程序和会议自动助理) 的报告编号。</span><span class="sxs-lookup"><span data-stu-id="6f03e-434">The performance counters listed below report numbers for all Voice over IP (VoIP) calls, including calls to Mediation Server, A/V Conferencing Server, Edge Server, Response Group application, and Conference Auto Attendant, when these scenarios are enabled.</span></span> 
  
<span data-ttu-id="6f03e-435">**VoIP 基本信息**</span><span class="sxs-lookup"><span data-stu-id="6f03e-435">**VoIP Basic Information**</span></span>

|<span data-ttu-id="6f03e-436">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-436">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-437">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-437">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-438">通话处于活动状态</span><span class="sxs-lookup"><span data-stu-id="6f03e-438">Calls Active</span></span>  <br/> |<span data-ttu-id="6f03e-439">当前正在进行的传入/传出语音呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-439">Total number of incoming/outgoing voice calls ongoing currently.</span></span>  <br/> |
|<span data-ttu-id="6f03e-440">通话终止</span><span class="sxs-lookup"><span data-stu-id="6f03e-440">Calls Terminated</span></span>  <br/> |<span data-ttu-id="6f03e-441">已终止的传入/传出语音通话总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-441">Total number of incoming/outgoing voice calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="6f03e-442">通话被拒绝</span><span class="sxs-lookup"><span data-stu-id="6f03e-442">Calls Declined</span></span>  <br/> |<span data-ttu-id="6f03e-443">已拒绝的传入语音呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-443">Total number of incoming voice calls declined.</span></span>  <br/> |
|<span data-ttu-id="6f03e-444">已尝试拨入/拨出电话</span><span class="sxs-lookup"><span data-stu-id="6f03e-444">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="6f03e-445">已尝试传入/传出语音通话的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-445">Total number of incoming/outgoing voice calls attempted.</span></span>  <br/> |
|<span data-ttu-id="6f03e-446">已建立传入/传出呼叫</span><span class="sxs-lookup"><span data-stu-id="6f03e-446">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="6f03e-447">已建立的传入/传出语音通话的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-447">Total number of incoming/outgoing voice calls established.</span></span>  <br/> |
|<span data-ttu-id="6f03e-448">呼叫接收的 NNN</span><span class="sxs-lookup"><span data-stu-id="6f03e-448">Calls Received NNN</span></span>  <br/> |<span data-ttu-id="6f03e-449">从服务器接收的 nnn 响应代码的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-449">Total number of nnn response codes received from the server.</span></span>  <br/> |
|<span data-ttu-id="6f03e-450">VoIP 传递率 (%)</span><span class="sxs-lookup"><span data-stu-id="6f03e-450">VoIP Pass Rate (%)</span></span>  <br/> |<span data-ttu-id="6f03e-451">已建立通话总次数/尝试的通话总次数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-451">Total calls established/Total calls attempted.</span></span>  <br/> |
   
<span data-ttu-id="6f03e-452">**响应组服务呼叫信息**</span><span class="sxs-lookup"><span data-stu-id="6f03e-452">**Response Group service Call Information**</span></span>

|<span data-ttu-id="6f03e-453">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-453">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-454">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-454">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-455">通话处于活动状态</span><span class="sxs-lookup"><span data-stu-id="6f03e-455">Calls Active</span></span>  <br/> |<span data-ttu-id="6f03e-456">对响应组应用程序的活动呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-456">Total number of active calls to the Response Group application.</span></span>  <br/> |
|<span data-ttu-id="6f03e-457">已尝试呼叫</span><span class="sxs-lookup"><span data-stu-id="6f03e-457">Calls Attempted</span></span>  <br/> |<span data-ttu-id="6f03e-458">尝试的通话总次数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-458">Total number of calls attempted.</span></span>  <br/> |
   
<span data-ttu-id="6f03e-459">**即时消息 (IM) 呼叫信息**</span><span class="sxs-lookup"><span data-stu-id="6f03e-459">**Instant Messaging (IM) Call Information**</span></span>

|<span data-ttu-id="6f03e-460">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-460">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-461">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-461">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-462">通话处于活动状态</span><span class="sxs-lookup"><span data-stu-id="6f03e-462">Calls Active</span></span>  <br/> |<span data-ttu-id="6f03e-463">正在进行的传入/传出即时消息呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-463">Total number of ongoing incoming/outgoing instant messaging calls.</span></span>  <br/> |
|<span data-ttu-id="6f03e-464">通话终止</span><span class="sxs-lookup"><span data-stu-id="6f03e-464">Calls Terminated</span></span>  <br/> |<span data-ttu-id="6f03e-465">已终止的传入/传出即时消息呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-465">Total number of incoming/outgoing instant messaging calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="6f03e-466">呼叫接收的 NNN</span><span class="sxs-lookup"><span data-stu-id="6f03e-466">Calls Received NNN</span></span>  <br/> |<span data-ttu-id="6f03e-467">从服务器接收的 nnn 响应代码的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-467">Total number of nnn response codes received from the server.</span></span>  <br/> |
|<span data-ttu-id="6f03e-468">接收/发送的 IM 消息</span><span class="sxs-lookup"><span data-stu-id="6f03e-468">IM Messages Received/Sent</span></span>  <br/> |<span data-ttu-id="6f03e-469">所有会话的已接收或已发送邮件的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-469">Total number of messages received or sent for all sessions.</span></span>  <br/> |
|<span data-ttu-id="6f03e-470">已尝试拨入/拨出电话</span><span class="sxs-lookup"><span data-stu-id="6f03e-470">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="6f03e-471">尝试的传入/传出即时消息呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-471">Total number of incoming/outgoing instant messaging calls attempted.</span></span>  <br/> |
|<span data-ttu-id="6f03e-472">已建立传入/传出呼叫</span><span class="sxs-lookup"><span data-stu-id="6f03e-472">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="6f03e-473">已建立的传入/传出即时消息呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-473">Total number of incoming/outgoing instant message calls established.</span></span>  <br/> |
   
<span data-ttu-id="6f03e-474">**应用共享呼叫信息**</span><span class="sxs-lookup"><span data-stu-id="6f03e-474">**App Sharing Call Information**</span></span>

|<span data-ttu-id="6f03e-475">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-475">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-476">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-476">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-477">通话处于活动状态</span><span class="sxs-lookup"><span data-stu-id="6f03e-477">Calls Active</span></span>  <br/> |<span data-ttu-id="6f03e-478">正在进行的传入/传出应用程序共享呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-478">Total number of ongoing incoming/outgoing application sharing calls.</span></span>  <br/> |
|<span data-ttu-id="6f03e-479">通话终止</span><span class="sxs-lookup"><span data-stu-id="6f03e-479">Calls Terminated</span></span>  <br/> |<span data-ttu-id="6f03e-480">已终止的传入/传出应用程序共享呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-480">Total number of incoming/outgoing application sharing calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="6f03e-481">呼叫接收的 NNN</span><span class="sxs-lookup"><span data-stu-id="6f03e-481">Calls Received NNN</span></span>  <br/> |<span data-ttu-id="6f03e-482">从服务器接收的 nnn 响应代码的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-482">Total number of nnn response codes received from the server.</span></span>  <br/> |
|<span data-ttu-id="6f03e-483">已尝试拨入/拨出电话</span><span class="sxs-lookup"><span data-stu-id="6f03e-483">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="6f03e-484">尝试的传入/传出应用程序共享呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-484">Total number of incoming/outgoing application sharing calls attempted.</span></span>  <br/> |
|<span data-ttu-id="6f03e-485">已建立传入/传出呼叫</span><span class="sxs-lookup"><span data-stu-id="6f03e-485">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="6f03e-486">已建立的传入/传出应用程序共享呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-486">Total number of incoming/outgoing application sharing calls established.</span></span>  <br/> |
   
<span data-ttu-id="6f03e-487">**CAA 通话信息**</span><span class="sxs-lookup"><span data-stu-id="6f03e-487">**CAA Call Information**</span></span>

|<span data-ttu-id="6f03e-488">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-488">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-489">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-489">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-490">通话处于活动状态</span><span class="sxs-lookup"><span data-stu-id="6f03e-490">Calls Active</span></span>  <br/> |<span data-ttu-id="6f03e-491">当前正在进行的传入/传出公共交换电话网络 (PSTN) 呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-491">Total number of incoming/outgoing public switched telephone network (PSTN) calls ongoing currently.</span></span>  <br/> |
|<span data-ttu-id="6f03e-492">通话终止</span><span class="sxs-lookup"><span data-stu-id="6f03e-492">Calls Terminated</span></span>  <br/> |<span data-ttu-id="6f03e-493">已终止的传入/传出 PSTN 呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-493">Total number of incoming/outgoing PSTN calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="6f03e-494">已尝试拨入/拨出电话</span><span class="sxs-lookup"><span data-stu-id="6f03e-494">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="6f03e-495">尝试的传入/传出 PSTN 呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-495">Total number of incoming/outgoing PSTN calls attempted.</span></span>  <br/> |
|<span data-ttu-id="6f03e-496">已建立传入/传出呼叫</span><span class="sxs-lookup"><span data-stu-id="6f03e-496">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="6f03e-497">已建立的传入/传出 PSTN 呼叫总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-497">Total number of incoming/outgoing PSTN calls established.</span></span>  <br/> |
   
<span data-ttu-id="6f03e-498">**会议信息**</span><span class="sxs-lookup"><span data-stu-id="6f03e-498">**Conference Information**</span></span>

|<span data-ttu-id="6f03e-499">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-499">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-500">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-500">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-501">活动即时消息会议</span><span class="sxs-lookup"><span data-stu-id="6f03e-501">Active Instant Messaging Conferences</span></span>  <br/> |<span data-ttu-id="6f03e-502">正在进行的即时消息会议总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-502">Total number of ongoing instant messaging conferences.</span></span>  <br/> |
|<span data-ttu-id="6f03e-503">活动音频/视频会议</span><span class="sxs-lookup"><span data-stu-id="6f03e-503">Active Audio/Video Conferences</span></span>  <br/> |<span data-ttu-id="6f03e-504">正在进行的音频/视频 (A/V) 会议总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-504">Total number of ongoing audio/video (A/V) conferences.</span></span>  <br/> |
|<span data-ttu-id="6f03e-505">活动应用程序共享会议</span><span class="sxs-lookup"><span data-stu-id="6f03e-505">Active Application Sharing Conferences</span></span>  <br/> |<span data-ttu-id="6f03e-506">正在进行的应用程序共享会议总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-506">Total number of ongoing application sharing conferences.</span></span>  <br/> |
|<span data-ttu-id="6f03e-507">参与者的人数</span><span class="sxs-lookup"><span data-stu-id="6f03e-507">Number of Participants</span></span>  <br/> |<span data-ttu-id="6f03e-508">当前连接到会议的参与者总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-508">Total number of participants currently connected to conferences.</span></span>  <br/> |
|<span data-ttu-id="6f03e-509">会议计划失败</span><span class="sxs-lookup"><span data-stu-id="6f03e-509">Conference Schedule Failure</span></span>  <br/> |<span data-ttu-id="6f03e-510">尝试安排会议时失败的总次数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-510">Total number of failures while trying to schedule a conference.</span></span>  <br/> |
|<span data-ttu-id="6f03e-511">加入会议失败</span><span class="sxs-lookup"><span data-stu-id="6f03e-511">Join Conference Failure</span></span>  <br/> |<span data-ttu-id="6f03e-512">尝试连接到会议时失败的总次数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-512">Total number of failures while trying to connect to a conference.</span></span>  <br/> |
   
<span data-ttu-id="6f03e-513">**UCWA 客户端计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-513">**UCWA Client Counters**</span></span>

|<span data-ttu-id="6f03e-514">**性能计数器**</span><span class="sxs-lookup"><span data-stu-id="6f03e-514">**Performance Counter**</span></span>|<span data-ttu-id="6f03e-515">**说明**</span><span class="sxs-lookup"><span data-stu-id="6f03e-515">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="6f03e-516">已成功联接的 IMMCU 总数</span><span class="sxs-lookup"><span data-stu-id="6f03e-516">Total Number of IMMCU Joins Succeeded</span></span>  <br/> |<span data-ttu-id="6f03e-517">已加入的即时消息会议的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-517">Total number of instant messaging conferences joined.</span></span>  <br/> |
|<span data-ttu-id="6f03e-518">已成功联接的 DMCU 总数</span><span class="sxs-lookup"><span data-stu-id="6f03e-518">Total Number of DMCU Joins Succeeded</span></span>  <br/> |<span data-ttu-id="6f03e-519">已加入/V 会议的总数。</span><span class="sxs-lookup"><span data-stu-id="6f03e-519">Total number of A/V conferences joined.</span></span>  <br/> |
