...
---
# <a name="prerequisites-and-setup-for-the-skype-for-busines-stress-and-performance-tool"></a>Skype for Busines 压力和性能工具的先决条件和设置
 
Skype for Business Server 2015 压力和性能工具的要求或先决条件。 如何安装或设置压力和性能工具。
  
我们在运行压力和性能工具之前，需要了解以下硬件、软件和系统配置要求：
...
此外，我们在下面还有一个有关安装 [Skype for Business Server 2015 压力和性能工具的部分](prerequisites-and-setup.md#Installing)
...
- 你需要安装 Microsoft .NET 4.5 Framework。 [在此处下载 .Net 4.5 Framework。](https://www.microsoft.com/download/details.aspx?id=30653)
    
- 你需要在 Windows 中启用桌面体验功能。
    
- 你需要安装 Microsoft Visual C++ 2013 (x64) 。 [在此处下载 Visual C++ 2013](https://www.microsoft.com/download/details.aspx?id=40784)
...
需要完成以下其他配置，以成功运行压力和性能工具：
  
- 您需要以 Domain 或 Local Administrator 组的成员登录服务器。
...
- 页面文件大小应进行系统管理，否则需要至少是计算机系统中 RAM 大小的 1.5 倍。
...
安装非常简单。 你需要在要用于模拟用户流量的每个客户端计算机上运行 Windows Installer 文件 **CapacityPlanningTool.msi，** 在将创建用户和联系人的每个池中的前端服务器上运行该文件。
  
若要下载 .msi 以及我们其他文章中提及的示例脚本，请转到下载中心链接 [：Skype for Business Server 2015](https://www.microsoft.com/download/details.aspx?id=50367)压力和性能工具。
