...
## [What's new in Business Server 的 Skype](../what-s-new-in-skype-for-business-server.md)
...
##### [同步到云中的用户和分配许可证](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/synchronize-users-to-the-cloud-and-assign-licenses.md)
...
##### [云连接器 Edition PSTN 网站规划](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/plan-for-cloud-connector-edition-pstn-sites.md)
##### [规划媒体绕过云连接器 Edition 中](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/plan-for-media-bypass-in-cloud-connector-edition.md)
#### [为业务云连接器 Edition 配置 Skype](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/configure-skype-for-business-cloud-connector-edition.md)
##### [准备云连接器 appliance](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/prepare-your-cloud-connector-appliance.md)
##### [部署云 Connector 中的单个网站](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/deploy-a-single-site-in-cloud-connector.md)
##### [部署云 Connector 中的多个站点](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/deploy-multiple-sites-in-cloud-connector.md)
##### [配置与 Office 365 租户云连接器集成](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/configure-cloud-connector-integration-with-your-office-365-tenant.md)
##### [验证您云连接器的部署](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/validate-your-cloud-connector-deployment.md)
...
#### [配置为音频会议提供商联盟](../skype-for-business-hybrid-solutions/deploy-hybrid-connectivity/configure-federation-for-an-audio-conferencing-provider.md)
#### [移动用户从内部部署到业务 online Skype](../skype-for-business-hybrid-solutions/deploy-hybrid-connectivity/move-users-from-on-premises-to-skype-for-business-online.md)
...
### [针对您的环境的要求](../plan-your-deployment/requirements-for-your-environment/requirements-for-your-environment.md)
...
### [视频互操作性服务器](../plan-your-deployment/video-interop-server.md)
...
##### [共享的行外观](../plan-your-deployment/enterprise-voice-solution/shared-line-appearance.md)
##### [闲选项](../plan-your-deployment/enterprise-voice-solution/busy-options.md)
#### [用单位电话呼叫](../plan-your-deployment/enterprise-voice-solution/call-via-work.md)
...
#### [创建并发布新拓扑](../deploy/install/create-and-publish-new-topology.md)
#### [安装 Business 服务器的 Skype](../deploy/install/install-skype-for-business-server.md)
#### [验证拓扑](../deploy/install/verify-the-topology.md)
### [升级到 Skype 业务服务器](../deploy/upgrade-to-skype-for-business-server.md)
### [部署用单位电话呼叫](../deploy/deploy-call-via-work.md)
...
#### [安装持久聊天的组件](../deploy/deploy-persistent-chat-server/install-persistent-chat-components.md)
...
### [部署视频互操作性服务器](../deploy/deploy-video-interop-server/deploy-video-interop-server.md)
...
#### [配置 CUCM 进行互操作](../deploy/deploy-video-interop-server/configure-cucm-for-interoperation.md)
...
#### [部署高级的企业语音功能](../deploy/deploy-enterprise-voice/deploy-advanced-enterprise-voice-features.md)
...
##### [部署媒体绕过](../deploy/deploy-enterprise-voice/deploy-media-bypass.md)
...
###### [自定义保持呼叫寄存音乐](../deploy/deploy-enterprise-voice/customize-call-park-music-on-hold.md)
###### [用户的启用呼叫寄存](../deploy/deploy-enterprise-voice/enable-call-park-for-users.md)
...
##### [组呼叫分拣的部署过程](../deploy/deploy-enterprise-voice/deployment-process-for-group-call-pickup.md)
###### [部署 SEFAUtil 工具](../deploy/deploy-enterprise-voice/deploy-the-sefautil-tool.md)
###### [创建或修改的组呼叫分拣号码范围](../deploy/deploy-enterprise-voice/create-or-modify-a-group-call-pickup-number-range.md)
###### [为用户启用组呼叫分拣和分配组数](../deploy/deploy-enterprise-voice/enable-group-call-pickup-for-users-and-assign-a-group-number.md)
##### [响应组部署过程](../deploy/deploy-enterprise-voice/deployment-process-for-response-group.md)
...
###### [创建的通知](../deploy/deploy-enterprise-voice/create-an-announcement.md)
...
#### [部署共享的行外观](../deploy/deploy-enterprise-voice/deploy-shared-line-appearance.md)
...
### [部署和配置 Mobility](../deploy/deploy-and-configure-mobility.md)
...
##### [Skype 的业务软件 liicense](../deploy/deploy-clients/skype-for-business-software-liicense.md)
##### [可管理性和工具](../deploy/deploy-clients/manageability-and-tools.md)
##### [会议室安装脚本](../deploy/deploy-clients/room-setup-scripts.md)
...
#### [修补程序或更新前端服务器](../manage/topology/patch-or-update-front-end-servers.md)
...
#### [修补程序或 SQL Server 更新](../manage/topology/patch-or-update-sql-server.md)
...
#### [监控数据的访问](../manage/health-and-monitoring/access-monitoring-data.md)
...
##### [创建或修改的 CDR 配置设置集合](../manage/health-and-monitoring/create-or-modify-a-collection-of-settings.md)
##### [删除现有的 CDR 配置设置集合](../manage/health-and-monitoring/delete-configuration-settings.md)
...
##### [呼叫诊断报告 （每个用户）](../manage/health-and-monitoring/call-diagnostic-reports-per-user.md)
...
###### [媒体质量标准分发报告](../manage/health-and-monitoring/media-quality-metrics-distribution-report.md)
...
##### [清除存档数据功能](../manage/archiving/purging-of-archived-data.md)
#### [策略](../manage/archiving/policies.md)
##### [创建新的策略](../manage/archiving/create-a-new-policy.md)
##### [更改现有的策略](../manage/archiving/change-an-existing-policy.md)
##### [将策略应用于用户](../manage/archiving/apply-a-policy-to-users.md)
...
### [容量规划计算器 （英文）](../management-tools/capacity-planning-calculator.md)
...
### [呼叫详细信息记录 (CDR) 数据库架构](../schema-reference/call-detail-recording-cdr-database-schema/call-detail-recording-cdr-database-schema.md)
...
### [用户体验 (QoE) 数据库架构的质量](../schema-reference/quality-of-experience-qoe-database-schema/quality-of-experience-qoe-database-schema.md)
...
#### [为业务 Server 控制面板管理员创建 Skype](../help-topics/help-depwiz/create-skype-for-business-server-control-panel-administrators.md)
#### [安装或更新 Skype 业务 Server 系统](../help-topics/help-depwiz/install-or-update-skype-for-business-server-system.md)
...
#### [部署向导： Windows Update](../help-topics/help-depwiz/deployment-wizard-windows-update.md)
...
#### [电话拨入访问号码： 创建新的或编辑现有的](../help-topics/help-lscp/dial-in-access-number-create-new-or-edit-existing.md)
#### [电话拨入访问号码](../help-topics/help-lscp/dial-in-access-number.md)
...
#### [Skype 业务 Server 控制面板的首次运行检查表](../help-topics/help-lscp/first-run-checklist-for-skype-for-business-server-control-panel.md)
...
#### [选择网站](../help-topics/help-lscp/select-a-site.md)
...
#### [选择从 Active Directory](../help-topics/help-lscp/select-from-active-directory.md)
...
#### [持久聊天外接程序主页页](../help-topics/help-lscp/persistent-chat-add-in-main-page.md)
#### [持久聊天类别](../help-topics/help-lscp/persistent-chat-category.md)
#### [持久聊天类别主页页](../help-topics/help-lscp/persistent-chat-category-main-page.md)
#### [持久聊天配置](../help-topics/help-lscp/persistent-chat-configuration.md)
#### [持久聊天配置主页页](../help-topics/help-lscp/persistent-chat-configuration-main-page.md)
#### [持久聊天策略](../help-topics/help-lscp/persistent-chat-policy.md)
#### [持久聊天策略主页页](../help-topics/help-lscp/persistent-chat-policy-main-page.md)
...
#### [添加中介服务器 NextHop](../help-topics/help-topobld/add-mediation-server-nexthop.md)
...
#### [将前端与 Office Web Apps Server 页关联](../help-topics/help-topobld/associate-front-end-with-office-web-apps-server-page.md)
...
#### [旧版合并添加扩展的边缘](../help-topics/help-topobld/legacy-merge-add-expanded-edge.md)
...
#### [Office Web Apps 服务器范围节点](../help-topics/help-topobld/office-web-apps-servers-scope-node.md)
...
#### [共享的组件范围节点](../help-topics/help-topobld/shared-components-scope-node.md)
...
#### [Trunk 范围节点](../help-topics/help-topobld/trunk-scope-node.md)
#### [Trunk 设置扩展器](../help-topics/help-topobld/trunk-settings-expander.md)
#### [Trunk 范围节点](../help-topics/help-topobld/trunks-scope-node.md)
...
#### [添加视频的网关 IP](../help-topics/help-topobld/add-video-gateway-ip.md)
#### [添加视频的网关的中继](../help-topics/help-topobld/add-video-gateway-trunk.md)
...
#### [添加 VIS 使用率](../help-topics/help-topobld/add-vis-usage.md)
...
#### [SIP 视频 Trunk 范围节点](../help-topics/help-topobld/sip-video-trunk-scope-node.md)
#### [SIP 视频 Trunk 设置扩展器](../help-topics/help-topobld/sip-video-trunk-setting-expander.md)
#### [SIP 视频 Trunk 范围节点](../help-topics/help-topobld/sip-video-trunks-scope-node.md)
#### [视频网关常规设置](../help-topics/help-topobld/video-gateway-general-settings.md)
#### [视频的网关范围](../help-topics/help-topobld/video-gateway-scope.md)
#### [视频的网关设置](../help-topics/help-topobld/video-gateway-setting.md)
#### [视频的网关范围](../help-topics/help-topobld/video-gateways-scope.md)
#### [视频互操作服务器常规设置](../help-topics/help-topobld/video-interop-server-general-settings.md)
#### [视频互操作性 Server 下一个跃点设置](../help-topics/help-topobld/video-interop-server-next-hop-settings.md)
#### [视频互操作服务器端口设置扩展器](../help-topics/help-topobld/video-interop-server-port-settings-expander.md)
#### [视频互操作性的服务器范围节点](../help-topics/help-topobld/video-interop-serverscope-the-node.md)
#### [视频互操作性服务器-范围节点](../help-topics/help-topobld/video-interop-serversscope-the-node.md)
#### [添加边缘服务器与单个 FQDN 页](../help-topics/help-topobld/add-edge-server-with-single-fqdn-page.md)
#### [测试-Skype 的业务 Server 站点范围节点](../help-topics/help-topobld/testskype-for-business-server-site-scope-node.md)
#### [Skype 的业务 Server 根范围节点](../help-topics/help-topobld/skype-for-business-server-root-scope-node.md)
