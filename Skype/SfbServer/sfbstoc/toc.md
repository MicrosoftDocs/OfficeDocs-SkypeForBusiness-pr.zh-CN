...
#### [云连接器版本中的媒体旁路规划](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/plan-for-media-bypass-in-cloud-connector-edition.md)
...
#### [升级至新版本的云连接器](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/upgrade-to-a-new-version-of-cloud-connector.md)
...
#### [使用 Operations Management Suite (OMS) 监视云连接器](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/monitor-cloud-connector-using-operations-management-suite-oms.md)
...
#### [对云连接器部署进行故障排除](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/troubleshoot-your-cloud-connector-deployment.md)
...
### [对你的环境的要求](../plan-your-deployment/requirements-for-your-environment/requirements-for-your-environment.md)
...
#### [负载均衡](../plan-your-deployment/network-requirements/load-balancing.md)
#### [DNS](../plan-your-deployment/network-requirements/dns.md)
##### [基本信息](../plan-your-deployment/network-requirements/basics.md)
##### [简单 URL](../plan-your-deployment/network-requirements/simple-urls.md)
##### [高级 Edge Server DNS](../plan-your-deployment/network-requirements/advanced-edge-server-dns.md)
...
#### [与 Office 的兼容性](../plan-your-deployment/clients-and-devices/compatibility-with-office.md)
...
### [高额用型和灾难恢复](../plan-your-deployment/high-availability-and-disaster-recovery/high-availability-and-disaster-recovery.md)
...
#### [高额用型和灾难恢复](../plan-your-deployment/persistent-chat-server/high-availability-and-disaster-recovery.md)
...
##### [呼叫管理控制](../plan-your-deployment/enterprise-voice-solution/call-admission-control.md)
...
####### [选择服务提供程序](../plan-your-deployment/enterprise-voice-solution/choose-a-service-provider.md)
...
##### [媒体旁路](../plan-your-deployment/enterprise-voice-solution/media-bypass.md)
...
###### [会议的 LBR](../plan-your-deployment/enterprise-voice-solution/lbr-for-conferencing.md)
...
##### [忙选项](../plan-your-deployment/enterprise-voice-solution/busy-options.md)
...
#### [统一的联系人存储库](../plan-your-deployment/integrate-with-exchange/unified-contact-store.md)
...
### [监视](../plan-your-deployment/monitoring.md)
...
#### [Edge 环境要求](../plan-your-deployment/edge-server-deployments/edge-environmental-requirements.md)
##### [高级 Edge Server DNS](../plan-your-deployment/network-requirements/advanced-edge-server-dns.md)
#### [应用场景](../plan-your-deployment/edge-server-deployments/scenarios.md)
...
#### [常见威胁](../plan-your-deployment/security/common-threats.md)
...
#### [寻址威胁](../plan-your-deployment/security/addressing-threats.md)
...
#### [关联监视存储情况](../deploy/deploy-monitoring/associate-a-monitoring-store.md)
...
#### [监控报告与镜像数据库](../deploy/deploy-monitoring/monitoring-reports-with-a-mirror-database.md)
#### [呼叫详细信息记录和 QoE](../deploy/deploy-monitoring/call-detail-recording-and-qoe.md)
#### [清除呼叫详细信息记录和 QoE](../deploy/deploy-monitoring/purgecall-detail-recording-and-qoe.md)
...
##### [多中继支持](../manage/voice-routing/multiple-trunk-support.md)
##### [内部中继路由](../manage/voice-routing/inter-trunk-routing.md)
##### [查看中继配置信息](../manage/voice-routing/view-trunk-configuration-information.md)
##### [配置中继（带媒体旁路）](../deploy/deploy-enterprise-voice/configure-trunk-with-media-bypass.md)
##### [配置中继（不带媒体旁路）](../deploy/deploy-enterprise-voice/configure-trunk-without-media-bypass.md)
...
#### [来电显示规则](../deploy/deploy-enterprise-voice/caller-id-presentation-rules.md)
#### [去电显示规则](../deploy/deploy-enterprise-voice/called-id-presentation-rules.md)
...
##### [配置语义邮件转义](../deploy/deploy-enterprise-voice/configure-voice-mail-escape.md)
...
###### [最终清单](../deploy/deploy-enterprise-voice/final-checklist.md)
...
##### [组内呼叫应答的部署流程](../deploy/deploy-enterprise-voice/deployment-process-for-group-call-pickup.md)
...
##### [响应组的部署流程](../deploy/deploy-enterprise-voice/deployment-process-for-response-group.md)
...
#### [SharePoint 以搜索存档数据](../deploy/integrate-with-exchange-server/sharepoint-to-search-for-archived-data.md)
#### [高分辨率照片](../deploy/integrate-with-exchange-server/high-resolution-photos.md)
#### [使用统一联系人存储](../deploy/integrate-with-exchange-server/use-the-unified-contact-store.md)
#### [Exchange 统一消息语音邮件](../deploy/integrate-with-exchange-server/exchangeunified-messaging-for-voice-mail.md)
#### [个人联系人存储](../deploy/integrate-with-exchange-server/personal-contacts-store.md)
#### [Outlook Web App](../deploy/integrate-with-exchange-server/outlook-web-app.md)
#### [在线和本地 OAuth](../deploy/integrate-with-exchange-server/oauth-with-online-and-on-premises.md)
...
#### [Office Web 应用服务器](../deploy/deploy-conferencing/office-web-app-server.md)
...
#### [验证 Edge 部署](../deploy/deploy-edge-server/validate-edge-deployment.md)
...
### [配置 Skype 会议直播](../deploy/configure-skype-meeting-broadcast.md)
...
#### [针对灾难恢复的前端池](../deploy/deploy-high-availability-and-disaster-recovery/front-end-pools-for-disaster-recovery.md)
#### [用于高可用性的 SQL 镜像](../deploy/deploy-high-availability-and-disaster-recovery/sql-mirroring-for-high-availability.md)
#### [为持久聊天配置 HADR](../deploy/deploy-persistent-chat-server/configure-hadr-for-persistent-chat.md)
## [管理](../manage/manage.md)
### [拓扑](../manage/topology/topology.md)
#### [管理前端服务器](../manage/topology/manage-front-end-servers.md)

#### [修补或更新后端服务器或 Standard Edition Server](../manage/topology/patch-or-update-a-back-end-or-standard-edition-server.md)
...
#### [高额用型和灾难恢复](../manage/persistent-chat/high-availability-and-disaster-recovery.md)
...
#### [监控移动性能](../manage/health-and-monitoring/monitor-mobility-performance.md)
##### [服务器内存容量限制](../manage/health-and-monitoring/server-memory-capacity-limits.md)
##### [服务和 UCWA 使用](../manage/health-and-monitoring/service-and-ucwa-usage.md)
...
##### [创建配置文件](../manage/archiving/create-a-configuration.md)
##### [删除配置文件](../manage/archiving/delete-a-configuration.md)
##### [启用或禁用存档](../manage/archiving/enable-or-disable-archiving.md)
##### [配置选项以处理故障](../manage/archiving/configure-options-to-handle-failures.md)
...
##### [查看](../manage/conferencing/view.md)
...
##### [配置策略以控制联盟用户访问](../manage/federation-and-external-access/external-access-policies/configure-policies-to-control-federated-user-access.md)
...
##### [分配外部用户访问策略](../manage/federation-and-external-access/external-access-policies/assign-an-external-user-access-policy.md)
...
##### [启用或禁用联盟伙伴发现](../manage/federation-and-external-access/access-edge/enable-or-disable-discovery-of-federation-partners.md)
...
#### [为 Skype for Business Online 客户配置联合身份验证支持](../manage/federation-and-external-access/federation-support/configuring-federation-support.md)

### 网络
#### [服务质量 (QoS)](../manage/network-management/qos/managing-quality-of-service-qos.md)
##### [为不基于 Windows 的设备启用 QoS](../manage/network-management/qos/enabling-qos-for-devices-that-are-not-based-on-windows.md)
##### [配置会议、应用程序和中介服务器的端口范围和 QoS 策略](../manage/network-management/qos/configuring-port-ranges-for-your-conferencing-application-and-mediation-servers.md)
##### [为 Edge Server 配置端口范围和 QoS 策略](../manage/network-management/qos/configuring-port-ranges-for-your-edge-servers.md)
##### [为 Skype for Business Server 客户端配置端口范围和 QoS 策略](../manage/network-management/qos/configuring-port-ranges-for-your-skype-clients.md)

#### 呼叫允许控制
##### [在 Skype for Business Server 上启用呼叫允许控制](../manage/network-management/call-admission-control/enabling-call-admission-control.md)
##### [在 Skype for Business Server 中管理网络带宽策略配置文件](../manage/network-management/call-admission-control/managing-network-bandwidth-policy-profiles.md)
##### [在 Skype for Business Server 中管理网络区域](../manage/network-management/call-admission-control/managing-network-regions.md)
##### [在 Skype for Business Server 中管理网络区域路由](../manage/network-management/call-admission-control/managing-network-region-routes.md)
##### [在 Skype for Business Server 中管理站点的呼叫允许控制](../manage/network-management/call-admission-control/managing-call-admission-control-for-sites.md)
##### [在 Skype for Business Server 中启用和禁用媒体旁路](../manage/network-management/call-admission-control/enabling-and-disabling-media-bypass.md)
##### [在 Skype for Business Server 中链接网络区域](../manage/network-management/call-admission-control/linking-network-regions.md)
##### [在 Skype for Business Server 中管理网络子网](../manage/network-management/call-admission-control/managing-network-subnets.md)

#### [网络接口](../manage/network-management/viewing-network-interface-information.md)

#### [阻止新连接](../manage/network-management/prevent-new-connections.md)
...
##### [配置双因素身份验证](../manage/authentication/configure-two-factor.md)
##### [使用双重身份验证](../manage/authentication/use-two-factor.md)

### [增强型 9-1-1 和位置服务](../manage/enhanced-9-1-1-and-location-service.md)

### [受信任的应用程序](../manage/trusted-applications.md)
...
#### [对池进行故障转移和故障回复](../manage/ha-dr-and-backup-service/failing-over-and-failing-back-a-pool.md)
...
#### [计划](../management-tools/call-quality-dashboard/plan.md)
...
####### [获取项目](../management-tools/call-quality-dashboard/get-items.md)
####### [获取项目](../management-tools/call-quality-dashboard/get-item.md)
####### [获取子项](../management-tools/call-quality-dashboard/get-sub-items.md)
####### [获取项目上级](../management-tools/call-quality-dashboard/get-item-ancestors.md)
...
### [集中日志服务](../management-tools/centralized-logging-service/centralized-logging-service.md)
...
##### [配置应用场景](../management-tools/centralized-logging-service/configure-scenarios.md)
...
#### [配置 Primary](../management-tools/use-scom-management-pack/configure-the-primary.md)
...
#### [计划](../management-tools/statistics-manager/plan.md)
...
### [资源套件工具](../management-tools/resource-kit-tools.md)
...
#### [审阅管理员报告](../management-tools/planning-tool/review-the-administrator-reports.md)
#### [UI 参考](../management-tools/planning-tool/ui-reference.md)
...
##### [监视](../management-tools/planning-tool/monitoring.md)
...
#### [应用场景](../management-tools/stress-and-performance-tool/scenarios.md)
##### [预配拓扑以运行负载](../management-tools/stress-and-performance-tool/provisioning-the-topology-to-run-load.md)
...
#### [常见问题解答](../management-tools/stress-and-performance-tool/faq.md)
## [架构参考](../schema-reference/schema-reference.md)
...
#### [CDR 视图列表](../schema-reference/call-detail-recording-cdr-database-schema/list-of-cdr-views.md)
...
### [体验质量 (QoE) 数据库架构](../schema-reference/quality-of-experience-qoe-database-schema/quality-of-experience-qoe-database-schema.md)
#### [QoE 表列表](../schema-reference/quality-of-experience-qoe-database-schema/list-of-qoe-tables.md)
...
#### [QoE 视图列表](../schema-reference/quality-of-experience-qoe-database-schema/qoe-view-details.md)
...
#### [持久聊天服务器表列表](../schema-reference/persistent-chat-database-schema/list-of-persistent-chat-server-tables.md)
#### [持久聊天服务器合规性表列表](../schema-reference/persistent-chat-database-schema/list-of-persistent-chat-server-compliance-tables.md)
...
### [Active Directory 架构扩展名、类和属性](../schema-reference/active-directory-schema-extensions-classes-and-attributes/active-directory-schema-extensions-classes-and-attributes.md)
...
#### [按类排列的架构属性](../schema-reference/active-directory-schema-extensions-classes-and-attributes/schema-attributes-by-class.md)
...
#### [Grant-CsSetupPermission 所做的更改](../schema-reference/active-directory-schema-extensions-classes-and-attributes/changes-made-by-grant-cssetuppermission.md)
#### [Grant-CsOUPermission 所做的更改](../schema-reference/active-directory-schema-extensions-classes-and-attributes/changes-made-by-grant-csoupermission.md)
## 帮助主题
### Help-DepWiz
...
#### [安装或删除 Skype for Business Server 组件（调用）](../help-topics/help-depwiz/setup-or-remove-skype-for-business-server-components-invoke.md)
...
#### [待处理的证书请求（已返回）](../help-topics/help-depwiz/pending-certificate-returned.md)
...
#### [证书请求（已生成证书签名请求）](../help-topics/help-depwiz/certificate-request-certificate-signing-request-generated.md)
...
#### [证书请求（联机脱机）](../help-topics/help-depwiz/certificate-request-online-offline.md)
...
#### [StartServices（简介）](../help-topics/help-depwiz/startservices-intro.md)
...
#### [部署向导：MSI 安装程序路径](../help-topics/help-depwiz/deployment-wizard-path-to-msi-installer.md)
...
#### [访问 Edge 配置：编辑](../help-topics/help-lscp/access-edge-configuration-edit.md)
#### [访问 Edge 配置](../help-topics/help-lscp/access-edge-configuration.md)
...
#### [SIP 联盟提供程序](../help-topics/help-lscp/sip-federated-providers.md)
...
#### [用户体验质量 (QoE) 数据：创建新的或编辑现有的](../help-topics/help-lscp/quality-of-experience-qoe-data-create-new-or-edit-existing.md)
#### [用户体验质量 (QoE) 数据](../help-topics/help-lscp/quality-of-experience-qoe-data.md)
...
#### [拓扑：查看简单 URL 的详细信息l](../help-topics/help-lscp/topology-view-simple-url-detail.md)
...
#### [保存语音路由测试案例信息](../help-topics/help-lscp/save-voice-routing-test-case-information.md)
...
#### [未分配的电话号码：创建新的编辑现有的](../help-topics/help-lscp/unassigned-phone-number-create-new-or-edit-existing.md)
#### [未分配的电话号码](../help-topics/help-lscp/unassigned-phone-number.md)
...
#### [语音策略：语音路由配置的提交更改状态](../help-topics/help-lscp/voice-routing-status-of-commit-changes-for-voice-routing-configuration.md)
...
#### [测试语音路由：创建新的或编辑现有的测试案例](../help-topics/help-lscp/test-voice-routing-create-new-or-edit-existing-test-cases.md)
#### [测试语音路由：测试案例](../help-topics/help-lscp/test-voice-routing-test-cases.md)
...
#### [持久聊天加载项](../help-topics/help-lscp/persistent-chat-add-in.md)
#### [持久聊天加载项主页](../help-topics/help-lscp/persistent-chat-add-in-main-page.md)
...
#### [新的呼叫号码转换规则](../help-topics/help-lscp/new-calling-number-translation-rule.md)
#### [选择呼叫号码转换规则](../help-topics/help-lscp/select-calling-number-rules-translation.md)
...
#### [添加存档服务器 SQL Server 存储](../help-topics/help-topobld/add-archiving-server-sql-server-store.md)
#### [添加 A/V MCU 机器](../help-topics/help-topobld/add-a-v-mcu-machine.md)
...
#### [添加控制器机器](../help-topics/help-topobld/add-director-machine.md)
...
#### [添加 Edge 机器外部 IP 2010](../help-topics/help-topobld/add-edge-machine-external-ip-2010.md)
#### [添加 Edge 机器外部 IP IPv4](../help-topics/help-topobld/add-edge-machine-external-ipv4.md)
#### [添加 Edge 机器外部 IP IPv6](../help-topics/help-topobld/add-edge-machine-external-ipv6.md)
#### [添加 Edge 机器内部 IP](../help-topics/help-topobld/add-edge-machine-internal-ip.md)
#### [添加 Edge 机器内部 IP 2010](../help-topics/help-topobld/add-edge-machine-internal-ip-2010.md)
#### [添加 Edge 机器 NAT IP](../help-topics/help-topobld/add-edge-machine-nat-ip.md)
#### [添加 Edge 机器 NAT IP 2010](../help-topics/help-topobld/add-edge-machine-nat-ip-2010.md)
#### [添加 Edge Server 关联](../help-topics/help-topobld/add-edge-server-associations.md)
#### [添加 Edge Server 外部 IP 2010](../help-topics/help-topobld/add-edge-server-external-ip-2010.md)
#### [添加 Edge Server 外部 IPv4](../help-topics/help-topobld/add-edge-server-external-ipv4.md)
#### [添加 Edge Server 外部 IPv6](../help-topics/help-topobld/add-edge-server-external-ipv6.md)
#### [添加 Edge Server FQDN](../help-topics/help-topobld/add-edge-server-fqdn.md)
#### [添加 Edge Server 内部 IP](../help-topics/help-topobld/add-edge-server-internal-ip.md)
#### [添加 Edge Server 内部 IP 2010](../help-topics/help-topobld/add-edge-server-internal-ip-2010.md)
#### [添加 Edge Server IP 选项](../help-topics/help-topobld/add-edge-server-ip-options.md)
#### [添加 Edge Server NAT IP](../help-topics/help-topobld/add-edge-server-nat-ip.md)
#### [添加 Edge Server NAT IP 2010](../help-topics/help-topobld/add-edge-server-nat-ip-2010.md)
#### [添加 Edge Server 下一个跃点](../help-topics/help-topobld/add-edge-server-next-hop.md)
#### [添加 Edge Server 选项](../help-topics/help-topobld/add-edge-server-options.md)
#### [为 Lync Server 2010 添加 Edge Server 选项](../help-topics/help-topobld/add-edge-server-options-for-lync-server-2010.md)
#### [添加 Edge Server](../help-topics/help-topobld/add-edge-server.md)
#### [添加 Edge Server 支持](../help-topics/help-topobld/add-edge-server-support.md)
#### [添加受信任应用程序机器](../help-topics/help-topobld/add-trusted-application-machine.md)
#### [添加受信任应用程序服务器下一个跃点](../help-topics/help-topobld/add-nexthop-trusted-application-server.md)
...
#### [添加前端机器](../help-topics/help-topobld/add-front-end-machine.md)
#### [添加前端监控存储页面](../help-topics/help-topobld/add-front-end-monitoring-store-page.md)
...
#### [为 Lync Server 2010 添加前端 SQL Store 页面](../help-topics/help-topobld/add-front-end-sql-store-page-for-lync-server-2010.md)
#### [添加前端 Web 服务](../help-topics/help-topobld/add-front-end-web-services.md)
#### [添加服务器](../help-topics/help-topobld/add-server.md)
#### [添加中介机器](../help-topics/help-topobld/add-mediation-machine.md)
#### [添加中介服务器下一个跃点](../help-topics/help-topobld/add-mediation-server-nexthop.md)
...
#### [在持久聊天池中定义计算机](../help-topics/help-topobld/define-computers-in-persistent-chat-pool.md)
#### [为持久聊天池定义属性和选项](../help-topics/help-topobld/define-properties-and-options-for-persistent-chat-pool.md)
...
#### [定义新 IP 或 PSTN 网关的根中继](../help-topics/help-topobld/define-the-root-trunk-for-a-new-ip-or-pstn-gateway.md)
...
#### [定义新中继](../help-topics/help-topobld/define-a-new-trunk.md)
...
#### [将分支机构设备与 Edge 关联](../help-topics/help-topobld/associate-branch-office-appliance-with-edge.md)
...
#### [将前端与 Edge 关联](../help-topics/help-topobld/associate-front-end-with-edge.md)
#### [将前端与监控关联](../help-topics/help-topobld/associate-front-end-with-monitoring.md)
#### [将前端与 Office Web Apps Server 页面关联](../help-topics/help-topobld/associate-front-end-with-office-web-apps-server-page.md)
#### [将中介服务器与 Edge 关联](../help-topics/help-topobld/associate-mediation-server-with-edge.md)
...
#### [面向 Lync Server 2010 的分支机构设备常规设置扩展器](../help-topics/help-topobld/branch-office-appliance-general-settings-expander-for-lync-server-2010.md)
...
#### [适合于 Lync Server 2010 的控制器常规设置扩展器](../help-topics/help-topobld/director-general-settings-expander-for-lync-server-2010.md)
#### [控制器范围节点](../help-topics/help-topobld/director-scope-node.md)
#### [控制器范围节点](../help-topics/help-topobld/directors-scope-node.md)
#### [Edge Server FQDN 设置扩展器](../help-topics/help-topobld/edge-server-fqdns-settings-expander.md)
#### [适合于 Lync Server 2010 的 Edge Server FQDN 设置扩展器](../help-topics/help-topobld/edge-server-fqdn-settings-expander-for-lync-server-2010.md)
#### [Edge 机器设置扩展器](../help-topics/help-topobld/edge-machine-settings-expander.md)
#### [适合于 Lync Server 2010 的 Edge 机器设置](../help-topics/help-topobld/edge-machine-settings-expander-for-lync-server-2010.md)
#### [Edge 下一个跃点设置扩展器](../help-topics/help-topobld/edge-next-hop-settings-expander.md)
#### [Edge Server 添加机器](../help-topics/help-topobld/edge-server-add-machine.md)
#### [Edge Server 范围节点](../help-topics/help-topobld/edge-server-scope-node.md)
#### [Edge Server 范围节点](../help-topics/help-topobld/edge-servers-scope-node.md)
#### [Edge 设置扩展器](../help-topics/help-topobld/edge-settings-expander.md)
#### [编辑适合于 Lync Server 2010 的 Edge 设置扩展器](../help-topics/help-topobld/edit-edge-settings-expander-for-lync-server-2010.md)
...
#### [适合于 Lync Server 2010 的前端中介服务设置扩展器](../help-topics/help-topobld/front-end-mediation-service-settings-expander-for-lync-server-2010.md)
...
#### [适合于 Lync Server 2010 的前端常规设置扩展器](../help-topics/help-topobld/front-end-general-settings-expander-for-lync-server-2010.md)
...
#### [前端开始页面](../help-topics/help-topobld/front-end-start-page.md)
#### [安装和创建数据库](../help-topics/help-topobld/install-and-create-databases.md)
#### [安装数据库创建镜像数据库页面](../help-topics/help-topobld/install-database-create-mirror-database-page.md)
#### [安装数据库选项页面](../help-topics/help-topobld/install-database-options-page.md)
#### [安装镜像数据库选项页面](../help-topics/help-topobld/install-mirror-database-option-page.md)
#### [旧版合并添加扩展的 Edge](../help-topics/help-topobld/legacy-merge-add-expanded-edge.md)
#### [旧版合并添加机器](../help-topics/help-topobld/legacy-merge-add-machine.md)
#### [旧版合并](../help-topics/help-topobld/legacy-merge.md)
#### [旧版合并 Edge 类型](../help-topics/help-topobld/legacy-merge-edge-type.md)
#### [旧版合并 FQDN](../help-topics/help-topobld/legacy-merge-fqdn.md)
#### [旧版合并登录](../help-topics/help-topobld/legacy-merge-landing.md)
...
#### [旧版合并摘要页面](../help-topics/help-topobld/legacy-merge-summary-page.md)
...
#### [机器范围节点](../help-topics/help-topobld/machine-scope-node.md)
#### [服务器设置扩展器](../help-topics/help-topobld/server-settings-expander.md)
#### [适合于 Lync Server 2010 的服务器设置扩展器](../help-topics/help-topobld/server-settings-expander-for-lync-server-2010.md)
#### [中介下一个跃点设置扩展器](../help-topics/help-topobld/mediation-next-hop-settings-expander.md)
#### [中介服务器常规设置扩展器](../help-topics/help-topobld/mediation-server-general-settings-expander.md)
#### [适合于 Lync Server 2010 的中介服务器常规设置扩展器](../help-topics/help-topobld/mediation-server-general-settings-expander-for-lync-server-2010.md)
...
#### [Office Web Apps Server 范围节点扩展器](../help-topics/help-topobld/office-web-apps-server-scope-node-expander.md)
#### [编辑 Office Web Apps Server 设置](../help-topics/help-topobld/edit-office-web-apps-server-settings.md)
#### [Office Web Apps Server 范围节点](../help-topics/help-topobld/office-web-apps-servers-scope-node.md)
...
#### [持久聊天机器扩展器](../help-topics/help-topobld/persistent-chat-machines-expander.md)
#### [持久聊天下一个跃点设置扩展器](../help-topics/help-topobld/persistent-chat-next-hop-settings-expander.md)
...
#### [发布拓扑创建镜像数据库页面](../help-topics/help-topobld/publish-topology-create-mirror-database-page.md)
#### [发布拓扑下一步](../help-topics/help-topobld/publish-topology-next-step.md)
#### [发布拓扑重设池页面](../help-topics/help-topobld/publish-topology-reset-pool-page.md)
...
#### [适合于 Lync Server for 2010 的注册器设置扩展器](../help-topics/help-topobld/registrar-settings-expander-for-lync-server-for-2010.md)
...
#### [为 Lync Server 2010 添加控制器关联](../help-topics/help-topobld/add-director-association-for-lync-server-2010.md)
#### [将控制器与 Lync Server 2010 监控页面关联](../help-topics/help-topobld/associate-director-with-monitoring-page-for-lync-server-2010.md)
#### [添加前端 Web 服务 2010](../help-topics/help-topobld/add-front-end-web-services-2010.md)
#### [添加持久聊天下一个跃点页面](../help-topics/help-topobld/add-persistent-chat-next-hop-page.md)
...
#### [添加 VIS 机器](../help-topics/help-topobld/add-vis-machine.md)
#### [添加 VIS 下一个跃点](../help-topics/help-topobld/add-vis-next-hop.md)
#### [添加 VIS 使用](../help-topics/help-topobld/add-vis-usage.md)
#### [将 VIS 与 Edge 关联](../help-topics/help-topobld/associate-vis-with-edge.md)
...
#### [视频互操作服务器下一个跃点设置](../help-topics/help-topobld/video-interop-server-next-hop-settings.md)
#### [视频互操作服务器端口设置扩展器](../help-topics/help-topobld/video-interop-server-port-settings-expander.md)
#### [视频互操作服务器 - 范围节点](../help-topics/help-topobld/video-interop-serverscope-the-node.md)
#### [视频互操作服务器 - 范围节点](../help-topics/help-topobld/video-interop-serversscope-the-node.md)
#### [添加带有单个 FQDN 页面的 Edge Server](../help-topics/help-topobld/add-edge-server-with-single-fqdn-page.md)
#### [测试 - Skype for Business Server 站点范围节点](../help-topics/help-topobld/testskype-for-business-server-site-scope-node.md)
