...
|**版本**|**建议**|
|:-----|:-----|
|Lync Server 2013  <br/> | 若要升级，请Skype for Business Server池关联的每台服务器上使用 In-Place 拓扑生成器和新的"升级"功能。 有关详细步骤，请参阅 Plan [to upgrade from Lync Server 2013 to Skype for Business Server 2015](upgrade.md#BKMK_PlanUpgradeFromLync2013)和 Upgrade to Skype for Business Server [2015。](../deploy/upgrade-to-skype-for-business-server.md) <br/> |
