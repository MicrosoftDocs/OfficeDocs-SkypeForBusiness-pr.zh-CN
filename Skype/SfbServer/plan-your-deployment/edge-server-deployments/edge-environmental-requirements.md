...
至少需要提供的公共证书颁发机构 (CA) 分配给您的外部边缘服务器接口的证书。 我们无法向你推荐某一家具体的 CA，但是我们确实有一份 CA 名单“[统一通信证书合作伙伴](https://support.microsoft.com/en-us/kb/929395)”，你可以查看此名单来了解你首选的 CA 是否列在其中。
