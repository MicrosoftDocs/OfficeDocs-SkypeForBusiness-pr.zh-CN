...
![使用公用 IP 的单一合并边缘的边缘方案。](../../media/Plan_LyncServer_Edge_Scenario_SingleConsolidatedEdgePublicIP.jpg)
...
![扩展的合并边缘（使用 NAT 的专用 IP 的 DNS LB）的边缘方案。](../../media/Plan_LyncServer_Edge_Scenario_ScaledConsolidatedEdgeDNSLBPrivateIP.jpg)
