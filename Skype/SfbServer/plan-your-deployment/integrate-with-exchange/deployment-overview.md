...
|企业语音用户启用 Exchange UM。  <br/> |在 Exchange UM 服务器上，确保已创建了统一消息邮箱策略和每个用户都有一个唯一的分机号码分配，，然后启用统一消息的用户。  <br/> |Exchange 收件人管理员  <br/> |对于 Exchange 2010 或最新的 Service Pack，请参阅[为用户启用统一消息](https://go.microsoft.com/fwlink/p/?LinkId=268701)。  <br/> 有关 Exchange 2013，请参阅[统一消息](https://go.microsoft.com/fwlink/p/?LinkId=266579)。  <br/> |
