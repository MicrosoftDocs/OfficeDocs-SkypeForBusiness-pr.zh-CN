...
您应部署一台边缘服务器的每个 12,000 个远程用户向将同时访问网站。 至少建议的高可用性的两个边缘服务器。 这些建议假定为边缘服务器的硬件满足[硬件与 Server Hardware Platforms](https://technet.microsoft.com/library/c964c1c0-0153-472b-88ad-a38866e0df0c.aspx)中的建议。
...
如果您部署控制器服务器角色，我们建议您部署的每个 12,000 个远程用户向将同时访问网站的一台控制器。 至少建议高可用性的两个的控制器。 这些建议假定为边缘服务器的硬件满足[硬件与 Server Hardware Platforms](https://technet.microsoft.com/library/c964c1c0-0153-472b-88ad-a38866e0df0c.aspx)中的建议。
...
下表提供了有关多少并发呼叫中介服务器可以处理，假定中介服务器的硬件满足[硬件与 Server Hardware Platforms](https://technet.microsoft.com/library/c964c1c0-0153-472b-88ad-a38866e0df0c.aspx)中的要求和启用了超线程的准则。 有关中介服务器可伸缩性的详细信息，请参阅[估算语音用法和 Skype 业务服务器通信](estimating-voice-traffic.md)和[Skype 业务服务器中的中介服务器的部署指南](mediation-server-deployment-guidelines.md)。
