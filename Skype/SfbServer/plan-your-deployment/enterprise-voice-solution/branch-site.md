...
在某些情况下，您可能需要在选定的分支站点实施分布式 SIP 中继。 若要确定分支站点是否需要 SIP 中继，以及有关在分支站点中部署 SIP 中继支持的拓扑选项的详细信息，请参阅 sip [trunking in Skype for Business Server](sip-trunking.md)。
