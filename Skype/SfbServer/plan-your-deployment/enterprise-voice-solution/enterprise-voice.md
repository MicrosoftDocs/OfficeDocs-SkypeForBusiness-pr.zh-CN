...
description: 企业语音规划基础知识Skype for Business Server，包括站点、区域、站点之间的网络链接以及估计语音使用流量。
...
企业语音规划基础知识Skype for Business Server，包括站点、区域、站点之间的网络链接以及估计语音使用流量。
...
首先，确定拓扑中要部署企业语音的站点以及这些站点所属的网络区域。 特别是，考虑如何将公用电话交换网 (PSTN) 连接到每个站点。 由于可管理性和物流方面的原因，这些站点所属的区域可能是一个决定性因素。 确定将在本地部署网关、将部署 Survivable Branch Appliances (SBA) 以及在本地或中央站点 (配置 SIP 中继) 到 Internet 电话服务提供商 (ITSP) 。
