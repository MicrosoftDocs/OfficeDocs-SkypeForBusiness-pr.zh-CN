...
> Skype for Business Server 为处理分支机构中的语音恢复能力提供了若干策略，包括：拥有可恢复的数据网络、在每个分支部署 SIP 中继或在中断期间将呼叫推送到本地网关。 有关详细信息，请参阅 sip [trunking in Skype for Business Server](sip-trunking.md)。
