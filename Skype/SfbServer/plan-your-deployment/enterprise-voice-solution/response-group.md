...
响应组扩展也到部门或工作组环境 （有关详细信息，请参阅[容量规划响应组](http://technet.microsoft.com/library/a2459a69-1f45-4f2f-bca5-d4f442708e44.aspx)），并且可以部署在全新的电话安装中。 它支持从企业语音部署和当地运营商网络的传入呼叫。 代理可以使用适用于商务、 Lync 2013，Lync 2010，Lync 2010 Attendant 或 Lync Phone Edition 的 Skype 才能向其路由呼叫。
...
|**指标**|**每个企业版池<br/>（具有 8 前端服务器）**|**每台 Standard Edition 服务器**|
|:-----|:-----|:-----|
