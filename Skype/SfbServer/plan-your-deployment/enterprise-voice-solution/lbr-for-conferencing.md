...
New-csserverapplication-Identity Service: Registrar:<Pool FQDN>/LBRouting-优先级<Application Priority>-启用 $true-关键 $true Urihttp://www.microsoft.com/LCS/LBRoutingFor示例：
  
New-csserverapplication-Identity Service:Registrar:LS2013CU2LBRPool.contoso.com/LBRouting-优先级 3-启用的 $true-关键 $true Urihttp://www.microsoft.com/LCS/LBRoutingAfter使用此 cmdlet，重新启动所有前端服务器池或 Standard Edition Server 位置已启用的会议应用程序的基于位置的路由。
