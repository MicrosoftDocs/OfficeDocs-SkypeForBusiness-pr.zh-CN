...
通知应用程序支持 Wave (.wav) 文件格式和 Windows Media 音频 (.wma) 文件格式音乐和公告。 通知应用程序的音频文件要求都与响应组应用程序相同。 有关详细信息，请参阅[响应组的技术要求](http://technet.microsoft.com/library/477488bd-124f-437b-9327-732a0d7271ca.aspx)。
