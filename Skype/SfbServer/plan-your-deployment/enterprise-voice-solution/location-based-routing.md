...
||**启用基于位置的路由的网络站点的用户终结点**|**用户终结点位于未知的网络站点，或者未启用基于位置的路由**|
|:-----|:-----|:-----|
...
|**用户启动呼叫转接/转接**|**目标终结点位于同一用户启动呼叫转移或正向网络站点**|**位于作为用户启动呼叫转移或正向不同的网络站点目标终结点**|**目标终结点是未知的网络站点或网络站点中未启用基于位置的路由**|
|:-----|:-----|:-----|:-----|
...
|**呼叫转接/转接终结点目标**|**Skype 业务用户的同一个网络站点**|**Skype 业务用户的不同的网络站点**|**一个或两个未知的网络站点或未启用基于位置的路由的网络站点中的业务用户的 Skype**|
|:-----|:-----|:-----|:-----|
...
|**传入 PSTN 呼叫**|**位于被叫方的同一网络站点**|**在不同的网络站点比被叫方位于**|**位于未知的网络站点或未启用基于位置的路由**|
|:-----|:-----|:-----|:-----|
...
|**同时拨打目标**|**位于被叫方的同一网络站点**|**在不同的网络站点比被叫方位于**|**位于未知的网络站点或未启用基于位置的路由**|
|:-----|:-----|:-----|:-----|
