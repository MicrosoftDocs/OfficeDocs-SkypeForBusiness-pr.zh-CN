...
此内容与 Skype 业务 Server security。 安全是一个非常广泛的主题。 安全达到跨 Skype 每个功能的业务服务器以及数据库、 服务和硬件构成生态系统。 此内容已 Skype 业务服务器有关的特定安全性主题的补充。
  
## <a name="in-this-section"></a>本节内容

- [防病毒扫描排除的 Skype 业务服务器](antivirus.md)
...
- [防范对核心基础结构的威胁 Skype 业务服务器](addressing-threats.md)
