...
若要确定您的硬件负载平衡器是否支持所需的 Skype 业务服务器所需的功能，请参阅[for Business 的 Skype 的基础结构](https://technet.microsoft.com/en-us/office/dn947483)。
...
> [!CAUTION]
> 有关第三方硬件负载平衡器的详细信息，请参阅[for Business 的 Skype 的基础结构](https://technet.microsoft.com/en-us/office/dn947483)。 
