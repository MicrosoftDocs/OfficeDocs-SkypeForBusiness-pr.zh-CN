...
Skype 业务服务器不支持电话拨入式会议的语音提示和保持音乐的自定义项。 但是，如果您有一项强的业务需求，需要更改默认音频文件，请参阅 Microsoft 知识库文章 961177，[如何自定义语音提示或为电话拨入式音频会议的音乐文件](http://go.microsoft.com/fwlink/p/?linkid=3052&amp;kbid=961177)。
