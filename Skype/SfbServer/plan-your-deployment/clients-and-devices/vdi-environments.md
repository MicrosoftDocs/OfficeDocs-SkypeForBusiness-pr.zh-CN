...
Citrix 的 VDI 环境插件 (XenApp 和 XenDesktop) 的一项功能与 Lync 2013 和 Skype for Business 2015 和 2016 (完整客户端兼容，使用任意单击即可运行安装程序，或在虚拟桌面上安装 2017 年 1 月 PU) 客户端后发布的 MSI 安装程序。 其整体功能基于 Microsoft Lync VDI 插件，但它适用于更广泛的客户端操作系统，包括 Windows 10、Macintosh 和 Linux。
