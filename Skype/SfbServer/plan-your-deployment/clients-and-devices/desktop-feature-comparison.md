...
**摘要：** Skype for Business Server 2015 或 Skype for Business Online 管理员可以使用这些表了解哪些客户端支持哪些功能。
 ...
 在部署或升级到 Skype for Business 之前，请检查组织中已在使用哪些客户端。 使用下表了解功能支持对这些客户端的影响。 这可以帮助您将更改传达给用户、加快推出过程，并完全了解升级到最新客户端的好处。
  
Skype for Business Server 2015 中提供某些功能在 Skype for Business Online 中不可用，请参阅 ["联机](desktop-feature-comparison.md#Online-Hybrid) "或"混合"用户帐户限制了解具体信息。 Skype for Business Online 管理员可能想要参考 [Skype for Business Online 服务说明](https://technet.microsoft.com/library/skype-for-business-online-service-description.aspx) ，了解他们可用的不同计划。

有关 [Skype for Business Server 2019](../../../SfBServer2019/plan/feature-comparison.md) 上的客户端支持，请参阅 Skype for Business 2019 的桌面客户端功能比较。
  
下表显示了适用于适用于 Skype for Business Server 2015 或 Skype for Business Online 的每个客户端的功能。 对于智能手机和平板电脑客户端功能比较，你可能还需要参考 [Skype for Business](mobile-feature-comparison.md) 的移动客户端功能比较。 组织购买的客户端访问许可证或用户订阅许可证还会影响哪些功能可供用户使用。 向用户部署完整客户端还是基本客户端取决于组织选择购买的许可证或计划。 有关详细信息 [，请参阅许可](https://products.office.com/skype-for-business/it-pros) 指南。
  
> [!IMPORTANT]
> Skype for Business Server 2015 和 Skype for Business Online 支持以下以前发布的客户端：Lync 2013、Lync 2010、Lync 2010 Mobile、Lync Phone Edition 和 Lync 2010 Attendant。 有关与其他服务器一同使用的这些客户端的信息，请参阅 [Lync Server 2013](https://technet.microsoft.com/library/gg425836%28v=ocs.15%29.aspx) 的客户端比较表和 [Lync Server 2010 的客户端比较表](https://technet.microsoft.com/library/gg425836%28v=ocs.14%29.aspx)。

> [!NOTE]
> **Lync 2010 Attendant** 客户端在 Skype for Business Online 中不受支持。

> [!NOTE]
> Skype for Business Web App 浏览器客户端和 Skype 会议应用 Windows 10 应用仅提供 [会议支持](desktop-feature-comparison.md#BKMK_Conferencing)。 有关这些 [客户端 (请参阅"规划会议 ](meetings-clients.md)) Web App 和会议应用程序。
...
|添加自定义位置 |&#x2714;|&#x2714;|&#x2714;|&#x2714;||||||
|添加自定义注释 |&#x2714;|&#x2714;|&#x2714;|&#x2714;|&#x2714;|&#x2714;||&#x2714;|&#x2714;|
|将来自任何公共网站的照片用于 Skype for Business Online (中不可用的"我的图片")  |&#x2714;||&#x2714;|||||||
...
|在 Outlook 中记录 IM 对话 |&#x2714;|&#x2714;如果打开服务器端对话历史记录  |&#x2714;|&#x2714;|&#x2714;|&#x2714;||保存在 Communicator for Mac 中 |保存在 Lync for Mac 中 |
|使用准备好的对话模板 |||||&#x2714;|&#x2714;||||
|检查拼写 |&#x2714;|&#x2714;||&#x2714;|||||&#x2714;|
...
|使用拨入音频会议 |&#x2714; &#x2777; |&#x2714;|&#x2714; &#x2777; |&#x2714;|&#x2714; &#x2777; |&#x2714; &#x2777; |&#x2714;|&#x2714;|||&#x2714;|
|启动"立即开会"会议 |&#x2714;|&#x2714;||&#x2714;|&#x2714;|&#x2714;|&#x2714;||||&#x2714;|
|添加并演示 Microsoft PowerPoint 文件 |&#x2714;| &#x2778;注释不可用 |&#x2714;|&#x2714;|&#x2714;|仅呈现 |&#x2714;|||| &#x2778;查看，批注不可用 |
...
|向响应组发起呼叫 |&#x2714;||&#x2714; &#x2776; ||&#x2714;|&#x2714;||||
|支持 E-911 (E-911)   |&#x2714;|&#x2714;需要 Skype for Business Server 2015 CU6 或更高版本 |&#x2714; &#x2776; ||&#x2714;|&#x2714;|&#x2714;||&#x2714;|
...
|文件传输、共享 OneNote 页面和 PowerPoint 注释的客户端存档  <br/>  (Skype for Business Online) |&#x2714;||&#x2714;||&#x2714;|||||
...
- 更改问候语
- 群呼代接
- 如果用户状态为 UM 已禁用，并且正在使用旧版 Outlook 客户端 (2013 或更早版本，则不会生成未接来电通知) 
