...
| 操作系统 | Edge | 32 位和 64 位 Internet Explorer 11 或更高版本 | 32 位和 64 位或更高版本的 Internet Explorer 10 | 32 位和 64 位或更高版本的 Internet Explorer 9 | 32 位和 64 位版本的 Firefox 12.X 或更高版本 | 32 位和 64 位版本的 Chrome 18.X 或更高版本 |
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
| 特性/功能 | Skype 业务 2016年客户端 | Skype 的 Mac 客户端上的业务 | Skype 会议应用 | Skype for Business Web App | Lync Web App |
|:-----|:-----|:-----|:-----|:-----|:-----|
...
|对经过身份验证的参与者切换到电话的音频  <br/> |& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|
|切换到电话的音频，来宾参与者  <br/> |& #x 2714;|& #x 2714;|& #x 2714;|||
|查看多方视频（库视图）  <br/> |& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|
|基于视频的屏幕共享  <br/> |& #x 2714;|& #x 2714;（对于仅承载在 Skype 的在线业务的会议） <br/> |& #x2714;(View-only)  <br/> |||
...
|共享程序（如果已启用）  <br/> |& #x 2714;||& #x 2714年; （在 Windows 只;需要插件）  <br/> |& #x 2714年; （在 Windows 只;需要插件）  <br/> |& #x 2714年; （在 Windows 只;需要插件）  <br/> |
|控制其他用户的共享的桌面或程序  <br/> |& #x 2714;||& #x 2714年; （在 Windows 只;需要插件）  <br/> |& #x 2714年; （在 Windows 只;需要插件）  <br/> |& #x 2714年; （在 Windows 只;需要插件）  <br/> |
|允许其他用户共享的桌面或程序的控制  <br/> |& #x 2714;|||||
|添加匿名参与者（如果已启用）  <br/> |& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|
|邀请参与者按名称  <br/> |& #x 2714;|& #x 2714;||||
|邀请参与者按电话号码  <br/> |& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|
...
|录制会议  <br/> |& #x 2714;|||||
|添加和下载附件  <br/> |& #x 2714;||& #x 2714;|& #x 2714;|& #x 2714;|
...
|问：&amp;管理器  <br/> |& #x 2714;||& #x 2714;|& #x 2714;|& #x 2714;|
|禁用与会者视频  <br/> |& #x 2714;|||||
|禁用会议 IM  <br/> |& #x 2714;||& #x 2714;|& #x 2714;|& #x 2714;|
|静音的观众  <br/> |& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|& #x 2714;|
|将每个人都设为与会者  <br/> |& #x 2714;|||||
|开通 Skype 会议直播  <br/> |& #x 2714;|||||
   
 & #x 2776; 参与者不能控制共享通过 Lync 为 Mac 2011 或 Communicator Mac 2011 用户的桌面。 Lync 为 Mac 2011 和 Communicator 的 Mac 2011 用户可以控制桌面由 Windows 用户共享。 这还不适合用于 Skype 业务上最大的 OSX 的 Web 应用程序。
  
 & #x 2777; Skype 的在线业务，这项功能需要 Microsoft PSTN 会议，Exchange 统一消息，或第三方音频会议提供商。
  
 & #x 2778; Lync 为 Mac 2011 客户端无法查看 Microsoft Office 2013 PowerPoint 演示文稿时共享在会议中通过 Skype 为企业 Web 应用程序。
