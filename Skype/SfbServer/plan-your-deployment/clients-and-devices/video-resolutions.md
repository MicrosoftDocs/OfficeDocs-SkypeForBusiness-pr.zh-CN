...
---
# <a name="skype-for-business-client-video-resolutions"></a>Skype for Business 客户端视频分辨率
 
**摘要：** 在规划 Skype for Business Server 时查看客户端视频要求。
  
本文介绍了 Skype for Business 视频呼叫的视频硬件支持，并介绍如何确定各种计算机、平板电脑和移动设备配置的预期视频质量。 
  
IT 专业人员会发现此信息在评估组织中已使用或考虑使用的笔记本电脑的适用性方面非常有用。 他们还可以在 [解决方案目录中搜索](https://partnersolutions.skypeforbusiness.com/solutionscatalog) 特定设备的信息。
  
## <a name="windows-desktop-mac-and-tablet-video-requirements-and-capabilities"></a>Windows 桌面、Mac 和平板电脑视频要求和功能

Skype for Business 使用硬件加速进行基于 H.264/MPEG-4 第 10 部分高级视频编码标准的视频编码和解码。 这允许 CPU 时钟速度较低的计算机对分辨率较高的视频进行编码和解码。 视频硬件要求随计算机配置和所需的视频分辨率的不同而不同。
...
|硬件加速 H.264 编码：芯片集要求  <br/> |支持以下 Intel 硬件加速视频编码解决方案：  <br/> • 第二代和第三代 Intel HD Graphics 2000、2500、3000 和 4000 芯片集 (或更高版本) 集成硬件视频编码器。 需要安装 Intel HD Graphics 驱动程序 15.28.9.2884 或包含以下内容的最新驱动程序：  <br/> • 显示驱动程序 9.17.10.2884 或最新的驱动程序  <br/> • HMFT (HMFT) 3.12.10.31 或最新 HMFT 的硬件媒体基础转换  <br/> 支持以下 AMD 硬件加速视频编码解决方案：  <br/> • AMD 视频编解码器引擎，可在多个离散显卡和 AMD A 系列加速处理器的集成加速处理单元中提供。 必须安装 AMD 视频编解码器引擎驱动程序 9.12.0.0 或更高版本。  <br/> |
|硬件加速 H.264 编码：摄像机要求  <br/> |具有符合 USB Video Class (UVC) 规格版本 1.5 的集成 H.264 硬件编码器的 USB 视频摄像机。  <br/> **注意：** Skype for Business 支持带 Windows 8 或 Windows 8.1 的 UVC 1.5 相机，包括对 UVC 1.5 的支持。 由于 Windows 7 不包括对 UVC 1.5 的支持，因此 Skype for Business 将 UVC 1.5 相机视为没有硬件编码支持的常规相机。 <br/> |
...
|1920x1080  <br/> |1920x1080  <br/> |无  <br/> |
...
下表介绍了受支持的移动设备上可用的最大视频分辨率。 有关移动设备支持 [、Skype for Business 的移动客户端功能比较详细信息](mobile-feature-comparison.md)。
  
|**功能**|**Windows Phone**|**iPhone**|**iPad**|**Android**|
|:-----|:-----|:-----|:-----|:-----|
|H.264 编码最大分辨率  <br/> |VGA  <br/> |QVGA：iPhone 4S  <br/> VGA：iPhone 5  <br/> 720p：iPhone 5S 及更高版本  <br/> |VGA：iPad 2 及更高版本/iPad 微型 1 及更高版本  <br/> 720p：iPad Air/iPad 微型 2/iPad Pro 及更高版本  <br/> |最多 VGA 取决于设备型号  <br/> |
|H.264 解码最大分辨率  <br/> |VGA  <br/> |QVGA：iPhone 4S  <br/> VGA：iPhone 5  <br/> 720p：iPhone 5S 及更高版本  <br/> |VGA：iPad 2 及更高版本/iPad 微型 1 及更高版本  <br/> 720p：iPad Air/iPad 微型 2/iPad Pro 及更高版本  <br/> |最多 VGA 取决于设备型号  <br/> |
