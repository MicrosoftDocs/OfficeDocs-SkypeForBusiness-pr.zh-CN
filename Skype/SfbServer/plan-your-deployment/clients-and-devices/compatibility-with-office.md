...
下表介绍了 Skype for Business 部署并集成 Exchange 后各种版本的 Office 支持的 Exchange 功能，如将 Skype for Business Server 与 Exchange Server[集成](../../deploy/integrate-with-exchange-server/integrate-with-exchange-server.md)中所述。
...
|启用智能标记Microsoft Word Microsoft Excel和 (中的 IM 和)     |Microsoft Word仅    |Microsoft Word仅    |否    |
