...
|:-----|:-----|:-----|:-----|
|**Outlook 功能** ||||
|自定义 Outlook 会议邀请（添加徽标、帮助 URL、免责声明、页脚文本）  |否  |必需   |是|
...
|Microsoft Outlook "发件人"、"收件人" 和 "抄送" 字段中的状态    |必需    |是     |是     |
|通过即时消息或 "可用性" 菜单中的呼叫进行答复    |是（从联系人卡片）    |是（从联系人卡片）    |是（从联系人卡片）    |
|“日程安排助理”选项卡上的会议请求中的状态    |必需    |是    |否    |
|在收到的电子邮件的工具栏或功能区中答复即时消息或呼叫    |必需    |是     |是     |
|**其他 Office 应用**   ||||
|OneNote 共享笔记    |否    |是    |否    |
...
|Exchange Server 2010  <br/>（仅限 Skype for Business 服务器2015） |只有通过 EWS 才能使用以下功能：  <br/>&bull;&nbsp;&nbsp;在 "对话历史记录" 文件夹中阅读或删除项目  <br/>&bull;&nbsp;&nbsp;阅读或删除语音邮件项目  <br/>&bull;&nbsp;&nbsp;显示扩展的忙/闲信息和会议主题和位置  <br/>&bull;&nbsp;&nbsp;Exchange 联系人同步  <br/> 公用文件夹在 Exchange Server 2010 中是可选的。  <br/> |
