...
**摘要：**了解新的 Skype 业务和可采取的步骤进行更新，准备您的环境和您的用户是否使用 Skype 业务在线、 Skype 业务服务器 2015年、 Lync Server 2013 或 Lync Server 2010。
...
- [为业务客户端 Skype 准备环境](user-experience.md#usinglync)
...
|**部署**|**Skype 的商业客户端体验**|**Lync 客户端体验**|
|:-----|:-----|:-----|
|Skype for Business Online  <br/> |除了部署客户端内部版本 4711.1002（2015 年 4 月）或更高版本之外，没有其他步骤。  <br/> |[使用业务 online 与 Skype 的 Lync 客户端体验](user-experience.md#LyncwithSfBO) <br/> |
|Skype for Business Server 2015  <br/> |除了部署客户端内部版本 4711.1002（2015 年 4 月）或更高版本之外，没有其他步骤。  <br/> |[使用 Skype 的业务 Server 内部部署 Lync 客户端体验](user-experience.md#LyncwithSfBServer) <br/> |
