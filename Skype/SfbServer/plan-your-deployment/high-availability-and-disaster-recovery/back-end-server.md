...
- SQL Server 2017 年 10 月，Enterprise Edition 和 Standard Edition
...
> [!IMPORTANT]
> 只有在主、镜像和见证 (服务器都属于同一个域时，才支持使用拓扑生成器或 cmdlet 设置和删除) SQL 镜像。 如果您需要在不同域中的服务器之间设置 SQL 镜像，请参阅 SQL Server 文档。 
