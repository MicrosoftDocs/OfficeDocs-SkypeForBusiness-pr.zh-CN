...
- Microsoft SQL Server 2012 （64位版），我们建议使用最新的 service pack 运行。 有关如何安装 Microsoft SQL Server 2012 的详细信息，请参阅[安装 SQL server 2012](https://go.microsoft.com/fwlink/p/?LinkID=248559)。
