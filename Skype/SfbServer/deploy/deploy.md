...
|![数字显示说明图标](../media/d73b5029-a6ba-4abd-9197-d8151dabf56e.png)|[Install Skype for Business Server 2015](install/install.md) <br/> |了解如何在物理Skype for Business Server环境中在各种拓扑中安装服务器。  <br/> |
...
|![数字显示说明图标](../media/d73b5029-a6ba-4abd-9197-d8151dabf56e.png)|[在 2015 Skype for Business Server部署边缘服务器](deploy-edge-server/deploy-edge-server.md) <br/> |如果贵组织的用户与未登录到内部网络的外部用户通信，则您需要部署边缘服务器。  <br/> |
