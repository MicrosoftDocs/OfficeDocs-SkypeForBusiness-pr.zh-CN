...
4. 若要仅从数据库SQL Server删除见证，请按照从数据库镜像会话中删除见证中的[ (SQL Server) 。 ](/sql/database-engine/database-mirroring/remove-the-witness-from-a-database-mirroring-session-sql-server)