...
15. 注意“**复制作业**”下的“**计划**”框中列出的复制计划。 若要自定义安装的计划，单击**计划**，并调整所需的 SQL Server 代理计划。 此计划应与备份计划大致相同。
...
19. 查看“**还原作业**”下的“**计划**”框中列出的还原计划。 若要自定义安装的计划，单击**计划**、 调整 SQL Server 代理计划，根据需要单击**确定**。 此计划应与备份计划大致相同。
