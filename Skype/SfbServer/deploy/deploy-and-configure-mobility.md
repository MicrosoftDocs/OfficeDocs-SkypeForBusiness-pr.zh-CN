...
3. 通常，你需要输入以下信息：
   ...
   - 你将需要发布**内部发布**的路径，并在你的前端池的负载平衡器（或控制器池的负载平衡器的 fqdn （如果有））上输入外部 Web 服务的 fqdn，例如，sfb_pool01 contoso。
...
3. 通常，你需要输入以下信息：
   ...
   - 你将需要发布**内部发布**的路径，并输入你的前端池的负载平衡器的**VIP 地址**的 FQDN，例如，sfb_pool01 是 contoso。
