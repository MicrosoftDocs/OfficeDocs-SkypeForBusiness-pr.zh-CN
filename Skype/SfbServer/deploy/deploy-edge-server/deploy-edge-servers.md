...
若要成功完成这些步骤，你将需要遵循为用户创建边缘拓扑一文[Skype for Business Server步骤。](create-your-edge-topology.md)
...
&nbsp;&nbsp;&nbsp;l. 然后单击 **"下** 一步"生成需要向 CA 提供的 CSR 文件 (还可以单击"查看日志"来查看证书请求日志) 。
...
5.  在每台 **服务器的"服务 MMC"** 中，验证所有Skype for Business Server服务是否正在运行。
