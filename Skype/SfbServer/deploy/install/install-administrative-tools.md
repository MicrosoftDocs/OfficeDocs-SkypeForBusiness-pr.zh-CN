...
5. Skype for Business Server核心组件将安装在服务器上。 
   ...
   - **Skype for Business Server部署向导** 一个部署计划，提供用于安装 Skype for Business Server 的各个组件的启动Skype for Business Server。
