...
> [!IMPORTANT]
> 如果要使用 Exchange 统一消息（UM）为企业语音用户提供呼叫应答、Outlook Voice Access 或自动助理服务，请阅读[Skype For business 中 Exchange 统一消息集成的计划](../../plan-your-deployment/integrate-with-exchange/unified-messaging.md)，然后按照本部分中的说明进行操作。 
