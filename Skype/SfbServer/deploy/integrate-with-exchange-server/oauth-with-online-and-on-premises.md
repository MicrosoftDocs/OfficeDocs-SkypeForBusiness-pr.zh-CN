...
配置 Exchange Server 和 Skype for Business Online 之间的集成Skype for Business和Exchange[功能支持 中所述的集成功能](../../plan-your-deployment/integrate-with-exchange/integrate-with-exchange.md#feature_support)。
...
运行 PowerShell 脚本导出本地授权证书，将在下一步中将其导入 Skype for Business Online 组织。
...
3. 确认你看到列出了与 Oauth 证书开始日期和结束日期相匹配Exchange开始日期和结束日期的密钥
