...
> [!NOTE]
> 如果客户在本地部署中有多个站点，并且他们仅部署了一个 Skype for Business Server 边缘服务器/池，则来自所有网站的搜索流量将经过一个可用的边缘服务器。 管理员需要确保所有站点中的池都可以访问边缘服务器/池中Skype for Business Server部署的内容。 
...
Skype连接也是 Skype for Business Online 的一项功能，它是 Microsoft 365 和 Office 365。 可以在管理中心Skype管理中心Skype for Business连接Microsoft 365 管理中心。
...
For Office 365 小型企业高级版： Sign in to Office 365， and go to Admin \> Service 设置 \> Instant messaging， meetings and conferencing. 打开"外部通信"。 外部通信开关可启用Skype连接性，并与其他使用 Skype for Business。
...
以前用于手动设置 Skype for Business 本地部署和 Skype 之间的联盟的网站不再需要，将在 2019 年 8 月 15 日关闭。 与 Skype 联盟现在利用联盟伙伴发现，这是与 Skype for Business Online 联盟所需的相同机制。
...
|:-----|:-----|:-----|
|Skype Windows 桌面版   |7.6 或更高版本、Windows XP 和更高版本   |**新增**：增加了对在 Windows XP 上运行的 Windows Skype 客户端的支持，并且 Windows Vista (需要最新的客户端 **版本 7.26 或)**  |
|Skype Mobile - Android 手机和平板电脑   |6.19 或更高版本，运行 Android OS 版本 4.0.3 或更高版本   |低规格设备可能不支持视频呼叫   |
|Skype Mobile - iOS   |IOS 7 或更高版本上的 6.11 或更高版本   |不支持 iPhone 4 及更早版本、iPod 第 4 代和更早版本、iPad 第 1 代   |
|Skype Mac   |7.19 或更高版本，在 Mac OS X 10.9 (Mave进行) 或更高版本   |需要 Mac OSX 10.9 或更高版本   |
|Skype 通用 Windows 应用 (Windows 10 桌面) 移动版   |Windows 10 (Redstone 1 更新或更高版本)    |Windows 通用应用将在 2016 年秋季收到更新，添加互操作支持   |
