...
3. 在“Trunk 配置”页上，使用以下方法之一配置中继：
   ...
   - **站点中继**：在"选择站点"中为此中继配置选择站点，然后单击"确定 **"。** 请注意，如果已经为站点创建了中继配置，则该站点不会显示在“选择站点”中。 此中继配置将应用于站点中的所有中继。
...
6. 如果存在一个已知的媒体终端 (例如，公用电话交换网 (PSTN) 网关，其中媒体终端与信号终端) 具有相同的 IP，则选中"集中式媒体处理"复选框。 如果中继没有已知的媒体端点，则清除该复选框。
