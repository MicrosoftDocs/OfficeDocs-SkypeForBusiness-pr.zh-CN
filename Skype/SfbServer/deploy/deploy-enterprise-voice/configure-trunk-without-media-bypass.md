...
如果要配置禁用媒体旁路功能的中继，请执行以下步骤。 如果要配置启用媒体旁路功能的中继，请参阅在 Skype for Business Server 中配置具有[媒体旁路功能的中继](configure-trunk-with-media-bypass.md)。
...
12. 应选择"启用转发 **P-Asserted-Identity** 数据"，以便可以在中介服务器端和网关端 (之间转发 PAI 呼叫发起方信息，反之亦然) （存在此情况）。
