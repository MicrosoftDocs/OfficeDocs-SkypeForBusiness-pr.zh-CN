...
呼叫企业语音使呼叫用户能够从一部电话将呼叫置于保持状态，然后稍后通过从任何电话拨打内部号码 (称为呼叫) 取回该呼叫。
