...
响应组是一企业语音一项功能，该功能将传入呼叫路由至称为代理的用户组（如技术支持或客户服务台）并排入队列。
