...
只能使用 Windows PowerShell 和 [Test-CsTrunkConfiguration](https://docs.microsoft.com/powershell/module/skype/test-cstrunkconfiguration?view=skype-ps) cmdlet 测试中继配置设置。 从业务 Server 命令行管理程序 Skype 或业务 Server Management Shell 的 Skype 的远程会话，则可以运行此 cmdlet。
