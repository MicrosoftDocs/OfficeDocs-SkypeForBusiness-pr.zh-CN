...
在安装Skype for Business Server时，将创建 SIP 中继配置设置的全局集合。 此外，管理员还可以在站点范围或服务范围为 PSTN 网关服务创建自定义设置 (，但只能) 。 管理员还可使用 Test-CsTrunkConfiguration cmdlet 验证中继能否将用户拨打的号码转换为网关可以处理的号码。
