...
> [!IMPORTANT]
> Microsoft 统一通信托管 API （UCMA）5运行时必须安装在你计划运行 SEFAUtil 工具的任何计算机上。 请在此处下载：[统一通信托管 API 5.0 运行时](https://www.microsoft.com/en-us/download/details.aspx?id=47344)。 你还可以下载 UCMA 5 SDK，其中包括运行时，如下所示： [UCMA 5.0 sdk](https://www.microsoft.com/en-us/download/details.aspx?id=47345)。
