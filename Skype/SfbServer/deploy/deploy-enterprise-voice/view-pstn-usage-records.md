...
公用电话交换网 (PSTN) 用法记录指定组织中各个用户或用户组可以拨打的呼叫 (如内部、本地或长途) 。 有关详细信息，请参阅规划 [文档中的 PSTN Usage Records](/previous-versions/office/lync-server-2013/lync-server-2013-pstn-usage-records) 。
