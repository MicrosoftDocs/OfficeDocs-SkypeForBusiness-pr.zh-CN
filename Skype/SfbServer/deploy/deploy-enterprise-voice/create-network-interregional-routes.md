...
创建或修改网络 interregional 路由，用于业务服务器通过 Skype 在企业语音调用许可控制。 
...
### <a name="to-create-network-interregional-routes-by-using-skype-for-business-server-management-shell"></a>若要通过使用 Skype 业务服务器管理外壳程序创建网络 interregional 路由

1. 启动 Skype for Business Server 命令行管理程序：依次单击“**开始**”、“**所有程序**”和“**Skype for Business 2015**”，然后单击“**Skype for Business Server 命令行管理程序**”。
    
2. 运行**新建 CsNetworkInterRegionRoute**用于定义所需的路由。 例如，运行：
...
### <a name="to-create-network-interregional-routes-by-using-skype-for-business-server-control-panel"></a>若要创建网络 interregional 路由通过 Skype 业务服务器的控制面板
...
[获得 CsNetworkInterRegionRoute](https://docs.microsoft.com/powershell/module/skype/get-csnetworkinterregionroute?view=skype-ps)
  
[一组 CsNetworkInterRegionRoute](https://docs.microsoft.com/powershell/module/skype/set-csnetworkinterregionroute?view=skype-ps)
