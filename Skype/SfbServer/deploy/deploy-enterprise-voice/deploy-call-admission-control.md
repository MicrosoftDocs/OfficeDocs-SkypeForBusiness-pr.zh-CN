...
2. 如果尚未定义，则必须定义网络区域与站点，并将子网与网络站点关联。 有关详细信息，请参阅部署网络[区域、站点和Skype for Business。](deploy-network.md)
...
6. 创建网络站点间策略，如 Create [network intersite policies in Skype for Business Server 中Skype for Business Server。](create-network-intersite-policies.md)
    
7. 启用呼叫允许控制，如启用呼叫允许控制中的[Skype for Business Server。](enable-call-admission-control.md)
