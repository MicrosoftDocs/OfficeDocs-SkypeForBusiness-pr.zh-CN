---
title: 在 Skype for Business Server 中部署监控
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
或者，你可以从 Skype for Business Server 控制面板中启用 CDR 监控。 从 Skype for Business Server 控制面板中，完成以下过程：
...
如果愿意，还可以从 Skype for Business Server 控制面板中启用 QoE 监控。 从控制面板中，完成以下过程：
...
[在 Skype for Business Server 中规划监视](../../plan-your-deployment/monitoring.md)