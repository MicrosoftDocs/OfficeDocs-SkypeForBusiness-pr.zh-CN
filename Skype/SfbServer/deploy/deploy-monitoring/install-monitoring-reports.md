...
|**参数名**|**必需**|**描述**|
|:-----|:-----|:-----|
|storedUserName  <br/> |是  <br/> |用于访问监控存储的用户帐户（格式为 domain\username）；例如：  <br/> ```-storedUserName "litwareinc\kenmyer"```此帐户必须具有之前指定的SQL Server SQL Server Reporting Services，否则脚本将失败。  <br/> |
