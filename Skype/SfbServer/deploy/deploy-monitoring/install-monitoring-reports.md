...
- **改进了用于分析视频和应用程序共享会话并对其进行故障排除的报告。** Skype for business [server 中的 "媒体质量摘要" 报表](../../manage/health-and-monitoring/summary.md)提供了一种方法来分析视频和应用程序共享呼叫, 而[Skype for business 服务器中的服务器性能报告](../../manage/health-and-monitoring/server-performance.md)将详细介绍生成这些服务器的服务器性能叫. 视频和应用程序共享指标现在还由 skype for business [server 中的 "对等会话详细信息" 报告](../../manage/health-and-monitoring/peer-to-peer-session-detail-report.md)和[Skype for business 服务器中的 "会议详细信息](../../manage/health-and-monitoring/detail-report.md)" 报告进行报告。
