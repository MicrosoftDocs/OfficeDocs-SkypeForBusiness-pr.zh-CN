...
---
# <a name="skype-room-systems-v2-scripts"></a>Skype 会议室系统 v2 脚本
 
复制各节中这篇文章到节标头中名为文本文件。 部署 Skype 会议室系统 v2 中使用这些文件： 
* [CreateSrsMedia.ps1](#createsrsmediaps1)是用于创建控制台设备软件映像的 Powershell 脚本。  
* [SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1)是用于设置 Skype 业务和 Exchange 帐户的设备的脚本将使用 Powershell。  
* 设置使用 OMS 的 Skype 会议室系统 v2 管理时使用[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) 。
  
<a name="CreateSrs"></a>
## <a name="createsrsmediaps1"></a>CreateSrsMedia.ps1
...
<a name="CreateRoom"></a>
## <a name="skyperoomprovisioningscriptps1"></a>SkypeRoomProvisioningScript.ps1
...
```
<a name="OMSVIEW"></a>
## <a name="skyperoomsystemsv2omsview"></a>SkypeRoomSystems_v2.omsview
