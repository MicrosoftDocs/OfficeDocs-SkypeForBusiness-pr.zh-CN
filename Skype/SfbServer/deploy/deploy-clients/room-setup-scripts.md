...
本部分阐述了调配 Skype 的空间系统帐户时可以使用的示例脚本。 这些脚本仅用于说明目的，并且只应在咨询你的 IT 专家或域管理员之后使用。
  
## <a name="example-setup-script-skype-for-business-and-exchange-server-on-premises"></a>示例安装程序脚本： Skype 业务和 Exchange Server （内部部署）
...
## <a name="example-setup-script-skype-for-business-and-exchange-server-online"></a>示例安装程序脚本： Skype 业务和 Exchange Server 联机
