...
2. 接下来，使用 Get-AzureADSubscribedSku Office 365 租户中检索可用的 Sku 的列表。
3. 一次您列表出 Sku，您可以添加使用集 AzureADUserLicense cmdlet 的许可证。 在此示例中，$strLicense 是你看到的 SKU 代码（例如，contoso:STANDARDPACK）。
