...
> [!NOTE]
> Microsoft Teams 会议室是具有不同的依赖项和部署过程的不同产品。 有关 Microsoft Teams 会议室的信息，请参阅 Microsoft Teams 会议室 [管理概述](https://docs.microsoft.com/microsoftteams/rooms/rooms-manage)。
...
加入域的每个 Skype 会议室系统客户端都可以由在 Skype 会议室系统设备电脑上具有本地管理员权限的域用户完全管理。 因此，可以在 Active Directory 中创建专用管理员组，在设置新的 Skype 会议室系统计算机期间授予此组管理权限。
