...
智能联系人列表功能允许自动填充最终用户的联系人列表。 首次使用Skype for Business时，你的用户将自动看到其经理和团队中其他人。 默认情况下，为 Microsoft 365 Office 365 启用此功能，但您必须通过配置客户端策略设置为本地用户显式启用此功能。
