...
---
# <a name="renew-cccacertificate"></a>续订 CcCACertificate
 
Renew-CcCACertificate cmdlet 可续订即将过期或已过期的 Skype for Business 云连接器版本根 CA 证书。 该命令被更改为在云连接器 2.0 和更高版本的更新 CcCACertificate。
