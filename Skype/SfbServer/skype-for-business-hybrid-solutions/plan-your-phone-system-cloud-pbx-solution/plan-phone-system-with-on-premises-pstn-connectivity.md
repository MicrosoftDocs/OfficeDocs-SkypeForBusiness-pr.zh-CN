...
---
# <a name="plan-phone-system-with-on-premises-pstn-connectivity-in-skype-for-business-server"></a>在 Skype for Business Server 中规划具有本地 PSTN 连接的电话系统
...
如果你已在本地部署 Skype for Business Server 或 Lync Server 2013，则此内容是相关的。 有关其他方案，请参阅[Microsoft 电话解决方案](https://docs.microsoft.com/SkypeForBusiness/hybrid/msft-telephony-solutions)。
 ...
 使用具有本地 PSTN 连接的电话系统，你可以利用电话系统（云 PBX）功能为你的用户提供支持。 这有助于以下方案：
