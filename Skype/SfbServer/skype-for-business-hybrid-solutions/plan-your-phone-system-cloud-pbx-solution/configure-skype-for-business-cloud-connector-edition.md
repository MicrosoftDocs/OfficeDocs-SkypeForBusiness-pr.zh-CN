...
description: 了解如何配置 Skype for Business 云连接器版本，这是一种最低本地拓扑，支持将本地语音基础结构与 电话系统 (Cloud PBX) Voice services 集成在 Skype for Business Online 中。
...
了解如何配置 Skype for Business 云连接器版本，这是一种最低本地拓扑，支持将本地语音基础结构与 电话系统 (Cloud PBX) Voice services 集成在 Skype for Business Online 中。 
...
|[配置云连接器与组织Microsoft 365或Office 365集成](configure-cloud-connector-integration-with-your-office-365-tenant.md) <br/> |添加 DNS 记录、配置混合、设置 PSTN 网关以及为用户启用电话系统语音邮件。  <br/> |
