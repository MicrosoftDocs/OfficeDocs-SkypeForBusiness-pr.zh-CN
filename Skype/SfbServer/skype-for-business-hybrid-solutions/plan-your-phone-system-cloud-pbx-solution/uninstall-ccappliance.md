...
---
# <a name="uninstall-ccappliance"></a>卸载-CcAppliance
...
下一个示例中漏下后，强行卸载主机服务器上正在运行的云接头装置，即使耗尽过程失败：
...
如果您要卸载的云连接器当前运行的版本，排出服务首先让并发呼叫完成卸载虚拟机之前的中介服务器和边缘服务器上运行。 如果你要卸载备份版本，则不执行排出操作。
...
|确认  <br/> |可选  <br/> |System.Management.Automation.SwitchParameter  <br/> |要求用户确认要卸载虚拟机。 默认值为 TRUE。  <br/> |
