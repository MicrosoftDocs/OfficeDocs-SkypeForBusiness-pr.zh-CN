...
有关语音路由策略的更多详细信息，请参阅在 Skype for Business 2015、New-CsVoiceRoutingPolicy 和[Grant-CsVoicePolicy](/powershell/module/skype/grant-csvoicepolicy?view=skype-ps)创建或修改语音策略和配置[PSTN](../../deploy/deploy-enterprise-voice/voice-policy-and-pstn-usage-records.md)用法记录。 [](/powershell/module/skype/new-csvoiceroutingpolicy?view=skype-ps)
