...
若要准备域以托管运行 Skype for Business Server 2015 或 Skype for business Server 用户的服务器，必须完成**步骤5：准备当前域**，如[使用安装程序运行域准备](https://technet.microsoft.com/library/95dab800-1f2c-4506-b36c-99986643b149.aspx)主题中所述。 要完成此步骤，必须以准备的域中 Domain Admins 组成员身份登录，或以该域所属的林中 Enterprise Admins 组成员身份登录。 若要准备域：
