...
description: 证书请求摘要页将显示所有选项和配置证书的详细的摘要。 摘要中显示证书请求将包含的内容，以及后续将如何颁发证书。 您应仔细阅读摘要以确保选择的所有条目和选项都是正确的。 如果您的选择是正确的请单击下一步继续请求生成并准备发送到证书颁发机构 (CA)。
