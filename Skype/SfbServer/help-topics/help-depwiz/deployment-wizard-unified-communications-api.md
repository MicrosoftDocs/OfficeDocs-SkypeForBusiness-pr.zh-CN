...
ms.locfileid: "33920990"
---
# <a name="deployment-wizard-unified-communications-api"></a><span data-ttu-id="5f2a5-103">部署向导：统一通信 API</span><span class="sxs-lookup"><span data-stu-id="5f2a5-103">Deployment Wizard: Unified Communications API</span></span>
 
<span data-ttu-id="5f2a5-104">有关使用部署向导安装业务服务器 2015 Skype 的详细信息，请参阅[安装的 Skype 的业务服务器 2015年](../../deploy/install/install.md)。</span><span class="sxs-lookup"><span data-stu-id="5f2a5-104">For details about using Deployment Wizard to install Skype for Business Server 2015, see [Install Skype for Business Server 2015](../../deploy/install/install.md).</span></span>
