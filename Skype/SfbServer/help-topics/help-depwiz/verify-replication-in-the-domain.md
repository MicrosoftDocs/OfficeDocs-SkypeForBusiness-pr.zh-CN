...
ms.locfileid: "60857779"
---
# <a name="verify-replication-in-the-domain"></a>验证域中的复制
 
若要验证在步骤 **1：** 准备架构中完成的域准备的复制，需要从命令行管理程序 Lync Server 命令行管理程序 运行 cmdlet Skype for Business Server命令行管理程序。 要运行 Windows PowerShell cmdlet，请以 Domain Admins 组成员的身份登录到作为已准备的域成员的计算机。 请执行以下操作：
