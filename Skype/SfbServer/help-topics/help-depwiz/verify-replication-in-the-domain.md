...
若要验证在**步骤 1: 准备架构**中完成的域准备的复制, 必须从 Skype For Business Server Management Shell Lync Server management shell 运行 cmdlet。 若要运行 Windows PowerShell cmdlet, 请登录到属于你已准备的域成员的计算机, 以及作为域管理员组的成员。 请执行下列操作：
