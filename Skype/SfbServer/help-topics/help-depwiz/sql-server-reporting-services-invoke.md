...
ms.locfileid: "58615978"
---
# <a name="sql-server-reporting-services-invoke"></a>SQL Server Reporting Services（调用）
 
向 Microsoft SQL Server 2008 R2 或 Microsoft SQL Server 2012 报告服务提供部署监控服务器报告所需的信息后，"执行命令"页将显示为将报告安装到 SQL Server Reporting Services 而发出的命令的摘要。
