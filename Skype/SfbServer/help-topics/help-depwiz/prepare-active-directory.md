...
若要开始安装 Skype for Business Server 2015，必须准备 Active Directory 域服务架构、林以及将托管服务器和用户的域。 Skype for Business Server 部署向导将指导你完成准备 Active Directory 所需的步骤，从架构开始，然后再准备林。 确认 Active Directory 复制成功后，准备将承载用户或服务器的每个域。
