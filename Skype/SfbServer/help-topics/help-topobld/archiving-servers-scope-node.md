...
> [!NOTE]
> 如果您之前已将存档服务器添加到拓扑生成器的拓扑中，则“存档服务器”节点将包含存档服务器。 但是，在设置存档服务器之前，无法存档即时消息或 Web 会议 (消息) ，其中包括在要用作存档服务器的服务器上安装 Skype for Business Server 和配置存档支持。 
