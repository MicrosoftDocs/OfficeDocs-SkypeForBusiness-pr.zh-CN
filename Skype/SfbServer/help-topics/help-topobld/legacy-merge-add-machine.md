...
---
# <a name="legacy-merge-add-machine"></a><span data-ttu-id="2e61b-103">旧版合并添加计算机</span><span class="sxs-lookup"><span data-stu-id="2e61b-103">Legacy Merge Add Machine</span></span>
 
<span data-ttu-id="2e61b-104">要定义组成边缘服务器池的计算机，请输入至少一台作为旧版负载平衡合并边缘池一部分的计算机的完全限定域名 (FQDN)。</span><span class="sxs-lookup"><span data-stu-id="2e61b-104">To define the computers that make up the Edge Server pool, enter the fully qualified domain name (FQDN) of at least one computer that is part of the legacy load-balanced, consolidated Edge pool.</span></span> 
