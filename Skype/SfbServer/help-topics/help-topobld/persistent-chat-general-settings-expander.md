...
- **持久聊天池的显示名称**：定义此设置以提供服务器或池的用户友好和用户可读设置。 此设置将便于用户根据 显示名称 关联给定的持久聊天服务器或持久聊天服务器池，而不是更难以理解的完全限定域名。
...
- 如果要 **为主SQL Server** 启用镜像，请选中"启用存储镜像SQL Server复选框。
    ...
    如果选择启用存储SQL Server，请从"镜像和存储"列表中选择存储和 **SQL Server实例**。
...
- 如果要 **为合规性SQL Server** 启用镜像，请选中"启用SQL Server镜像"复选框。
    ...
    如果选择启用合规性SQL Server镜像，请从"合规性"和"存储镜像"SQL Server **存储和实例**。
