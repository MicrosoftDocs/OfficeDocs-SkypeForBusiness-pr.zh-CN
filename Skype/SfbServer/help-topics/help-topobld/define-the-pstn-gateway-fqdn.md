...
您指定将连接到 PSTN 或专用交换机 (PBX) 的企业语音组件的公用电话交换网 (pstn) 网关的完全限定的域名 (FQDN)。

有关详细信息，请参阅[中的业务服务器 2015 Skype 的 PSTN 连接组件](../../plan-your-deployment/enterprise-voice-solution/pstn-connectivity.md)
