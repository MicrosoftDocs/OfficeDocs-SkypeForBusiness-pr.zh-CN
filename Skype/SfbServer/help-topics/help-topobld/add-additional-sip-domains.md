...
ms.locfileid: "48217443"
---
# <a name="add-additional-sip-domains"></a><span data-ttu-id="5d87c-104">添加其他 SIP 域</span><span class="sxs-lookup"><span data-stu-id="5d87c-104">Add Additional SIP Domains</span></span>
 
<span data-ttu-id="5d87c-p102">指定要在部署中支持的每个其他域的域名。例如，如果指定了 contoso.net 作为主会话初始协议 (SIP) 域，并且要针对部署中的 SIP 流量支持 fabrikam.net，则指定 fabrikam.net 作为其他支持域。</span><span class="sxs-lookup"><span data-stu-id="5d87c-p102">Specify the domain name of each additional domain that you want to support in your deployment. For example, if you have specified contoso.net as the primary Session Initiation Protocol (SIP) domain and you also want to support fabrikam.net for SIP traffic in your deployment, specify fabrikam.net as an additional supported domain.</span></span>
