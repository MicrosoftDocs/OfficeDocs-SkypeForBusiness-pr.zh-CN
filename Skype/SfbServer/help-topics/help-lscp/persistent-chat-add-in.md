...
2. 从**开始**菜单中，选择 Skype 业务服务器的控制面板或打开浏览器窗口，然后输入管理 URL。 有关可用来启动控制面板的不同方法的详细信息，请参阅[打开 Lync 服务器管理工具](http://technet.microsoft.com/library/8c58de94-9e0a-4368-9e14-9afcaa1142d0.aspx)。
