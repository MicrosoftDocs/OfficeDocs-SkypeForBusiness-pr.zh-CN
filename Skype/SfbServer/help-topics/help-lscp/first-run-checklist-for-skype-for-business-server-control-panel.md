...
> [!NOTE]
> 下表中执行的任务之前, 确保您登录使用正确的用户权限、 权限和角色的[基于角色的访问控制](https://technet.microsoft.com/library/41204ba3-ce5b-41a8-a6c3-b444468fa328.aspx)主题的"角色和作用域"部分中所述。
...
|Skype 为用户启用企业服务器。 （可选)，如果从早期版本迁移，将用户移至 Skype 业务服务器。  <br/> |**用户** <br/> |[管理用户](https://technet.microsoft.com/library/8021087e-5084-4a39-9fef-ab9376c6d371.aspx) <br/> |
