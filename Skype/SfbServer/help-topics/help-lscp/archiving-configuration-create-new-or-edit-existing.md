...
- **Microsoft Exchange集成** 如果你有用户位于 2013 年 10 月，Exchange选择此选项。 使用此选项，Exchange 2013 用于存储这些用户的数据（如果他们的邮箱已置于In-Place保留状态）。 如果您的所有用户都位于 Exchange 2013 上，则无需为存档数据SQL Server单独的数据库。
