...
---
# <a name="configure-a-network-region-route-create-new-or-edit-existing"></a>配置网络区域路由： 新建或编辑现有的
 
您希望执行什么操作？单击您要执行的任务所对应的链接。
  
- [配置网络区域路由](http://technet.microsoft.com/library/76993daa-76c2-4cec-8363-de8aebef0145.aspx)
