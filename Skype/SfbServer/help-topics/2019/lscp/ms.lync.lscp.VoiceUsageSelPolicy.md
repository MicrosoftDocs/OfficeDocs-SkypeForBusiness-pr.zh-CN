...
---
# <a name="voice-usage-policy"></a><span data-ttu-id="266cf-103">语音用法策略</span><span class="sxs-lookup"><span data-stu-id="266cf-103">Voice Usage Policy</span></span>
 
<span data-ttu-id="266cf-104">有关使用 Skype for Business Server 控制面板可执行的不同过程的详细信息，请参阅在[skype For Business server 2019](../../../../SfBServer2019/skype-for-business-server-2019.yml)中管理文章。</span><span class="sxs-lookup"><span data-stu-id="266cf-104">For details about the different procedures that you can perform by using the Skype for Business Server Control Panel, see the Manage articles in [Skype for Business Server 2019](../../../../SfBServer2019/skype-for-business-server-2019.yml).</span></span>
