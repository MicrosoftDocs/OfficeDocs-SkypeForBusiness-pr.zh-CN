...
- **语音服务质量 (QoS)** 你可以从 Skype for business Phone Edition 设备指定分配给语音流量 emanating 的 DSCP 值。 默认值为40。 但是, 40 不是通常用于音频流量的值;相反, 音频流量几乎始终标有 DSCP 代码46。 为了保持整个网络的一致性, 你可能希望将此值更改为46。
