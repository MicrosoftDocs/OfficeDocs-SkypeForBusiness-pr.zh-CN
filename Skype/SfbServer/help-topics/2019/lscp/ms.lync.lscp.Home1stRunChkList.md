...
欢迎使用 Skype for business Server 控制面板, 用于管理和管理 Skype for Business 服务器的基于 web 的用户界面。 您可以使用控制面板执行以前版本中使用 Microsoft 管理控制台执行的各种管理任务。

在部署 Skype for Business 服务器之后, 我们强烈建议你执行一些重要任务。 其中某些任务是初始配置步骤，您可能已在部署过程中执行过，而另一些任务是对您在部署过程中配置的设置或默认设置的细化或修改。 本主题中介绍的其他任务可验证您在部署过程中所做的配置。
...
我们强烈建议你查看本主题中涉及的任务, 然后在你的组织中执行相应的部署过程。
...
|为 Skype for business 服务器启用用户。 或者, 如果从以前的版本迁移, 请将用户移动到 Skype for business 服务器。  <br/> |**用户** <br/> |[Managing Users](https://technet.microsoft.com/library/8021087e-5084-4a39-9fef-ab9376c6d371.aspx) <br/> |
...
|如果已部署监控服务器，请查看监控服务器报告以查看使用情况和诊断信息。  <br/> |**主页** <br/> |[在 Skype for Business 服务器中管理运行状况和监视](../../../manage/health-and-monitoring/health-and-monitoring.md) <br/> |
