...
强烈建议您查看本主题中引用的任务，然后执行适当的过程以在组织中部署。
...
|如果已部署监控服务器，请查看监控服务器报告以查看使用情况和诊断信息。  <br/> |**主页** <br/> |[在 Skype for Business Server 中管理运行状况和监视](../../../manage/health-and-monitoring/health-and-monitoring.md) <br/> |
