...
> [!NOTE]
> 如果您之前已将存档服务器添加到拓扑生成器的拓扑中，则“存档服务器”节点将包含存档服务器。 但是，在设置存档服务器之前，无法存档即时消息或 Web 会议 (消息) ，这包括在要用作存档服务器的服务器上安装 Skype for Business Server 以及配置存档支持。 
  
除了本主题中之前介绍的存档服务器选项之外，“存档服务器”节点还具有控制台树中的其他节点也具有的一些常规选项。其中包括以下选项：
  
- **拓扑**。 使用此选项可定义新的拓扑、打开现有拓扑、下载当前拓扑、保存拓扑副本、发布拓扑、安装数据库、合并组件或删除部署。
