...
有关移动中央管理服务器存储的详细信息，请参阅 Windows PowerShell cmdlet 参考中的[Move-CsManagementServer。](/powershell/module/skype/move-csmanagementserver?view=skype-ps)
