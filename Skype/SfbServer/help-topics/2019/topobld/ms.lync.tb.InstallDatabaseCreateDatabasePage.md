...
> [!CAUTION]
> SQL Server 如果必须打开任何) 和防火墙端口以容纳要部署数据库的实例，则必须为实例 (配置该端口。 有关详细信息，请参阅配置 [SQL Server](/previous-versions/office/lync-server-2013/lync-server-2013-configure-sql-server-for-lync-server)
