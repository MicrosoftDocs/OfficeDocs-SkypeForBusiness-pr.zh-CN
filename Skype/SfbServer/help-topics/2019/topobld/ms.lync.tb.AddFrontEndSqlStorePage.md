...
有关 SQL Server 支持的详细信息, 请参阅支持文档中的[数据库软件和群集支持](https://technet.microsoft.com/library/e05d0032-bbea-4e61-987d-d07b1c045fd5.aspx)。 有关为后端数据库设置 SQL Server 的详细信息, 请参阅部署文档中的 "[配置 Sql server](https://technet.microsoft.com/library/375e5cc4-e436-46dc-9b02-5063f35cdcc1.aspx) "。
