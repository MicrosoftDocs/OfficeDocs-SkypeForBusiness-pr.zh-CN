...
如果要将中介服务器并放在前端池或 Standard Edition 服务器上，请选中启用并 **排中介服务器的复选框**。 如果选择不并置中介服务器，则本节中没有可定义的设置。
...
有关定义和配置 Enterprise Edition 前端池或 Standard Edition Server 的设置的详细信息，[](https://technet.microsoft.com/library/51d1601e-4f83-48d4-ad08-3b4d5e2003aa.aspx)请参阅"定义和配置拓扑和部署中介服务器"和"[定义对等方"。](https://technet.microsoft.com/library/a684f1da-6671-4011-adf6-2db49e2528e2.aspx)
