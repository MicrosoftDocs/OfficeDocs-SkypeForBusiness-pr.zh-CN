...
使用此向导可以定义网站的新前端池。 每个网站必须具有至少一个企业版池或 Standard Edition server。 有关使用向导创建一个新的前端池的要求的详细信息，请参阅部署文档中的[Define and Configure a Front End Pool](http://technet.microsoft.com/library/713fc263-23dd-414a-b001-82932e4fe966.aspx) 。
