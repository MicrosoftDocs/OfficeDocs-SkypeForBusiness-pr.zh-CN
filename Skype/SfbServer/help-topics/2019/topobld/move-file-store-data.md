---
title: 将文件存储数据移动到新文件存储Skype for Business Server
ms.reviewer: ''
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
---
# <a name="move-file-store-data-to-a-new-file-store-in-skype-for-business-server"></a>将文件存储数据移动到新文件存储Skype for Business Server
