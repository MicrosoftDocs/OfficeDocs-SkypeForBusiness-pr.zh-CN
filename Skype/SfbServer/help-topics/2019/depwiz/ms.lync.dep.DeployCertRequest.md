...
ms.locfileid: "30874463"
---
# <a name="deployment-wizard-request-a-certificate"></a><span data-ttu-id="d6d40-103">部署向导：请求证书</span><span class="sxs-lookup"><span data-stu-id="d6d40-103">Deployment Wizard: Request a Certificate</span></span>
 
<span data-ttu-id="d6d40-104">有关使用部署向导安装 Skype 业务服务器的详细信息，请参阅[业务服务器安装 Skype](../../../deploy/install/install.md)。</span><span class="sxs-lookup"><span data-stu-id="d6d40-104">For details about using Deployment Wizard to install Skype for Business Server, see [Install Skype for Business Server](../../../deploy/install/install.md).</span></span>
