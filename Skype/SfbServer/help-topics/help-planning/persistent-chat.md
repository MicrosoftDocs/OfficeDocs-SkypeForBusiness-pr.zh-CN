...
持久聊天服务器，用户可以参与随着时间的推移保留的、 基于主题的多方对话。
  
有关您的环境准备持久聊天服务器的详细信息，请参阅[Plan for Persistent Chat Server in Skype 的业务服务器 2015年](../../plan-your-deployment/persistent-chat-server/persistent-chat-server.md)。
