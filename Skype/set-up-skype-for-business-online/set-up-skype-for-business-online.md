...
看起来需要帮助您 Office 365 的订阅设置 Skype。 您可以按照以获取您安装已完成此文章中的步骤。
  
## <a name="1-plan-for-skype-for-business"></a>1. Skype for Business 计划

如果您拥有**[Office 365 的业务津贴](https://products.office.com/en-us/business/office-365-business-premium)**或**业务精要**可以使用 Skype 业务进行在线求助其他人在您的业务感到您的订购。 例如，如果您的公司有 10 个人，您可以[开始使用 Skype 为 IM 和联机会议业务](http://support.office.com/article/cc05afa6-1894-4a82-9dd9-6222061f50fd)到彼此，并执行步骤 2-6 下后业务使用 Skype[与 Skype 的业务会议](https://support.office.com/article/2eed8424-581a-4497-b505-c08c152e5851)。 并且您可以[设置在 Outlook 中的商务会议 Skype](https://support.office.com/article/b8305620-d16e-4667-989d-4a977aad6556#bkmk_OWA)参加联机会议，太 ！
...
- **选项 2。升级您的计划，并购买 Office 365 的电话系统和调用计划**。 最简单的方法来找出多少这成本，然后进行切换、 到[与客户支持联系业务产品的管理帮助](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)并让他们为您做的一切。
...
2. 登录到 Office 365 管理中心，并输入您的 Office 365 提供用户 ID 和密码。 在您登录后，您将看到 Office 365 管理中心：
...
1. [添加域和 Office 365 提供给用户](https://support.office.com/article/6383f56d-3d09-4dcb-9b41-b5f5a5efd611)： 使用 Office 365 安装向导来设置您使用 Office 365 （如*fourthcoffee.com*) 的自定义域。 **默认情况下，Office 365 安装向导包括 Skype 的在线业务设置并创建您为业务用户 Id 的 Skype。** 如果您已经使用向导为 Office 365 设置您的域，您已完成此步骤。
...
3. [Office 365 的 Url 和 IP 地址范围](https://support.office.com/article/8548a211-3fe7-47cb-abb1-355ea5aa88a2#BKMK_LYO)： 大多数中小企业不需要执行此步骤。 **但如果有防火墙或代理服务器，它将对部分网站的访问**，您必须创建规则以允许访问 Skype 的在线业务的终结点。 这是高级的步骤最好执行通过防火墙和代理服务器配置有丰富经验的人。 如果您没有这样过，考虑雇用[的 Microsoft 合作伙伴](https://go.microsoft.com/fwlink/?linkid=391089)来为您设置业务的 Skype。
...
- [安装 Skype for Business](http://support.office.com/article/8a0d4da8-9d58-44f9-9759-5c8f340cb3fb)：有关如何从 Office 365 门户下载该应用并将其安装在你的 PC 或 Mac 上的说明。
    
- [部署 Office 365 中的业务客户端的 Skype](deploy-the-skype-for-business-client-in-office-365.md)： 部署在大型企业中的应用程序的说明进行操作。
...
- [打开或关闭移动电话通知](turn-on-or-off-mobile-phone-notifications.md)： Skype 业务在移动设备上安装后，您和其他人在您的业务可以接收到通知有关传入和错过的即时消息。
...
之前设置更多的功能，请确保您对它们有许可证。 [Skype 的附加业务和 Microsoft 小组授权](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md)
...
Skype 会议广播 是一项功能，允许你针对最多 10,000 个与会者制作、主持和直播会议。 **要了解其工作方式的详细信息，请参阅[什么是 Skype 会议直播？](http://support.office.com/article/c472c76b-21f1-4e4b-ab58-329a6c33757d)**
  
以下是设置 Skype 会议广播 的步骤概述：
  
1. [如何分配或取消分配 Office 365 商业版适用的用户许可证](http://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc)：为将 **主持** 直播会议的每个人分配 **Skype for Business Online** 或 **企业版计划** 许可证。
    
2. [启用广播 Skype 会议](../set-up-your-network-for-skype-meeting-broadcast/enable-skype-meeting-broadcast.md)： 默认情况下，不启用此功能。 将其打开后，您的用户将能够承载广播与组织中其他人的会议。
...
Skype for Business 中音频、视频和应用程序共享的质量很大程度上受端到端网络连接质量的影响。为获得最佳体验，必须确保公司网络和 Skype for Business Online 间有高质量网络连接。有关网络和优化的信息，请参见 [优化 Skype for Business Online 性能](http://support.office.com/article/beec23c2-c5d6-4e84-a8af-e82aefca7802)。
  
## <a name="all-done-setting-up-getting-started-using-skype-for-business"></a>全部设置已完成？开始使用 Skype for Business
<a name="bkmk_more"> </a>

[Skype 业务培训](http://support.office.com/article/8a3491a3-c095-4718-80cf-cbbe4afe4eba)： 签出此列表的培训主题，以帮助您快速启动 ！
  
[开始 Skype for Business 电话会议](http://support.office.com/article/8dc8ac52-91ac-4db9-8672-11551fdaf997)
  
[在 Skype for Business 中设置视频设备选项](http://support.office.com/article/d09017c0-deba-4f6c-a122-9eca6604f50c)
  
[使用 Skype for Business 拨打和接听视频呼叫](http://support.office.com/article/abf62493-670f-4b0d-b2cf-fe03b49caf42)
