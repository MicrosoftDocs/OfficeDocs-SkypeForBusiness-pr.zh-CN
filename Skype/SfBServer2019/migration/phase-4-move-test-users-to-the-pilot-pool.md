...
您可以将单个用户组移动到业务服务器 2019年部署使用以下两种方法您新 Microsoft Skype: Skype 业务 Server Control Panel 和 Skype 的业务 Server Management Shell。 本节中的主题介绍了试点部署过程中以及业务服务器 2019 Skype 的部署从试点部署移动到生产级部署之前必须完成的任务。
...
- [将多个用户移至试点池](move-multiple-users-to-the-pilot-pool.md)
