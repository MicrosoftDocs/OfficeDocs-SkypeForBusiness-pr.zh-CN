...
description: 在部署 Skype for Business Server 2019 后，您需要为站点配置联盟路由。 为了使用旧安装使用的联合路由，必须将 Skype for Business Server 2019 配置为使用此路由。
...
在部署 Skype for Business Server 2019 后，您需要为站点配置联盟路由。 为了使用旧安装使用的联合路由，必须将 Skype for Business Server 2019 配置为使用此路由。 
...
7. 在拓扑生成器的"Skype for Business Server 2019"节点下，导航到 Standard Edition **服务器** 或 Enterprise Edition **前端池**，右键单击该池，然后单击"编辑 **属性"。**
...
11. 在 **拓扑生成器中**，选择最顶层的节点 **，Skype for Business Server。**
