...
3. 持久聊天、SQL 镜像和 XMPP 功能在 Skype for Business Server 2019 中已弃用，不再作为 Skype for Business Server 2019 功能提供，但如果它们以前部署在旧环境中，可以在共存环境中继续使用。 如果要继续使用这些功能，应计划继续采用共存环境，其中某些用户将保留在旧池中。
