...
2. 若要确保由 Skype for Business Server 2019 上用户组织的会议与在旧版安装上建立的联合用户无缝协作，分配给迁移用户的会议策略应允许匿名参与者。
