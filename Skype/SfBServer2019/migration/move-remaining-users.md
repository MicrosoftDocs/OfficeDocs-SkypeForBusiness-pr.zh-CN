...
3. 允许匿名参与者的会议策略允许**参与者邀请**在 Skype For business Server 2019 控制面板中选择的匿名用户，并在 skype For Business Server Management Shell 中的**CsConferencingPolicy** cmdlet 的输出中将**AllowAnonymousParticipantsInMeetings**设置为**True** 。 
