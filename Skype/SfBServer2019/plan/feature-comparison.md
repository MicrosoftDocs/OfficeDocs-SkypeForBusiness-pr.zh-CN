...
**摘要：** Skype for Business Server 2019 或 Skype for Business Online 管理员可以使用这些表了解哪些客户端支持哪些功能。
 ...
 在部署或升级到 Skype for business Server 之前，请检查您的组织中已使用的客户端。 使用下面的表格了解功能支持对这些客户端的影响。 这可帮助您传达对用户所做的更改、使滚动过程的步调以及充分了解升级到最新客户端的好处。

Skype for business Server 2019 中提供的某些功能在 Skype for Business Online 中不可用;有关详细信息，请参阅[联机或混合用户帐户限制](feature-comparison.md#Online-Hybrid)。 Skype for business Online 管理员可能需要参考[skype for Business Online 服务说明](https://technet.microsoft.com/library/skype-for-business-online-service-description.aspx)，以了解有关可用的不同计划的信息。
...
> [!IMPORTANT]
> Skype for Business Server 2019 和 Skype for business Online 支持以下以前发布的客户端： Lync 2013、Skype for Business 2015 和 Skype for Business 2016，以及 Skype for business 2019 客户端。 有关这些客户端与其他服务器一起使用时的信息，请参阅适用于 Skype for business 2015 的 Lync Server 2013 和[桌面客户端功能比较](../../SfbServer/plan-your-deployment/clients-and-devices/desktop-feature-comparison.md)的[客户端比较表](https://technet.microsoft.com/library/gg425836%28v=ocs.15%29.aspx)。 


> [!NOTE]
> Skype for Business Web 应用浏览器客户端和 Skype 会议应用程序 Windows 10 应用仅提供[会议支持](feature-comparison.md#BKMK_Conferencing)。 有关这些客户端的详细信息，请参阅[规划会议客户端（Web 应用程序和会议应用程序）](../../SfbServer/plan-your-deployment/clients-and-devices/meetings-clients.md) 。
...
| 功能/功能                                                                                  | Skype for Business 2015、2016或2019客户端 | Mac 版 Skype for Business | Lync 2013 客户端 |
|:----------------------------------------------------------------------------------------------------|:----------------------------------------------|:--------------------------|:-----------------|
| 发布状态                                                                                      | &#x2714;                                      | &#x2714; &#x2776;         | &#x2714;         |
| 查看状态                                                                                         | &#x2714;                                      | &#x2714;                  | &#x2714;         |
| 查看状态注释和外出消息                                                        | &#x2714;                                      | &#x2714;                  | &#x2714;         |
| 添加自定义位置                                                                               | &#x2714;                                      | &#x2714;                  | &#x2714;         |
| 添加自定义注释                                                                                   | &#x2714;                                      | &#x2714;                  | &#x2714;         |
| 对我的图片使用来自任何公共网站的照片  <br/> （在 Skype for Business Online 中不可用） | &#x2714;                                      |                           | &#x2714;         |
...
| 显示“当前对话”组                                                           | &#x2714;                                      | &#x2714;                  | &#x2714;         |
| 显示其他联系人视图（例如平铺）                                           | &#x2714;                                      | &#x2714;                  | &#x2714;         |
| 按组、关系或新用户（已将您添加到联系人列表中的人员）对联系人进行排序 | &#x2714;                                      |                           | &#x2714;         |
| 按状态（可用性）对联系人进行排序                                                        | &#x2714;                                      |                           | &#x2714;         |
| 搜索和添加 Exchange 联系人                                                              | &#x2714;                                      |                           | &#x2714;         |
...
|在 Outlook 中记录 IM 对话  |&#x2714;|如果启用了服务器端对话历史记录 &#x2714;   |&#x2714;|   
|检查拼写 |&#x2714;|&#x2714;||   
...
> [!NOTE]
>  Skype for business Online 的 skype for business 会议功能在 Skype for Business Online 独立计划1中不可用。  正在[停](/SkypeForBusiness/skype-for-business-and-microsoft-teams-add-on-licensing/license-options-based-on-your-plan/skype-for-business-online-plan-1-retirement
)用计划1。
...
|功能/功能 | Skype for Business 2016 客户端 | Mac 版 Skype for Business | Skype for Business Web 应用 | Skype for Business 2015 客户端 | Lync 2013 客户端 | 
|:-----|:-----|:-----|:-----|:-----|:-----|  
|添加计算机音频  |&#x2714;|&#x2714;|&#x2714; （需要插件）  |&#x2714;|&#x2714;| 
|添加视频 |&#x2714;|&#x2714;|&#x2714; （需要插件） |&#x2714;|&#x2714;| 
|查看多方视频（库视图）  |&#x2714;|&#x2714;|&#x2714;|&#x2714;|&#x2714;|
...
&#x2779; Skype for Business 2016 应用程序，您必须使用即点即用，生成16.0.4227 或更高版本。

&#x2780; Skype for Business 2015 应用程序，您必须拥有九月更新、内部版本15.0.4747 或更高版本。
...
新式验证还需要在[采用新式验证时支持的 Skype For business 拓扑](../../SfbServer/plan-your-deployment/modern-authentication/topologies-supported.md)中介绍的拓扑。
...
此表涵盖与支持存档和日志记录功能相关的功能。
 ...
 | 功能/功能 | Skype for Business 2015、2016或2019客户端 | Mac 版 Skype for Business | Lync 2013 客户端 |  
|:-----|:-----|:-----|:-----|  
|Outlook 对话历史记录中的 IM 对话的存档|&#x2714; &#x2776; |如果启用了服务器端对话历史记录 &#x2714;  |&#x2714; &#x2776; | 
|音频、视频、应用程序共享、桌面共享和上载的内容的客户端存档  |&#x2714; &#x2776; ||&#x2714; &#x2776; |
|文件传输、共享的 OneNote 页面和 PowerPoint 注释的客户端存档（在 Skype for Business Online 中不可用）  |&#x2714;||&#x2714;|
