...
可以通过安装管理包（指示 System Center Operations Manager 可以监视的项目、应监视这些项目如何以及触发和报告警报方式的软件）来扩展 System Center Operations Manager 的功能。 Skype for Business Server 2019 包括两个 System Center Operations Manager 管理包，它们提供以下功能：
