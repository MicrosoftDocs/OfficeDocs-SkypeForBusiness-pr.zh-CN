...
了解 2019 年 10 月Skype for Business Server的功能。 有关 2019 年 Skype for Business Server 中的新功能的信息，请参阅 [2019 年 Skype for Business Server中的功能](whats-new.md)。
...
SQL 2019 年 10 月Skype for Business Server镜像。 提供高可用性和灾难恢复的其他选项仍受支持，你应该从中选择。 请参阅 [Plan for high availability and disaster recovery in Skype for Business Server](../SfbServer/plan-your-deployment/high-availability-and-disaster-recovery/high-availability-and-disaster-recovery.md)查看这些选项。
