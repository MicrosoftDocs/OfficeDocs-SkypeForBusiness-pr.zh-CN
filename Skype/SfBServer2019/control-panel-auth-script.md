...
description: 通过 OAuth 协议使用 Microsoft 365 或 Office 365 配置 SFB 2019 控制面板身份验证的帮助程序脚本。
ms.openlocfilehash: 76f8444e78dfe31e008ea24be31c0e7b788b3130
ms.sourcegitcommit: da2a70a9b5e05d0fd7ecc150b451f5805667514c
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/12/2021
ms.locfileid: "50756218"
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="76665-103">Skype for Business Server 2019 控制面板身份验证脚本</span><span class="sxs-lookup"><span data-stu-id="76665-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="76665-104">以下是适用于现代管理员控制面板的身份验证相关帮助程序脚本 (MACP) 。</span><span class="sxs-lookup"><span data-stu-id="76665-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="76665-105">使用 Microsoft 365 或 Office 365 配置 MACP 身份验证</span><span class="sxs-lookup"><span data-stu-id="76665-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="76665-106">此脚本应在安装 Skype for Business Server 2019 累积更新 1 或更高版本后运行，作为新控制面板设置的一部分。</span><span class="sxs-lookup"><span data-stu-id="76665-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="76665-107">在 ADFS 场中配置 MACP 应用程序</span><span class="sxs-lookup"><span data-stu-id="76665-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="76665-108">此脚本应在安装 Skype for Business Server 2019 最新累积更新后运行，作为新控制面板设置的一部分。</span><span class="sxs-lookup"><span data-stu-id="76665-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="76665-109">为 MACP 配置 OAuth</span><span class="sxs-lookup"><span data-stu-id="76665-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="76665-110">此脚本应在安装 Skype for Business Server 2019 最新累积更新后运行，作为新控制面板设置的一部分。</span><span class="sxs-lookup"><span data-stu-id="76665-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
