...
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="53072-103">Skype for Business 服务器2019控制面板身份验证脚本</span><span class="sxs-lookup"><span data-stu-id="53072-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="53072-104">在安装 Skype for Business Server 2019 累积更新1（作为全新控制面板的一部分设置）之后，应运行此脚本。</span><span class="sxs-lookup"><span data-stu-id="53072-104">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1, as part of the set-up for the new Control Panel.</span></span> <span data-ttu-id="53072-105">此脚本将在 Azure 上创建 Azure AD 应用程序。</span><span class="sxs-lookup"><span data-stu-id="53072-105">This script will create an Azure AD Application on Azure.</span></span> <span data-ttu-id="53072-106">这将帮助使用新控制面板中的 OAuth 登录 Office 365。</span><span class="sxs-lookup"><span data-stu-id="53072-106">This will help in signing into Office 365 using OAuth in the new Control Panel.</span></span>
