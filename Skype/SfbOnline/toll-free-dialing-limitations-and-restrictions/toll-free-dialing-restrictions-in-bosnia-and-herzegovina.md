...
---
# <a name="toll-free-dialing-restrictions-in-bosnia-and-herzegovina"></a>在波斯尼亚和黑塞哥维那的免费电话拨号限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> | 0800 XXXXX <br/> |
|国家/地区的 ISO 代码  <br/> |BA  <br/> |
|涵盖岛/区域  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |不适用  <br/> |
|有线固定行的可用性  <br/> |部分。 请参阅注释。  <br/> |
|移动网络的可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |可通过 HT Eronet/Mostar、Telekom Srpske/MTEL 和 BHT 固定网络和移动网络访问。  <br/> |
