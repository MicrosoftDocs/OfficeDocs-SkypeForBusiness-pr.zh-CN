...
ms.openlocfilehash: 4327a0a4479d51b303c8cf2ece29b03eae3aca03
ms.sourcegitcommit: a0d3e7a177fcd0667ab0d7d0e904f4053b09a92d
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/18/2018
---
# <a name="toll-free-dialing-restrictions-in-kenya"></a>在肯尼亚的免费电话拨号限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> | 0 800 7XX XXX <br/> |
|国家/地区的 ISO 代码  <br/> |KE  <br/> |
|涵盖岛/区域  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |不适用  <br/> |
|有线固定行的可用性  <br/> |部分。 请参阅注释。  <br/> |
|移动网络的可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |固定的网络访问： Safaricom 以及 Airtel。 移动网络访问： Safaricom，Airtel 和橙色。  <br/> |
