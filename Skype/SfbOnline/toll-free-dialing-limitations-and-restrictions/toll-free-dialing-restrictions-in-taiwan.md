...
---
# <a name="toll-free-dialing-restrictions-in-taiwan"></a>在台湾的免费电话拨号限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> |00 801 XXX XXX  <br/> |
|国家/地区的 ISO 代码  <br/> |TW  <br/> |
|涵盖岛/区域  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |不适用  <br/> |
|有线固定行的可用性  <br/> | ITFS:KG Telecom = 否 <br/> |
|移动网络的可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |KG Telecom 不提供有线访问。 移动访问： 通话不收费。 对于移动访问： 可通过除 KG Telecom 以外的所有移动网络访问。  <br/> |
