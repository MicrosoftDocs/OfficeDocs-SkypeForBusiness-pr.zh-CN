...
---
# <a name="toll-free-dialing-restrictions-in-indonesia"></a>在印度尼西亚的免费电话拨号限制
...
|国家/地区的 ISO 代码  <br/> |ID  <br/> |
|涵盖岛/区域  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |不适用  <br/> |
|有线固定行的可用性  <br/> |是  <br/> |
|移动网络的可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |在更大的范围内提供两种号码格式。 数字格式 007 803 CCC XXXX 格式是从 PT Telkom 网络，包括 Telkomsel 和 XL 移动访问。 号码格式 001 803 CCC XXXX 可通过 Indosat 网络访问。 对于移动： 矩阵移动 （前缀 0855年、 0858年、 0815 和 0816年） 只。  <br/> |
