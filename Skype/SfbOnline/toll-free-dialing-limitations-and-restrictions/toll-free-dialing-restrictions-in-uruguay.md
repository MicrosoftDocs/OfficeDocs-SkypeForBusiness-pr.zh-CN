...
---
# <a name="toll-free-dialing-restrictions-in-uruguay"></a>在乌拉圭的免费电话拨号限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> |0004 019 XXXX  <br/> |
|国家/地区的 ISO 代码  <br/> |UY  <br/> |
|涵盖岛/区域  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |不适用  <br/> |
|有线固定行的可用性  <br/> |是，Claro 除外。  <br/> |
|移动网络的可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |移动访问： 通话收费。 移动访问： 通过 Ancel 和 Movistar 使用。  <br/> |
