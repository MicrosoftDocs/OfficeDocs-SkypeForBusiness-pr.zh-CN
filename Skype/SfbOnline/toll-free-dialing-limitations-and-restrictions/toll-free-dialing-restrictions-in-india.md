...
---
# <a name="toll-free-dialing-restrictions-in-india"></a>在印度的免费电话拨号限制
...
|国家/地区的 ISO 代码  <br/> |IND  <br/> |
|涵盖岛/区域  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |不适用  <br/> |
|有线固定行的可用性  <br/> |部分。 请参阅注释。  <br/> |
|移动网络的可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |可以从下列网络访问： 循环移动，BSNL-固定 （Bhopal 但所有区域），Vodafone、 主意/趣味 （所有地区，但旁遮普语趣味），MTS 印度/Shyam （都固定） 和 MTNL-都固定&amp;移动，依赖性 （所有区域，但 Ahmedabad Bhopal、 BhuneswerJaipur，Lucknow，Meerut)，TTML &amp; TTSL (固定&amp;postpaid)，Tata DoCoMo，HFCL Infotel/Ping 移动、 S 电话移动、 Uninor、 Videocon 移动，BSNL 移动，Bharti/Airtel 网络。  <br/> 从以下网络不可访问： TTSL （预付款）、 Etisalat DB 电信和 Jio。  <br/> |
