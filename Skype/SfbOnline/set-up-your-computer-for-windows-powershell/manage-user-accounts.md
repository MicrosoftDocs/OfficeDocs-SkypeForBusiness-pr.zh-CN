...
- [在 Skype for Business Online 中返回特定用户的信息](manage-user-accounts.md#BKMKReturnInfoSpecificUser)

- [为 Skype for Business Online 中的特定用户返回特定信息](manage-user-accounts.md#BKMKReturninfoSpecificUsers)
