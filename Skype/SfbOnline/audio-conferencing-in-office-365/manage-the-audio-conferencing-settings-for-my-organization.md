...
---
# <a name="manage-the-audio-conferencing-settings-for-my-organization-in-skype-for-business-online"></a>管理我的组织中 Skype 业务 online 的音频会议设置

> [!NOTE]
> 如果您想要管理团队中的这些设置，请参阅[管理我的组织中的 Microsoft 团队的音频会议设置](/MicrosoftTeams/manage-the-audio-conferencing-settings-for-my-organization-in-teams)。
...
4. 在**产品许可证**页上，打开**要进行音频会议**，然后单击**保存**。 有关许可的更多信息，请参阅 [Skype for Business 附加许可](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md)。
