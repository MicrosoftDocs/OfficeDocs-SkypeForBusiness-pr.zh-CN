...
除了已分配给您的会议桥的电话号码，您可以[获取额外的服务号码](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md)（收费和免费电话号码用于音频会议） 从其他位置，然后分配给会议桥接以便您可以展开您的用户的范围。
...
用户的默认电话是他们安排会议时在会议邀请中包含的号码。 有关详细信息，请参阅[设置的电话号码包含在邀请](set-the-phone-numbers-included-on-invites.md)。
...
使用会议迁移服务，您可以选择更新之前已更改其默认电话号码已发送到组织中用户的会议邀请。 有关更多信息，请参阅[设置会议迁移服务 (MMS)](setting-up-the-meeting-migration-service-mms.md)。
...
```
 > [!IMPORTANT] 
 >您还可以更改默认收费电话或业务管理中心的 Skype 中的用户的免费电话号码。 但是，这不会自动重新计划他们的会议。 
 
 有关其他信息，请参阅[设置的电话号码包含在邀请](set-the-phone-numbers-included-on-invites.md)。
