...
- 可以使用 [Get-CsOnlineDialInConferencingServiceNumber](/powershell/module/skype/Get-CsOnlineDialInConferencingServiceNumber) cmdlet 查看贵组织的音频会议专用电话号码。
    
- 你可以使用 [Get-CsOnlineDialInConferencingLanguagesSupported](/powershell/module/skype/Get-CsOnlineDialInConferencingLanguagesSupported) cmdlet 查看可以对专用拨入电话号码设置的语言。
    
- 你可针对每个音频会议电话号码最多设置四种语言 - 一种主要语言和三种辅助语言。 还可以在专用音频会议电话号码上设置语言。
    
- 若要为用户设置拨入电话号码，请参阅设置 [邀请中包括的电话号码](set-the-phone-numbers-included-on-invites.md)。
