...
![Skype for Business联机活动报告。](../images/670c8bc6-d29c-4033-87fc-a20d324c9aae.png)
  
***
![数字 1。](../images/sfbcallout1.png)<br/>
可以查看 **Skype for Business活动** 电子邮件活动报告，了解过去 7 天、30 天、90 天或 180 天的趋势。 但是，如果单击报告中的某一天，则表 (请参阅数字 7) 将显示自当前日期起最多 28 天的数据 (而不是报表的生成日期) 。
...
* " **组织会议**"显示该用户组织的会议的总数。
* " **参与会议**"显示该用户参与的会议总数。
* **分配的产品** 是Microsoft 365 Office 365此用户的产品。<br/>
...
- [Skype for Business设备使用情况报告](device-usage-report.md)可以看到安装了 Skype for Business 应用并且正使用它进行即时消息和会议的设备，包括基于 Windows 的操作系统和移动设备。
