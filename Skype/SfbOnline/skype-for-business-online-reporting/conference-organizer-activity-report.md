...
此报告中的，以及其他 Skype 业务报告为您提供了详细信息在组织的会议活动上整个组织。 当你为组织进行调查、规划及执行其他业务决策时，这些详细信息非常有用。 
...
2. 在**使用率**页上，单击**业务会议组织者活动的 Skype**上**选择的报告列表**左侧的。 或者，单击**业务活动的 Skype**小部件，然后单击**Skype 的业务活动**列表上的**业务会议组织者活动的 Skype** 。
...
您可以按查看**活动**、**用户**和**分钟**图表的业务会议您 Skype 到获取视图。
...
*    在**分钟**活动图表中，Y 轴是分钟音频/视频、 电话拨入式 Microsoft 分钟和拨出式 Microsoft 分钟，以便在您的组织中的用户组织的会议的总数。  
...
***
![数字 10](../images/sfbcallout10.png)<br/>单击或点击中的任何列添加或从报表中删除列**列**图标。           <br/> ![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)
