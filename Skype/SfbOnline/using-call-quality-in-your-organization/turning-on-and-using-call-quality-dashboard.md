...
|**功能**|**Summary Reports**|**Detailed Reports**|
|:-----|:-----|:-----|
|Application sharing metric  <br/> |否  <br/> |是  <br/> |
|Customer building information support  <br/> |是  <br/> |是  <br/> |
|Drill-down analysis support  <br/> |否  <br/> |是  <br/> |
|Media reliability metrics  <br/> |否  <br/> |是  <br/> |
|Out-of-the-box reports  <br/> |是  <br/> |是  <br/> |
|Overview reports  <br/> |是  <br/> |是  <br/> |
|Per-user report set  <br/> |否  <br/> |是  <br/> |
|Report set customization (add, delete, modify reports)  <br/> |否  <br/> |是  <br/> |
|Video-based screen sharing metrics  <br/> |否  <br/> |是  <br/> |
|Video metrics  <br/> |否  <br/> |是  <br/> |
|Amount of data available  <br/> |Last 6 months  <br/> |Last 6 months  <br/> |
|Microsoft Teams data  <br/> |是  <br/> |是  <br/> |
...
|城市  <br/> |字符串  <br/> |西雅图  <br/> |
|ZipCode  <br/> |字符串  <br/> |98001  <br/> |
|Country  <br/> |字符串  <br/> |US  <br/> |
|省/市/自治区  <br/> |字符串  <br/> |WA  <br/> |
|区域  <br/> |字符串  <br/> |MSUS  <br/> |
