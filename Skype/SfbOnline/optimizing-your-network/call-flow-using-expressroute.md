...
## <a name="network-segments-and-traffic-types"></a>网络段和通信类型
...
## <a name="principles-for-call-flows-with-skype-for-business"></a>用于原则 for Business 呼叫与 Skype 的流
...
## <a name="skype-for-business-call-flows-with-expressroute"></a>For Business 的 Skype 调用与 ExpressRoute 流
...
## <a name="basic-skype-for-business-call-flow"></a>基本 Skype 的业务呼叫流
...
### <a name="online-user-on-your-network-joining-a-conference-that-is-hosted-online"></a>联机用户加入会议的网络上承载 Online
<a name="bk_Figure3"> </a>

在对等的示例中，媒体流量始终所需的最直接路由至其目标。 但是，对于联机会议，目标是在 Office 365 云中。 这意味着加入会议从您的网络内的所有用户的媒体流量区域将遍历 ExpressRoute 连接到 Office 365 云传输信号流量。 下图显示媒体和信号区域将遍历网络，内部用户的 ExpressRoute 连接，并直接将遍历的用户的连接到 Internet 从外部网络，如咖啡从 Internet店或酒店。
...
### <a name="joining-a-conference-hosted-by-on-premises-user-in-hybrid-deployment"></a>加入会议承载的混合部署中的内部部署用户
<a name="bk_Figure3"> </a>
...
### <a name="on-premises-edge-server-with-office-365-hosted-conferences"></a>与 Office 365 的内部部署边缘服务器承载会议
<a name="bk_Figure5"> </a>
...
### <a name="pstn-call-using-skype-for-business-cloud-connector-edition"></a>使用 for Business 云连接器 Edition Skype 的 PSTN 呼叫
<a name="bk_Figure6"> </a>
...
### <a name="skype-meeting-broadcast-with-users-joining-from-customer-network"></a>Skype 与用户加入客户网络从广播的会议
<a name="bk_Figure6"> </a>
...
## <a name="call-flow-patterns-by-deployment-type"></a>呼叫流模式部署类型
...
### <a name="call-flows-for-skype-for-business-online"></a>业务 online Skype 的呼叫流
...
### <a name="call-flows-for-skype-for-business-hybrid"></a>Skype 业务混合的呼叫流
...
### <a name="call-flows-for-skype-for-business-with-cloud-connector"></a>Skype for Business 使用云连接器的呼叫流
