...
## <a name="step-1-set-up-allowed-domains"></a>步骤1：设置允许的域
...
## <a name="step-2-add-skype-meeting-broadcast-domains-urls-and-ip-addresses"></a>步骤2：添加 Skype 会议直播域、Url 和 IP 地址

安装过程中的第二个步骤是：首先添加所需的域，然后添加要使用的 Skype 会议直播所需的 IP 地址和 Url。

- **通过查看此处需要的内容，添加所需的 Skype For Business Online 终结点 url 和 IP 地址** [](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2?ui=en-US&amp;rs=en-US&amp;ad=US#bkmk_lyo)。
