...
ms.locfileid: "58594846"
---
# <a name="set-up-your-network-for-skype-meeting-broadcast"></a>设置 Skype 会议直播网络

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]

启用["Skype 会议广播](enable-skype-meeting-broadcast.md)Skype 会议广播"后，需要配置网络。 如果要为企业外部人员举办网络研讨会和其他直播，请执行此步骤。
...
2. 在"**外部** 共享"页面上的"域例外"下，选择"阻止所有域（除 ）"，并输入以下域，用逗号分隔 (，) ：
...
设置过程的第二步是先添加所需的域，然后添加运行广播Skype 会议 IP 地址和 URL。
