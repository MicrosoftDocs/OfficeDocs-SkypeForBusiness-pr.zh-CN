...
ms.locfileid: "54325549"
---
# <a name="why-is-number-activation-listed-as-updating"></a>为什么号码激活列为"正在更新"？

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]?

地址验证是设置呼叫计划的重要部分。 如果出于某种原因，电话号码未激活并且由于地址验证而列为正在更新，则需要创建并提交服务请求。 你执行此操作的方式基于你的组织规模。
