...
---
# <a name="what-should-i-put-in-for-the-account-number"></a>什么应该我放入的科目编号？

通常情况下，可以找到任何清单上的帐号或发票必须从您的服务提供商或运营商，也可以登录到运营商的网站。 如果您仍然不知道的帐号，您可以联系您的服务提供商或运营商以得。
  
> [!CAUTION]
>  请务必确保输入您的服务提供商或运营商帐户号码时，不要使用空格、 短划线或连字符。
