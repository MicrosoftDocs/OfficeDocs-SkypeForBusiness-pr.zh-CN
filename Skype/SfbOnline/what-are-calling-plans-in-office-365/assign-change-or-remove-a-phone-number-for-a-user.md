...
时设置调用计划在 Office 365 中，您可以向用户分配电话号码。 

在 Microsoft 团队客户端，当他们单击**呼叫**时，将列出您分配的电话号码。

![显示在 Microsoft 团队中的用户的电话号码。](../images/teams-phone-number.png)

在业务客户端 Skype，分配的电话号码将列在**工作电话**框中，不能由用户更改。
...
6. 在**选择要分配的号码**列表中**分配号码**页上，选择用户的电话号码。
    
    > [!TIP]
    > 如果您看不到列出任何电话号码，您需要[获取电话号码为用户](getting-phone-numbers-for-your-users.md)首次。 或者，如果您使用**的业务管理中心 Skype** > **语音** > **电话号码**页上，单击**添加**，然后单击**新的用户数量**。 
  
7. 分配或更改紧急关联的地址，在下，**选择验证紧急位置**，从列表中选择位置或者，如果您有多个定义的位置，在搜索框中输入市/县的名称并单击**搜索**。
