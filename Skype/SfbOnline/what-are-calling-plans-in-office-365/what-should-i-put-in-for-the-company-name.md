...
---
# <a name="what-should-i-put-in-for-the-company-name"></a>什么应该我放入的公司名称？

这是您的公司或组织的名称。 公司名称只限于 25 个字符，包括空格。 公司的名称不用来处理端口订单请求;它通常在出现争议时，或如果东西时不正确的电话号码通过端口连接。 如果不能适应整个名称框中的公司，它将不会推迟或取消的端口顺序。
