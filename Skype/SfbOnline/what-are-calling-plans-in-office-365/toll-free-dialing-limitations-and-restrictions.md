...
---
# <a name="toll-free-dialing-limitations-and-restrictions"></a><span data-ttu-id="af395-105">免费电话拨号限制和限制</span><span class="sxs-lookup"><span data-stu-id="af395-105">Toll-free dialing limitations and restrictions</span></span>

<span data-ttu-id="af395-106">这将帮助您了解如何拨打免费电话在每个国家或地区。</span><span class="sxs-lookup"><span data-stu-id="af395-106">This will help you find out how to dial toll free numbers in each country or region.</span></span> <span data-ttu-id="af395-107">选择国家/地区后，它将为包含其中收费电话免费服务是包括的特定详细信息、 限制和限制可用的页。</span><span class="sxs-lookup"><span data-stu-id="af395-107">After you select the country/region, it will take you to a page that contains where toll free service is available including specific details, restrictions, and limits.</span></span> <span data-ttu-id="af395-108">拨号格式将显示您所需的访问码，每个国家/地区拨打免费电话号码。</span><span class="sxs-lookup"><span data-stu-id="af395-108">The dialing format or formats will show you the required access codes within each country/region to dial the toll-free number.</span></span>
  
<span data-ttu-id="af395-109">如果您已经准备好，选择一个国家或地区：</span><span class="sxs-lookup"><span data-stu-id="af395-109">If you're ready, select a country or region:</span></span>
  
## <a name="select-your-country-or-region-to-see-the-dialing-codes-limitations-and-restrictions"></a><span data-ttu-id="af395-110">选择您的国家或地区，请参阅拨号代码、 局限性和限制。</span><span class="sxs-lookup"><span data-stu-id="af395-110">Select your country or region to see the dialing codes, limitations and restrictions.</span></span>
...
> - [中国 （华南地区）](../toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-chinasouth-10-800-140-xxxx-range.md)
...
## <a name="here-are-some-important-things-for-you-to-remember-about-toll-free-numbers"></a><span data-ttu-id="af395-172">以下是一些重要的事情，记住关于免费电话号码：</span><span class="sxs-lookup"><span data-stu-id="af395-172">Here are some important things for you to remember about toll free numbers:</span></span>

- <span data-ttu-id="af395-173">**每个国家/地区范围内仅使用免费电话号码。**</span><span class="sxs-lookup"><span data-stu-id="af395-173">**Toll free numbers only operate within each country/region.**</span></span> <span data-ttu-id="af395-174">例如，您的用户将无法调用外部澳大利亚澳大利亚免费电话号码。</span><span class="sxs-lookup"><span data-stu-id="af395-174">For example, your users won't be able to call an Australian toll-free number outside of Australia.</span></span>
    
- <span data-ttu-id="af395-175">**购买或移植通用国际免费电话号码 (UIFN) 不受支持。**</span><span class="sxs-lookup"><span data-stu-id="af395-175">**Acquiring or porting Universal International Freephone Numbers (UIFN) isn't supported.**</span></span>
    
- <span data-ttu-id="af395-176">**在许多国家/地区，该国家/地区中的调压器/电信机构要求每个免费电话号码来维护至少 100 分钟，每月的使用情况，以便保留数。**</span><span class="sxs-lookup"><span data-stu-id="af395-176">**In many countries/regions, the regulator/telecommunication agency in the country/region requires each toll free phone number to maintain at least 100 minutes of usage per month in order to retain the number.**</span></span>
    
    > [!NOTE]
    > 万一您获得的免费电话号码和编号的用法不能满足这些最低要求，Microsoft 可能不得不由调压器/电信机构收回您的号。 
  
- <span data-ttu-id="af395-178">**有线、 固定的行和免费电话号码的移动网络访问可能会完全或部分地限制。**</span><span class="sxs-lookup"><span data-stu-id="af395-178">**Wireline, fixed line, and mobile network access to toll-free numbers may be fully or partially restricted.**</span></span> <span data-ttu-id="af395-179">拨号格式介绍每个国家/地区使用免费号码进行呼叫所需的访问代码。</span><span class="sxs-lookup"><span data-stu-id="af395-179">The dialing format describes the required access codes within each country/region to place calls using the toll free number.</span></span>
    
- <span data-ttu-id="af395-180">**北美编号计划免费电话号码：**北美地区编号计划免费电话每分钟费率由原始的国家决定。</span><span class="sxs-lookup"><span data-stu-id="af395-180">**North America Numbering Plan Toll Free Numbers:** Per-minute rates for North America Numbering Plan toll free numbers are determined by the originating country.</span></span> <span data-ttu-id="af395-181">调用的频率定义为"北美。"源于美国地图收费免费每分钟费率</span><span class="sxs-lookup"><span data-stu-id="af395-181">The toll free per-minute rate for calls that originate from the United States map to the rate defined as "North America."</span></span> <span data-ttu-id="af395-182">但是，调用源自其他北美国家如加拿大、 波多黎各等有具体的收费电话免费速率。</span><span class="sxs-lookup"><span data-stu-id="af395-182">However, calls that originate from other North American countries such as Canada, Puerto Rico, etc. have specific toll free rates.</span></span>

> [!NOTE]
> 如果需要获取更多电话号码，请[联系商业版产品支持人员 - 管理员帮助](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)
    
## <a name="related-topics"></a><span data-ttu-id="af395-184">相关主题</span><span class="sxs-lookup"><span data-stu-id="af395-184">Related topics</span></span>
[<span data-ttu-id="af395-185">获取 Skype for Business 和 Microsoft Teams 的服务电话号码</span><span class="sxs-lookup"><span data-stu-id="af395-185">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md)

## <a name="feedback"></a><span data-ttu-id="af395-186">反馈意见？</span><span class="sxs-lookup"><span data-stu-id="af395-186">Feedback?</span></span>
<span data-ttu-id="af395-187">提供产品反馈意见或让我们知道我们所执行的信息，请参阅[Skype 业务反馈](https://www.skypefeedback.com)。</span><span class="sxs-lookup"><span data-stu-id="af395-187">To provide product feedback or to let us know how we're doing, see [Skype for Business Feedback](https://www.skypefeedback.com).</span></span>