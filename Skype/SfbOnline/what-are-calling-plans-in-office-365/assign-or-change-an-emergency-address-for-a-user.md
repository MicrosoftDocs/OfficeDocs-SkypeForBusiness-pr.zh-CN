...
当您设置 Office 365 中调用计划时，您需要分配给每个用户的电话号码和紧急的地址。 必须先创建紧急地址，然后才能将其与电话号码关联。 请参阅[什么是紧急位置、 地址和呼叫路由？](what-are-emergency-locations-addresses-and-call-routing.md)的详细信息。
