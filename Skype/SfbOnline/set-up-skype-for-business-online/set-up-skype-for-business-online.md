...
看来你需要帮助来完成与你的 Office 365 订阅相关的 Skype 设置。 您可以按照以获取您安装已完成此文章中的步骤。
  
## <a name="1-plan-for-skype-for-business"></a>1. Skype for Business 计划

如果有 **[Office 365 商业高级版](https://products.office.com/en-us/business/office-365-business-premium)** 或 **商业协作版** ，则可使用 Skype for Business 拨打联机电话给企业中订阅上的其他人。 例如，如果您的公司有 10 个人，您可以[开始使用 Skype 为 IM 和联机会议业务](http://support.office.com/article/cc05afa6-1894-4a82-9dd9-6222061f50fd)到彼此，并执行步骤 2-6 下后业务使用 Skype[与 Skype 的业务会议](https://support.office.com/article/2eed8424-581a-4497-b505-c08c152e5851)。 并且您可以[设置在 Outlook 中的商务会议 Skype](https://support.office.com/article/b8305620-d16e-4667-989d-4a977aad6556#bkmk_OWA)参加联机会议，太 ！
  
如果你想使用 Skype for Business 与组织 **外部** 的用户进行 *通话*  ，则有下列选项：
  
- **选项 1。使用免费的 [Skype 应用](https://www.skype.com/)** 。 如果企业的规模很小（例如，1-2 人），则使用 Skype 应用比较好。 进行国内和国际呼叫的费用较低。 仍然可以容纳会议呼叫、 打视频电话，并共享您的桌面的演示文稿。 [检出率和付款选项](https://secure.skype.com/en/calling-rates?wt.mc_id=legacy&amp;expo365=bundled)。
    
- **选项 2。升级你的计划，并购买 Office 365 的电话系统和呼叫计划** 。 最简单的方法来找出多少这成本，然后进行切换、 到[与客户支持联系业务产品的管理帮助](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)并让他们为您做的一切。
...
2. 登录到 Office 365 管理中心，并输入您的 Office 365 提供用户 ID 和密码。 登录后，你将看到 Office 365 管理中心：
...
1. [添加域和 Office 365 提供给用户](https://support.office.com/article/6383f56d-3d09-4dcb-9b41-b5f5a5efd611)： 使用 Office 365 安装向导来设置您使用 Office 365 （如*fourthcoffee.com*) 的自定义域。 **By default, the Office 365 setup wizard includes setting up Skype for Business Online and creating your Skype for Business user IDs.** If you already used the wizard to set up your domain for Office 365, then you've completed this step.
...
3. [Office 365 URL 和 IP 地址范围](https://support.office.com/article/8548a211-3fe7-47cb-abb1-355ea5aa88a2#BKMK_LYO)：大多数小型企业不需要执行此步骤。 **但是，如果你有限制访问部分 Web 的防火墙或代理服务器** ，你必须创建规则来允许访问 Skype for Business Online 终结点。 这是最好由有配置防火墙和代理服务器经验的人执行的高级步骤。 如果您没有这样过，考虑雇用[的 Microsoft 合作伙伴](https://go.microsoft.com/fwlink/?linkid=391089)来为您设置业务的 Skype。
...
之前设置更多的功能，请确保您对它们有许可证。 [Skype for Business 和 Microsoft Teams 外接程序许可](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md)
...
2. [启用广播 Skype 会议](../set-up-your-network-for-skype-meeting-broadcast/enable-skype-meeting-broadcast.md)： 默认情况下，不启用此功能。 在启用该功能后，你的用户将能够与组织中的其他人一起主持直播会议。
