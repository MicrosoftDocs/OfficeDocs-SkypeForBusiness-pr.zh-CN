...
---
# <a name="skype-for-business-mobile-app-security"></a>Skype 的企业移动应用程序安全
...
|||||
|:-----|:-----|:-----|:-----|
||**用户名/密码** <br/> |**应用程序数据 (对话，<br/>联系人列表、 会议)** <br/> |**诊断日志** <br/> |
...
**注意：**请在每个上述的移动平台上可用的设备 pin 实施[此公用文档](https://docs.microsoft.com/en-us/InTune/deploy-use/introduction-to-device-compliance-policies-in-microsoft-intune)，参阅
