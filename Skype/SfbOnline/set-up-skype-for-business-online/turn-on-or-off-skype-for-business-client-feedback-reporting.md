...
- Windows PowerShell 全部用于管理用户以及允许或禁止用户执行的操作。使用 Windows PowerShell，您可以使用单一的管理点管理 Office 365 和 Skype for business Online，这样就可以简化日常工作。若要开始使用 Windows PowerShell，请参阅以下主题：
