...
如果需要有关启动 Windows PowerShell连接，请参阅在单个 Windows PowerShell[](/microsoft-365/enterprise/connect-to-all-microsoft-365-services-in-a-single-windows-powershell-window)窗口中连接所有 Microsoft 365 或 Office 365 服务，或为 Windows PowerShell 设置[计算机。](../set-up-your-computer-for-windows-powershell/set-up-your-computer-for-windows-powershell.md)
...
- Windows PowerShell在速度、简单性和工作效率方面具有许多优点Microsoft 365 管理中心例如，当您一次对许多用户进行设置更改时。 通过以下主题了解这些优势：
