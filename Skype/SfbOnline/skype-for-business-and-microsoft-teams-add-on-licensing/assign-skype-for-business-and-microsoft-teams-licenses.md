...
- **面向混合用户使用本地 PSTN 连接？** 如果是这样，您只需分配一个**电话系统**许可证。 您**不**应该分配 PSTN 通话套餐。
...
- **错误消息**：如果你还没有购买正确数量的许可证，则会收到一条错误消息。 如果您需要购买更多通话套餐许可证，请选择**购买更多**。

- **后续步骤**：向用户分配通话套餐许可证后，你需要获得贵组织的电话号码，然后将这些号码分配给组织中的人员。 有关分步设置的说明，请参阅[设置通话套餐](../what-are-calling-plans-in-office-365/set-up-calling-plans.md)。
...
- **第三方音频会议提供商**：如果有人已设置为使用第三方音频会议提供商，您为 他们分配**音频会议**许可证时，他们将改为使用 Microsoft 为音频会议提供商。 你可以将他们更改回第三方提供商。
...
- **后续步骤** ：分配这些许可证后，你需要获得贵组织的电话号码，然后将这些号码分配给组织中的人员。 有关分步设置的说明，请参阅[设置通话套餐](../what-are-calling-plans-in-office-365/set-up-calling-plans.md)。
