...
若要使用户能够成功登录到业务联机电话 Skype 和发起呼叫，您需要确保用户分配正确的许可证。 至少需要分配电话系统许可证和调用规划。 有关其他信息，您可以看到[Skype 业务和 Microsoft 团队许可加载项](../../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md)和[业务和 Microsoft 团队许可证分配 Skype](../../skype-for-business-and-microsoft-teams-add-on-licensing/assign-skype-for-business-and-microsoft-teams-licenses.md)。
  
可以通过阅读了解有关调用计划详细[什么是 Office 365 中调用计划？](../../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md)
...
- **电话功能**功能集可能有所变化稍微基于 IP 电话合作伙伴。 完整功能设置并为每个电话制造商的功能的详细信息，请参阅[业务 online Skype 的入门电话](getting-phones-for-skype-for-business-online.md)。
    
- **电话锁定**是用于保护电话的业务认证的电话的 Skype 中最近引入的功能。 如果启用，用户将需要创建一个成功的身份验证时的 PIN。 一旦创建，空闲超时定义过期、 用户手动锁定他们的电话，或其与使用电话配对其 PC 锁定同步其电话锁定时，将锁定电话。 如果电话锁定 PIN 输入错误多次，则电话将用户注销或需要管理员的代码以解锁电话，但这异电话合作伙伴。 用户的 PIN 应介于 6 到 15 位数字。
