...
f1keywords: None
ms.custom: Reporting
description: "新 Office 365 报告仪表板显示在您的组织中的 Office 365 产品活动概述。 它使您能够钻到单独的产品级报告，以使您更精确地了解每种产品中的活动。"
...
新 Office 365**的报告**控制板显示在您的组织中的 Office 365 产品活动概述。 它使您能够钻到单独的产品级报告，以使您更精确地了解每种产品中的活动。 例如， **Skype 业务会话详细信息**报表可用于单个用户的呼叫体验有关的详细信息，请参阅。
...
***
![数字 4](../images/sfbcallout4.png)<br/>下表显示了每个用户的所有会话详细信息的分类。 这将显示所有已分配给他们和他们的会话信息业务的 Skype 的用户。 您可以添加/移除列的表。 <br/><br/>为每个会话表包含以下列：
