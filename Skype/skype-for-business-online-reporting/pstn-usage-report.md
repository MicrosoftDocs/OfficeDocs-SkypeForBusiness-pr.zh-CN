...
新 Skype 业务管理中心**报告**区域显示您呼叫和音频会议活动组织中。 它使您能够深入到报表，以使您更精确地了解每个用户的活动。 例如，可以使用**Skype 业务 PSTN 用法详细信息**报表以查看入站/出站调用用的和成本为这些调用的分钟数。 您可以查看包括通话的成本，这样可以了解您的使用情况并调用记帐详细资料以确定您的组织中使用的音频会议 PSTN 使用状况细节。
...
***
![1 号](../images/sfbcallout1.png)<br/>下表显示了每个用户所有的 PSTN 使用的细目分类。 这将显示已分配给他们和他们的 PSTN 使用业务的 Skype 的所有用户。 您可以添加/移除列的表。
