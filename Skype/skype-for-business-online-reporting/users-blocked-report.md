...
下表显示禁止打电话的用户所有的细目分类。 这将显示所有的用户电话系统或音频会议分配给他们的用户。 您可以添加/移除列的表。
***
...
这导出所有用户的数据，使您可以执行简单的排序和筛选供进一步分析。 如果您有少于 2000年用户，您可以排序和筛选报告本身中的表内。 如果您有 2000 多个用户，到筛选和排序顺序，您需要将数据导出。
***
