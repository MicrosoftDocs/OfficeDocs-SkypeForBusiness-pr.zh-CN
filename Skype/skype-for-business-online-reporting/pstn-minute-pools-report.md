...
***
![数字 3](../images/sfbcallout3.png)<br/>你还可以单击或点击" **导出到 Excel**"按钮，将报告数据导出到 Excel .csv 文件中。 <br/><br/> 这导出所有用户的数据，使您可以执行简单的排序和筛选供进一步分析。 如果您有少于 2000年用户，您可以排序和筛选报告本身中的表内。 如果您有 2000 多个用户，到筛选和排序顺序，您需要将数据导出。
