...
1. 请转到**Office 365 管理中心** > **业务的 Skype**。
    
    > [!NOTE]
    > 当提供程序将从另一个提供程序更改为**Microsoft**时，（会议 ID，收费和免费电话号码） 的用户的音频会议信息将被替换。 您应保存此信息，然后再更改提供程序。 
...
- 在您的组织中，您可以使用 Microsoft 作为其音频会议提供商中，一些人和其他人使用第三方提供程序。 但这是更复杂的设置和管理。
