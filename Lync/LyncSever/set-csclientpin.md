...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg398929(v=OCS.15)
ms:contentKeyID: 49314377
ms.date: 05/19/2016
...
Assigns a new personal identification number (PIN) to the specified user. 此 cmdlet 是在 Lync Server 2010 中引入的。 Note that the Lync Server 2013 version of this cmdlet can only assign PIN numbers to users homed on Lync Server 2013. You should use the Lync Server 2010 version of Set-CsClientPin to assign PIN numbers to users homed on Lync Server 2010.
