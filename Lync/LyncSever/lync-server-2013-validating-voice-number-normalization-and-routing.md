...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dn720922(v=OCS.15)
ms:contentKeyID: 62246694
ms.date: 05/19/2016
...
We recommend conducting this validation daily by using the Lync Server 控制面板, starting with developing a robust set of test cases against the current set of normalization rules that were published in the Lync Server global settings. These test cases should be run daily to highlight any unwanted changes that were made and committed to the dial plan.

Lync Server 控制面板 also helps you visualize, test, change, archive, and share configuration information about voice routing and in changing Enterprise Voice number normalization rules, dial plans, voice policy, and routes. It has additional features for doing the following:
  ...
  - More information about voice routing tests can be found at [在 Lync Server 2013 中测试语音路由](lync-server-2013-test-voice-routing.md)
