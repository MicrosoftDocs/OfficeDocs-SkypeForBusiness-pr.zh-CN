...
_**上次修改的主题：** 2013-01-25_

Lync Server 2013 压力和性能工具包括简化 Lync Server 2013 容量规划的工具。 Lync Server 2013 的压力和性能工具将帮助你执行以下操作：

  - 简化对 Lync Server 2013 的硬件规划。

  - 为您提供有关性能优化的更多知识和最佳做法。

  - 衡量预期的 Lync Server 2013 部署的性能。
...
9.  [Lync Server 2013 压力和性能工具常见问题解答](lync-server-2013-stress-and-performance-tool-faq.md)
