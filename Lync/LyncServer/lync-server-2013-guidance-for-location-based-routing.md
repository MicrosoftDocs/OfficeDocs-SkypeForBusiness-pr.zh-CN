...
基于位置的路由可应用于用户的终结点网络站点位置或 PSTN 网关的网络站点位置。 本主题提供有关如何应用基于位置的路由的指南。

<div>

## <a name="in-this-section"></a>本部分内容

  - [Lync Server 2013 中的用户位置](lync-server-2013-user-s-location.md)

  - [Lync Server 2013 中的 PSTN 网关的位置](lync-server-2013-pstn-gateway-s-location.md)
