---
title: Lync Server 2013：组的呼叫应答的技术要求
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
# <a name="technical-requirements-for-group-call-pickup-in-lync-server-2013"></a>Lync Server 2013 中组内呼叫应答的技术要求
...
组呼叫装货与呼叫寄存应用程序具有相同的硬件、软件和端口要求。 组呼叫应答不使用音频文件。
