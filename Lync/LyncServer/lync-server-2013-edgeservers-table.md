...
# <a name="edgeservers-table-in-lync-server-2013"></a>Lync Server 2013 中的 EdgeServers 表
...
_**上次修改的主题：** 2010-11-06_

EdgeServers 表是一个支持表格。 每个记录存储有关在数据库中包含记录的呼叫中涉及的一台边缘服务器的信息。
