...
---
# <a name="the-skype-for-business-online-cmdlets"></a>Skype for Business Online cmdlet
...
当您使用 Windows PowerShell 连接到 Skype for business Online 时，会将 Skype for business Online cmdlet 的集合复制到计算机上的内存中。 除了您在本地计算机上已有的任何其他 cmdlet (包括安装 Windows PowerShell) 时安装的核心 cmdlet 外，这些 cmdlet 都可用于管理 Skype for business Online 部署和 Skype for business Online 用户帐户。 Skype for Business Online cmdlet 将在以下主题中引入：
  ...
  - [管理 Skype for Business Online 中的策略](https://docs.microsoft.com/office365/enterprise/powershell/manage-skype-for-business-online-policies-with-office-365-powershell)
  ...
  - [管理外部用户和组织在 Skype for business Online 中的通信](https://docs.microsoft.com/skypeforbusiness/set-up-skype-for-business-online/allow-users-to-contact-external-skype-for-business-users)

  - [管理 Skype for Business Online 会议和会议](https://docs.microsoft.com/skypeforbusiness/manage/conferencing/conferencing-policies)
...
[快速参考：使用 Windows PowerShell 执行常见的 Skype for Business Online 管理任务](https://docs.microsoft.com/office365/enterprise/powershell/manage-skype-for-business-online-with-office-365-powershell)  
