...
8.  若要指定您希望此路由适应的模式，您可以使用 " **生成模式以匹配** 工具" 来生成正则表达式，也可以手动编写正则表达式。
      ...
      - 若要手动定义匹配模式，请在“构建要匹配的模式”**** 工具中单击“编辑”****，然后键入 .NET Framework 正则表达式，以便为应用路由的目标电话号码指定匹配模式。 有关如何编写正则表达式的详细信息，请参阅中的 ".NET Framework 正则表达式" [https://go.microsoft.com/fwlink/p/?linkId=140927](https://go.microsoft.com/fwlink/p/?linkid=140927) 。
...
11. 若要将一个或多个公用电话交换网 (PSTN) 使用与语音路由相关联，请单击 " **选择** "，然后从已为您的企业语音部署定义的 PSTN 用法记录列表中选择一个记录。
