...
# <a name="install-lync-server-2013-prerequisite-software"></a>安装 Lync Server 2013 必备软件
...
持久聊天服务器的必备软件与 Lync Server 2013 前端服务器的必备软件以及安装持久聊天服务器功能的 Lync Server 2013 Standard Edition 服务器相同。

持久聊天服务器文件存储所需的必备软件与 Lync Server 2013 所需的软件相同。

用于持久聊天服务器内容和合规性的 SQL Server 数据库的必备软件也与 Lync Server 2013 的必备软件相同。
