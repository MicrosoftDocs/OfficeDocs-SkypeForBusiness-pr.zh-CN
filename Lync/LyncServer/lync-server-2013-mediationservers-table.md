...
---
# <a name="mediationservers-table-in-lync-server-2013"></a>Lync Server 2013 中的 MediationServers 表
...
MediationServers 表是一个支持表格。 每个记录存储有关在数据库中包含记录的呼叫中涉及的一台中介服务器的信息。
