...
若要为 Windows 7 或 Windows 8 计算机创建服务质量音频策略，请首先登录到安装了组策略管理的计算机。 打开组策略管理（单击“开始”****，指向“管理工具”****，然后单击“组策略管理”****），然后完成下列过程：
...
对于文件传输策略：
  ...
  - 对应用程序使用先前配置的端口范围。 例如，如果已为应用程序共享保留端口 42020 到 42039，然后将端口范围设置为：“42020:42039”****。
...
请记住，应该将这些策略指向客户端计算机目标。 不应将它们应用于运行 Lync Server 的服务器。
