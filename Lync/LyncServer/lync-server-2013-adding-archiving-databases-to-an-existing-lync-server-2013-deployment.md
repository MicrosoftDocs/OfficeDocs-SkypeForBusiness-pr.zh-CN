...
在设置了用于存档的系统平台和基础结构之后，必须使用拓扑生成器将存档添加到拓扑，然后发布拓扑。
...
## <a name="in-this-section"></a>本部分内容
  ...
  - [发布更新后的拓扑以在 Lync Server 2013 中添加存档数据库](lync-server-2013-publishing-the-updated-topology-to-add-archiving-databases.md)
