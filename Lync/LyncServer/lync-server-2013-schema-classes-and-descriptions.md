...
<td><p>此辅助类到 msRTCSIP-ApplicationServer 包含表示应用程序服务实例的设置的属性。</p></td>
<td><p>通信服务器 2007 R2 中的新增项。</p></td>
</tr>
<tr class="even">
...
<td><p>此辅助类保存 Microsoft Lync Web App bank 的设置。</p></td>
<td><p>通信服务器 2007 R2 中的新增项。</p></td>
</tr>
<tr class="even">
...
<td><p>此类容器表示单个访问边缘服务。 由于在外围网络中部署了访问边缘服务，并且客户通常不允许从外围网络进行 Active Directory 域服务访问，因此 Access Edge 服务的实例未加入 intranet 的 Active Directory 网络。 这样，访问代理就不会在 AD DS 中自动注册。 管理员必须手动配置 AD DS 中的每个 Access Edge 服务实例的存在。</p></td>
<td><p>-</p></td>
</tr>
<tr class="even">
...
<td><p>此类包含适用于所有在 Lync Server 部署中的设置。</p></td>
<td><p>-</p></td>
</tr>
<tr class="odd">
...
<td><p>此类保存多个 Lync Server 策略类，并且没有任何属性本身。</p></td>
<td><p>在 Lync Server 2010 中已过时。</p></td>
</tr>
<tr class="odd">
...
<td><p>此类保存多个 Lync Server 池，并且没有任何属性本身。</p></td>
<td><p>-</p></td>
</tr>
<tr class="odd">
...
<td><p>此类是表示可使用全局可路由用户代理 URI (GRUU) 地址进行路由的受信任服务的容器。 当激活由 Lync Server 信任的新服务器时，将创建此类的实例。 此受信任服务器必须加入 Active Directory 域。</p></td>
<td><p>通信服务器2007中的新增项。</p></td>
</tr>
<tr class="odd">
