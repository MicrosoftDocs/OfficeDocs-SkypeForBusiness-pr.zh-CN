...
若要向组织中的企业语音用户提供[集成统一消息和 Lync Server 2013 的功能](lync-server-2013-features-of-integrated-unified-messaging.md)中所述的 Exchange UM 功能和服务, 必须部署 Microsoft Exchange 邮箱服务器和客户端访问服务器,其中托管用户邮箱和为电子邮件和语音邮件提供单个存储位置。 Exchange UM 在 Exchange 邮箱和客户端访问服务器上作为服务运行。
