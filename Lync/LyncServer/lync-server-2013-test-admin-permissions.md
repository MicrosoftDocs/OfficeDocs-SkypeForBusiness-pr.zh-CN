...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dn767945(v=OCS.15)
ms:contentKeyID: 62486232
ms.date: 05/19/2016
...
For more information on OU permissions, see the article [Lync Server 2013 中权限继承在计算机、用户或 InetOrgPerson 容器上被禁用](lync-server-2013-permissions-inheritance-is-disabled-on-computers-users-or-inetorgperson-containers.md).
