...
# <a name="lync-server-2013-network-interfaces"></a>Lync Server 2013 网络接口
...
使用本部分中的过程管理 Lync Server 2013 环境的网络接口。

<div>

## <a name="in-this-section"></a>本节内容

  - [在 Lync Server 2013 中查看网络接口信息](lync-server-2013-viewing-network-interface-information.md)
