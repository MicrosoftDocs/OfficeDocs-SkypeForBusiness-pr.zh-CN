...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg398709(v=OCS.15)
ms:contentKeyID: 49313539
ms.date: 05/19/2016
...
Creates a new client version policy. Client version policies enable you to specify which versions of clients (such as Microsoft Office Communicator 2007 R2) will be able to log on to your Lync Server system. 此 cmdlet 是在 Lync Server 2010 中引入的。
