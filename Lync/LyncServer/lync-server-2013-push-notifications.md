...
您可以从 "Lync Server 2013 控制面板" 的 "**客户端**" 部分管理推送通知。

<div>

## <a name="in-this-section"></a>本部分内容

  - [在 Lync Server 2013 中为 Iphone 启用或禁用推送通知](lync-server-2013-enabling-or-disabling-push-notifications-for-iphones.md)

  - [在 Lync Server 2013 中为 Windows phone 启用或禁用推送通知](lync-server-2013-enabling-or-disabling-push-notifications-for-windows-phones.md)

  - [查看 Lync Server 2013 中的推送通知设置的相关信息](lync-server-2013-viewing-information-about-push-notification-settings.md)
