...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ204629(v=OCS.15)
ms:contentKeyID: 49311819
ms.date: 05/19/2016
...
**Lync Server 控制面板:** The functions carried out by the R**emove-CsUserServicesPolicy** cmdlet are not available in the Lync Server 控制面板.
