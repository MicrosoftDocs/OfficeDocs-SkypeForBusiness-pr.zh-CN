...
> [!IMPORTANT]  
> 本主题仅适用于 Lync Server 2013 移动服务（Mcx），不适用于 Lync Server 2013 的累积更新：2月2013中提供的统一通信 Web API （UCWA）。
...
3.  ASP.NET 进程模型设置为 "自动配置" （仅适用于 IIS 7.5）。

4.  Http.sys 队列限制设置为1000（默认情况下）。
