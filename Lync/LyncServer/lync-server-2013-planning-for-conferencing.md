...
Lync Server 2013 提供了一组丰富的会议功能：
  ...
  - 电话拨入式会议，它允许用户通过使用公开交换的电话网络 (PSTN) 电话（无需使用第三方音频会议提供商）加入 Lync Server 2013 会议的音频部分。

  - 即时消息 (IM) 会议，其中两个双方在一个 IM 会话中进行通信。 有关 IM 会议的详细信息，请参阅 [在 Lync Server 2013 中规划前端服务器、即时消息和状态](lync-server-2013-planning-for-front-end-servers-instant-messaging-and-presence.md)。
...
> [!NOTE]  
> 如果您的部署包括使用 Office Communicator 2007 R2 客户端组织的会议 (包括 Live Meeting 控制台或适用于 Microsoft Office Outlook 的会议外接程序) ，则在将会议迁移到 Lync Server 2013 之后，将有以下限制： 
> <UL>
> <LI>
