...
如果安全性是非常重要的问题（例如使用展台时），应启用此功能。 有关令牌重播检测的详细信息，请参阅在上[http://go.microsoft.com/fwlink/p/?LinkId=309215](http://go.microsoft.com/fwlink/p/?linkid=309215)安全规划和部署 AD FS 2.0 的最佳实践。
