...
响应组应用程序提供了采用26种语言的语音识别和文本到语音转换功能。 可以使用文本到语音转换功能或 Wave (.wav) 或 Windows Media 音频 (.wma) 文件输入 IVR 问题。 呼叫者可以使用语音或双音多频 (DTMF) 响应进行响应。
...
> [!NOTE]  
> 当您使用 Lync Server 命令行管理程序设计呼叫流时，您可以定义任何号码级别的 IVR 问题和任意数量的应答。 但是，为了方便呼叫者使用，建议不要使用三个级别以上的问题，并且每个问题的答案不要超过五个。 此外，如果设计的呼叫流中有两个以上的问题，每个级别多于四个，则无法使用 Lync Server 2013 控制面板编辑呼叫流。
...
![使用交互式语音响应设计呼叫流](images/Gg413020.4820a9f7-b5b0-4831-b972-baae0c015ec1(OCS.15).jpg "使用交互式语音响应设计呼叫流")
...
![使用交互式语音响应设计呼叫流](images/Gg413020.a5b62083-312d-4419-898b-d1a225a5379f(OCS.15).jpg "使用交互式语音响应设计呼叫流")
