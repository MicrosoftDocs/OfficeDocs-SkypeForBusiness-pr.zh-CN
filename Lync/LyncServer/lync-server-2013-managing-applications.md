...
使用本节中的过程管理 Lync Server 2013 的应用程序。
...
## <a name="in-this-section"></a>本部分内容
  ...
  - [Lync Server 2013 中 (应用程序/计算机/终结点/池) 的受信任应用程序](lync-server-2013-trusted-applications-application-computer-endpoint-pool.md)
