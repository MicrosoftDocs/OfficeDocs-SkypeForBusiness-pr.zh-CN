...
9.  单击 "**主机提供此服务**"，然后键入 lync Server 2013 边缘池的完全限定域名（FQDN），该域名为受信任的外部客户端提供对 lync server 2013 系统的访问权限。
    ...
    > [!NOTE]
    > 此外，还必须将域设置为 Exchange Online 设置中的权威性的接受域。 有关详细信息，请参阅在上<A href="http://go.microsoft.com/fwlink/p/?linkid=229762">http://go.microsoft.com/fwlink/p/?linkId=229762</A>创建接受的域。
