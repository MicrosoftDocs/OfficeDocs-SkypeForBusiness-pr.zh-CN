...
电话号码应按您希望的拨号方式进行格式设置。 例如, 如果在拨长途电话之前, 用户通常不先拨 1, 则应使用以下格式:

`-DialedNumber "2065551219"`

当然, 在这种情况下, 如果你没有可以将数字2065551219正确转换为 Lync Server 使用的 E: 164 电话格式的规范化规则, 测试将失败。 有关详细信息, 请参阅帮助主题 CsVoiceNormalizationRule cmdlet。
