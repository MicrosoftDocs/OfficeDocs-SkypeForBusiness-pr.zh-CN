...
您必须在运行 Windows Server 2012、Windows Server 2012 R2 或 Windows Server 2008 R2 （SP1）的计算机上运行 Active Directory 准备步骤， (64) 。 Active Directory 准备需要 Lync Server 命令行管理程序和 OCSCore。
