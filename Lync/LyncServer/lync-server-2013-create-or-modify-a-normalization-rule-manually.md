...
3.  Optional按照在[Lync server 2013 中创建拨号计划](lync-server-2013-create-a-dial-plan.md)中的步骤或[在 lync Server 2013 中修改拨号计划](lync-server-2013-modify-a-dial-plan.md)中的步骤进行操作。
...
7.  在“键入正则表达式”**** 中输入以下内容：
    ...
    例如，如果在 "**转换规则**" 中输入 " **^\\{7}（d） $** " 与此模式和 **+ 1425 $ 1** **相匹配**，则该规则会将5550100规范化为 + 14255550100。
