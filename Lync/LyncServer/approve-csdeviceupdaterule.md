...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg398949(v=OCS.15)
ms:contentKeyID: 49314420
ms.date: 05/19/2016
...
Approves a device update rule that has been imported to the system. After a device update rule has been approved, the corresponding update will automatically be downloaded and installed by client devices affected by the update. 此 cmdlet 是在 Lync Server 2010 中引入的。
