...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg425937(v=OCS.15)
ms:contentKeyID: 49312685
ms.date: 05/19/2016
...
Assigns a conferencing policy at the per-user scope. Conferencing policies determine the features and capabilities that can be used in a conference. This includes everything from whether or not the meeting can include IP audio and video to the maximum number of people who can attend a meeting. 此 cmdlet 是在 Lync Server 2010 中引入的。
