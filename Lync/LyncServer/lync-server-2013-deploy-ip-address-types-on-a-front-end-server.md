...
2.  在“**编辑属性**”对话框中，选择您要配置的 IP 地址类型。对于双协议栈配置，则选择“**启用 IPv4**”和“**启用 IPv6**”，如下图所示。
    ...
    **前端服务器池的“编辑属性”对话框**
    ...
    ![前端服务器的 "编辑属性" 对话框](images/JJ205191.737a9d71-c0bc-4a54-9608-9e028dacc814(OCS.15).png "前端服务器的 "编辑属性" 对话框")
      ...
      - **PSTN IP 地址**。 Collocated 中介服务器角色不支持安装其他网络接口卡（NIC） s 来支持 Lync Server 2013 的 PSTN IP 地址配置。 有关 Lync Server 2013 支持的 NIC 配置的详细信息，请参阅[Lync server 2013 的服务器硬件平台](lync-server-2013-server-hardware-platforms.md)。
