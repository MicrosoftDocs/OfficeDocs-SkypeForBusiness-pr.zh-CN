...
您可以在每个边缘服务器中配置两个网络适配器，如下所示：
  ...
  - **网络适配器 1（内部接口）**
    ...
    确保从网络中有一个路由，该网络包含到包含 Lync Server 客户端或运行 Lync Server 的服务器的任何网络的边缘服务器内部接口 (例如，从172.25.33.0 到 192.168.10.0) 。
...
<td><p>sip.contoso.com</p></td>
<td><p>SIP 访问边缘服务外部接口需要联合合作伙伴（称为 "允许的 SIP 域"）的自动 DNS 发现，在以前的版本中称为 "增强联盟" 的 () 。 对于启用了 Lync 的用户和使用推送通知服务或 Apple 推送通知服务的 Microsoft Lync 移动客户端的所有 SIP 域，请按需重复执行此操作。</p></td>
</tr>
<tr class="even">
<td><p>内部 DNS/A</p></td>
