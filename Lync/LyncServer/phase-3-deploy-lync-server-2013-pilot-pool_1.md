...
## <a name="in-this-section"></a>本节内容
  ...
  - [为 Lync Server 2013 准备 Active Directory](prepare-active-directory-for-lync-server-2013.md)

  - [安装 Lync Server 管理工具](install-lync-server-administration-tools.md)

  - [部署 Lync Server 2013 试验池](deploy-lync-server-2013-pilot-pool_1.md)
