...
<td><p>tinyint</p></td>
<td><p>主</p></td>
<td><p>0是主要音频，1是主要视频，2是全景视频，3是应用程序/桌面共享。 此标签在单个会话中必须是唯一的。</p></td>
</tr>
<tr class="even">
<td><p><strong>ConnectivityIce</strong></p></td>
<td><p>tinyint</p></td>
<td><p> </p></td>
<td><p>此列存在，但在 Microsoft Lync Server 2013 中未使用。 CallerConnectivityICE 和 CalleeConnectivityICE 列中捕获了用于媒体行的连接的相关信息。</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p>对外</p></td>
<td><p>呼叫者的 BSSID （如果使用无线）。 <a href="lync-server-2013-macaddress-table.md">在 Lync Server 2013 中从 MacAddress 表</a>引用。</p></td>
</tr>
<tr class="even">
<td><p><strong>CallerVPN</strong></p></td>
<td><p>位</p></td>
<td></td>
<td><p>呼叫者的链接。 1 是虚拟专用网 (VPN)，0 是非 VPN。</p></td>
</tr>
<tr class="odd">
...
<td><p>位</p></td>
<td><p> </p></td>
<td><p>1表示呼叫接收器位于企业网络内，0表示呼叫接收器在网络外部。</p></td>
</tr>
<tr class="even">
<td><p><strong>CalleeMacAddress</strong></p></td>
<td><p>int</p></td>
<td><p>对外</p></td>
<td><p>被叫方 Mac 地址。 <a href="lync-server-2013-macaddress-table.md">在 Lync Server 2013 中从 MacAddress 表中</a>引用。</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p> </p></td>
<td><p>呼叫接收器在 A/V 边缘服务上使用的端口。</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p>对外</p></td>
<td><p>呼叫接收器的捕获设备的驱动程序。 <a href="lync-server-2013-devicedriver-table.md">在 Lync Server 2013 中从 DeviceDriver 表</a>引用。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td><p>对外</p></td>
<td><p>被呼叫者的 BSSID （如果使用无线）。 <a href="lync-server-2013-macaddress-table.md">在 Lync Server 2013 中从 MacAddress 表</a>引用。</p></td>
</tr>
<tr class="odd">
...
<td><p>位</p></td>
<td><p> </p></td>
<td><p>指示是否收到来自呼叫者的指标;1为 "是"，null 值为 "否"。</p></td>
</tr>
<tr class="odd">
<td><p><strong>约定</strong></p></td>
<td><p>位</p></td>
<td><p> </p></td>
<td><p>指示是否已收到来自呼叫接收器的指标;1为 "是"，null 值为 "否"。</p></td>
</tr>
<tr class="even">
<td><p><strong>MidCallReport</strong></p></td>
<td><p>位</p></td>
<td></td>
<td><p>指示报表是针对会话的一部分还是完整会话。</p>
...
<td><p>tinyInt</p></td>
<td></td>
<td><p>指示呼叫者是否使用 ICE 协议（Internet 连接建立）连接至网络。</p>
<p>本专栏是在 Microsoft Lync Server 2013 中引入的。</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p>对外</p></td>
<td><p>发出呼叫的用户所采用的 WiFi 驱动程序的设备说明。</p>
<p>本专栏是在 Microsoft Lync Server 2013 中引入的。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td><p>对外</p></td>
<td><p>发出呼叫的用户所采用的 WiFi 驱动程序的版本号。</p>
<p>本专栏是在 Microsoft Lync Server 2013 中引入的。</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p>对外</p></td>
<td><p>接收呼叫的用户所采用的 WiFi 驱动程序的版本号。</p>
<p>本专栏是在 Microsoft Lync Server 2013 中引入的。</p></td>
</tr>
</tbody>
</table>
