...
---
# <a name="port-summary---extensible-messaging-and-presence-protocol-xmpp-federation-in-lync-server-2013"></a>Lync Server 2013 中的端口摘要-可扩展消息和状态协议 (XMPP) 联盟
...
为可扩展消息和状态协议定义的端口和协议 (XMPP 在边缘服务器上部署) 代理允许从 XMPP 联合合作伙伴到边缘服务器的通信，还允许从边缘服务器到 XMPP 联盟伙伴的通信。 在面向内部的防火墙上定义的规则也是从前端服务器或前端池到边缘服务器或边缘池。
