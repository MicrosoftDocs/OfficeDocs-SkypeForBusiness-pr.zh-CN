...
## <a name="in-this-section"></a>本部分内容
  ...
  - [在 Microsoft Exchange Server 上配置统一消息以使用 Lync Server 2013](lync-server-2013-configuring-unified-messaging-on-microsoft-exchange-server-to-work-with-lync-server.md)

  - [配置 Lync Server 2013 以使用 Microsoft Exchange Server 上的统一消息](lync-server-2013-configure-lync-server-2013-to-work-with-unified-messaging-on-microsoft-exchange-server.md)
