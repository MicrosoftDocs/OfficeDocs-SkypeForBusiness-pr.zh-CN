...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Hh689989(v=OCS.15)
ms:contentKeyID: 49311831
ms.date: 05/19/2016
...
Verifies that authenticated users can use Lync Web App to join a Lync Server conference. 此 cmdlet 是在 Lync Server 2010 中引入的。
