...
安装持久聊天服务器已集成到 Lync Server 2013 安装程序中，并使用 Lync Server 2013 使用的相同的引导程序进行安装。 有关安装说明，请参阅部署文档中的[Deploying Lync Server 2013](lync-server-2013-deploying-lync-server.md)。
