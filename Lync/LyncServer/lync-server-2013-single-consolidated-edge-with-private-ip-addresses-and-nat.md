...
TOCTitle: 使用专用 IP 地址和 NAT 的单一合并边缘
ms:assetid: e1e5189e-f17d-45e9-b177-e0e6f97f8951
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg399001(v=OCS.15)
ms:contentKeyID: 49314525
ms.date: 12/10/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013 中使用专用 IP 地址和 NAT 的单一合并边缘
...
![单一合并边缘拓扑](images/Gg399001.d9b889c1-587c-4732-9b68-841186ccff78(OCS.15).jpg "单一合并边缘拓扑")
