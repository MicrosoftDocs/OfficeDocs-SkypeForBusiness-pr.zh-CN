...
---
# <a name="modify-an-existing-pin-policy-in-lync-server-2013"></a>在 Lync Server 2013 中修改现有 PIN 策略
...
您可以使用 " **Pin 策略** " 选项卡为使用 IP 电话连接到 Lync 2013 的用户提供 (PIN) 身份验证的个人标识号。 要使用 PIN 身份验证，请确保在 Web 服务设置中选中“启用 PIN 身份验证”****。 有关详细信息，请参阅 [在 Lync Server 2013 中修改现有的 Web 服务配置设置](lync-server-2013-modify-existing-web-service-configuration-settings.md)。
