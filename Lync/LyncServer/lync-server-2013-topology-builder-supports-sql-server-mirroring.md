...
ms.locfileid: "48549088"
---
# <a name="topology-builder-supports-sql-server-mirroring-in-lync-server-2013"></a>拓扑生成器在 Lync Server 2013 中支持 SQL Server 镜像
...
Lync Server 2013 支持镜像后端服务器以实现高可用性。 您可以使用拓扑生成器设置镜像，包括设置见证。
