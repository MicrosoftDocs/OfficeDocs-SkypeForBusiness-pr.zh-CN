...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg398186(v=OCS.15)
ms:contentKeyID: 49312008
ms.date: 05/19/2016
...
Creates a new Response Group question. The 响应组应用程序 uses questions to provide callers with choices, and then takes action based on those choices. 此 cmdlet 是在 Lync Server 2010 中引入的。
