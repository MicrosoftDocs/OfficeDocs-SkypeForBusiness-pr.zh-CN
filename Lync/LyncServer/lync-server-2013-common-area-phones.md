...
> [!NOTE]  
> 您有三个适用于常见区域电话的选项: Aastra 6721ip 通用区域电话、HP 4110 IP 电话和 Polycom CX500 IP 公共区域电话。 Polycom CX3000 IP 会议电话是另一个变种通用的区域电话。 但是, 它旨在在会议室中使用。 有关常见的区域电话的详细信息, 请参阅<A href="http://technet.microsoft.com/en-us/library/gg398958(v=ocs.14).aspx">选择新设备</A>的通用区域电话部分。
