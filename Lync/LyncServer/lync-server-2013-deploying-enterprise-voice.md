...
若要查看有关可以在其中部署企业语音服务器角色（以及与其他 Lync Server 2013 服务器角色之间的关系）的示例的参考拓扑，请参阅规划文档中的 " [Lync server 2013 中的参考拓扑](lync-server-2013-reference-topologies.md)"。
...
如果您使用拓扑生成器定义和发布在每台前端服务器或 Standard Edition 服务器上 collocates 中介服务器的拓扑，则可以跳过以下内容，因为部署向导已经自动安装了文件当您为前端服务器池或 Standard Edition server 安装文件时，中介服务器：
