...
Lync Server 2013, 企业语音使用 Exchange 统一消息 (UM) 基础结构提供呼叫应答、呼叫通知、语音访问 (包括语音邮件) 和自动助理服务。
...
Exchange UM 包括传真功能, 使用户能够接收其 Exchange 邮箱中的传入传真。 有关详细信息, 请参阅 Microsoft Exchange Server 文档中的 "统一消息[http://go.microsoft.com/fwlink/p/?linkId=135652](http://go.microsoft.com/fwlink/p/?linkid=135652)"。
