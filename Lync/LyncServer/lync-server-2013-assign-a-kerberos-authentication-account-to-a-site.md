...
4.  **可选**：您可能已为您的 WebServices 配置替代 FQDN （完全限定域名），因为[在 Lync Server 2013 中，根据更改 Web 服务 URL](lync-server-2013-change-the-web-services-url.md)。 如果是这种情况，您还需要为此 FQDN 添加 SPN。 例如，如果 FQDN 为 webservices，则应运行：
