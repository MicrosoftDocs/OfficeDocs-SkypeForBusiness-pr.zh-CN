...
Lync Server 2013 的设计和开发符合 Microsoft 高可信计算安全开发生命周期 (SDL), 其介绍如下<http://go.microsoft.com/fwlink/?linkid=68761>。
  ...
  - **已通过部署**   获得信任所有 Lync Server 2013 文档包括最佳做法和建议, 可帮助你确定和配置你的部署的最佳安全级别, 并评估激活非默认的安全风险选项。
