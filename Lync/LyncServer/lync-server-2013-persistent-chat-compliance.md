...
# <a name="persistent-chat-compliance-in-lync-server-2013"></a><span data-ttu-id="e9e10-102">Lync Server 2013 中的持久聊天合规性</span><span class="sxs-lookup"><span data-stu-id="e9e10-102">Persistent Chat compliance in Lync Server 2013</span></span>
...
<span data-ttu-id="e9e10-103">_**主题上次修改时间:** 2012-10-06_</span><span class="sxs-lookup"><span data-stu-id="e9e10-103">_**Topic Last Modified:** 2012-10-06_</span></span>

<span data-ttu-id="e9e10-104">创建新的持久聊天合规性配置</span><span class="sxs-lookup"><span data-stu-id="e9e10-104">To create a new Persistent Chat compliance configuration</span></span>
...
<span data-ttu-id="e9e10-105">获取持久的聊天合规性配置</span><span class="sxs-lookup"><span data-stu-id="e9e10-105">To get Persistent Chat compliance configuration</span></span>

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

<span data-ttu-id="e9e10-106">设置持久聊天合规性配置</span><span class="sxs-lookup"><span data-stu-id="e9e10-106">To set Persistent Chat compliance configuration</span></span>
...
<span data-ttu-id="e9e10-107">删除持久聊天合规性配置</span><span class="sxs-lookup"><span data-stu-id="e9e10-107">To remove Persistent Chat compliance configuration</span></span>
