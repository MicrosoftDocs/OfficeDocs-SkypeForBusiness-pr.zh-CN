...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg425794(v=OCS.15)
ms:contentKeyID: 49312371
ms.date: 05/19/2016
...
Removes an existing collection of health monitoring configuration settings. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. 此 cmdlet 是在 Lync Server 2010 中引入的。
