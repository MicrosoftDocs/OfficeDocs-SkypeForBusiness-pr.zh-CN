...
以下是用户和用户的本地计算机的要求：
  ...
  - 本地计算机必须运行 Windows Embedded Standard 7 with SP1、Windows 7 SP1、windows 8、Windows 8.1 Embedded 或 Windows 8.1 (不嵌入) 。

  - 如果使用远程桌面服务，则 Lync VDI 插件位数 (也就是说，应用程序是否为32位或64位) 必须与本地计算机的操作系统位数匹配。 本地计算机上的操作系统和虚拟机上的操作系统的位数不需要匹配。 如果使用的是其他虚拟化解决方案或平台，请参阅虚拟化解决方案提供商关于位数要求的指南。

  - 本地计算机必须运行最新版本的远程桌面客户端。 从虚拟化解决方案提供商处安装来自 Microsoft 或最新远程桌面客户端软件的远程桌面服务客户端的最新更新。 有关最新的远程桌面服务更新，请参阅 [https://go.microsoft.com/fwlink/p/?LinkId=268032](https://go.microsoft.com/fwlink/p/?linkid=268032) 。
...
1.  如果本地计算机运行的是 Windows 8，请跳过此步骤。 如果本地计算机运行的是 Windows 7 SP1，请安装最新的 Windows 8 版本的远程桌面服务客户端，网址为 [https://go.microsoft.com/fwlink/p/?LinkId=268032](https://go.microsoft.com/fwlink/p/?linkid=268032) 。
