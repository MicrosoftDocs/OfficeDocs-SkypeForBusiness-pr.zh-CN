...
Lync Server 2010 或 Office 通信服务器不支持 IP 版本 6 (IPv6)。 出于试验目的, 你可以测试 Lync Server 2010 和 Lync Server 2013 双重堆栈共存。 我们建议在对任何池启用 IPv6 (双栈网络) 之前, 将给定中心站点的所有池升级到 Lync Server 2013。 如果您需要为池配置仅 IPv6，则建议您在实验室环境中设置仅 IPv6 以进行测试。
