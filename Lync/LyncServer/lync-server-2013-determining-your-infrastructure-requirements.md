...
您需要确定和理解您的部署的基础结构要求，以便您可以在部署 Lync Server 之前规划如何满足这些要求。
...
## <a name="in-this-section"></a>本部分内容
  ...
  - [Lync Server 2013 中的 Internet 信息服务 (IIS) 要求](lync-server-2013-internet-information-services-iis-requirements.md)
