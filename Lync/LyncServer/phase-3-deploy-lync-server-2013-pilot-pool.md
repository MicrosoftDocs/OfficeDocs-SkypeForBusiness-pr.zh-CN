...
本节介绍了部署 Lync Server 2013 的引导池所需的步骤。 部署 Lync Server 2013 需要使用拓扑生成器来定义您的拓扑和要部署的组件，为部署 Lync Server 2013 组件准备环境，在第一台前端服务器上发布拓扑设计，然后为部署的组件安装和配置 Lync Server 2013 软件。 完成后，你的 Lync Server 2013 试点池部署将与现有 Lync Server 2010 池共存。
