...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ205145(v=OCS.15)
ms:contentKeyID: 49313879
ms.date: 05/19/2016
...
用户单击会议请求中的会议链接时，与会页面将检测该用户的计算机上是否已安装 Lync 2013 客户端。如果已安装客户端，将打开该客户端并加入会议。如果未安装客户端，默认情况下会打开 Microsoft Lync Web App 的 2013 版本。

如果想要允许用户通过 Office Communicator 2007 R2 或 Lync 2010 Attendant 加入会议，则可以修改与会页面的行为。这些配置选项已从 Lync Server 2013 控制面板中删除，但是您可以使用 CsWebServiceConfiguration cmdlet 来配置它们。

### 与会页面 CsWebServiceConfiguration 参数
