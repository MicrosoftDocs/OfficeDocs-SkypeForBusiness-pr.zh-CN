...
---
# <a name="managing-application-level-response-group-settings-in-lync-server-2013"></a>在 Lync Server 2013 中管理应用程序级响应组设置
...
响应组应用程序的应用程序级别设置包括默认的保持音乐配置、默认的保持音乐音频文件、代理回拨宽限期和呼叫上下文配置。 您只能针对每个池定义一组应用程序级别设置。 要查看应用程序级别设置，请使用 **Get-CsRgsConfiguration** cmdlet。 要修改应用程序级别设置，请使用 **Set-CsRgsConfiguration** cmdlet。
...
[CsRgsConfiguration](https://docs.microsoft.com/powershell/module/skype/Set-CsRgsConfiguration)  
