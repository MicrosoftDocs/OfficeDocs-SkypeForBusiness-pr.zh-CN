...
ms.locfileid: "48529759"
---
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a><span data-ttu-id="55e12-102">使用综合事务测试持久聊天服务器</span><span class="sxs-lookup"><span data-stu-id="55e12-102">Test Persistent Chat Server with a synthetic transaction</span></span>
...
<span data-ttu-id="55e12-103">_**上次修改的主题：** 2012-09-21_</span><span class="sxs-lookup"><span data-stu-id="55e12-103">_**Topic Last Modified:** 2012-09-21_</span></span>

<span data-ttu-id="55e12-104">测试持久聊天服务器以在两个用户之间的聊天室中发送和接收邮件</span><span class="sxs-lookup"><span data-stu-id="55e12-104">To test Persistent Chat Server for sending and receiving messages in a chat room between two users</span></span>
...
<span data-ttu-id="55e12-105">或</span><span class="sxs-lookup"><span data-stu-id="55e12-105">or</span></span>
...
<span data-ttu-id="55e12-106">或</span><span class="sxs-lookup"><span data-stu-id="55e12-106">or</span></span>
