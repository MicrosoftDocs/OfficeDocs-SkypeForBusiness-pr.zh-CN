...
本部分将指导您完成 Lync Server 2013 电话拨入式会议的配置。

<div>

## <a name="in-this-section"></a>本部分内容

  - [Lync Server 2013 中的电话拨入式会议配置先决条件和权限](lync-server-2013-dial-in-conferencing-configuration-prerequisites-and-permissions.md)
