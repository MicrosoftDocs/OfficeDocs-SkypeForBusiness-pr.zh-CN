...
> [!NOTE]  
> 本主题假设你已至少在一个中心网站中设置了一个前端池或标准版服务器, 如在<A href="lync-server-2013-define-and-configure-a-front-end-pool-or-standard-edition-server.md">Lync server 2013 中定义和配置前端池或标准版服务器</A>以及在<A href="lync-server-2013-publish-the-topology.md">lync 中发布拓扑中所述。</A>部署文档中的服务器2013。
...
4.  在“关联的 PSTN 网关”**** 下，选择 PSTN 对等网关以与此中继相关联。
    ...
    用于![干线的 PSTN 网关对等的属性设置]用于(images/JJ721915.7c3fe8ee-8f4c-4413-8462-8347228e61bb(OCS.15).png "干线的 PSTN 网关对等的属性设置")
