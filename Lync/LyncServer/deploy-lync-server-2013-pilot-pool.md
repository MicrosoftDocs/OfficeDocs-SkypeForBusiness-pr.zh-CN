...
部署试点池时，应使用“定义新前端池”向导。 您应在 lync Server 2010 池中部署 Lync Server 2013 引导池中的相同功能和工作负载。 如果您部署了存档服务器、监视服务器或 System Center Operations Manager 以存档或监视 Lync Server 2010 环境，并且您希望在整个迁移过程中继续进行存档或监控，则还需要在您的试点环境中部署这些功能。 您部署的用于存档或监视 Lync Server 2010 环境的版本将不会在 Lync Server 2013 环境中捕获数据。
...
6.  在 " **选择并置服务器角色** " 页上，我们建议您在 Lync server 2013 中并置中介服务器。 将旧版拓扑与 Lync Server 2013 合并时，我们需要您首先并置 Lync Server 2010 中介服务器。 在合并拓扑并配置 Lync Server 2013 中介服务器之后，您可以决定是否保留并置中介服务器，或在部署过程中稍后将中介服务器角色移动到 Lync Server 2013 时，将其更改为独立服务器。
