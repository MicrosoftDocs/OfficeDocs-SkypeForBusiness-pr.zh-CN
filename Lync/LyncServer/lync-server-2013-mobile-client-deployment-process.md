...
在 Microsoft Lync Server 2013 的部署完成后，用户可以从他们习惯于其特定设备使用的移动市场安装 Lync 2013 应用程序。

<div>

## <a name="lync-mobile-deployment-process"></a>Lync 移动部署过程
...
<td><p>管理员</p></td>
<td><p>在服务器规划文档中<a href="lync-server-2013-planning-for-mobility.md">规划 Lync Server 2013 中的移动性</a>。</p>
<p>在服务器部署文档中<a href="lync-server-2013-deploying-mobility.md">部署 Lync Server 2013</a>中的移动功能。</p>
