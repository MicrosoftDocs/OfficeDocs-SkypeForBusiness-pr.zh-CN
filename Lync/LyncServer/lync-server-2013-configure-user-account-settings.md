...
本主题中的过程介绍如何为单个用户帐户分配“线路 URI”****。 如果需要为多个用户帐户分配“线路 URI”****，则可以创建使用 **Set-CsUser** cmdlet 的脚本。 有关使用示例脚本将 **线路 URI** 分配给多个用户帐户的详细信息，请参阅处的 "为多个用户分配行 uri" [https://go.microsoft.com/fwlink/p/?linkId=196945](https://go.microsoft.com/fwlink/p/?linkid=196945) 。
