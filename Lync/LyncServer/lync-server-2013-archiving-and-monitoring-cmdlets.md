...
# <a name="archiving-and-monitoring-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的存档和监控 cmdlet
...
存档和监控 cmdlet 使管理员能够管理即时消息和会议会话存档;记录呼叫详细信息;以及使用体验质量（QoE）监视 Microsoft Lync Server 2013。
...
## <a name="archiving-and-monitoring-cmdlets"></a>存档和监控 Cmdlet
