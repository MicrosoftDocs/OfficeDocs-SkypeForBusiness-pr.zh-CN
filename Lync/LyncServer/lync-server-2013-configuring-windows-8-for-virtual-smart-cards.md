...
对于安装了符合规范版本1.2 的受信任的平台模块（TPM）芯片的计算机，组织现在可以获得智能卡登录的好处，而无需在硬件中进行任何额外的投资。 有关详细信息，请参阅在上[https://go.microsoft.com/fwlink/p/?LinkId=313365](https://go.microsoft.com/fwlink/p/?linkid=313365)使用虚拟智能卡和 Windows 8。
