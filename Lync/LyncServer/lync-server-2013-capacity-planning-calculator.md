...
**企业语音**
  ...
  - 在“使用媒体旁路的呼叫百分比”中，键入由你的用户拨打的、将绕过中介服务器的呼叫百分比。 默认值为 65%。

  - 在“UC-PSTN 呼叫中涉及的语音用户百分比”中，键入你的组织的呼叫属于 UC-PSTN 电话呼叫的百分比。 默认值为 60%
...
**会议**
  ...
  - 在使用语音的会议百分比中, 键入将包含音频组件的会议的百分比。
      ...
      - 如果您的语音会议的 20% 包括数据上载 (如 Microsoft PowerPoint®演示文稿), 请选中 "包括 web 会议" 复选框。
...
绿色单元格显示为您输入的使用模型提供的建议。
  ...
  - 前端服务器总数: 所需的物理服务器数基于运行 Lync Server 2013 的专用服务器 (采用双处理器, 十六进制), 2260 兆周期。
