...
---
# <a name="mobility-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的移动性 cmdlet
...
引入了移动性 cmdlet 以管理在 Lync Server 2010 的累积更新中添加的移动功能：2011年11月。 可使用这些 cmdlet 管理移动功能的设置，如 Mobility Service 配置和用户策略。

<div>

## <a name="mobility-cmdlets"></a>移动 Cmdlet

配置移动功能的 cmdlet 允许您从 Lync Server 命令行管理程序运行命令，也可以编写脚本来配置和测试各种移动设置。
