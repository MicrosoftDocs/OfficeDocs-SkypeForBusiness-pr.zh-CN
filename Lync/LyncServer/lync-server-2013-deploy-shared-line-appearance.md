...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Mt712152(v=OCS.15)
ms:contentKeyID: 72522149
ms.date: 06/13/2016
...
2.  Add delegates to the group by using the [Add-CsSlaDelegates](https://docs.microsoft.com/en-us/powershell/module/skype/add-cssladelegates) cmdlet:
    ...
    The following example adds a user to the SLA group. Each user added to the group must be a valid 企业语音-enabled user:
