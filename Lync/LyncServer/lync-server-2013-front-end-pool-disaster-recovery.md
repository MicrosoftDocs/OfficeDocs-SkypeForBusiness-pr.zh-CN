...
# <a name="front-end-pool-disaster-recovery-in-lync-server-2013"></a>Lync Server 2013 中的前端池灾难恢复
...
本节中的主题说明 Lync Server 2013 中的高可用性和灾难恢复能力前端池。
...
## <a name="in-this-section"></a>本部分内容
  ...
  - [Lync Server 2013 中池发生故障期间的用户体验](lync-server-2013-user-experience-during-pool-failure.md)
