...
### <a name="firewall-summary-for-scaled-consolidated-edge-dns-load-balancing-with-public-ip-addresses-external-interface--node-1-and-node-2-example"></a>扩展的合并边缘的防火墙摘要、使用公用 IP 地址的 DNS 负载平衡：外部接口–节点1和节点 2 (示例) 
