...
## <a name="in-this-section"></a>本部分内容
  ...
  - [在 Lync Server 2013 中创建注册器配置设置](lync-server-2013-create-registrar-configuration-settings.md)

  - [在 Lync Server 2013 中修改现有的注册器配置设置](lync-server-2013-modify-existing-registrar-configuration-settings.md)

  - [在 Lync Server 2013 中删除现有的注册器配置设置](lync-server-2013-delete-existing-registrar-configuration-settings.md)
  ...
  - [在 Lync Server 2013 中删除现有的 Web 服务配置设置](lync-server-2013-delete-existing-web-service-configuration-settings.md)
