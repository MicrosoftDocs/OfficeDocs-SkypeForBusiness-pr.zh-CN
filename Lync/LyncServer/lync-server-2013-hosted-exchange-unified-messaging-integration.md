...
除了支持以前的 Lync Server 2013 版本与 Exchange 统一消息 (UM) 的*本地*部署集成之外, Lync Server 2013 还引入了支持与*托管*Exchange UM 集成的支持。 如果将部分或全部传输到托管 Exchange 服务提供商 (如 Microsoft Exchange Online), 则托管 Exchange UM 支持 Lync Server 2013 向用户提供语音消息服务。

Lync Server 2013 企业版语音使用 Exchange UM 基础结构提供呼叫应答、呼叫通知、语音访问 (包括语音邮件) 和自动助理服务。 有关详细信息, 请参阅[集成的统一消息和 Lync Server 2013 的功能](lync-server-2013-features-of-integrated-unified-messaging.md)。
