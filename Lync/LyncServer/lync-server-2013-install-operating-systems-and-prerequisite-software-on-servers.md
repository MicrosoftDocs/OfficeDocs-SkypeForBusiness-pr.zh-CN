...
在每台服务器上安装 Windows 更新中的以下更新：
  ...
  - **运行 lync server 2013**   的服务器的 Windows 更新有关运行 lync server 2013 的服务器所需的有关 Windows 更新更新的详细信息，请参阅规划文档中[Lync Server 2013 的其他软件要求](lync-server-2013-additional-software-requirements.md)。
