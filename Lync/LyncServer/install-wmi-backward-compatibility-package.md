...
2.  安装 OCSWMIBC.MSI。
    ...
    > [!IMPORTANT]  
    > 可以在安装了 Lync Server 2013 Core 组件和 Lync Server 2013 命令行管理程序的域中的任何计算机上安装 OCSWMIBC.msi，并能够访问 Active Directory 域服务 (AD DS) 和 SQL Server) 中的 Office 通信服务器 2007 R2 拓扑 (WMI 提供程序。
