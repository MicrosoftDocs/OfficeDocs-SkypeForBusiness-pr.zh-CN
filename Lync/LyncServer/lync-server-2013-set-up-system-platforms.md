...
> [!IMPORTANT]  
> 我们不支持持久聊天服务器 &nbsp; 标准版实现高可用性。 性能和规模将受到限制。 此外，我们仅支持新的持久聊天服务器 &nbsp; Standard Edition server 部署。 我们不支持将 Lync Server 2010 （Group Chat Server）升级到 Lync Server 2013 &nbsp; 持久聊天服务器 &nbsp; Standard Edition。
