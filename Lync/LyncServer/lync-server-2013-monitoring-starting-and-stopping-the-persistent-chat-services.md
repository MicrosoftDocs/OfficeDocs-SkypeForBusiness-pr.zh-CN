...
---
# <a name="monitoring-starting-and-stopping-the-persistent-chat-services-in-lync-server-2013"></a>在 Lync Server 2013 中监视、启动和停止持久聊天服务
...
持久聊天服务和持久聊天合规性服务是 Lync Server 2013 拓扑的一部分，因此可以分别使用 Windows PowerShell cmdlet、 **start-cswindowsservice**、 **start-cswindowsservice**和 **start-cswindowsservice**进行监视、停止和启动。
