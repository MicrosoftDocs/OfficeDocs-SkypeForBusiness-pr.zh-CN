...
## <a name="in-this-section"></a>本部分内容
  ...
  - [Lync Server 2013 中的 DNS 摘要-扩展的合并边缘（使用公用 IP 地址进行 DNS 负载平衡）](lync-server-2013-dns-summary-scaled-consolidated-edge-dns-load-balancing-with-public-ip-addresses.md)
