...
应用程序终结点是 Active Directory 域服务中的联系人对象。 你可以使用 Lync Server Management Shell 中的 cmdlet 来管理 Microsoft Lync Server 2013 的这些联系人。

<div>

## <a name="application-endpoints-cmdlets"></a>应用程序终结点 Cmdlet
