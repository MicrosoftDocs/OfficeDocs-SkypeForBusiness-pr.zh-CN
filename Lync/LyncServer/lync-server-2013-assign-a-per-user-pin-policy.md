...
 
 ...
 (PIN) 策略的电话拨入式会议个人识别码是可在 Lync Server 2013 控制面板中配置的用户帐户的个人设置之一。
...
## <a name="assigning-a-per-user-pin-policy-by-using-windows-powershell-cmdlets"></a>使用 Windows PowerShell Cmdlet 分配 Per-User PIN 策略
