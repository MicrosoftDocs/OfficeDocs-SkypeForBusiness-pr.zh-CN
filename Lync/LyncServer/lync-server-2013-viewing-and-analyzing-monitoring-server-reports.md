...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dn720332(v=OCS.15)
ms:contentKeyID: 62221724
ms.date: 05/19/2016
...
2.  Open a browser window, and then enter the Admin URL to open the Lync Server 控制面板.
...
[媒体质量比较报告](lync-server-2013-media-quality-comparison-report.md)
