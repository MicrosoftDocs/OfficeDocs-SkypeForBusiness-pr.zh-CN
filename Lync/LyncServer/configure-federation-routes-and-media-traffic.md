...
4.  清除 "**为此 Edge 池启用联盟（端口5061）** " 复选框条目，然后选择 **"确定"** 关闭页面。
...
4.  选中 "为**此 Edge 池启用联盟（端口5061）** " 复选框条目，然后单击 **"确定"** 关闭页面。
...
3.  在 "**常规**" 页面上，验证 "为**此 Edge 池启用联盟（端口5061）** " 设置是否已选中。
