...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Gg425788(v=OCS.15)
ms:contentKeyID: 49312372
ms.date: 12/10/2016
...
Modifies an existing conferencing policy. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. 此 cmdlet 是在 Lync Server 2010 中引入的。
