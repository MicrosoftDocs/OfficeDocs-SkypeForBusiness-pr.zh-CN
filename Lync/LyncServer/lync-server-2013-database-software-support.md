...
有关 SQL Server 2012 中故障转移群集的详细信息和最佳实践， <http://technet.microsoft.com/library/hh231721.aspx>请参阅。 有关 SQL Server 2008 中的故障转移群集<http://technet.microsoft.com/library/ms189134(v=sql.105).aspx>，请参阅。
