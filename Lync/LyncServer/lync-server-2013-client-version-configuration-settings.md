...
ms.openlocfilehash: 9b421e084d7809a683364d675b142e2c3514b295
ms.sourcegitcommit: 4d6bf5c58b2c553dc1df8375ede4a9cb9eaadff2
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/16/2020
ms.locfileid: "48517859"
---
...
客户端版本配置设置用于为全局或对特定网站启用或禁用客户端版本控制。 使用以下过程可配置 Lync Server 2013 的客户端版本配置设置。

<div>

## <a name="in-this-section"></a>本部分内容

  - [在 Lync Server 2013 中启用或禁用客户端版本控制](lync-server-2013-enable-or-disable-client-versioning.md)
  ...
  - [修改在 Lync Server 2013 中未明确支持或不受限制的客户端的默认操作](lync-server-2013-modify-the-default-action-for-clients-not-explicitly-supported-or-restricted.md)
