...
> [!NOTE]  
> 如果你以前使用拓扑生成器定义完整拓扑 (包括边缘拓扑), 则可以<A href="lync-server-2013-define-your-edge-topology.md">在 Lync server 2013 中跳过 "定义你的边缘拓扑</A>" 和 "在本部分中的<A href="lync-server-2013-publish-your-topology.md">lync server 2013 任务中发布你的拓扑</A>", 但确实需要若要完成<A href="lync-server-2013-export-your-topology-and-copy-it-to-external-media-for-edge-installation.md">导出 Lync Server 2013 拓扑并将其复制到外部媒体以进行边缘安装</A>任务。
