...
description: 列出因驱动程序问题而未启用硬件加速的操作系统、模型和驱动程序的组合。
f1.keywords:
- CSH
ms.custom:
...
ms.locfileid: "65675124"
---
# <a name="hardware-decoder-and-encoder-driver-recommendations"></a>硬件解码器和编码器驱动程序建议

除本文中列出的解码器和编码器外，Microsoft 支持所有解码器和编码器。

## <a name="hardware-decoder-driver-recommendations---intel"></a>硬件解码器驱动程序建议 - Intel

操作系统、模型和驱动程序的以下组合由于各种驱动程序问题而未启用硬件加速。
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [0.0.0.0] - [8.15.10.2753] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [9.17.10.2867] - [9.17.10.4459] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 |0x1616 | [9.18.7.9] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [10.18.10.3431] - [10.18.10.4425] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [10.18.14.4280] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 |[10.18.15.4281] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 |[20.19.15.4390] - [20.19.15.4444] |
|Windows 10 | 所有 | [21.20.16.4541] |
|Windows 10 | 所有 | [22.20.16.4811] |
|Windows 10 | 所有 | [24.20.100.6293] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [8.17.11.9745], [8.17.12.5738] |
...
|Windows 10 | 所有 | [10.18.13.5891] - [10.18.13.6881] |
|Windows 10 | 所有 | [21.21.13.6909], [21.21.13.7570] |
|Windows 7 | 所有 | [21,21,13,4201] |

## <a name="hardware-decoder-driver-recommendations---amd"></a>硬件解码器驱动程序建议 - AMD

对于旧版操作系统，仅启用以下Device_ids进行硬件加速。
...
|操作系统           | 模型 (Device_id)  | 驱动程序/范围 |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [0.0.0.0] – [25.20.15017.1009] |

## <a name="hardware-encoder-driver-recommendations---intel"></a>硬件编码器驱动程序建议 - Intel

操作系统、模型和驱动程序的以下组合由于各种驱动程序问题而未启用硬件加速。

|操作系统           | 模型 (Device_id)  | 驱动程序/范围 |
|---------------------------|-------------------|--------------|
|Windows 7 | 所有 | [8.15.10.2200] - [8.15.10.2600] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [8.15.10.2653] - [8.15.10.2827] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [9.14.3.1176] - [9.14.3.1177] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [9.17.10.2800] - [9.17.10.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [9.18.10.3222] |
|Windows 7 | 所有 | [9.18.10.3234] |
|Windows 7 | 所有 | [9.18.10.3272] |
|Windows 7 | 所有 | [10.18.10.3242] - [10.18.10.9999] |
|Windows 8/Windows 8.1/Windows 10 | 所有 | [10.18.10.0000] - [10.18.10.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [10.18.14.4153] - [10.18.14.4161] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [10.18.14.4264] |
|Windows 7 | 所有 | [10.18.14.4578] |
|Windows 7 | 所有 | [10.18.14.4889] |
|Windows 7 | 所有 | [10.18.14.5057] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [20.19.15.4300] - [20.19.15.4444] |
|Windows 7 | 所有 | [20.19.15.4474] |
...
|操作系统           | 模型 (Device_id)  | 驱动程序/范围 |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [0.0.0.0] - [21.21.13.7848] |
...
|Windows 7 | 所有 | [0.0.0.0] - [16.199.9999.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [15.21.0.0] - [16.199.9999.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [15.201.1101.0] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 所有 | [21.19.137.1] |
