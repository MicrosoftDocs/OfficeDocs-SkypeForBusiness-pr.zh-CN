...
> [!NOTE]
> 如果您的组织已满足 Microsoft 365 政府-GCC 资格要求, 并已接受并接受该计划, 则可以跳过步骤1和步骤 2, 直接转到步骤3。 
...
在 onboarded 到 Microsoft 365 政府-GCC 后, 您可以按照使用[FastTrack](https://www.microsoft.com/fasttrack)和所选合作伙伴的标准部署方法来实现服务的集成。
