...
ms.locfileid: "58632006"
---
# <a name="plan-for-microsoft-365-government---gcc-deployments"></a>规划Microsoft 365政府 - GCC部署

本指南适用于在美国联邦、州、地方、部落或政府实体或其他处理受政府法规和要求（使用 Microsoft 365 政府版 - GCC）符合这些要求的实体中驱动 Microsoft 365 部署的 IT 专业人员。 2020 年 3 月 26 日新版：不要错过可下载的快速[入门](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/Quick-Start-Guide-for-GCC.pdf?raw=true)指南，GCC。

> [!IMPORTANT]
> Microsoft Teams COVID-19 的 CORVID-19 (导致在线呼叫和音频/视频会议出现) 高峰。<br/>
> 
...
> 
>合格、经筛选的人员通过查看这些服务器的任何交互式登录来监视这些服务器，以可能访问客户数据。 合格人员GCC访问客户内容的要求。 有关屏蔽要求的详细信息，请参阅GCC[说明](/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/gcc)。<br/>
> 
>感谢你的支持，因为我们采取一些措施来确保我们的服务在这些特殊时刻保持可用和可靠。<br/>


> [!NOTE]
> 如果你的组织已满足 Microsoft 365 政府 - GCC资格要求，并且已申请并接受该计划，你可以跳过步骤 1 和 2 并直接转到步骤 3。 
...
除了享受企业功能Microsoft 365，组织还受益于政府 - Microsoft 365独有的GCC：
...
|    |     |
|-----------|------------|
| ![描述决策点的图标](media/audio_conferencing_image7.png) <br/>决策点|<ul><li>决定是否要修改任何默认Microsoft 365 - GCC安全设置，首先了解可能做出的任何更改的影响。</li></ul> |
...
> [!Note]
> 其他工作负荷在云中完全可用GCC，当所有其他集成工作完成时，这些工作负荷Teams在云中可用。
...
在加入政府 - Microsoft 365后，GCC遵循如何推出 Microsoft Teams[中概述的建议部署Microsoft Teams。](./deploy-overview.md) 请务必与采用和更改管理团队互动，并Teams团队。
