...
ms.locfileid: "60013296"
---
# <a name="plan-for-microsoft-365-government---gcc-deployments"></a>规划Microsoft 365政府 - GCC部署

本指南适用于在美国联邦、州、地方、部落或主权政府实体或处理受政府法规和要求处理数据的其他实体中驱动 Microsoft 365 部署的 IT 专业人员，如果适合使用 Microsoft 365 政府版 - GCC 来满足这些要求。 2020 年 3 月 26 日新版：不要错过可下载的快速[入门](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/Quick-Start-Guide-for-GCC.pdf?raw=true)指南GCC。
...
> 
>这些音频/视频服务器驻留在美国Microsoft Azure FedRAMP 高认证边界服务器中，不存储任何客户内容。 但是，这些服务器正在处理呼叫和会议的音频和视频，并且在此过渡期间在我们的商业人员下操作。<br/>
> 
...
> [!NOTE]
> 如果你的组织已满足 Microsoft 365 政府 - GCC资格要求，并且已申请并接受该计划，则你可以跳过步骤 1 和 2 并直接转到步骤 3。 
...
除了享受企业功能Microsoft 365，组织还受益于以下政府 - Microsoft 365独有的GCC：
...
本[Microsoft 365美国政府](/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/office-365-us-government)服务说明介绍了该平台的好处，其中心内容是满足美国内部的合规性要求。
...
> [!Note]
> Microsoft 365政府 - GCC仅适用于美国。 非美国政府客户可以从多个政府Microsoft 365[中选择](https://products.office.com/en/government/compare-office-365-government-plans)。


## <a name="step-2-apply-for-microsoft-365-government---gcc"></a>第 2 步 申请政府Microsoft 365 - GCC
...
为了适应政府云客户的要求，政府 - Microsoft 365 计划与GCC计划Enterprise差异。 请参阅下表，了解哪些功能可用。

[Microsoft Teams服务说明](/office365/servicedescriptions/teams-service-description)

> [!Note]
> 其他工作负荷在云GCC完全可用后，当所有其他集成工作Teams，这些工作负荷将在云中可用。
...
确定监管要求以及如何满足这些要求。 有关详细信息[，请转到Teams](plan-teams-governance.md)规划治理。

|&nbsp;|&nbsp;|
|-----------|------------|
| ![描述决策点的图标。](media/audio_conferencing_image7.png) <br/>决策点|<ul><li>按照规划中治理中的指导原则，确定并记录治理[Teams。](plan-teams-governance.md)</li></ul> |

## <a name="step-6-deploy-teams-for-collaboration"></a>第 6 步 部署Teams进行协作

在加入政府 - Microsoft 365后，GCC按照如何推出部署中概述的建议[部署Microsoft Teams。](./deploy-overview.md) 请务必与采用和更改管理团队互动，并Teams者。
