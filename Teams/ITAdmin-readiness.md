...
使用培训资源向自己介绍 Teams、教授其他人或举办研讨会。 请经常返回此处查看新内容。

|               |               |               |               |
| :------------ | :------------ | :------------ | :------------ |
| ![一个描述手和向上箭头的图标](https://docs.microsoft.com/office/media/icons/get-started-teams.png) | [通过几个团队和频道快速入门](/MicrosoftTeams/get-started-with-teams-quick-start) | ![描述两个用户的图标](https://docs.microsoft.com/office/media/icons/users-people.png) | [为用户获取培训](https://support.office.com/article/microsoft-teams-video-training-4f108e54-240b-4351-8084-b1089f0d21d7) |
| ![描述勾号的图标](https://docs.microsoft.com/office/media/icons/success-teams.png) | [在 YouTube 上的"云中的咖啡"频道中查看最佳做法和操作方法视频](https://www.youtube.com/channel/UCs2IXBqperxWVe2ozrr3Gdg/videos) | ![任务剪贴板符号](https://docs.microsoft.com/office/media/icons/task-checklist-planning-teams.png) | [Teams 团队会议：了解有关热门 Teams 方案的最佳实践和实用指南](https://aka.ms/TeamsChalkTalks) |

<h2>技术培训</h2>

| 模块 | 视频 | PowerPoint 幻灯片  |
| ------------ | -------------------- | -------------------- |
| [Microsoft 机制 - Teams Essentials for IT YouTube 频道](https://aka.ms/MicrosoftTeamsforIT) | [视频](https://www.youtube.com/watch?v=MfDB7VenWuA&list=PLXtHYVsvn_b_JeDjgD5XdkyHTDXdYgPGn) ：10：13 分钟 (Teams Essentials for IT) <br>[视频：&配置 Teams -](https://www.youtube.com/watch?v=o2mlsUubIO4&list=PLXtHYVsvn_b_JeDjgD5XdkyHTDXdYgPGn&index=2) (8：22 分钟)   <br>[视频：安全与 (](https://youtu.be/91lHNKVVvQ4) 12：42) <br>[视频](https://www.youtube.com/watch?v=Km4T4hMM__k) ：10：54 (Teams 安全性和符合性控制) ||
...
| 直接路由 | [视频 1：在 Teams 中规划直接路由](https://aka.ms/teams-dr-plan)<br>[视频 2：在 Teams 中配置和管理直接路由](https://aka.ms/teams-dr-config)<br>[视频 3：迁移到 Teams 中的直接路由](https://aka.ms/teams-dr-migrate)  | [幻灯片](https://aka.ms/teams-direct-routing-deck) |
...
<h2>适用于 IT 和 AV 专业人员& Teams 会议室基础</h2>

<p>下表包含指向全面视频培训的链接，以及 Microsoft Teams 会议室 (PDF 格式) 随附的 PowerPoint 幻灯片。  

| 模块 | 视频 | PowerPoint 幻灯片 (PDF)   |
| ------------ | -------------------- | -------------------- |
| 模块 1：18：29 (Microsoft Teams 会议室简介)  | [视频](https://www.youtube.com/watch?v=LpFQ24S8QlY) | [幻灯片](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/rooms/module-1-introduction-to-microsoft-teams-rooms.pdf?raw=true) |
...
| 标题                                                                       | 抽象                                                                                                                                                                                                               |  指南链接                             |
|-----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| Teams 的标识、&管理与威胁防护                   | 了解如何使用 Microsoft 管理中心和 PowerShell 配置访问和标识策略，以及为 Teams 启用 Office 365 高级威胁防护                                                            | [Teams 安全指南](https://aka.ms/teamsesecurityinteractiveguide)         |
| 在 Teams 中管理合规性                                                | 使用 Microsoft 365 安全、Microsoft 365 合规性和 Microsoft Teams 管理中心以及 Windows PowerShell 管理和配置 Office 365 组织的 Microsoft Teams 策略和设置。 | [管理 Teams 中的符合性指南](https://aka.ms/complianceinteamsinteractiveguide)      |
| Teams 顾问：在 Microsoft Teams 中部署聊天、团队、频道和应用 | 了解如何利用 Teams 顾问来评估环境，并生成部署聊天、团队、频道和应用的计划。                                                                                         |  [Teams 顾问指南](https://aka.ms/MicrosoftTeamsAdvisorInteractiveguide)  |
| 使用 PowerShell 和动态组简化 Teams 管理        | 将 Office 365 组从静态成员身份转换为动态，Windows PowerShell向所有成员分配新的应用权限策略。                                                                         |  [简化 Teams 管理指南](https://aka.ms/StreamliningTeamsadminInteractiveGuide) |
...
| 配置 Teams 电话系统：自动助理 &呼叫队列                   | 在 Microsoft Teams 呼叫过程中逐步完成创建和部署呼叫队列和自动助理 Microsoft Teams 呼叫的一部分。                                                          |  [配置 Teams 手机系统指南](https://aka.ms/TeamsPhoneInteractiveGuide)             |
| 配置直接路由：连接 SDC 和语音路由                 | 使用 Microsoft Teams Phone 系统直接路由与现有的电话基础结构集成。                                                                                                              | [配置直接路由指南](https://aka.ms/DirectRoutingInteractiveGuide)          |
| 在 Microsoft Teams 中配置治理                                     | 了解如何为组织创建 Teams 消息传递保留策略，以及如何存档、删除和还原单个 Teams                                                                                   |  [在 Microsoft Teams 中配置治理指南](https://aka.ms/TeamsGovernanceInteractiveGuide)        |
...
- [快速入门：Teams 教育管理员](teams-quick-start-edu.yml)
- [快速入门：在 Teams 中配置通话计划](configuring-teams-calling-quickstartguide.md)
