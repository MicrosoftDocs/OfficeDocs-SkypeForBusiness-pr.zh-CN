...
- seo-marvel-mar2020
description: 培训视频PowerPoint、幻灯片、教程和其他资源，供管理员了解如何规划、部署和运行Microsoft Teams。
appliesto:
- Microsoft Teams
...
| 直接路由 | [视频 1：规划直接路由Teams](https://aka.ms/teams-dr-plan)<br>[视频 2：在 Teams 中配置和管理直接Teams](https://aka.ms/teams-dr-config)<br>[视频 3：迁移到云中的直接Teams](https://aka.ms/teams-dr-migrate)  | [幻灯片](https://aka.ms/teams-direct-routing-deck) |
...
<h2>Teams 会议室IT 和 AV &的基础</h2>

<p>下表包含全面视频培训的链接，以及PowerPoint幻灯片 (PDF 格式) 幻灯片Microsoft Teams 会议室。  
...
<p>下表包含全面培训的链接，PowerPoint 平台 (PDF 格式) ，在 Microsoft Teams Android 设备上，包括 Teams 显示器、Teams 手机、Teams 会议室 for Android 和 Teams 面板。  
...
| 管理Teams                                                | 使用Microsoft 365、Microsoft 365合规性Microsoft Teams管理中心以及 Windows PowerShell 来管理和配置 Office 365 组织的 Microsoft Teams 策略和设置。 | [管理 Teams 指南中的符合性](https://aka.ms/complianceinteamsinteractiveguide)      |
...
| 在 Teams 管理中心管理Microsoft Teams和来宾访问         | 了解如何为组织配置Microsoft Teams来宾访问权限。                                                                                                                              | [管理Teams和来宾访问指南](https://aka.ms/TeamsandGuestAccessInteractiveGuide)    |
...
| 在管理中配置Microsoft Teams                                     | 了解如何为组织创建Teams消息传送保留策略，以及如何存档、删除和还原单个Teams                                                                                   |  [在管理指南Microsoft Teams治理](https://aka.ms/TeamsGovernanceInteractiveGuide)        |
| 配置和部署Microsoft Teams会议                          | 逐步完成为会议部署会议工作负荷的过程Microsoft Teams。                                                                                                                                       |  [配置和部署Microsoft Teams会议指南](https://aka.ms/TeamsMeetingsInteractiveGuide)          |
| 为会议配置音频Microsoft Teams                            | 了解音频会议在会议Teams并了解如何分配会议网桥和拨入电话号码。                                                                                          |  [为会议指南配置Microsoft Teams会议](https://aka.ms/AudioConferencingInteractiveGuide)      |
| 配置Microsoft Teams一线员工                           | 了解如何为 Firstline Workforce Microsoft Teams和部署适当的安全环境。                                                                                                                  | [为一Microsoft Teams员工配置服务指南](https://aka.ms/ConfigFLWInteractiveGuide)              |
...
|使用Teams Android 设备|了解如何管理和升级手机Microsoft Teams、Microsoft Teams、Microsoft Teams 会议室Microsoft Teams面板。|[使用Microsoft Teams Android 设备](https://aka.ms/teamsandroiddeviceslab)|
