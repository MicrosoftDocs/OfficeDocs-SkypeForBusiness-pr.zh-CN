...
- seo-marvel-mar2020
description: 为管理员PowerPoint、部署和运行资源的培训视频、幻灯片、教程和其他Microsoft Teams。
appliesto:
- Microsoft Teams
...
<p>下表包含全面视频培训的链接，以及随附的 PowerPoint 幻灯片 (PDF 格式) ，Microsoft Teams 会议室。  
...
| 管理 Teams 中的符合性                                                | 使用Microsoft 365、Microsoft 365合规性Microsoft Teams管理中心以及 Windows PowerShell 来管理和配置Office 365组织的 Microsoft Teams 策略和设置。 | [管理 Teams 指南中的符合性](https://aka.ms/complianceinteamsinteractiveguide)      |
...
| 配置和部署Microsoft Teams会议                          | 逐步完成为会议部署会议工作负荷Microsoft Teams。                                                                                                                                       |  [配置和部署Microsoft Teams会议指南](https://aka.ms/TeamsMeetingsInteractiveGuide)          |
...
| 为一Microsoft Teams员工配置服务                           | 了解如何为 Firstline Workforce Microsoft Teams和部署适当的安全环境。                                                                                                                  | [为一Microsoft Teams员工配置服务指南](https://aka.ms/ConfigFLWInteractiveGuide)              |
...
| 部署Microsoft Teams 会议室                           | 了解如何创建和配置一个帐户，以在 Microsoft Teams 会议室 管理中心内管理Microsoft Teams设备。                                                                                                                  | [部署Microsoft Teams 会议室](https://aka.ms/teamsroomslab)              |
