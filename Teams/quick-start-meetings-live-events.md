---
title: 快速入门 - 会议、网络研讨会和直播活动
ms.reviewer: ''
description: 管理员在 Microsoft Teams 中推出和配置会议、网络研讨会和直播活动的快速入门指南。
ms.topic: article
author: CarolynRowe
ms.author: crowe
manager: serdars
...
[会议](#meetings)、[网络研讨会](#webinars) 和 [直播活动](#live-events) 都是各种类型的会议，但网络研讨会和直播活动为组织者提供了对于对话和参与者的额外控件。 网络研讨会提供双向交互，而直播活动则提供了托管的问答体验。 
...
- 为了获得大型会议、网络研讨会和直播活动最佳体验，Microsoft 建议使用 Teams 桌面客户端或 Teams 移动客户端。 
...
| [Teams 会议应用](/platform/apps-in-teams-meetings/teams-apps-in-meetings.md) | 会议应用扩展性、API 参考，以及如何为会议启用和配置应用的概述。 |
| [有关 Teams 会议应用的详细信息](/platform/apps-in-teams-meetings/teams-apps-in-meetings.md) | 包括可用于 Teams 会议的应用的链接。 |
...
任何人都可以免费参加 Teams 会议或直播活动，&mdash;无需许可证。 
