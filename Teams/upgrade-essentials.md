...
# <a name="about-the-upgrade-essentials-checklist"></a>有关升级 Essentials 清单 

设计的小型组织或业务 online IM （聊天） 和仅会议使用 Skype 那些，升级 Essentials 清单是加速的行动计划包括核心，建议使用活动和关联的资源实施从 for Business 的 Skype 到团队的成功移动。

这些十个轻松步骤提供所需的升级成功的全部内容。 请注意日程表是近似值;您应调整它根据您的组织升级计划。

不熟悉团队？ [阅读有关如何团队](https://products.office.com/en-us/microsoft-teams/group-chat-software)对话、 会议、 文件、 Office 应用程序和第三方集成在一起，为 Office 365 中的团队协作提供单个集线器。
...
-   [示例电子邮件： 利益干系人通信](#step-1-email)
 
[返回页首](#about-upgrade-essentials)

<a name="step-2"></a>

## <a name="step-2-envision-your-organization-on-teams"></a>步骤 2。 Envision 团队对组织

*（关于在升级前四到六周）*

团队提供的商业功能兼容 Skype — 例如 IM （聊天） 和会议，但它还可以执行等很多。 团队协作，则返回 true 集线器，为团队允许工作组用于管理项目、 文件、 对话和所有位于同一个位置的应用程序。 决定如何组织将使用团队和启用您的环境以获得成功。
...
-   [了解团队和频道](https://docs.microsoft.com/MicrosoftTeams/teams-channels-overview)
-   [完成技术的规划](https://docs.microsoft.com/MicrosoftTeams/quick-start-enable-teams#step-3-complete-technical-planning)
...
## <a name="step-4-notify-your-users-that-skype-for-business-is-becoming-teams"></a>步骤 4。 通知用户 for Business 的 Skype 正在成为团队

*（即将升级前的 2 到 3 周）*

向用户提供留出足够的通知将为其提供熟悉而不会产生负面影响其工作效率，正更多的用户体验产生团队的时间。 发送通信以告知他们有什么变化、 更改为什么和如何可以为其准备。
...
-   [管理组织中的团队功能](https://docs.microsoft.com/microsoftteams/enable-features-office-365)
-   [示例电子邮件： 通知用户有关 Skype for Business](#step-4-email)
...
维护升级 momentum 通过启用通过管理门户，提供可视通知业务客户端 for Business 的 Skype 正在成为团队 Skype 中的升级通知用户。
...
## <a name="step-6-remind-your-users-that-skype-for-business-is-becoming-teams"></a>步骤 6。 提醒用户 for Business 的 Skype 正在成为团队
*（关于在升级之前的五天）*
...
-   [示例电子邮件： 提醒用户开始使用团队](#step-6-email)
...
今天是您的组织正式升级到团队为您的通信和协作解决方案的天。 在 Office 365 管理门户中，激活升级开关。 在其 Skype 业务他们已向工作组已升级的客户端，用户将收到通知。

我们建议每个人在升级之后，您发送电子邮件向工作组欢迎它们。

**资源：**

-   升级用户说明 – Irinel 链接？ – 等待其他版本的功能和文档
-   [示例电子邮件： 欢迎用户参加团队](#step-7-email)
...
-   [示例电子邮件： 检查用户使用](#step-9-email)，以及[用户调查](#step-9-surveys)
...
-   [示例电子邮件： 鼓励用户进一步了解团队](#step-10-email)
...
## <a name="sample-surveys-for-the-check-in-email-in-step-9"></a>对在步骤 9 中签入电子邮件的示例调查
