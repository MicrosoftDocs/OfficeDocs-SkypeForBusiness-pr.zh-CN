...
ms.locfileid: "33298458"
---
# <a name="whats-the-status-of-my-port-orders-in-teams"></a>Teams 中我的转网订单的状态是什么？

您可以转到**Microsoft 团队管理中心**看到端口订单的状态 > **旧门户** > **语音** > **端口订单**。 在**状态**列中，将列出每个端口订单状态。 如果您需要帮助，[请与业务产品-管理员技术支持联系](https://docs.microsoft.com/office365/admin/contact-support-for-business-products?toc=/microsoftteams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)。
...
|**Error** <br/> |否  <br/> |是  <br/> |是   <br/> |是 （此时，您不能删除该端口订单出现错误时。 端口顺序需要重新创建，或需要[与业务产品的管理员技术支持部门联系](https://docs.microsoft.com/office365/admin/contact-support-for-business-products?toc=/microsoftteams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)。  <br/> |可能会丢失运营商已拒绝顺序。  <br/> |
...
> [!NOTE]
> 如果需要获取更多电话号码，请[联系商业版产品支持人员 - 管理员帮助](https://docs.microsoft.com/office365/admin/contact-support-for-business-products?toc=/microsoftteams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)
