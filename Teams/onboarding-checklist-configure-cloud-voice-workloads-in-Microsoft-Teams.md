...
| ppls-2  | 验证用于启用音频会议的用户和部署节奏列表    | 检查是否有与团队的音频会议范围内的业务部门或网站的列表。 使用 "目标" 和 "关键结果" 模型，即可处理范围内的用户。 我们建议你按逐个网站的方式工作，以便你可以专注于你的资源。<br/><br/> 作为支持计划的一部分，确定将启用哪些用户以及何时（试点、站点1、站点2等）。 | | [音频会议展望](https://docs.microsoft.com/MicrosoftTeams/audio-conferencing#Envision_AudioConferencing)  |
...
| ppls-2  | 验证用于启用呼叫计划的用户和部署节奏列表 | 检查在与团队通话计划的范围中是否有业务部门或网站的列表。 使用 "目标" 和 "密钥结果" 模型，可了解哪些用户将位于呼叫计划范围内。 我们建议你按逐个网站的方式工作，以便你可以专注于你的资源。<br/><br/> 作为支持计划的一部分，确定将启用哪些用户（试验、站点1、站点2等）。 | | [具有通话套餐的电话系统](calling-plan-landing-page.md) |
...
| 4  | 配置拨号计划 | 通过拨号计划，用户可以按其使用的方式拨打电话号码，例如省略本地呼叫的区号、忽略国内电话的国家/地区代码，或者甚至在会议期间使用短数字拨号拨出其他用户。 <br/><br/>服务拨号计划（默认值）基于用户的 Office 365 使用位置，不能更改。 <br/><br/>如果默认服务计划不能满足你的需求，你可以在租户或用户级别配置租户拨号计划。 检查是否已完成音频会议的此步骤。 | | [具有通话套餐的电话系统](calling-plan-landing-page.md) <br/><br/>[Office 365 通话计划拨号计划](https://docs.microsoft.com/SkypeForBusiness/what-are-calling-plans-in-office-365/what-are-dial-plans) |
