...
| 第一个 MAC 地址|String|媒体访问控制 (第一个终结点的网络设备的 MAC) 地址。 仅对过去30天的数据可用，并且仅对具有允许 EUII 访问权限的用户可见。| |
| 第二个 MAC 地址|String|媒体访问控制 (第二终结点的网络设备的 MAC) 地址。 仅对过去30天的数据可用，并且仅对具有允许 EUII 访问权限的用户可见。| |
| 第一个 Sip Uri|String|会话初始协议 (第一个终结点的用户的 SIP) URI。 仅填充 Skype for Business 终结点。 仅对过去30天的数据可用，并且仅对具有允许 EUII 访问权限的用户可见。|
...
| 第一个 UPN|String|用户主体名称 (第一个终结点的用户的 UPN) 。 仅对过去30天的数据可用，并且仅对具有允许 EUII 访问权限的用户可见。|
| 第二 UPN|String|第二终结点用户的用户主体名称 (UPN) 。 仅对过去30天的数据可用，并且仅对具有允许 EUII 访问权限的用户可见。|
