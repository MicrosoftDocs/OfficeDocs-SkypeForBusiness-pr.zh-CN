...
|功能     | 最大限制 |
|------------|---------------|
|会议中的人数（可聊天和通话）  |300。“**仅查看**”最多允许 20,000 位仅收听的参与者加入组织者拥有高级通信加载项 SKU 许可证的会议。<sup>1</sup> [!INCLUDE [template](includes/preview-feature.md)] <br><br>**注意：** 对于 Teams 政府版（GCC、GCC 高、DoD），该限制仍然为 250。 政府云限制从 250 增加到 300 并支持会议溢出时，我们会更新此文章。   |
|会议中的人数（可聊天和通话）  | 300 |
|通过视频或音频通话聊天的人员数 | 20 |
|PowerPoint 文件的最大大小 | 2GB|
|Teams 保留了不会上传到 Microsoft Stream 且可供本地下载的[会议记录](cloud-recording.md) | 20 天 |

<sup>1</sup> “仅查看”默认处于打开状态。 可使用 PowerShell 禁用会议溢出。 
```powershell
Set-CsTeamsMeetingPolicy -Identity Global -StreamingAttendeeMode Disabled
Set-CsTeamsMeetingPolicy -Identity Global -StreamingAttendeeMode Enabled
```
如果会议中不再提供“仅查看”功能，或者与会者无权绕过基于设定的“会议厅策略”或“选项”的会议厅，“仅查看”与会者将无法加入会议。 “仅查看”参与者将无法看到本机 PPT 共享文件。
