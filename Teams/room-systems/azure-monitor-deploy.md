...
1.  [验证日志分析配置](azure-monitor-deploy.md#validate_LogAnalytics)
2.  [配置日志分析管理安装程序测试设备](azure-monitor-deploy.md#configure_test_devices)
3.  [映射自定义字段](azure-monitor-deploy.md#Custom_fields)
4.  [日志分析中定义的 Microsoft 团队聊天室视图](azure-monitor-deploy.md#Define_Views)
5.  [定义通知](azure-monitor-deploy.md#Alerts)
6.  [将所有设备都配置为监控](azure-monitor-deploy.md#configure_all_devices)
7.  [配置其他 Azure 监视解决方案](azure-monitor-deploy.md#Solutions)
