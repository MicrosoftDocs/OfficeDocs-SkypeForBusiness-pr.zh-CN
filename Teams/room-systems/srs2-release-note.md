...
- 当从 PC/Web/移动团队共享客户端时, 在 Microsoft 球队的会议室前面接收/呈现 Microsoft<sup></sup> <sup></sup>白板
...
- 用户界面改进的主题和前面
- TLS 1.2 客户端支持。 对于本地客户, 为 Microsoft 团队聊天室启用通过 TLS 1.2 进行通信需要 Skype for business Server 2015 累积更新 9 (CU9) 或 Skype for business 服务器2019累积更新 1 (CU1)。
