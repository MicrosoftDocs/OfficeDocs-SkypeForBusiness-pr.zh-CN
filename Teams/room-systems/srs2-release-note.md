...
- 修复了 "在应用启动时挂起" 错误, 它影响了旧版 Windows 10 RS2 内部版本的设备。  
...
- 当会议室系统设备上未启用 "蓝牙信标" 时, 会议室的正面显示删除 "强制转换" 图标
- 修复团队会议中的卷控制问题
...
- 用户界面改进的主题和前面
- TLS 1.2 客户端支持。 对于本地客户, 在针对 Microsoft 团队聊天室启用 TLS 1.2 的 communciation 需要 Skype for Business Server 2015 Cummulative 更新 9 (CU9) 或 Skype for Buisness Server 2019 Cummulative Update 1 (CU1)。
...
- 通过本地化的 EULAs 修复格式设置问题-特别是挪威语-可防止在 EULA 的 "OOBE" 设置窗口之外继续
...
- 通过按 Crestron SR 设备上的 "应用" 按钮, 可访问的 Crestron 应用程序的修补程序无法正常启动。 安装4.0.19.0 后需要重新启动 Microsoft 团队聊天室应用。 
...
- 优化: 使 IT 专业人员能够使用 Windows 10 版本1709和更高版本生成自身映像。  
...
- 支持 Windows 10 企业版创建程序的更新 (英语、内部版本 1703)
...
Microsoft 团队聊天室版本 3.0.12.0 (update 3) 不再支持64位版本的 Windows 10 企业版周年版 (英语、版本 1607)。
...
- 双屏幕支持 (适用于旧式系统奇偶校验)
- Themability (内置主题和设置自定义主题的功能)
- 提供对公共内部版本的反馈的能力
- 改进了有关会议加入可靠性的遥测
- 其他 OMS 报告
- IT 管理员远程配置设备的能力  <!--  - Front-of-Room UX shows room details pre-meeting U2  -->
