...
> [!NOTE]
> 如果当前使用的是 E1、E3、E4 和 E5 Sku, 并且使用 Skype for Business 独立计划1或 Skype for business 计划2或使用 Office365 Phone 系统和通话计划的 Skype for business 计划 2, 这些功能将继续有效。 但是, 在当前许可证到期后的表中, 你应该考虑移到更简单的许可模型。  
...
|  | 您有 Microsoft 团队或 Skype for business Online <br/> 需要购买的项目：   |您有 Skype for Business 服务器 2015/2019 (本地或混合版)。 <br/> 需要购买的项目：|
|:-----|:-----|:-----|
