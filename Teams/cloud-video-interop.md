...
- 在超过 50 (个没有资格与) 直接集成的设备上部署会议室设备和个人视频设备Microsoft Teams
- 我们的一个云视频互操作合作伙伴支持
...
|![表示 BlueJeans 网关的徽标。](media/bluejeans.png)| <a href="https://aka.ms/BluejeansGateway" target="_blank">BlueJeans Gateway for Microsoft Teams</a> |
...
云视频互操作是一项第三方服务，由我们的合作伙伴提供，用于提供本地现有视频会议和个人视频设备解决方案与Microsoft Teams。
...
- 直接拨号 
  - 使用 tenantkey 的完整字符串，Teams直接拨号功能直接拨入 Teams 会议，而无需与合作伙伴的 IVR 交互。VTC ConferenceId@domain。
- 一键式拨号 
...
- **Get-CsTeamsVideoInteropServicepolicy：Microsoft** 为每个支持的合作伙伴提供预构建的策略，允许你指定要用于云视频互操作 (合作伙伴) 。<br>使用此 cmdlet 可以标识可在组织中使用的预构建策略。 可以通过使用 Grant-CsTeamsVideoInteropServicePolicy cmdlet 将此策略分配给一个或多个用户。
