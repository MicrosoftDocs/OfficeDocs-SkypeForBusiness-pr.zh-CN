...
---
# <a name="which-calling-plan-is-right-for-you"></a>哪些通话计划适合您？ 
...
我的用户是否有通话计划许可证？ | 要购买和分配许可证, 请参阅[步骤 2: 购买和分配许可证](set-up-calling-plans.md#step-2-buy-and-assign-licenses)。 |
我的用户是否每个都有直接拨入电话号码？ | 若要获取电话号码, 请参阅[步骤 3: 获取电话号码](set-up-calling-plans.md#step-3-get-phone-numbers)。 |
|||

### <a name="transfer-phone-numbers-to-office-365"></a>将电话号码转接到 Office 365

将您的电话号码从当前服务提供商转移到团队非常简单。 将您的电话号码移植到团队后, Microsoft 将成为您的服务提供商, 并向您收取这些电话号码。 有关详细信息, 请参阅[将电话号码转移到 Office 365](transfer-phone-numbers-to-office-365.md)。
