...
可以使用本地部署Microsoft Teams或Skype for Business部署Microsoft Teams 会议室。  有关所需许可证的信息，请参阅[Teams 会议室许可更新](rooms-licensing.md)。
...
|----------------------------|----------------------------------------|-------------|-----------------------|
| 清单会议室            | 设施/AV 团队/IT Project团队 |             | [会议室清单和功能规划](#room-inventory-and-capability-planning) |
| 规划功能          | IT Project团队                        |             | [会议室清单和功能规划](#room-inventory-and-capability-planning) |
| 设备选择           | IT Project团队/AV 团队              |             | [设备选择](#device-selection) |
| 采购                | IT Project团队/AV 团队              |             | [采购](#procurement) |
| 网站就绪             | 设施/AV 团队/IT Project团队 |             | [网站就绪](rooms-deploy.md#site-readiness) |
| 服务就绪          | IT Project团队                        |             | [服务就绪](rooms-deploy.md#service-readiness) |
| 配置              | IT Project团队                        |             | [配置和部署](rooms-deploy.md#configuration-and-deployment) |
...
**Pro提示** – 某些房间类型可能不适用于部署。

| &nbsp; | &nbsp; |
|---|---|
| ![范围中的会议室。](../media/audio_conferencing_image7.png) <br/>决策点 | <ul><li>从清单中，哪些类型的会议室在部署范围内？</li><li>将为每个房间类型部署哪些系统？</li></ul> |
| ![收集材料。](../media/audio_conferencing_image9.png)<br/>后续步骤 | <ul><li>"开始"菜单收集所选系统的关键操作材料，并与采购团队联系。</li></ul> |
...
**Pro提示 -** 现在是开始收集所选Microsoft Teams 会议室解决方案信息的好时机。
...
| &nbsp; | &nbsp; |
|---|---|
| ![寄送组件。](../media/audio_conferencing_image7.png) <br/>决策点|<ul><li>是将组件直接寄送到站点还是临时设施？</li><li>如果决定使用一个) ，Who会管理过渡设施 (？</li></ul> |
