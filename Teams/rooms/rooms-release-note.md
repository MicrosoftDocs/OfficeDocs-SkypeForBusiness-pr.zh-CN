...
此更新中引入的内容：
- Microsoft 团队和 Surface Hub 2 之间的协调会议 
- 在安装了 [windows 10 更新 KB4565351](https://support.microsoft.com/en-us/help/4565351/windows-10-update-kb4565351) 或 [WINDOWS 10 更新 KB4571709](https://support.microsoft.com/en-us/help/4571709/windows-10-update-kb4571709) 时，修复 Skype for business 登录失败
...
- 支持使用团队客户环) 所需和发布的团队的动态紧急呼叫 (服务组件的支持
- 使用 XML 在双重显示的会议中禁用重复内容的功能
- 应用程序初始屏幕
- 开放源代码软件 (OSS) 在设备设置中的通知
...
- 修复在 Azure 监视器中显示错误的设备事件报告

### <a name="43330-1102020"></a>4.3.33.0 (1/10/2020) 

此更新中引入的内容：

- 针对在某些配置中看到的窗口大小调整/闪烁问题的修复程序
- 删除了第三方会议的日历处理
- 已删除 Cortana 状态设置
...
- 自动应答邻近呼叫和管理设置以控制此
- 通过在 "关于" 选项卡下添加设备配置来刷新设备管理员设置 UI
- 将聊天室控件移回到主屏幕
- 在 GCC 中可用的会议室 SKU
- 对基于 Surface Pro 的系统的内容照相机支持 (最低要求的应用内部版本： 4.2.4.0) 
...
- 在室内的两个前部显示内容 (用于在双屏幕房间系统上) 显示的内容
- 用户界面改进的主题和前面
- TLS 1.2 客户端支持。 对于本地客户，在针对 Microsoft 团队聊天室启用 TLS 1.2 的通信时需要 Skype for business Server 2015 累积更新 9 (CU9) 或 Skype for business Server 2019 累积更新 1 (CU1) 。
...
- 通过本地化的 EULAs 修复格式设置问题 (特别是挪威) ，可防止在 EULA 的 "OOBE" 设置窗口之外继续
...
- 在 "团队" 模式下 "报告问题" 功能改进 (等同于 Skype for Business 模式中的 "提供反馈") 
...
- 在基于 Windows 10 版本1709的系统中，修复 OSK (屏幕键盘) 行为
- 改进了针对未来操作系统更新的准备
...
- 对 [POLYCOM MSR 系列](https://www.polycom.com/hd-video-conferencing/microsoft-video/msr-series.mdl) 插接硬件的支持
- 对[Logitech Brio](https://www.logitech.com/product/brio)的支持
- 解决了显示 (控制台和会议室) 在会议室中没有活动时无法进入睡眠模式的问题
...
- 支持 Windows 10 企业版创建者的更新 (英语语言、内部版本 1703) 
- 对 [CRESTRON SR](https://www.crestron.com/products/line/sr-for-skype-for-business-room-system) dock 硬件的支持
- 适用于环境控件 (Crestron) 的 OEM 支持

64位版本的 Windows 10 企业版周年版 (英语、版本 1607) 在 Microsoft 团队聊天室版本 3.0.12.0 (update 3) 中不再受支持。
...
### <a name="release-to-market-1272016"></a> (12/7/2016) 发布到市场
