...
Microsoft [SkypeRoomProvisioningScript.ps1](https://go.microsoft.com/fwlink/?linkid=870105)提供了可帮助创建新用户帐户的脚本，或验证你拥有的现有资源帐户，以便帮助你将其转换为兼容的 Microsoft 团队聊天室用户帐户。 如果你愿意，可以按照以下步骤配置 Microsoft 团队聊天室设备将使用的帐户。
...
- 启用使用 Skype for Business 服务器的设备帐户。 要启用设备帐户，你的环境需要满足以下先决条件：
  ...
  - 您需要在 Microsoft 365 或 Office 365 计划中安装 Skype for Business Online (计划 2) 或更高版本。 该计划需要支持会议功能。
...
2. 在 Exchange PowerShell 中，为帐户创建邮箱 (邮箱-通过运行以下命令启用帐户) ：
