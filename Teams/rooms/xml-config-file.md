...
| \<NoiseSuppressionDefault\>                 | 布尔&#x2777;            | 第一&#x2776; | 默认情况下已启用，为 true。 如果为 false，则仅关闭基于 Microsoft AI 的干扰抑制 (NS) 。 如果 HW 内置了干扰抑制，则 Microsoft NS 将在打开时级联。 如果管理员只想使用 OEM 提供的 NS，则应关闭基于 Microsoft AI 的 NS。
