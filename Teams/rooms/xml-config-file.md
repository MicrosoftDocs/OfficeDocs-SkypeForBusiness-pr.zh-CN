...
| \<TeamsMeetingsEnabled\>                    | 布尔值&#x2777;            | 第一&#x2776; | 默认情况下处于禁用状态。 <br/> <br/> 如果同时禁用 和 \<SkypeMeetingsEnabled\>\<TeamsMeetingsEnabled\> ，则 XML 文件被视为格式不正确，但可以同时启用这两个设置。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| \<UseCustomInfoForThirdPartyMeetings\>      | 布尔值&#x2777;            | 第一&#x2776; | 默认情况下禁用，并使用会议室帐户信息加入第三方会议。 <br/> <br/> 如果此值设置为 true，则必须指定 两 \<CustomDisplayNameForThirdPartyMeetings\>个 ， \<CustomDisplayEmailForThirdPartyMeetings\> 必须指定 。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| \<DisableTeamsAudioSharing\>                | 布尔值&#x2777;            | 第一&#x2776; | 设置为 true 以禁用与会议参与者之间的 HDMI 音频Teams共享。 默认为 false。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| \<FrontRowEnabled>                          | 布尔值&#x2777;            | 第一&#x2776; | 默认为启用。 如果为 false，则禁用 Front Row。
| \<DefaultFoRExperience>                     | 布尔值&#x2777;            | 第一&#x2776; | 库视图默认。 Put 1 将默认布局从"库视图"更改为"前行"。
| \<CortanaWakewordEnabled\>                  | 布尔值&#x2777;            | 第一&#x2776; | 设置为 true 以启用Cortana"你好，Cortana"。 此设置没有任何影响，除非你的Cortana或区域支持该服务，并且连接的音频外围设备支持Cortana。 默认为 false。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| \<SendLogs\>                                | 容器                   | 第一&#x2776; |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| \<ContentCameraEnhancement>                 | 布尔值&#x2777;            |                | 如果设置为 true (默认) ，内容相机图像将进行数字增强：检测到白板边缘，选择适当的缩放，增强墨迹线条，使白板上书写的人透明。  <br><br> 如果打算向会议参与者发送原始视频源（对于没有用笔绘制白板的空间）设置为 false，则摄像机用于显示便笺、海报或其他媒体。                                                                                                                                                                                                                                                                                                                                                                                             |
...
| \<TrustedAccounts\>                         | String                      |                | 这是每个 Teams 会议室设备或 Surface Hub 设备应接受会议加入请求或者应发送到的会议加入请求的 UPN 的逗号分隔列表。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| \<Settings\>                                | 容器                   |                | 用于协调会议的配置音频和视频配置元素的容器。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| \<Audio\>                                   | 布尔值&#x2777;            |                | 控制设备上Teams 会议室配置。 此元素具有两个属性：<br><ul><li><b>default</b> 确定在会议开始时麦克风将处于活动状态的设备。 只有一 (设备Teams 会议室`true``false`设备) 可以将此字段设置为 ，而其余设备必须将此字段设置为 以避免音频回声和反馈。</li><li><b>enabled</b> 确定会议参与者是否可以打开或关闭麦克风。 将 **"音频默认值** "设置为 `false` `false` 的设备应将此设置设置为 ，以便参与者不会意外打开麦克风并引发音频回声或反馈。<p>如果 **"音频** 默认值"设置为 `true`**，则忽略**"启用音频"设置，参与者可以将麦克风设为静音或取消静音。</li></ul>                        |
| \<Video\>                                   | 布尔值&#x2777;            |                | 控制设备上Teams 会议室配置。 此元素具有两个属性：<br><ul><li><b>default</b> 确定在会议开始时相机将在哪个设备上处于活动状态。 为获得最佳体验，建议仅将Teams 会议室设置为 `true` ，而所有其他设备都设置为 `false`。</li><li><b>enabled</b> 确定会议参与者是否可以打开或关闭摄像机。 您可以在事件`true`参与者想要共享不同视频透视图的其他任何设备上 (，例如，如果参与者正在使用 Surface Hub 白板) 。 如果不希望参与者在设备上打开或关闭摄像机，请将其设置为 `false`。<p> 如果 **"视频** 默认值"设置为 `true`**，则忽略**"启用视频"设置，参与者可以打开或关闭摄像机。</li></ul> |
| \<Whiteboard\>                              | 布尔值&#x2777;            |                | 控制设备上白板Teams 会议室配置。 此元素具有两个属性：<br><ul><li><b>default</b> 确定启动会议时白板将在哪个设备上处于活动状态。 为获得最佳体验，我们建议`false`将Teams 会议室设置为 ，并使用白板在 Surface Hub。</li><li><b>enabled</b> 确定会议参与者是否可以打开或关闭白板。 如果不希望参与者在设备上打开或关闭白板，请将其设置为 `false`。<p> 如果 **Whiteboard 默认值** 设置为 `true`，则忽略 **启用白板** 的设置，参与者可以打开或关闭白板。</li></ul>                                                                                                                                                   |
...
启动时，如果Microsoft Teams 会议室找到名为 SkypeSettings.xml `C:\Users\Skype\AppData\Local\Packages\Microsoft.SkypeRoomSystem_8wekyb3d8bbwe\LocalState`的 XML 文件，它会应用 XML 文件指示的配置设置，然后删除该 XML 文件。
...
- [使用 PowerShell 和](rooms-operations.md#RemotePS)[配置文件项进行远程管理](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc772536(v=ws.11))
...
自定义主题图像文件必须放置在 文件夹中`C:\Users\Skype\AppData\Local\Packages\Microsoft.SkypeRoomSystem_8wekyb3d8bbwe\LocalState` 。 在 变量中输入文件名和 \<CustomThemeImageUrl\> 扩展名。
...
## <a name="set-front-row-as-the-default-layout"></a>将"前行"设置为默认布局

如果未在 XML 配置中为聊天室设置默认显示布局，则默认布局将设置为"库"。 若要将 Front 行视为默认布局，请 ```<DefaultFoRExperience>1</DefaultFoRExperience>``` 将其添加到 XML 配置文件。

最终用户可以在调整期间使用布局选取器从默认显示布局切换。

## <a name="turn-off-front-row"></a>关闭"前行"

默认情况下，前行已启用。 如果不希望最终用户在特定房间使用"前行"，请关闭"前行"。 为此，请添加到 ```<FrontRowEnabled>false</FrontRowEnabled>``` XML 配置文件。
