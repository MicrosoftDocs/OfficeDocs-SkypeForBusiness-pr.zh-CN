...
- 9–12英尺 (2.7 – 3.6) 宽-支持
- 超过12英尺 (3.6 m) 宽-摄像头覆盖9–12英尺 (2.7 – 3.6 m) 并裁剪其余部分。

## <a name="camera-location"></a>相机位置

内容照相机的理想位置在白板上垂直和水平居中。 本地建筑物代码可能具有高度限制，需要将相机提升到与白板顶部更高的位置。

您可以将摄像头安装到最多6个。  (152 mm) 高于白板顶部，并以白色板为中心，如图所示。 请确保相机图像包含至少6个。 沿水平方向 (152 mm) 边框。 你可以使用 Microsoft 团队聊天室应用中的相机预览来确定照相机的最终位置。
...
| 摄像头 HFoV |3英尺 (0.91)      |  (1.8 m) 的6英尺    |  (2.74 m) 的9英尺        |12英尺。 (3.65 m)          | 最大距离白板的距离  |
|:---         |:---               |:---                |:---                 |:---             | :--- |
| 80°         | 1.79 英尺 (0.54)  | 3.58 英尺 (1.09)   | 5.36 英尺 (1.6)     |7.15 英尺 (2.17)  |7.51 英尺 (2.28)  |
| 90°         | 1.5 英尺 (0.45)  | 3.00 英尺 (0.91)    | 4.5 英尺 (1.37)     |6.0 英尺 (1.82)     |6.3 英尺 (1.92)  |
| 100°        | 1.26 英尺 (0.38) | 2.52 英尺 (0.77)    | 3.78 英尺 (1.15)    |5.03 英尺 (1.53)    |5.29 英尺 (1.61)  |
| 110°        | 1.05 英尺 (0.32) | 2.10 英尺 (0.64)    | 3.15 英尺 (0.96)    |4.2 英尺 (1.28)     |4.41 英尺 (1.31)  |
| 120°        | 0.87 英尺 (0.26) | 1.73 英尺 (0.52)    | 2.60 英尺 (0.79)    |3.46 英尺 (1.05)    |3.64 英尺 (1.10)  |
|             |               |                  |                  |        |                    |                  |

内容相机与白板上挂载的墙壁之间的距离取决于该型号的摄像头的 HFoV，这是不同的。 使用较大的 HFoV 安装摄像头 (120 度，例如) 靠近墙壁的相机，以及距离墙壁较窄的 HFoV。 先检查 HFoV，然后再开始安装所选相机。

如果你的白板大于12英尺。 (3.65 m) 或不带角 (如满墙白板) ，可以将相机放置在中间的任何位置。 如果找不到 "白板" 拐角，增强软件将在中间区域中选择一个区域。
...
3.  (可选) 如果照相机是从天花板安装的，请选择 " **旋转内容相机180°** " 选项。
4. 选择 " **保存并退出**"。
