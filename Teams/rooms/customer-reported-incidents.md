...
1. 选择 **“关闭票证**”。
   ...
   ![事件概述详细信息的屏幕截图](../media/customer-reported-incidents-003.png)

1. 通过从列表中选择一个类别来选择关闭的原因。

   确认关闭原因后，票证将关闭并移至 **“已解决**”。

   ![已关闭票证的屏幕截图](../media/customer-reported-incidents-004.png)

票证的“详细信息概述”部分显示，托管会议室服务 (Microsoft) 或客户/合作伙伴的名称关闭了票证。  

 ![谁关闭了票证的屏幕截图 ](../media/customer-reported-incidents-005.png)
