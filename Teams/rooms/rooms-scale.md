...
<span data-ttu-id="b1e3b-104">本文提供使用 Microsoft 终结点配置管理器创建 Microsoft 团队聊天室部署的所有必要信息。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-104">This article gives you all the necessary information to create your Microsoft Teams Rooms deployments by using Microsoft Endpoint Configuration Manager.</span></span>
...
4.  <span data-ttu-id="b1e3b-141">下载完成后，选择更新，然后选择 "**安装更新包**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-141">After the download is complete, select the update, and then select **Install Update Pack**.</span></span>
...
-   <span data-ttu-id="b1e3b-228">SRS v2-Sysprep 程序包</span><span class="sxs-lookup"><span data-stu-id="b1e3b-228">SRS v2 - Sysprep Package</span></span>
...
4. <span data-ttu-id="b1e3b-239">输入以下信息以创建程序包：</span><span class="sxs-lookup"><span data-stu-id="b1e3b-239">Enter the following information to create the package:</span></span>
   ...
   - <span data-ttu-id="b1e3b-243">选中 "**此程序包包含源文件**" 复选框，输入 SRS v2 的路径 **-Microsoft Monitoring Agent 程序包**文件夹，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-243">Select the **This package contains source files** check box, enter the path to the **SRS v2 - Microsoft Monitoring Agent Package** folder, and then select **Next**.</span></span>
...
4. <span data-ttu-id="b1e3b-254">在 Configuration Manager 控制台中，转到 "**软件库** \> **应用程序管理** \> **程序包**"，然后选择 "**创建程序包**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-254">In the Configuration Manager console, go to **Software Library** \> **Application Management** \> **Packages**, and then select **Create Package**.</span></span>
...
3.  <span data-ttu-id="b1e3b-270">输入以下信息以创建程序包：</span><span class="sxs-lookup"><span data-stu-id="b1e3b-270">Enter the following information to create the package:</span></span>
...
6.  <span data-ttu-id="b1e3b-288">查看**确认设置**页面，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-288">Review the **Confirm the settings** page, and then select **Next**.</span></span>
...
6. <span data-ttu-id="b1e3b-314">查看**确认设置**页面，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-314">Review the **Confirm the settings** page, and then select **Next**.</span></span>
...
1.  <span data-ttu-id="b1e3b-329">下载最新的驱动程序和固件。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-329">Download the latest drivers and firmware.</span></span>
...
12. <span data-ttu-id="b1e3b-343">将所有导入的驱动程序移动到新创建的文件夹，以便更轻松地进行导航和操作。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-343">Move all the imported drivers to the newly created folder for easier navigation and operation.</span></span>
...
<span data-ttu-id="b1e3b-357">必须将所有程序包分发到在 Configuration Manager 层次结构中分配有分发点角色的服务器。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-357">All the packages must be distributed to the servers that have been assigned the distribution point role in the Configuration Manager hierarchy.</span></span> <span data-ttu-id="b1e3b-358">按照以下说明启动软件包分发。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-358">Follow the instructions below to initiate package distribution.</span></span>
...
3.  <span data-ttu-id="b1e3b-371">分发操作系统程序包。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-371">Distribute operating system packages.</span></span>
    ...
    2.  <span data-ttu-id="b1e3b-374">查看程序包列表，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-374">Review the list of packages, and then select **Next**.</span></span>
...
1. <span data-ttu-id="b1e3b-392">选择导入的任务序列，然后选择 "**编辑**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-392">Select the imported task sequence, and then select **Edit**.</span></span>

    <span data-ttu-id="b1e3b-393">任务序列编辑器随即打开，并显示部署和配置 Microsoft 团队聊天室单元所需的每个连续步骤。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-393">The Task Sequence Editor opens and displays each sequential step that you need to deploy and configure a Microsoft Teams Rooms unit.</span></span>

2. <span data-ttu-id="b1e3b-394">演练每个步骤并完成推荐的更新：</span><span class="sxs-lookup"><span data-stu-id="b1e3b-394">Walk through each step and complete the recommended updates:</span></span>

   1. <span data-ttu-id="b1e3b-395">**在 WINDOWS PE 中重启**：此步骤将重新启动，然后将计算机启动到 Windows PXE。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-395">**Restart in Windows PE**: This step restarts and then boots the computer into Windows PXE.</span></span> <span data-ttu-id="b1e3b-396">此步骤不需要任何更改。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-396">No changes are required for this step.</span></span>

   2. <span data-ttu-id="b1e3b-397">**分区磁盘 0-UEFI**：此步骤将擦除磁盘配置，并基于已配置的设置创建分区。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-397">**Partition Disk 0 – UEFI**: This step wipes the disk configuration and creates partitions based on the configured settings.</span></span> <span data-ttu-id="b1e3b-398">我们建议您不要对此步骤进行任何更改。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-398">We recommend that you not make any changes to this step.</span></span>

   3. <span data-ttu-id="b1e3b-399">**设置 SRS 计算机名**：此步骤包括一个 HTML 应用程序，用于在部署期间提供用于为 Microsoft 团队聊天室单元设置计算机名称的 UI。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-399">**Set SRS Computer Name**: This step includes an HTML application to provide a UI to set a computer name for the Microsoft Teams Rooms unit during the deployment.</span></span>
      -  <span data-ttu-id="b1e3b-400">这是一个可选步骤，但仅当你希望通过备用进程管理计算机命名时，才可以禁用它。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-400">This is an optional step, but it can only be disabled if you want to manage computer naming through an alternate process.</span></span>
      -  <span data-ttu-id="b1e3b-401">验证是否已选中 " **SRS v2-SRSComputerName** " 程序包。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-401">Verify that the **SRS v2 - Set-SRSComputerName** package is selected.</span></span> <span data-ttu-id="b1e3b-402">如果不是，请浏览到程序包并将其选中。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-402">If it isn't, browse to the package and select it.</span></span>

   4. <span data-ttu-id="b1e3b-403">**应用操作系统**：此步骤指定要部署的操作系统映像和要使用的无人参与 Sysprep 应答文件。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-403">**Apply Operating System**: This step specifies the operating system image to be deployed and the unattended Sysprep answer file to use.</span></span>
      -  <span data-ttu-id="b1e3b-404">验证是否选择了正确的 Windows 10 企业操作系统映像文件。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-404">Verify that the correct Windows 10 Enterprise operating system image file is selected.</span></span>
      -  <span data-ttu-id="b1e3b-405">验证是否已启用 "**为自定义安装使用无人参与或 Sysprep 应答文件**"，并选中 " **SRS V2-sysprep 程序包**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-405">Verify that **Use an unattended or Sysprep answer file for a custom installation** is enabled, and the **SRS v2 - Sysprep Package** is selected.</span></span> <span data-ttu-id="b1e3b-406">此外 **，请确保文件名设置**为**unattend.xml**。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-406">Also ensure that **File Name** is set to **unattend.xml**.</span></span>

   5. <span data-ttu-id="b1e3b-407">**应用 Windows 设置**：此步骤收集有关 Windows 安装的信息。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-407">**Apply Windows Settings**: This step gathers information about the Windows installation.</span></span>
      -  <span data-ttu-id="b1e3b-408">提供授权和注册信息，包括产品密钥、本地管理员帐户密码和时区（取决于你的需要）。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-408">Provide licensing and registration information including the product key, local administrator account password, and time zone (depending on your needs).</span></span>

   6. <span data-ttu-id="b1e3b-409">**应用网络设置**：此步骤允许你指定工作组或 Active Directory 域名和组织单位。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-409">**Apply Network Settings**: This step allows you to specify a workgroup or Active Directory domain name and organizational unit.</span></span>
      > [!NOTE]
      > <span data-ttu-id="b1e3b-410">请参阅[Skype 会议室系统域加入](domain-joining-considerations.md)有关建议操作的注意事项，在部署 Microsoft 团队聊天室单元作为 Actve Directory 域的成员时需要执行此操作。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-410">See [Skype Room System domain joining considerations](domain-joining-considerations.md) for recommended actions you need to take in deploying Microsoft Teams Rooms units as members of an Actve Directory domain.</span></span>
   7. <span data-ttu-id="b1e3b-411">**应用驱动程序：** 此步骤及其子步骤用于基于你所拥有的 Surface Pro 模型部署适用的设备驱动程序和固件。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-411">**Apply Drivers:** This step and its sub-steps are used to deploy applicable device drivers and firmware based on the Surface Pro model you have.</span></span> <span data-ttu-id="b1e3b-412">更新每个步骤以指定与此部署关联的相关驱动程序包。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-412">Update each step to specify the relevant driver package associated with this deployment.</span></span>
      -   <span data-ttu-id="b1e3b-413">每个驱动程序包都配置为利用 Windows Management Instrumentation （WMI）筛选器，根据 Surface Pro 和 model 部署相关的驱动程序和固件。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-413">Each driver package is configured to leverage Windows Management Instrumentation (WMI) filters to deploy relevant drivers and firmware based on the Surface Pro make and model.</span></span>
      -   <span data-ttu-id="b1e3b-414">我们强烈建议您不要更改这些驱动程序的配置，否则部署可能会失败。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-414">We highly recommend that you not alter the configuration of these drivers, otherwise deployment might fail.</span></span>

   8. <span data-ttu-id="b1e3b-415">**设置 Windows 和配置管理器**：此步骤可部署和配置 Configuration Manager 客户端。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-415">**Set up Windows and Configuration Manager**: This step deploys and configures the Configuration Manager client.</span></span> <span data-ttu-id="b1e3b-416">更新此步骤以指定内置的 Configuration Manager 客户端包。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-416">Update this step to specify the built-in Configuration Manager Client Package.</span></span>

   9. <span data-ttu-id="b1e3b-417">**安装根证书**：此步骤为非域加入的设备分发根证书，因此默认情况下为可选和禁用。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-417">**Install Root Certificate**: This step distributes the root certificate for non–domain-joined devices, and therefore is optional and disabled by default.</span></span>
      -   <span data-ttu-id="b1e3b-418">如果需要将根证书部署到 Microsoft 团队聊天室单元，请启用此步骤。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-418">Enable this step if you need to deploy a root certificate to the Microsoft Teams Rooms units.</span></span>
      -   <span data-ttu-id="b1e3b-419">如果确实需要执行此步骤，请验证**SRS v2 –根证书程序包**和 "**禁用64位文件系统重定向**" 是否已选中。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-419">If you do need to perform this step, verify that the **SRS v2 – Root Certificate Package** and **Disable 64-bit file system redirection** are selected.</span></span>

   10. <span data-ttu-id="b1e3b-420">**安装和配置监视代理**：此步骤安装64位版本的 Microsoft Azure 监视器代理并将代理配置为连接到 Log Analytics 工作区。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-420">**Install and Configure Monitoring Agent**: This step installs the 64-bit version of the Microsoft Azure Monitor agent and configures the agent to connect to your Log Analytics workspace.</span></span>
       -   <span data-ttu-id="b1e3b-421">此步骤默认情况下处于禁用状态。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-421">This step is disabled by default.</span></span> <span data-ttu-id="b1e3b-422">只有当你要使用监视 Agent 监视 Microsoft 团队会议室的运行状况时，才启用此步骤。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-422">Enable this step only if you're going to use the Monitoring Agent to monitor the health of your Microsoft Teams Rooms units.</span></span>
       -   <span data-ttu-id="b1e3b-423">编辑此步骤并更新命令行参数以指定你的**工作区 ID**和**工作区密钥**。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-423">Edit this step and update the command-line parameters to specify your **Workspace ID** and **Workspace Key**.</span></span>
       -   <span data-ttu-id="b1e3b-424">有关获取 Operations Management Suite 工作区 ID 和主键的详细信息，请参阅[配置 Azure 监视的测试设备](azure-monitor-deploy.md#configure-test-devices-for-azure-monitoring)。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-424">See [Configure test devices for Azure Monitoring](azure-monitor-deploy.md#configure-test-devices-for-azure-monitoring) for more information about obtaining the Operations Management Suite Workspace ID and the primary key.</span></span>
       -   <span data-ttu-id="b1e3b-425">验证**SRS v2-Microsoft Monitoring Agent 程序包**和 "**禁用64位文件系统重定向**" 是否已选中。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-425">Verify that the **SRS v2 – Microsoft Monitoring Agent Package** and **Disable 64-bit file system redirection** are selected.</span></span>
       -   <span data-ttu-id="b1e3b-426">有关监视 Microsoft 团队聊天室部署的运行状况的详细信息，请参阅通过[azure 监视器规划 Microsoft 团队会议室管理](azure-monitor-plan.md)、通过[Azure 监视器部署 microsoft 团队聊天室管理](azure-monitor-deploy.md)和[利用 Azure 监视器管理 Microsoft 团队聊天室设备](azure-monitor-manage.md)。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-426">For more information about monitoring the health of your Microsoft Teams Rooms deployment, see [Plan Microsoft Teams Rooms management with Azure Monitor](azure-monitor-plan.md), [Deploy Microsoft Teams Rooms management with Azure Monitor](azure-monitor-deploy.md) and [Manage Microsoft Teams Rooms devices with Azure Monitor](azure-monitor-manage.md).</span></span>

   11. <span data-ttu-id="b1e3b-427">**复制 SRS V2 配置文件**：此步骤将所需的设置和配置文件从 Microsoft 团队聊天室部署工具包复制到本地硬盘。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-427">**Copy SRS v2 Configuration Files**: This step copies the required setup and configuration files from the Microsoft Teams Rooms deployment kit to the local hard drive.</span></span> <span data-ttu-id="b1e3b-428">此步骤不需要自定义。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-428">No customization is required for this step.</span></span>
       -   <span data-ttu-id="b1e3b-429">验证**srs v2 – Srs 应用程序包**和 "**禁用64位文件系统重定向**" 是否已选中。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-429">Verify that the **SRS v2 – SRS Application Package** and **Disable 64-bit file system redirection** are selected.</span></span>

   12. <span data-ttu-id="b1e3b-430">**安装-SRSv2-OS-更新**：此步骤将部署 Microsoft 团队聊天室部署所需的任何必需的操作系统更新。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-430">**Install-SRSv2-OS-Updates**: This step deploys any mandatory operating system updates required with the Microsoft Teams Rooms deployment.</span></span> <span data-ttu-id="b1e3b-431">执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="b1e3b-431">Do the following:</span></span>
       -   <span data-ttu-id="b1e3b-432">选中 "[配置 Microsoft 团队聊天室" 控制台](console.md)以查看需要哪些更新。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-432">Check [Configure a Microsoft Teams Rooms console](console.md) to see which updates are required.</span></span>
       -   <span data-ttu-id="b1e3b-433">验证**SRS v2-OS 更新程序包**中是否包含所有必需的更新。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-433">Verify that your **SRS v2 – OS Updates Package** includes all the required updates.</span></span>
       -   <span data-ttu-id="b1e3b-434">验证 " **SRS v2-OS 更新" 程序包**是否已选中。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-434">Verify that the **SRS v2 – OS Updates Package** is selected.</span></span>
       -   <span data-ttu-id="b1e3b-435">验证是否已将 PowerShell 执行策略设置为 "**回避**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-435">Verify that the PowerShell execution policy is set to **Bypass**.</span></span>

   13. <span data-ttu-id="b1e3b-436">**重新启动计算机**：此步骤会在安装必需的操作系统更新后重新启动计算机。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-436">**Restart Computer**: This step reboots the computer after the mandatory operating system updates are installed.</span></span> <span data-ttu-id="b1e3b-437">此步骤不需要自定义。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-437">No customization is required for this step.</span></span>

   14. <span data-ttu-id="b1e3b-438">**配置 Windows 组件**：此步骤配置所需的 Windows 功能。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-438">**Configure Windows Components**: This step configures the required Windows features.</span></span> <span data-ttu-id="b1e3b-439">此步骤不需要自定义。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-439">No customization is required for this step.</span></span>

   15. <span data-ttu-id="b1e3b-440">**重新启动计算机**：此步骤将在配置 Windows 功能后重新启动计算机。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-440">**Restart Computer**: This step reboots the computer after the Windows features are configured.</span></span> <span data-ttu-id="b1e3b-441">此步骤不需要自定义。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-441">No customization is required for this step.</span></span>

   16. <span data-ttu-id="b1e3b-442">**添加本地 Skype 用户**：此步骤创建用于自动登录 Windows 和启动 Microsoft 球队聊天室应用程序的本地 skype 帐户。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-442">**Add Local Skype User**: This step creates the local Skype account used to automatically sign in to Windows and start the Microsoft Teams Rooms application.</span></span> <span data-ttu-id="b1e3b-443">此步骤没有与之关联的任何软件包，并且不需要进行自定义。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-443">This step doesn't have any software package associated with it, and no customization is required for it.</span></span>

   17. <span data-ttu-id="b1e3b-444">**设置和配置 SRS 应用程序**：此步骤为操作系统的下一次启动配置 Microsoft 团队聊天室应用程序安装。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-444">**Set up and configure SRS application**: This step configures the Microsoft Teams Rooms application installation for the next boot of the operating system.</span></span>
       -   <span data-ttu-id="b1e3b-445">验证**srs v2-"配置 Srs 安装程序包**" 和 "**禁用64位文件系统重定向**" 是否已选中。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-445">Verify that the **SRS v2 – Configure SRS Setup Package** and **Disable 64-bit file system redirection** are selected.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="b1e3b-446">任务序列步骤必须按所提供的顺序排列，这一点非常重要。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-446">It is very important that the task sequence steps must be in the provided order.</span></span> <span data-ttu-id="b1e3b-447">修改步骤顺序或配置其他步骤可能会中断部署。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-447">Modifying the order of steps, or configuring additional steps might break the deployment.</span></span>
>
> <span data-ttu-id="b1e3b-448">**设置和配置 SRS 应用程序**步骤必须是任务序列中的最后一步，否则部署可能失败。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-448">**Set up and configure SRS application** step must be the last step in the task sequence, otherwise the deployment might fail.</span></span>

### <a name="create-deployment-for-the-task-sequence"></a><span data-ttu-id="b1e3b-449">为任务序列创建部署</span><span class="sxs-lookup"><span data-stu-id="b1e3b-449">Create deployment for the task sequence</span></span>

1. <span data-ttu-id="b1e3b-450">选择任务序列，然后选择 "**部署**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-450">Select the task sequence, and then select **Deploy**.</span></span>

2. <span data-ttu-id="b1e3b-451">选择 "**浏览**"，选择要部署的目标集合。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-451">Select **Browse** to select target collection for deployment.</span></span>

3. <span data-ttu-id="b1e3b-452">选择 "**所有未知计算机**"，然后选择 **"确定"**。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-452">Select **All Unknown Computers** and then select **OK**.</span></span>

4. <span data-ttu-id="b1e3b-453">选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-453">Select **Next**.</span></span>

5. <span data-ttu-id="b1e3b-454">在 "**用途**" 下拉列表中选择 "**可用**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-454">Select **Available** on the **Purpose** drop down list.</span></span>

6. <span data-ttu-id="b1e3b-455">仅在 "**可用于以下**列表" 列表中选择 "**媒体和 PXE** "，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-455">Select **Only Media and PXE** in the **Make available to the following** list, and then select **Next**.</span></span>
   > [!WARNING]
   > <span data-ttu-id="b1e3b-456">将 "**用途**" 设置为 "**可用**" 非常重要。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-456">It is very important that **Purpose** is set to **Available**.</span></span> <span data-ttu-id="b1e3b-457">请确保 "**用途**"**未**设置为 "**必需**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-457">Make sure that the **Purpose** is **NOT** set to **Required**.</span></span> <span data-ttu-id="b1e3b-458">此外，请确保仅选择 "在**以下情况下可用**的**媒体和 PXE** "。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-458">Also make sure that you select **Only Media and PXE** in the **Make available to the following**.</span></span>
   >
   > <span data-ttu-id="b1e3b-459">将这些值设置为其他值可能会导致所有计算机在引导时获得 Microsoft 团队会议室部署映像。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-459">Setting these values to something else might cause all computers to get the Microsoft Teams Rooms deployment image when booted.</span></span>
7. <span data-ttu-id="b1e3b-460">不要指定任何计划，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-460">Do not specify any schedule and select **Next**.</span></span>

8. <span data-ttu-id="b1e3b-461">不要更改 "**用户体验**" 部分中的任何内容，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-461">Do not change anything within the **User Experience** section and select **Next**.</span></span>

9. <span data-ttu-id="b1e3b-462">不要更改 "**通知**" 部分中的任何内容，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-462">Do not change anything within the **Alerts** section and select **Next**.</span></span>

10. <span data-ttu-id="b1e3b-463">不要更改 "**分发点**" 部分中的任何内容，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-463">Do not change anything within the **Distribution Points** section and select **Next**.</span></span>

11. <span data-ttu-id="b1e3b-464">确认设置，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-464">Confirm the settings and then select **Next**.</span></span>

12. <span data-ttu-id="b1e3b-465">选择 "**关闭**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-465">Select **Close**.</span></span>

<a name="validate-and-troubleshoot-the-solution"></a><span data-ttu-id="b1e3b-466">验证和解决解决方案</span><span class="sxs-lookup"><span data-stu-id="b1e3b-466">Validate and troubleshoot the solution</span></span>
--------------------------------------

<span data-ttu-id="b1e3b-467">完成 Microsoft 终结点配置管理器任务序列后，需要执行测试运行以验证任务序列是否可以部署和配置 Microsoft 团队会议室单元。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-467">After you've completed the Microsoft Endpoint Configuration Manager task sequences, you'll need to perform a test run to validate that the task sequence can deploy and configure Microsoft Teams Rooms units.</span></span>

1.  <span data-ttu-id="b1e3b-468">使用受支持的以太网适配器之一或使用 Surface dock 将测试设备连接到有线网络。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-468">Connect the test device to the wired network by using one of the supported Ethernet adapters or using the Surface dock.</span></span> <span data-ttu-id="b1e3b-469">如果尚未针对你的环境配置 PXE 启动功能，你可以使用[之前创建](https://docs.microsoft.com/configmgr/osd/deploy-use/create-bootable-media)的 usb 闪存驱动器上的启动映像从 usb 启动并连接到 Configuration Manager。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-469">If PXE boot functionality hasn't been configured for your environment, you can use the boot image on the USB flash drive [that you created earlier](https://docs.microsoft.com/configmgr/osd/deploy-use/create-bootable-media) to boot from USB and connect to Configuration Manager.</span></span>

2.  <span data-ttu-id="b1e3b-470">访问固件并启动 PXE 启动：</span><span class="sxs-lookup"><span data-stu-id="b1e3b-470">Access the firmware and initiate PXE boot:</span></span>

    1.  <span data-ttu-id="b1e3b-471">确保已关闭 Surface 设备电源。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-471">Ensure the Surface device is powered off.</span></span>

    2.  <span data-ttu-id="b1e3b-472">按住**音量**按钮。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-472">Press and hold the **Volume Up** button.</span></span>

    3.  <span data-ttu-id="b1e3b-473">按下并释放 "**电源**" 按钮。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-473">Press and release the **Power** button.</span></span>

    4.  <span data-ttu-id="b1e3b-474">在设备开始启动后，释放 "**音量**" 按钮。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-474">After the device begins to boot, release the **Volume Up** button.</span></span>

    5.  <span data-ttu-id="b1e3b-475">选择 "**启动配置**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-475">Select **Boot configuration**.</span></span>

    6.  <span data-ttu-id="b1e3b-476">请执行下列操作之一：</span><span class="sxs-lookup"><span data-stu-id="b1e3b-476">Do one of the following:</span></span>

        -   <span data-ttu-id="b1e3b-477">选择 " **PXE 启动**"，然后将其拖动到列表顶部。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-477">Select **PXE boot**, and drag it to the top of the list.</span></span> <span data-ttu-id="b1e3b-478">或者，你可以在网络适配器上向左轻扫以立即启动到设备。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-478">Alternatively, you can swipe left on the network adapter to boot to the device immediately.</span></span> <span data-ttu-id="b1e3b-479">这不会影响启动顺序。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-479">This won't affect the boot order.</span></span>
        -   <span data-ttu-id="b1e3b-480">选择包含启动媒体的 u 盘。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-480">Select the USB flash drive that holds the boot media.</span></span>

3.  <span data-ttu-id="b1e3b-481">选择 "**退出**"，然后选择 "**立即重启**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-481">Select **Exit**, and then select **Restart Now**.</span></span>

4.  <span data-ttu-id="b1e3b-482">出现提示时，选择 "**输入**网络启动服务"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-482">When prompted, select **Enter** for network boot service.</span></span>

5.  <span data-ttu-id="b1e3b-483">Windows PE 将加载到内存中，任务序列向导将启动。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-483">Windows PE will load into memory, and the Task Sequence Wizard will start.</span></span> <span data-ttu-id="b1e3b-484">选择 "**下一步**" 继续。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-484">Select **Next** to continue.</span></span>

6.  <span data-ttu-id="b1e3b-485">选择之前导入的任务序列，然后选择 "**下一步**"。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-485">Select the task sequence that you imported earlier, and then select **Next**.</span></span>

7.  <span data-ttu-id="b1e3b-486">在应用磁盘配置后，系统将提示你为设备指定计算机名称。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-486">After the disk configuration is applied, you'll be prompted to specify a computer name for the device.</span></span> <span data-ttu-id="b1e3b-487">用户界面将根据 Surface Pro 设备的序列号显示推荐的计算机名称。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-487">The user interface will display a recommended computer name based on the serial number of the Surface Pro device.</span></span> <span data-ttu-id="b1e3b-488">你可以接受建议的名称，也可以指定一个新名称。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-488">You can either accept the proposed name or specify a new one.</span></span> <span data-ttu-id="b1e3b-489">按照 "计算机名称分配" 屏幕上的说明进行操作。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-489">Follow the instructions on the computer name assignment screen.</span></span> <span data-ttu-id="b1e3b-490">选择 "**接受**" 时，将开始部署。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-490">When you select **Accept**, the deployment begins.</span></span>

8.  <span data-ttu-id="b1e3b-491">部署过程的其余部分是自动完成的，不会询问更多用户输入。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-491">The rest of the deployment process is automatic and doesn't ask for any more user input.</span></span>

9.  <span data-ttu-id="b1e3b-492">部署任务序列完成配置设备后，你将看到以下配置屏幕，该屏幕要求你配置 Microsoft 团队聊天室应用程序设置。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-492">After the deployment task sequence finishes configuring the device, you'll see the following configuration screen that asks you to configure the Microsoft Teams Rooms application settings.</span></span>

    ![Microsoft 团队聊天室应用程序的初始设置屏幕](../media/room-systems-scale-image2.png)

10.  <span data-ttu-id="b1e3b-494">将 Surface Pro 插入 Microsoft 团队聊天室控制台，然后配置应用程序设置。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-494">Plug the Surface Pro into the Microsoft Teams Rooms console, and configure the application settings.</span></span>

11.  <span data-ttu-id="b1e3b-495">验证[Microsoft 团队聊天室](https://support.office.com/article/Skype-Room-Systems-version-2-help-e667f40e-5aab-40c1-bd68-611fe0002ba2)中列出的功能是否帮助正在使用部署的设备。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-495">Validate that the capabilities listed in [Microsoft Teams Rooms help](https://support.office.com/article/Skype-Room-Systems-version-2-help-e667f40e-5aab-40c1-bd68-611fe0002ba2) are working on the deployed device.</span></span>


<span data-ttu-id="b1e3b-496">若要解决安装失败的问题，请检查**SMSTS**文件，该文件将记录配置管理器任务序列中执行的所有步骤。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-496">To troubleshoot a failed installation, check the **SMSTS.log** file, which logs all the steps executed in a Configuration Manager task sequence.</span></span>

<span data-ttu-id="b1e3b-497">SMSTS 文件存储在多条路径中，具体取决于生成过程的阶段。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-497">The SMSTS.log file is stored on one of a number of paths, depending on the stage of the build process.</span></span> <span data-ttu-id="b1e3b-498">检查下表以标识 SMSTS 文件的路径。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-498">Check the following table to identify the path to the SMSTS.log file.</span></span>


| <span data-ttu-id="b1e3b-499">**部署阶段**</span><span class="sxs-lookup"><span data-stu-id="b1e3b-499">**Deployment phase**</span></span>                                                            | <span data-ttu-id="b1e3b-500">**任务序列日志路径**</span><span class="sxs-lookup"><span data-stu-id="b1e3b-500">**Task sequence log path**</span></span>                         |
|---------------------------------------------------------------------------------|----------------------------------------------------|
| <span data-ttu-id="b1e3b-501">在 HDD 格式之前的 WinPE</span><span class="sxs-lookup"><span data-stu-id="b1e3b-501">WinPE, before HDD format</span></span>                                                        | <span data-ttu-id="b1e3b-502">X：\\Windows\\Temp\\smstslog\\smsts</span><span class="sxs-lookup"><span data-stu-id="b1e3b-502">X:\\Windows\\Temp\\smstslog\\smsts.log</span></span>             |
| <span data-ttu-id="b1e3b-503">在 HDD 格式后进行 WinPE</span><span class="sxs-lookup"><span data-stu-id="b1e3b-503">WinPE, after HDD format</span></span>                                                         | <span data-ttu-id="b1e3b-504">C：\\_SMSTaskSequence\\日志\\Smstslog\\smsts</span><span class="sxs-lookup"><span data-stu-id="b1e3b-504">C:\\_SMSTaskSequence\\Logs\\Smstslog\\smsts.log</span></span>    |
| <span data-ttu-id="b1e3b-505">在安装 Configuration Manager 代理之前已部署操作系统</span><span class="sxs-lookup"><span data-stu-id="b1e3b-505">Operating system deployed, before the Configuration Manager agent was installed</span></span> | <span data-ttu-id="b1e3b-506">c：\\_SMSTaskSequence\\日志\\Smstslog\\smsts</span><span class="sxs-lookup"><span data-stu-id="b1e3b-506">c:\\_SMSTaskSequence\\Logs\\Smstslog\\smsts.log</span></span>    |
| <span data-ttu-id="b1e3b-507">操作系统和配置管理器代理已部署</span><span class="sxs-lookup"><span data-stu-id="b1e3b-507">Operating system and the Configuration Manager agent deployed</span></span>                   | <span data-ttu-id="b1e3b-508">% windir%\\System32\\ccm\\log\\Smstslog\\smsts</span><span class="sxs-lookup"><span data-stu-id="b1e3b-508">%windir%\\System32\\ccm\\logs\\Smstslog\\smsts.log</span></span> |
| <span data-ttu-id="b1e3b-509">任务序列执行完成</span><span class="sxs-lookup"><span data-stu-id="b1e3b-509">Task sequence execution complete</span></span>                                                | <span data-ttu-id="b1e3b-510">% windir%\\System32\\ccm\\\\smsts 日志</span><span class="sxs-lookup"><span data-stu-id="b1e3b-510">%windir%\\System32\\ccm\\logs\\smsts.log</span></span>           |

> [!TIP]
> <span data-ttu-id="b1e3b-511">你可以在任务序列期间随时选择**F8**以打开命令控制台，然后获取对 SMSTS 文件的访问权限。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-511">You can select **F8** at any time during the task sequence to open a command console, and then get access to the SMSTS.log file.</span></span>

<span data-ttu-id="b1e3b-512">若要解决 PXE 启动问题，请检查 Configuration Manager 服务器上特定于 PXE 操作的两个日志文件：</span><span class="sxs-lookup"><span data-stu-id="b1e3b-512">To troubleshoot PXE boot issues, check the two log files on the Configuration Manager server that are specific to PXE actions:</span></span>

-   <span data-ttu-id="b1e3b-513">**Pxecontrol**，位于 Configuration Manager 安装日志目录中</span><span class="sxs-lookup"><span data-stu-id="b1e3b-513">**Pxecontrol.log**, located in the Configuration Manager installation logs directory</span></span>

-   <span data-ttu-id="b1e3b-514">**Smspxe**，位于 Configuration Manager 管理点（MP）日志目录中</span><span class="sxs-lookup"><span data-stu-id="b1e3b-514">**Smspxe.log**, located in Configuration Manager Management Point (MP) logs directory</span></span>

<span data-ttu-id="b1e3b-515">有关可用于进一步对 Configuration Manager 安装进行故障排除的日志文件的完整列表，请参阅 Microsoft 终结点配置管理器[日志文件参考](https://docs.microsoft.com/configmgr/core/plan-design/hierarchy/log-files)。</span><span class="sxs-lookup"><span data-stu-id="b1e3b-515">For a complete list of the log files that you can use to further troubleshoot your Configuration Manager installation, see the Microsoft Endpoint Configuration Manager [Log file reference](https://docs.microsoft.com/configmgr/core/plan-design/hierarchy/log-files).</span></span>
