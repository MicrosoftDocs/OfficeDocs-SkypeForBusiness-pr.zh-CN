...
部署涉及资源帐户创建和 Teams 会议室，如部署[Microsoft Teams 会议室 中所述](rooms-deploy.md)。
...
> [!NOTE]
> Microsoft Teams 会议室 2019 Microsoft Teams 2019 Skype for Business Server或 2015 Skype for Business Server，并且可能会加入这些服务托管的会议。
>
> Microsoft Teams 会议室不支持 Lync Server 2013 等早期平台。 Microsoft Teams 会议室世纪Microsoft 365或 DoD Office 365或 DoD 环境运行。
>
...
[会议室系统产品展示](https://products.office.com/microsoft-teams/across-devices/devices/category?devicetype=20&page=1&filterIds=)中提供了所有当前的 Microsoft Teams 会议室设备和捆绑包。
  ...
  |[使用 UC 演示发射器和 ASUS 电脑 (UC-PR) 的 Crestron Flex UC-BX30-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Wall-Mount-Conferencing-Systems/UC-BX30-T)|核心 i5/i7|8 GB |128 GB |
