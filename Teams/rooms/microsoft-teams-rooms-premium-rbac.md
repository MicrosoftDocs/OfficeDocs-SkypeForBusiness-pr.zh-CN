---
title: Microsoft Teams Pro 管理门户中基于角色的访问控制
author: altsou
ms.author: altsou
manager: serdars
ms.reviewer: altsou
...
description: 在 Microsoft Teams 会议室 Pro Management 门户中了解基于角色的访问控制。
f1keywords: ''
...
ms.locfileid: "68218521"
---
# <a name="role-based-access-control-in-the-microsoft-teams-pro-management-portal"></a>Microsoft Teams Pro 管理门户中基于角色的访问控制

Microsoft Teams 会议室 Pro Management 门户中的基于角色的访问控制 (RBAC) 可帮助你管理用户对组织中会议室资源数据的访问权限。 通过将角色分配给门户用户，可以限制他们可以看到和更改的内容。 每个角色都有一组权限，用于确定具有该角色的用户可以在组织中访问和更改哪些用户。

若要创建、编辑或分配角色，帐户必须具有以下权限之一：

- 通过 Azure Active Directory (Azure AD) 全局管理员
- 通过 Microsoft Teams 会议室 Pro 管理门户的托管服务管理员

## <a name="what-is-a-role"></a>什么是角色？

角色定义授予分配给该角色的用户的权限集。 目前，Microsoft Teams 会议室 Pro 管理门户具有三个内置角色：**托管服务管理员**、**站点主管** 和 **站点技术**。 它们涵盖了组织中可能参与管理会议室的用户的一些常见方案。

若要查看角色，请在 Microsoft Teams 会议室 Pro Management 门户的左侧导航中转到 **“角色**”，然后选择任何角色以查看角色的属性、权限和分配。  
...
- **托管服务管理员**：可以完全访问 Microsoft Teams 会议室专业版管理门户。
- **网站主管**：组织会议室，有权访问报表，并可以管理票证。 无法重置注册密钥或更改服务配置。  
- **网站技术**：管理特定会议室的门票。 无权修改服务配置或组织会议室。
...
|    |查看         |&#10004;           |&#10004;           |&#10004;  |
|    |更新         |&#10004;           |&#10004;           |&#10004;  |
|Microsoft Teams 会议室 Pro Management 服务设置    |查看         |&#10004;           |         ||
|    |修改        |&#10004;           |         ||
|角色管理    |查看         |&#10004;           |         ||
|    |修改         |&#10004;           |         ||
...
1. 在 Microsoft Teams 会议室 Pro Management 门户的左侧导航中，转到 **“设置** > **角色**”。
2. 选择 **“创建角色**”。
...
- [Microsoft Teams 会议室 Pro Management 门户](microsoft-teams-rooms-premium.md)
