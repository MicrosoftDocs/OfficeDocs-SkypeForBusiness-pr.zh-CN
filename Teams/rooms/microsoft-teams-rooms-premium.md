...
Microsoft Teams 会议室托管服务是基于云的 IT 管理和监视服务，可使 Microsoft Teams 会议室设备及其外围设备保持最新状态并主动受到监视，从而支持针对出色的用户体验进行优化的环境。

Microsoft Teams 会议室托管服务适用于寻求通过为 Microsoft Teams 会议室设备提供主动管理来改善其会议室体验并快速扩展其占用空间的组织。 该服务允许组织节省时间、资金和专业知识，否则花费在"自己执行"房间管理上。  
...
下面是 Microsoft Teams 会议室托管服务的功能概述。
...
|**客户支持**   |24x7x365 票证支持，通过专用的 Microsoft Teams 会议室托管服务运营中心 (SOC) 。 在适用时代表你向其他主要供应商升级。 有关详细信息，请参阅 [客户支持](#customer-support)。|
...
下面是 Microsoft Teams 会议室托管服务为支持上述功能提供的重要功能摘要。

|功能  |说明  |
|---------|---------|
|**库存管理**   |使用批量导出选项跟踪房间库存，其中列出了会议室设备、外围设备、制造和型号。         |
|**会议室注册**   |通过自行将会议室设备注册到 Microsoft Teams 会议室托管服务，轻松载入。          |
|**聊天室管理**     |用于托管服务功能、见解、管理设置和会议室组管理的客户门户。         |
|**监视**    |应用程序、操作系统、外围设备和固件运行状况监视。 针对由于外围设备运行状况等问题而影响会议体验的问题的自动事件检测。 通过 Microsoft Teams 会议室托管服务门户查看整个房间空间和事件的运行状况概述。|
|**故障排除和修正**     |自动诊断和自动修正（如果适用）。 针对非自动化情况，Microsoft Teams 会议室托管服务 SOC 辅助的事件补救。 用于事件协调的"现在服务"集成。         |
|**更新管理**   |基于客户可配置的部署环的自动化会议应用程序和固件更新业务流程         |
|**见解和建议**   |使用情况、事件、运行状况和总体报告 (历史视图)          |

## <a name="service-prerequisites"></a>服务先决条件

若要使 Microsoft Teams 会议室托管服务保持服务质量，已注册的会议室必须是 [Microsoft Teams 会议室](requirements.md#hardware-requirements)支持的设备，并且必须使用会议室设备完全允许和访问所有必需的 Office [365 URL](/office365/enterprise/urls-and-ip-address-ranges) 和 IP 地址范围来准备环境。 有关详细信息 [，请参阅](rooms-prep.md) Microsoft Teams 会议室文档中的"准备环境"。
...
Microsoft Teams 会议室托管服务通过专用的 Microsoft Teams 会议室托管服务 SOC 支持。 从 Microsoft Teams 会议室托管服务 SOC 与客户通信的主要模式是通过 Microsoft Teams 会议室托管服务门户。 Microsoft Teams 会议室托管服务 SOC 针对系统或组织提出的票证提供第一个响应和适当的升级。

|  |  |
|---------|---------|
|**范围**   |与会议室应用、会议室设备和外围设备相关的事件包含在 Microsoft Teams 会议室托管服务支持中。|
|**受众**  |仅 IT 操作         |
|**支持的语言**    |英语         |
|**通过门户支持可用性**   | 24X7      |
...
|---------|---------|---------|
|**服务配置**   |         |         |
|Microsoft Teams 会议室 Windows 配置的调查和指导，包括 Microsoft Teams 会议室应用设置、第一方网络配置、第一方软件设置，以及推荐的电源设置和配置。     |不直接属于 Microsoft Teams Room 应用的任何第三方软件配置和调查。 此外，需要第一方窗口或 Microsoft Teams Room 应用设置外部配置的任何特定于 OEM 的配置。         |第三方标准支持渠道         |
|**会议室帐户设置**    |         |         |
...
|**会议体验**   |         |         |
|应请求提供调查 Microsoft Teams 会议室应用的会议设置中的问题，以及正确配置设备上服务质量的指南。      |此范围内不包括通话质量问题或网络相关问题的根本原因分析或调查。         |Microsoft 主流支持         |
|**修正、载入和持续**     |         |         |
|客户会获得指南，指导其房间符合 Microsoft Teams 会议室托管服务在载入时建议的标准    |有关内部自定义软件映像或不符合 Microsoft Teams 会议室托管服务建议的软件版本指南的调查不在范围内。          |         |
