...
ms.locfileid: "60842514"
---
# <a name="get-started-driving-adoption-of-microsoft-teams"></a>开始推动采用 Microsoft Teams

通过推动Microsoft Teams，你可以提供卓越的用户体验，并提升公司的业务价值。 我们的目标是快速启动并运行，以便你可以开始使用 Teams。 本指南重点介绍用户采用Teams，并依赖于环境的技术准备情况，本文档的其他部分将对此进行介绍。
...
在此Teams采用计划中，我们按采用阶段 、下一部分所述，分阶段组织步骤Teams特定[指南](#adoption-phases)。
...
- **规模**- 这是一个广泛的部署阶段，在此阶段中，Teams所有员工启用新功能。 在此阶段，组织的规模将确定这是一个"大项目"，该项目将同时为所有员工启用 Teams，或者是否按区域、业务部门或其他员工群体细分方法实现此目标。 在此阶段，将转移到持续交付模型。 员工、领导和业务部门希望扩展其 Teams 并且需要培训和参与，以了解如何最好地使用 Teams Microsoft 365 或 Office 365 的其他功能。

其中每个采用阶段都取决于用户对应用环境Teams。 让我们开始吧！
