...
我们正在管理中心中积极推出升级Microsoft Teams工具，它很快就会[](manage-teams-skypeforbusiness-admin-center.md)在你的租户上推出。 一旦可用，就可以在设置共存和升级设置 中查找有关迁移 [用户的信息](./setting-your-coexistence-and-upgrade-settings.md)。
...
|---|---|---|
| [5](upgrade-basic.md#step-5) | 群岛 + 通知Skype for Business用户<br> (用户当前处于岛屿模式（默认 (，请使用此命令 | ```Grant-CsTeamsUpgradePolicy -PolicyName IslandsWithNotify -Identity $SipAddress```<br>*(例如，$SipAddress='TestUser@contoso.com')* |
