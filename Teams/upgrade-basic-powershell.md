...
我们正在 Microsoft [Teams](manage-teams-skypeforbusiness-admin-center.md)管理中心积极推出升级工具，你的租户中很快就会提供该工具。 一旦可用，就可以在"设置共存和升级设置"中查找有关迁移 [用户的信息](https://aka.ms/SkypeToTeams-SetCoexistence)。
