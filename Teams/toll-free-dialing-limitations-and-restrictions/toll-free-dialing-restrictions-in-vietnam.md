...
| 批注、限制和访问问题  <br/> | 120 XX XXX number 格式适用于越南电讯国际（VTI）和 VNPT （越南和电信）固定和移动网络。 <br/> <br/> 从2018年6月起，不能从 Mobifone 的移动网络调用 120 XX XXX 号格式。 <br/> <br/>**注意：** Mobifone &amp; VINAPHONE 是 VNPT 的一部分。 The number format 122 XXX XX network coverage: Viettel (fixed and mobile). 根据越南的电信部，允许的最长通话时间为2小时。 |
