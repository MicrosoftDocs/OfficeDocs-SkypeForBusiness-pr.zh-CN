...
---
# <a name="toll-free-dialing-restrictions-in-chile"></a>智利的免费拨号限制
...
|国家/地区 ISO 代码  <br/> |CL  <br/> |
|已覆盖的岛/地区  <br/> |不适用  <br/> |
|未覆盖的岛/区域  <br/> |在复活节岛无法访问。  <br/> |
|有线/固定线路可用性  <br/> |部分。 请参阅注释。  <br/> |
|移动网络可用性  <br/> |部分。 请参阅注释。  <br/> |
|批注、限制和访问问题  <br/> |可通过 Telefonica 网络使用 188 800 XXX XXX 号码格式。 123 XXXX XXXX number 格式只能从 Entel 网络访问。 两种号码格式均支持移动访问。  <br/> |
