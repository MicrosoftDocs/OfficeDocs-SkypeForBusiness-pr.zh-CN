...
---
# <a name="toll-free-dialing-restrictions-in-belarus"></a>免费电话拨号白俄罗斯中的限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> |8 820 XXXX XXXX  <br/> |
|国家/地区 ISO 代码  <br/> |BY  <br/> |
|岛/区域介绍  <br/> |不适用  <br/> |
|未涵盖岛/区域  <br/> |不适用  <br/> |
|有线固定行可用性  <br/> |是  <br/> |
|移动网络可用性  <br/> |是  <br/> |
|注释、 限制和访问问题  <br/> |Velcom、 MTS，和生命周期的移动网络访问权限。  <br/> |
