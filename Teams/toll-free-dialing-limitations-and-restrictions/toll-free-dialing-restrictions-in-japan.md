...
---
# <a name="toll-free-dialing-restrictions-in-japan"></a>日本的免费电话拨号限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> |00531 XX XXXX  <br/> |
|国家/地区 ISO 代码  <br/> |JP  <br/> |
|岛/区域介绍  <br/> |不适用  <br/> |
|未涵盖岛/区域  <br/> |不适用  <br/> |
|有线固定行可用性  <br/> |是  <br/> |
|移动网络可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |Mobile 网络访问： NTT Docomo、 Au (KDD) 和 Softbank。  <br/> |
