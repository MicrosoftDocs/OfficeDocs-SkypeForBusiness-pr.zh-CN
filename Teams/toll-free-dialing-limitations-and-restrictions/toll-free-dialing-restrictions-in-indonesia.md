...
---
# <a name="toll-free-dialing-restrictions-in-indonesia"></a>免费电话拨号印度尼西亚中的限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> | 001 803 CCC 格式 <br/>  007 803 CCC 格式 <br/> |
|国家/地区 ISO 代码  <br/> |ID  <br/> |
|岛/区域介绍  <br/> |不适用  <br/> |
|未涵盖岛/区域  <br/> |不适用  <br/> |
|有线固定行可用性  <br/> |是  <br/> |
|移动网络可用性  <br/> |部分。 请参阅注释。  <br/> |
|注释、 限制和访问问题  <br/> |在更大的范围内提供两种号码格式。 从 PT Telkom 网络，包括 Telkomsel 和 XL 移动访问号码 007 803 CCC 格式格式。 号码格式 001 803 CCC XXXX 可通过 Indosat 网络访问。 Mobile： 矩阵的移动电话 （前缀 0855年、 0858年、 0815 和 0816年） 仅。  <br/> |
