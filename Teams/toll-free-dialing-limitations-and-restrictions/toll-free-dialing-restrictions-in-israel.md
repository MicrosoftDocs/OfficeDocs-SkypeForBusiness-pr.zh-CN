...
---
# <a name="toll-free-dialing-restrictions-in-israel"></a>免费电话拨号以色列中的限制
...
|:-----|:-----|
|是免费调用可用？  <br/> |是  <br/> |
|拨号格式  <br/> | 1-80 94 X 格式 <br/>  1-80-92 X 格式 <br/> |
|国家/地区 ISO 代码  <br/> |IL  <br/> |
|岛/区域介绍  <br/> |不适用  <br/> |
|未涵盖岛/区域  <br/> | 无法从巴勒斯坦领土访问。 <br/> |
|有线固定行可用性  <br/> |是  <br/> |
|移动网络可用性  <br/> | 部分。 请参阅注释。 <br/> |
|注释、 限制和访问问题  <br/> |Mobile access: No access from Paltel &amp; Jawal/Watania mobile networks.  <br/> |
