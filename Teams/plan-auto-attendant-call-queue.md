...
ms.locfileid: "60045728"
---
# <a name="plan-for-teams-auto-attendants-and-call-queues"></a>规划Teams自动助理和呼叫队列

自动助理允许您设置菜单选项，以便根据呼叫者输入路由呼叫。 菜单选项，例如"对于销售，请按 1。  对于"服务按 2"，对于自动助理，让组织提供一系列选项，引导呼叫者快速到达其目的地，而无需依赖人工接线员来处理传入呼叫。
...
- 对于要[直接拨打](getting-service-phone-numbers.md)的每个资源帐户，至少有一个 Microsoft 服务号码、连接号码、直接路由号码或混合号码
 - 服务号码可能是收费或免费号码
...
- 0 (0) 将调用方重定向到操作员。 该自动助理的接线员已配置为组织中 **的人**。
