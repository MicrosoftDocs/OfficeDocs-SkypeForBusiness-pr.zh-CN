...
管理[中心](manage-apps.md)中的"Microsoft Teams"页面是查看和管理组织Teams应用的地方。 例如，可以看到应用的组织级状态和属性、批准新的自定义应用或将其上传到组织的应用商店、在组织级别阻止或允许应用，以及管理组织范围内的应用设置。
...
> [!NOTE]
> 虽然"审阅权限和许可"选项不可用于 Teams 服务管理员，并且他们无法向应用授予组织范围的管理员许可，但 Teams 服务管理员可以在应用的"权限"选项卡上查看内容。  例如，Teams服务管理员可以单击"Azure Active Directory"链接，在门户中查看应用Azure AD详细信息。 
...
RSC 权限在应用清单中定义，而不是在Azure AD。 将应用添加到团队时，需要授予对 RSC 权限的许可。 有关详细信息，请参阅[RSC (资源特定的) 。 ](/microsoftteams/platform/graph-api/rsc/resource-specific-consent)
...
- [终结点中的权限和Microsoft 标识平台许可](/azure/active-directory/develop/v2-permissions-and-consent)
- [资源特定的许可Teams](resource-specific-consent.md)
- [RSC (资源特定的) ](/microsoftteams/platform/graph-api/rsc/resource-specific-consent)
- [在](https://aka.ms/PR132)Ignite 2020 Teams应用中导航 (应用生命周期) 