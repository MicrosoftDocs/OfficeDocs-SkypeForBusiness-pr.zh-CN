...
如果允许您的组织中的用户授予许可，并且如果一个或多个用户授予了对特定应用的同意，则还将看到相同的消息，告知你已授予同意，以及 Azure AD 门户中应用的页面的 Azure Active Directory 链接。
...
RSC 权限在应用清单中定义，而不是在Azure AD。 将应用添加到团队时，需要授予对 RSC 权限的许可。 有关详细信息，请参阅 [RSC (资源 ](/microsoftteams/platform/graph-api/rsc/resource-specific-consent)) 。
...
- [特定资源许可Teams](resource-specific-consent.md)
- [RSC (特定于资源) ](/microsoftteams/platform/graph-api/rsc/resource-specific-consent)
- [在](https://aka.ms/PR132) Ignite 2020 会话Teams应用生命周期 (导航) 