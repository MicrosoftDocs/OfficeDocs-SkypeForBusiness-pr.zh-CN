...
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|2020 年 10 月 5 日<br> *(完成)*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| 启用 Teams 会议策略，将会议录制保存到 OneDrive for Business 和 SharePoint，而不是将 Microsoft Stream (经典) |
|从 2021 年 1 月 7 日开始推出<br> *(完成)*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|所有新的 Teams 会议录制都将保存到 OneDrive for Business 和 SharePoint，除非你通过修改组织的 Teams 会议策略并显式将其设置为 Stream 来延迟此 **更改**。 将策略报告为流是不够的。 需要将策略值显式设置为 **Stream。**|
...
|从 2021 年 7 月 7 日开始逐步推出 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|**企业 (教育版和 GCC 版的所有)**<br>无法将新的会议录制保存到 Microsoft Stream (经典) ;即使所有客户将 Teams 会议策略更改为"流式传输"，也将自动将会议录制保存到 OneDrive for Business 和 SharePoint。<br><br> 我们建议客户为了更好地控制组织中的变化，每当你熟悉更改时都选择加入，而不是等待更改发生。 |
...
字幕有助于为具有各种能力的观看者创建包容性内容。 作为所有者，您可以隐藏会议录制内容上的字幕，不过会议脚本在 Teams 上仍然可用，除非将其删除。 
