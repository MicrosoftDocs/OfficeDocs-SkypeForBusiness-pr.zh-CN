...
将用户升级到 Teams的关键先决条件是部署混合连接。

有关详细信息，请参阅[在 Skype for Business Server 与 Skype for Business Online 之间部署混合连接](/skypeforbusiness/skype-for-business-hybrid-solutions/deploy-hybrid-connectivity/deploy-hybrid-connectivity)
...
有关详细信息，请参阅[直接路由电话系统注意事项](./direct-routing-landing-page.md)。 如果你计划使用呼叫计划，请参阅我们的指南，将你的电话号码转移到[Teams。](phone-number-calling-plans/transfer-phone-numbers-to-teams.md)