...
Tasks 同时作为应用和频道中的选项卡存在。 该应用显示来自 To Do 的单个任务和 Planner 中的团队任务。 该选项卡仅显示团队任务。
...
**我的任务** 显示用户的个人任务。 **共享计划** 显示全队当前任务，且包含任何作为选项卡添加到频道的任务列表。 请注意“任务”、“要执行”和“规划器”中的任务之间的以下关系：
...
Teams 中定制的一线应用体验为拥有 [F 许可证](https://www.microsoft.com/microsoft-365/enterprise/frontline#office-SKUChooser-0dbn8nt)的用户固定 Teams 中最相关的应用。 固定应用包括任务、Walkie Talkie、Shifts 和审批。 默认情况下，此功能处于启用状态，为一线员工提供根据其需求定制的现新体验。
