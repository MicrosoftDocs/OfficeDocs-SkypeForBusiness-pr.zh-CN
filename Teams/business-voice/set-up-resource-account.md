---
title: 设置Microsoft Teams 电话系统资源帐户
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
description: 了解如何设置一个Microsoft Teams 电话系统自动助理使用的资源帐户。
appliesto:
- Microsoft Teams
...
创建资源帐户后，需要分配一个Microsoft Teams 电话 *-* 虚拟用户许可证或 *Teams 电话许可证*。

1. 打开Microsoft 365 管理中心，使用全局管理员用户登录。这通常是用于注册帐户的帐户Microsoft 365。
1. 在左侧导航窗格中，转到" <a href="https://admin.microsoft.com/Adminportal/Home#/users" target="_blank">**用户""活动** > **用户"**</a>。
1. 选择资源帐户。
1. 在"**许可证和应用"选项卡** 上的"许可证 **"下**，Microsoft Teams 电话 **标准 - 虚拟用户"**。
1. 选择 **"保存更改"，** 然后选择" **关闭"**。
