...
商务语音通过将 Microsoft 365 电话系统功能封装到单个易于管理的捆绑包中来实现所有这些功能。 你无需担心是否选择了正确的计划或功能，一切都已为你准备就绪。 由于电话系统是 Teams 的一部分，因此可以将任何电脑、Mac 或移动设备转换为可使用你的商务语音电话号码的电话。

如果你的组织员工不超过 300 人，并且你使用的是以下 Microsoft 365 订阅之一，那么商务语音非常适合你：
