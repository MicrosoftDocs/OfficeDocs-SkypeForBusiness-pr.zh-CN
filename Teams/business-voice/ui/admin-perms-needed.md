...
你好! 你已被发送到此页面，因为你尝试购买Microsoft 365 商务语音许可证，但没有这样做所需的[](../whats-business-voice.md)权限。

首先，如果您意外单击了某个链接，但并不想尝试购买 Business Voice 许可证，则只需关闭此页面。 如果 **想购买** Business Voice 许可证 (或者想要了解有关 Business Voice) ，请继续阅读！
...
- **未登录**- 确保登录到要管理的组织的全局管理员或Microsoft 365 Office 365帐户。
- **登录到错误的组织**- 如果有权访问多个组织或Microsoft 365 Office 365，请确保登录到正确的组织。 你需要注销当前帐户Office 365帐户，并登录到要管理的组织中帐户。
- **业务语音在用户当前位置不可用** - 业务语音当前在有限数量的国家和地区中可用。 请查看 [什么是业务语音](../whats-business-voice.md) ，查看企业语音是否可用。

## <a name="what-if-im-still-having-trouble"></a>如果我仍遇到问题，该做什么？

如果已检查上述所有原因，但仍无法购买 Business Voice，请参阅联系商业产品支持 [人员 - 管理员帮助](/microsoft-365/admin/contact-support-for-business-products)。