...
可以使用名为 CallingLineIdentity 的策略控制 电话系统 用户的入站和出站呼叫的来电显示。
  
无论 PSTN 连接如何，呼叫电话系统 ID 功能都可用：
...
最终用户可以使用 Skype for Business 桌面客户端中的 **设置** 选项卡将其来电显示设置为匿名，选择"呼叫最终用户 ("（如果由管理员) 启用），然后选择"隐藏我的电话号码和个人资料信息"作为所有 **呼叫**。 在 Teams 中，用户可以转到右上角的个人资料图片，选择 **"设置 呼叫"，** 然后在"来电显示"下，选择"隐藏我的电话号码和个人资料信息"作为所有  >  **呼叫。** 
...
电话系统与 Azure AD 中的用户关联，则会显示外部电话号码的已调用 ID。 如果电话号码不在 Azure AD 中，则会显示显示名称提供的电话号码（如果可用）。
