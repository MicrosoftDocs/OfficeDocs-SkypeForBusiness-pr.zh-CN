...
| ![描述后续步骤的图标](media/audio_conferencing_image9.png)<br/>后续步骤|<ul><li>使用下面的列表生成准备情况计划的想法。 选择最相关的活动（或添加你自己的活动）来设计针对你的组织进行了优化的准备情况计划。 请记住，使用广泛范围（适用于整个组织）和目标（适用于 laggards 或特定角色）市场活动以获得最大结果。</li></ul>|
