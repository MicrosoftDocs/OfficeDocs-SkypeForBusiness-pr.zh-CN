...
有关直接路由是否是适用于组织的解决方案的信息，请参阅 [电话系统直接路由](direct-routing-landing-page.md)。 有关先决条件和规划部署的信息，请参阅 [规划直接路由](direct-routing-plan.md)。

> [!Tip]
> 还可以观看以下会话，了解直接路由的好处、如何规划它以及如何部署它 [：Microsoft Teams 中的直接路由](https://aka.ms/teams-direct-routing)。
