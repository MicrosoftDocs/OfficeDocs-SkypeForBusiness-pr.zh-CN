...
ms.collection:
- M365-collaboration
description: 了解团队模板以及如何在Microsoft Teams管理中心管理它们。
f1.keywords:
- CSH
ms.custom:
...
>
> - GCC环境中的团队模板不支持敏感度标签。 从模板流创建团队中的敏感度标签选项将不会应用于团队。

## <a name="overview"></a>概述

Microsoft Teams中的团队模板是围绕业务需求或项目设计的团队结构的定义。 作为管理员，可以使用模板轻松地在整个组织中部署一致的团队。 使用模板，用户可以使用预定义的设置、通道和应用快速创建丰富的协作空间。

可以在Microsoft Teams管理中心或使用 PowerShell 管理团队模板。 可以使用我们提供的预生成模板，还可以 [创建自己的自定义模板](#create-your-own-team-templates)。 还可以[应用模板策略](#apply-team-template-policies)来控制哪些模板可用于用户Teams。

本文概述了如何在Teams管理中心使用团队模板。 你将了解模板中支持的属性、我们提供的预生成模板、模板大小限制、如何创建和管理模板等。

> [!NOTE]
> 用户可以在Teams应用中[从预建或自定义团队模板创建团队](https://support.microsoft.com/office/create-a-team-from-a-template-a90c30f3-9940-4897-ab5b-988e69e4cd9c)。 开发人员还可以使用 Microsoft Graph 以编程方式从预构建的团队模板创建团队。 若要了解详细信息，请参阅[使用 Microsoft Graph 的团队模板开始](get-started-with-teams-templates.md)。
...
> [!NOTE]
> 我们将在将来的Microsoft Teams版本中添加更多模板功能，因此请查看有关受支持属性的最新信息。

## <a name="pre-built-team-templates-in-the-teams-admin-center"></a>在Teams管理中心预建团队模板

下面是预构建的团队模板，可在Teams管理中心使用。 预生成的模板是我们为特定行业创建的模板。 若要查看这些模板，请在Teams管理中心的左侧导航中转到 **Teams** >  **Team 模板**。
...
|载入员工|`com.microsoft.teams.template.OnboardEmployees` | 频道： <ul><li>常规</li> <li>公告</li> <li>员工聊天</li> <li>培训</li></ul>应用：<ul><li>Wiki</li><li>社区</li><li>任务</li><li>员工想法</li><li>Power Automate</li><li>公告</li><li>里程碑</li></ul>|
...
| 危机通信 |`com.microsoft.teams.template.CollaborateOnAGlobalCrisisOrEvent`| 频道： <ul><li>常规<li>公告</li><li>世界新闻</li><li>内部 comms</li><li>外部 comms</li><li>审批请求</li><li>客户升级</li><li>执行更新</li><li>规划</li><li>后勤工作</li></ul>应用： <ul><li>网站</li><li>任务</li><li>问题发布者</li><li>审批</li><li>公告</li><li>OneNote</li><li>Power Automate</li><li>SharePoint</li></ul>|
...
有关详细信息，请参阅[Teams的限制和规范](limits-specifications-teams.md)。
...
若要查看团队模板，请在Teams管理中心的左侧导航中转到 **Teams** >  **Team 模板**。 选择模板以查看更多详细信息，包括它包含的通道和应用。
...
若要控制用户在[创建团队](https://support.microsoft.com/office/create-a-team-with-team-templates-702a2977-e662-4038-bef5-bdf8ee47b17b)Teams中看到的模板，可以设置模板策略并将其分配给组织中的用户和组。 若要了解详细信息，请参阅[Teams管理中心中的管理团队模板](templates-policies.md)。
