...
对于提供音频会议订阅的国家/地区，此更改并未发生，但我们当前未启用设置通信积分。 这些特定国家/地区包括俄罗斯、韩国和台湾。
...
对于每分钟计费的拨出呼叫数超过租户拨出分钟数池的 (呼叫，或者对不在区域 [A](audio-conferencing-zones.md) 国家和地区列表中的目标的呼叫) ，呼叫及其关联的费率主要基于呼叫的目标，而不是组织者或发起拨出呼叫的参与者的国家和地区。 例如，如果呼叫法国的电话号码是由美国或法国的会议参与者发起的，将按相同的费率进行计费。
