...
|**聚**  |           |            |           |设备将自动重启并安装所选固件。|   |
|          |三重奏 8500  |5.9.5.3182  |7.2.2.1094 |   |   |
|          |三重奏 8800  |5.9.5.3182  |7.2.2.1094 |   |   |
...
|          |IP-DECT 访问点 IPBSx        |11.8.8     |11.8.8     |IP-DECT 访问点 |   |
...
> [!NOTE]
> Ascom 手机从 Ascom IP-DECT 服务器通过空中接收固件更新。
