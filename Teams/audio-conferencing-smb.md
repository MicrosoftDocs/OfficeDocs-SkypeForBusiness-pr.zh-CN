...
> [!NOTE]
> 如果你拥有 Enterprise E5 或 Microsoft 365 商务语音，你将不能使用免费的音频会议优惠，因为这些许可证已包含音频会议。
...
有两种类型的号码可用于会议网桥。 你可以像本文 **前面** (设置音频会议"部分一样使用 [](#set-up-audio-conferencing)共享号码或) **号码**。 下面是有关每个项的更多信息。
