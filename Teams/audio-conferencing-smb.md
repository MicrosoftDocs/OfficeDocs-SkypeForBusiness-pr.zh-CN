...
现在，会议组织者可以在会议中安排Outlook。 在Outlook，转到"**日历**"，然后选择"新建Teams **会议**"按钮。 会议拨入号码和会议 ID 将自动添加到发送给会议与会者的会议邀请中。 若要了解有关详细信息，请参阅[在 Teams 中安排Outlook会议](https://support.microsoft.com/office/schedule-a-teams-meeting-from-outlook-883cc15c-580f-441a-92ea-0992c00a9b0f)。
...
有两种类型的号码可用于会议网桥。 可以使用 **共享号码 (** 如本文前面"设置音频会议"部分 [](#set-up-audio-conferencing)所述或) **号码**。 下面是有关每个项的更多信息。
...
2. 选择 **"** 音频会议"**旁边的**"编辑"，然后在"音频会议"窗格中，在"收费电话号码"或"免费号码"列表中选择一个数字，然后选择"应用 **"。** 
