...
### <a name="move-from-staffhub-to-shifts-in-teams"></a>将从 StaffHub 移动到团队中的变化
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解 StaffHub 退休和转换到团队中的变化</h3>
                    </div>
                </div>
            </div>
        </div>
...
### <a name="set-up-and-manage-shifts"></a>设置和管理引进
