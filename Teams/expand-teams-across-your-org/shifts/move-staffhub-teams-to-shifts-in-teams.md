...
#### <a name="get-a-list-of-all-users-on-staffhub-teams-that-have-team-members-that-arent-provisioned-with-an-azure-ad-account"></a>获取包含未使用 Azure AD 帐户预配的团队成员的 StaffHub 团队中的所有用户的列表
...
#### <a name="provision-the-account"></a>设置帐户
...
- 删除非预配帐户, 然后使用 UPN 重新添加帐户。
    1. 运行[StaffHubUser](https://docs.microsoft.com/powershell/module/staffhub/Remove-StaffHubUser?view=staffhub-ps) cmdlet 以从 StaffHub 团队中删除未预配的帐户。
