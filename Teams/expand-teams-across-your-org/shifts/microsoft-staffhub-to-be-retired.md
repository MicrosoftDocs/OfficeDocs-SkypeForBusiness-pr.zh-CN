...
这些更改是我们的持续努力的一部分，使每位员工能够Microsoft 365。 借助 Teams 中为一线员工提供的功能，您的组织中的每个员工都将能够使用 Teams 简化工作日、与同事协作以及访问信息和专业知识以帮助他们完成最佳工作。
...
2019 年 1 月，Teams开始提供以前在 Microsoft StaffHub 中提供的班次。 此功能允许经理计划和分发排班计划，以及团队成员有机会查看其日程安排，以及从移动设备提出日程安排更改请求。 若要了解有关详细信息，请参阅在应用程序中管理组织的[Shifts Teams。](manage-the-shifts-app-for-your-organization-in-teams.md)
...
Teams StaffHub 创建且未移动到 Teams 则自 StaffHub 停用后，不再可以查看或移动。 但是，你随时都可以Teams，在 Shifts 应用中创建排班计划。
...
Shifts 适用于所有Teams浏览器，包括最新版本的 Microsoft Edge、Internet Explorer、Google Chrome 和 Mozilla Firefox。 有关详细信息，请参阅获取[适用于 Teams 的客户端](../../get-clients.md)。
...
Shifts 数据存储在北美和西欧的数据中心的 Azure 中。 SharePoint利用Microsoft 365组，并使用相同的存储和支持。
...
默认情况下，Teams所有组织都启用此功能。 向用户Teams许可证，以控制个人对Teams。 有关详细信息，请参阅[在Teams启用登录](../../Office-365-set-up.md)和管理用户[对 Teams](../../user-access.md)的访问权限。
...
Teams支持与 Skype for Business 共存。 有关详细信息，请参阅了解[Teams 和](../../teams-and-skypeforbusiness-coexistence-and-interoperability.md)Skype for Business 共存和互操作性，以及将 Teams 与 Skype for Business 一起用于组织的[迁移和互操作性Skype for Business。](../../migration-interop-guidance-for-teams-with-skype.md)
...
文件共享功能（即经理将文件分发给团队成员的功能）由 SharePoint Online 在后端提供。 创建团队后，Microsoft 365自动为该组预配组。
...
一线员工可以在排班中一目了然地查看其整个工作计划。 作为路线图的一部分，我们将支持Outlook日历的本机集成。 同时，使用 Microsoft Flow 设置与 Teams 和 Google 日历Outlook Shifts 的集成。
...
在移动应用中，点击 **屏幕左上角** 的"更多"，转到"发送  >  **设置"** 或"**报告问题"。** 同样，在桌面和 Web 应用中，在屏幕左下角，转到"帮助  >  **分享** 想法"或"**报告问题"。**