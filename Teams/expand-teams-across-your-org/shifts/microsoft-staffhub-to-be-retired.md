...
ms.locfileid: "46778054"
---
# <a name="microsoft-staffhub-has-been-retired"></a>Microsoft StaffHub 已停用

2020年6月30日生效，Microsoft StaffHub 已停用。 我们正在将 StaffHub 功能构建到 Microsoft 团队中。 今天，团队包括 "倒班" 应用，用于计划管理，而其他功能将随着时间的推移而推出。
...
StaffHub 已停止为2020年6月30日的所有用户工作。 尝试打开该应用的任何人都将显示一条消息，引导他们下载团队。
...
我们致力于提供出色的用户体验，并将 StaffHub 的独有功能带入团队。
...
若要从团队中的倒班访问 StaffHub 团队，您必须在2020年6月30日之前将 StaffHub 团队移到团队，这是在 StaffHub 已停用。

#### <a name="what-happens-if-i-didnt-move-a-staffhub-team-to-shifts-in-teams"></a>如果我没有将 StaffHub 团队移动到团队倒班，会发生什么情况？

使用 StaffHub 创建的团队在 StaffHub 已停用时，无法再查看或移动到2020年6月30日。 但是，你可以随时开始使用团队并在倒班应用中创建班次计划。

如果你有一个与未移动到团队的 Office 365 组相关联的 StaffHub 团队，而你现在想要创建一个团队班次与该 Office 365 组相关联的计划，请联系支持人员。
...
#### <a name="are-there-differences-between-the-shifts-desktop-and-web-apps-and-the-mobile-ios-and-android-apps"></a>在切换桌面和 web 应用以及移动 (iOS 和 Android) 应用之间有何区别？

对于经理，桌面和 web 应用经过优化，可创建团队、添加成员、构建和发布日程安排，并与团队共享内容。 经理通常使用移动应用来批准请求、向团队发送快速消息、呼叫团队成员以及协作处理。 

对于团队成员，已优化移动应用以查看其日程安排，查看他们在一天中正在处理的人员、上班打卡、下班打卡、设置可用性、请求下班时间、交换或提供倒班和开放班次。 用户可以在桌面和 web 应用和移动应用中执行的操作有所不同。 我们正在处理功能奇偶校验。
...
倒班以下列语言提供：简体中文、英语 (美国 ) 、西班牙语、俄语、日语、法语、巴西语、德语、朝鲜语、意大利语、繁体中文、荷兰语、土耳其语、瑞典语、丹麦语和挪威语。 我们计划将来添加其他语言支持。  
...
每个用户都必须具有符合条件的计划的活动 Microsoft 365 或 Office 365 许可证，并且必须分配有团队许可证。 

#### <a name="how-do-i-enable-teams-in-my-organization"></a>如何在我的组织中启用团队？

默认情况下，将为所有组织启用团队。 将团队许可证分配给用户以控制对团队的个人访问。 有关详细信息，请参阅在 [你的组织中启用团队](../../Office-365-set-up.md) 和 [管理用户对团队的访问权限](../../user-access.md)。
...
#### <a name="does-each-user-need-to-have-a-microsoft-365-or-office-365-account-or-azure-active-directory-azure-ad-account"></a>每个用户是否需要将 Microsoft 365 或 Office 365 帐户或 Azure Active Directory (Azure AD) 帐户？

是的，使用团队和团队成员在团队中的倒班的每位经理和团队成员必须在 (Azure AD) 中拥有 Microsoft 365 或 Office 365 帐户，并且必须为其分配有效的许可证。
...
通过 Microsoft 团队 PowerShell 模块和 Skype for Business PowerShell 模块管理团队。 有关详细信息，请参阅 [团队 PowerShell 概述](../../teams-powershell-overview.md)。 目前，没有可用于管理班次的特定 PowerShell cmdlet。  
