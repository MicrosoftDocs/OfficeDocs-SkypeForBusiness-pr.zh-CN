...
**其他服务：** Viva Connections、SharePoint、Power Platform 和 Power Apps
...
详细信息：使用 Microsoft Teams 和 Bookings 应用 [虚拟访问](bookings-virtual-visits.md)
...
## <a name="set-up-the-fundamentals"></a>设置基础知识
