...
---
# <a name="facilitate-user-adoption-of-your-new-online-phone-system"></a><span data-ttu-id="78114-103">帮助用户采用新的在线电话系统</span><span class="sxs-lookup"><span data-stu-id="78114-103">Facilitate user adoption of your new online phone system</span></span>

<span data-ttu-id="78114-104">手机可以是用户生命线。</span><span class="sxs-lookup"><span data-stu-id="78114-104">A phone can be a user's lifeline.</span></span> <span data-ttu-id="78114-105">从传统电话系统切换到在线电话系统是用户工作方式的一个显著变化，可能会对工作效率产生负面影响。</span><span class="sxs-lookup"><span data-stu-id="78114-105">Switching from a traditional phone system to an online phone system represents a significant change in the way users work, and can negatively affect productivity.</span></span> <span data-ttu-id="78114-106">通过此更改，花时间通知、指导和支持用户有助于确保积极的用户体验并最大化投资回报。</span><span class="sxs-lookup"><span data-stu-id="78114-106">Taking time to inform, guide, and support users through this change can help ensure a positive user experience and maximize your return on investment.</span></span>

<span data-ttu-id="78114-107">本文包含可自定义的电子邮件模板，可帮助用户了解其新电话系统。</span><span class="sxs-lookup"><span data-stu-id="78114-107">This article contains customizable email templates to help inform users about their new phone system.</span></span> <span data-ttu-id="78114-108">自定义并发送相应的电子邮件，以便与特定语音部署保持一致。</span><span class="sxs-lookup"><span data-stu-id="78114-108">Customize and send the appropriate emails to align with your specific voice deployment.</span></span> <span data-ttu-id="78114-109">为了便于个性化，我们使用了括号来指示部分，但我们建议你添加特定于组织的消息，使公告最适用于你的用户。</span><span class="sxs-lookup"><span data-stu-id="78114-109">We've used brackets to indicate sections for easy personalization, but we recommend that you add organization-specific messaging to make the announcement most relevant for your users.</span></span> <span data-ttu-id="78114-110">如果适用于部署，请将对"Teams"的所有引用替换为"Skype for Business"。</span><span class="sxs-lookup"><span data-stu-id="78114-110">If applicable for your deployment, replace all references to "Teams" with "Skype for Business."</span></span>

## <a name="email-number-1-send-three-weeks-before-launch"></a><span data-ttu-id="78114-111">电子邮件编号 1：在启动前三周发送</span><span class="sxs-lookup"><span data-stu-id="78114-111">Email number 1: Send three weeks before launch</span></span>

<span data-ttu-id="78114-112">主题行：</span><span class="sxs-lookup"><span data-stu-id="78114-112">Subject line:</span></span>

```
IMPORTANT ANNOUNCEMENT about your office desk phone
```

<span data-ttu-id="78114-113">电子邮件正文：</span><span class="sxs-lookup"><span data-stu-id="78114-113">Body of email:</span></span>
...
## <a name="email-number-2-send-one-week-before-launch"></a><span data-ttu-id="78114-114">电子邮件编号 2：在启动前一周发送</span><span class="sxs-lookup"><span data-stu-id="78114-114">Email number 2: Send one week before launch</span></span>

<span data-ttu-id="78114-115">主题行：</span><span class="sxs-lookup"><span data-stu-id="78114-115">Subject line:</span></span>

```
ACTION REQUESTED: Are you ready for your new phone system?
```

<span data-ttu-id="78114-116">电子邮件正文：</span><span class="sxs-lookup"><span data-stu-id="78114-116">Body of email:</span></span>
...
## <a name="email-number-3-send-on-launch-day"></a><span data-ttu-id="78114-117">电子邮件编号 3：在启动日发送</span><span class="sxs-lookup"><span data-stu-id="78114-117">Email number 3: Send on launch day</span></span>

<span data-ttu-id="78114-118">主题行：</span><span class="sxs-lookup"><span data-stu-id="78114-118">Subject line:</span></span>

```
IMPORTANT NOTICE: Your new phone system is live
```

<span data-ttu-id="78114-119">电子邮件正文：</span><span class="sxs-lookup"><span data-stu-id="78114-119">Body of email:</span></span>
...
## <a name="email-number-4-send-two-weeks-after-launch"></a><span data-ttu-id="78114-120">电子邮件编号 4：在启动后发送两周</span><span class="sxs-lookup"><span data-stu-id="78114-120">Email number 4: Send two weeks after launch</span></span>

<span data-ttu-id="78114-121">主题行：</span><span class="sxs-lookup"><span data-stu-id="78114-121">Subject line:</span></span>

```
FEEDBACK REQUESTED: Your new phone system
```

<span data-ttu-id="78114-122">电子邮件正文：</span><span class="sxs-lookup"><span data-stu-id="78114-122">Body of email:</span></span>
