...
- Phone System
- seo-marvel-apr2020
description: 分步指南，详细说明如何在 Microsoft 365 中为组织设置Teams 电话系统服务。
...
ms.locfileid: "61262136"
---
# <a name="set-up-teams-phone-in-your-organization"></a>在Teams 电话中设置帐户

下面是有关在 Microsoft 365 中设置 Teams 电话 的分步Microsoft 365。 在每个步骤的末尾都提供指向其他详细信息的链接。

## <a name="step-1-make-sure-that-teams-phone-is-available-in-your-country-or-region"></a>步骤 1：确保Teams 电话的可用区域
...
若要将电话系统和呼叫计划许可证分配给单个用户，步骤与分配Microsoft 365相同。  也可以批量向多个用户分配许可证。 有关详细信息，请参阅[分配Microsoft Teams许可证](teams-add-on-licensing/assign-teams-add-on-licenses.md)。

如果呼叫计划不适用于你的国家/地区，则还有其他用于连接到 PSTN 公用电话交换网 (的选项) 。  有关详细信息，请参阅 [PSTN 连接选项](pstn-connectivity.md)。
...
3. 在左侧导航窗格中，转到"语音  >    >  **电话""** 添加新号码"，然后单击"新建 **服务号码"。**
...
如果要转移来自当前服务提供商或运营商的服务号码，需要向 Microsoft 手动提交转网订单。 你需要为每种服务号码（收费和免费 (）提交单独的转站订单) 使用授权书 (LOA) 。 在 LOA (授权书) ，必须选择正确的服务编号类型。 联系 Microsoft 支持部门时，请指定要转移服务号码 (而不是用户或订阅者号码 *) ，* 否则并发呼叫容量可能不足以处理呼叫量。 如果您想要转接电话号码，或执行其他操作与您的电话号码，请参阅 [管理您的组织的电话号码](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) 。
...
- 对于自动助理，你可以向自动助理分配专用号码 **，Teams** 中心语音自动助理并按照  >    >  提示进行分配。  有关详细信息，请参阅 [设置云自动助理](create-a-phone-system-auto-attendant.md)。
...
如果未设置通信信用额度计费并将通信信用额度许可证分配给你的用户，并且你的组织 (根据你的呼叫计划或音频会议计划在你的国家/地区) 中用完了分钟数，则这些用户将无法进行呼叫或从音频会议会议拨出。 有关详细信息，包括建议的资金金额，请参阅 [什么是通信信用额度？](what-are-communications-credits.md) 和为组织设置通信 [信用额度](set-up-communications-credits-for-your-organization.md)。
