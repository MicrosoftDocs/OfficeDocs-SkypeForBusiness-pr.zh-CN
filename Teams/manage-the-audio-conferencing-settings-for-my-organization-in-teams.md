...
### <a name="enable-or-disable-using-the-microsoft-teams-admin-center"></a>使用管理中心启用Microsoft Teams禁用
...
### <a name="enable-or-disable-using-windows-powershell"></a>启用或禁用Windows PowerShell
...
### <a name="reset-the-meeting-conference-id-using-the-microsoft-teams-admin-center"></a>使用管理中心重置Microsoft Teams ID
...
### <a name="reset-a-conference-organizers-pin-using-the-microsoft-teams-admin-center"></a>使用会议管理中心重置Microsoft Teams PIN
...
### <a name="send-an-email-using-the-microsoft-teams-admin-center"></a>使用管理中心Microsoft Teams发送电子邮件
...
### <a name="set-invite-phone-numbers-using-the-microsoft-teams-admin-center"></a>使用管理中心设置Microsoft Teams电话号码
...
### <a name="set-the-meeting-experience-when-callers-join-a-meeting-using-the-microsoft-teams-admin-center"></a>当呼叫者使用管理中心加入会议时设置Microsoft Teams体验
...
### <a name="enable-or-disable-email-from-being-sent-to-audio-users"></a>启用或禁用向音频用户发送电子邮件
...
### <a name="see-primary-and-secondary-languages-using-the-microsoft-teams-admin-center"></a>使用管理中心查看主要Microsoft Teams辅助语言

1. 在左侧导航中，转到“**会议**” > “**会议网桥**”。

2. 从列表中选择一个电话号码，然后单击"编辑 **"。**

3. 在"默认语言"和"备用语言"下 **选择** (**可选) 。**

4. 单击“**保存**”。

请参阅[设置音频会议自动助理语言](set-auto-attendant-languages-for-audio-conferencing-in-teams.md)。
  
## <a name="see-audio-conferencing-dial-in-numbers-using-the-microsoft-teams-admin-center"></a>使用管理中心查看音频Microsoft Teams拨入号码
