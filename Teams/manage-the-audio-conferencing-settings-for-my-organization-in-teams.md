...
4. 在“**重置会议 ID?**”窗口中，单击“**重置**”。 如果启用了将电子邮件发送给用户，将自动创建会议 ID 并使用新的会议 ID 向用户发送邮件。 默认情况下处于启用状态。
...
3. 在“**网桥设置**”窗格中，启用或禁用“**会议进入和退出通知**”。
    ...
    默认情况下，此选项处于启用状态。 如果你禁用此选项，则默认情况下，当有人进入或离开会议时，已加入会议的用户不会收到通知。
...
## <a name="see-audio-conferencing-dial-in-numbers"></a>查看音频会议拨入号码


1. 在左侧导航中，转到“**会议**” > “**会议网桥**”。 

2. 从列表中选择一个电话号码，然后单击“**编辑**”。 你可以在此处：
    
  - 查看 Office 365 设置用于音频会议的电话号码。 
