---
title: 开始使用 Microsoft 团队
description: 使用此说明性指导可帮助您推出您前几个团队，以便您可以开始使用 Microsoft 团队聊天、 工作组和通道和会议。
layout: LandingPage
...
appliesto:
- Microsoft Teams
ms.openlocfilehash: 8585b9ef55ae30d5d4ff4d4ec7dd21f749857f52
ms.sourcegitcommit: 139b3d3b7fcc1dd7fba7fd14ff34e4ffdfcc7eeb
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/08/2018
ms.locfileid: "26215677"
---
# <a name="get-started-with-microsoft-teams"></a>开始使用 Microsoft 团队



<ul class="panelContent cardsF">
    <li>
        <a href="https://review.docs.microsoft.com/en-us/MicrosoftTeams/get-started-with-teams-1?branch=v-lanac-getstarted-working">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>快速入门</h3>
                        <p>指导您完成小型的团队推出，以便您可以了解团队和规划组织范围内部署</p>
                    </div>
                </div>
            </div>
        </div>
