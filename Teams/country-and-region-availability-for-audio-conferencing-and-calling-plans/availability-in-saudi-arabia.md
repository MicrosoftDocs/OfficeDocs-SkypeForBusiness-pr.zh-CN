...
以下是适用于沙特阿拉伯的 Skype for business 和 Microsoft 团队的 Office 365 服务。
...
|**功能**|**详细信息**|
|:-----|:-----|
|你可以获取哪些首都或大城市的收费电话号码？  <br/> | 利雅得（[按请求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)） <br/> |
