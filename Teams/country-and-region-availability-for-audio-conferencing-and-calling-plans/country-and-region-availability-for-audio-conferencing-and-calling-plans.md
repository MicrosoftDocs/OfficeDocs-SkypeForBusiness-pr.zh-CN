...
- LIL_Placement
- seo-marvel-mar2020
description: 了解某个国家或地区是否提供音频会议、电话系统、通话套餐、通信额度以及收费和免费电话号码。
...
**如果要查找包含所有国家和地区的电子表格，请下载并保存 [云语音功能国家/地区可用性电子表格](https://download.microsoft.com/download/d/b/6/db6992c5-ec9a-4b02-8742-59df17dd90a7/country-and-region-availability-(v-19OCT2021)-(en-us).xlsx)**。

***

验证其中一项 Teams 服务是否可用后，可以看到 [Microsoft Teams 附加许可](../teams-add-on-licensing/microsoft-teams-add-on-licensing.md) ，以帮助你购买许可证并将其分配给用户。
...
有时，组织中的人员需要使用电话拨入会议。 Teams 包含适用于这种情况的音频会议功能！ 人员可以使用电话（而不是移动设备或电脑上的 Teams 应用）拨入会议。 当你决定要为组织使用音频会议时，请为组织中要安排/主持 **音频会议的** 每个人购买一个音频会议许可证。
  
借助音频会议，用户可以使用收费和免费电话号码拨入会议。 在以下国家/地区中，如果组织已启用音频会议，收费号码会自动作为共享音频会议号码分配给组织。 可以从其他城市向组织分配专用收费和免费号码。

> [!IMPORTANT]
> 没有包含所有音频会议拨入号码列表的资源。 若要了解你的地区或国家/地区是否有可用的拨入电话号码，请转到 **Teams 管理中心** > **“语音** > **电话号码**”，单击“ **添加**”，然后单击“ **新建服务号码**”。 使用“国家/地区”、“省/直辖市/自治区/地区”和“城市”列表来筛选搜索结果。 如果要查找免费服务号码，请从 **“州/地区**”列表中选择“**免费”。**
...
在音频会议中，“*呼叫我*”功能用于允许其他人加入电话拨入式会议。 使用本文中的下拉列表搜索国家/地区，并查看此功能是否可用。

> [!CAUTION]
> 可能无法拨出免费电话号码或免费电话号码，因为某些免费电话号码仅在某个国家/地区的特定国家或地区内可用。 例如，如果从美国拨出到巴西的免费号码，则呼叫可能不会成功，因为该呼叫不是来自巴西境内或来自巴西境内的特定区域。 拨出免费号码的功能因拨打的免费号码的限制而有很大差异。 遗憾的是，我们无法控制此行为，因此，你的体验可能会有所不同，具体取决于拨打的免费号码和免费号码的限制。
  
可以使用 [通信点数](../what-are-communications-credits.md)从会议拨出到下面未列出的另一个国家/地区。 对于这些用户，你需要 [为组织设置通信额度](../set-up-communications-credits-for-your-organization.md)。

### <a name="phone-system"></a>电话系统

使用电话系统，可以创建自动助理和呼叫队列， (使用收费或免费号码) 来接听组织的来电。 为用户添加通话套餐时，他们可以使用 Teams 处理基本的呼叫控制任务，例如拨打和接听呼叫、转接呼叫以及静音和取消静音呼叫。 **电话系统** 用户单击其通讯簿中的姓名，Teams 将向该用户发出呼叫。 若要拨打和接听电话， **电话系统** 用户使用其移动设备、带笔记本电脑或电脑的头戴显示设备，或者使用 Teams 的众多 IP 电话之一。

其中一些位置的收费电话号码的可用性可能在任意给定时间因库存级别而异。 除了为个人用户获取电话号码外，还可以搜索和获取音频会议 (等服务的收费或免费电话号码) 、自动助理和呼叫队列。 这些称为“服务号码”。 若要获取电话号码，请参阅[获取服务电话号码](../getting-service-phone-numbers.md)。 不过，对于用户，在将通话套餐分配给他们后，你可以分配用户电话号码，以便他们能够拨打和接听电话。 若要查找这些电话号码，请参阅[为用户获取电话号码](../getting-phone-numbers-for-your-users.md)。 还可以参阅[为用户分配、更改或删除电话号码](../assign-change-or-remove-a-phone-number-for-a-user.md)。

[电话系统定价](https://www.microsoft.com/microsoft-teams/voice-calling?#office-StandaloneSKU-pkdogb9)
...
### <a name="microsoft-teams-calling-plans"></a>Microsoft Teams 通话套餐

除了电话系统，通话套餐还允许用户拨打和接听电话。 首先，用户 (订阅者) 电话号码 (而不是要分配给该用户的服务号码) ，然后分配通话套餐。 有三种类型的通话套餐可用： **国内**、 **国际** 和 **即用即付**。 有关更多详细信息，请参阅 [Microsoft Teams 通话套餐](../calling-plans-for-office-365.md) 。

还可以查看 [Microsoft Teams 附加许可选项](../teams-add-on-licensing/microsoft-teams-add-on-licensing.md) 以获取许可信息。
...
除了为个人用户获取电话号码外，还可以搜索和获取音频会议 (等服务的收费或免费电话号码) 、自动助理和呼叫队列。 这些称为“服务号码”。
  
下面列出了可以获取用于音频会议和通话套餐的收费服务号码的首都和主要城市。 使用 **Teams 管理中心** 从这些位置获取收费服务号码。
  
如果要获取收费或免费服务号码，可以查看 [获取服务电话号码](../getting-service-phone-numbers.md)。 如果已有要从其他提供商转移的收费或免费服务号码，请参阅 [管理组织的电话号码](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md)。
...
如果未设置通信点数并向用户分配许可证，并且组织 (时间不足，具体取决于通话套餐或音频会议计划或国家/地区) ，则他们将无法拨打电话或拨出会议。 若要了解详细信息（包括建议的资金数额），请参阅[什么是通信点数？](../what-are-communications-credits.md)
