...
- Phone System
- Calling Plans
description: 以下是适用于智利的 Skype for Business 和 Microsoft Teams 的 Microsoft 365 和 Office 365 服务。
...
以下是适用于智利的 Skype for Business 和 Microsoft Teams 的 Microsoft 365 和 Office 365 服务。
...
|:-----|:-----|
|是否可购买音频会议？  <br/> |是  <br/> |
|是否会为音频会议自动分配电话号码？  <br/> |是，适用于：<br/><ul><li> San一 (仅向智利境内组织) </ul>如果你需要专用电话号码，请参阅[获取 Skype for Business 和 Microsoft Teams 的服务电话号码](../getting-service-phone-numbers.md)。  <br/> |
...
|**功能**|**Details**|
|:-----|:-----|
|你可以获取哪些首都或大城市的收费电话号码？  <br/> |圣安东尼奥  <br/> **注意：** 仅适用于智利内的组织。           |
