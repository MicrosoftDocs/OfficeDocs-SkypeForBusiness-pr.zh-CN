...
|:-----|:-----|
|是否可购买音频会议？  <br/> |是  <br/> |
|是否会为音频会议自动分配电话号码？  <br/> |是，适用于：<br/><ul><li> 东京</ul> 如果你需要专用电话号码，请参阅[获取 Skype for Business 和 Microsoft Teams 的服务电话号码](../getting-service-phone-numbers.md)。  <br/> |
...
> [!IMPORTANT]
> 仅通过 SoftBank 提供，适用于基于日语的租户。 有关详细信息，请参阅[SoftBank Calling for Office 365) 。](https://aka.ms/SoftBankVoicePlan)

|**功能**|**详细信息**|
|:-----|:-----|
|是否可购买通话套餐？  <br/> |是，请参阅[SoftBank Calling for Office 365。](https://aka.ms/SoftBankVoicePlan)  <br/> |
|通话套餐的可用分钟数  <br/> |请参阅[SoftBank Calling for Office 365。](https://aka.ms/SoftBankVoicePlan) <br/> |
|是否可以拨打呼出电话？  <br/> |请参阅[SoftBank Calling for Office 365。](https://aka.ms/SoftBankVoicePlan) <br/> |

> [!IMPORTANT]
> 若要删除由 SoftBank (提供的) 用户 (，请) SoftBank 联系。
> 若要更新用户或订阅者 (紧急) 由 SoftBank (提供的) ，请直接联系 SoftBank。
> 有关详细信息，请参阅[SoftBank Calling for Office 365。](https://aka.ms/SoftBankVoicePlan)

## <a name="toll-and-toll-free-numbers-for-services"></a>服务的收费和免费电话号码

|**功能**|**详细信息**|
|:-----|:-----|
|你可以获取哪些首都或大城市的收费电话号码？  <br/> |东京  <br/> |
|是否提供收费电话号码？  <br/> |是 <br/> |
|是否提供免费电话号码？  <br/> |是  <br/> |
