...
以下是适用于乌拉圭的 Skype for business 和 Microsoft 团队的 Microsoft 365 和 Office 365 服务。
...
|**功能**|**Details**|
|:-----|:-----|
|你可以获取哪些首都或大城市的收费电话号码？  <br/> | 蒙得维的亚（[按请求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)） <br/> |
