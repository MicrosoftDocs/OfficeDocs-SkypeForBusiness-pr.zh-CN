...
以下是适用于 Skype for business 的 Office 365 服务和适用于科威特的 Microsoft 团队。
...
|**功能**|**详细信息**|
|:-----|:-----|
|你可以获取哪些首都或大城市的收费电话号码？   | 科威特城（[按要求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)） <br/> |
