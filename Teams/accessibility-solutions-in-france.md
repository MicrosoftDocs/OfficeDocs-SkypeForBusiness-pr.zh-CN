...
Skype Entreprise dans Office 365 prend également en charge diverses fonctionnalités d'accessibilité. Pour les personnes qui utilisent des lecteurs d'écran， l'interface utilisateur de Skype Entreprise peut être parcourue à l'aide du clavier， et des pages d'aide sont fournies pour expliquer ：
...
La reconnaissance utilise de Windows peut également aider les personnes à mobilité réduite et bénéficier de l'utilisation de commandes utilises plut àt que du clavier ou de la souris. Les instructions pour activer la reconnaissance sur sur un坐标ur fonctionnant sous Windows 10 sont disponibles ici： [https://support.microsoft.com/fr-fr/help/17208/windows-10-use-speech-recognition](https://support.microsoft.com/fr-fr/help/17208/windows-10-use-speech-recognition).
...
Pour aider ses clients à évaluer l'accessibilité， Microsoft 建议 une documentation qui décrit comment Skype Entreprise et Microsoft Teams se conforment à la norme européenne EN 301 549 relative aux exigences d'accessibilités applicables aux marchés publics des produits et services liés aux TIC (Technologies de l'Information et de la Communication) en Europe. Des copies des rapports EN 301 549 sont jointes en一es.
