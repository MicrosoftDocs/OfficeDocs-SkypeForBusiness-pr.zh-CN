...
ms.locfileid: "62055682"
---
# <a name="phone-numbers-for-audio-conferencing-in-microsoft-teams"></a>Microsoft Teams 中用于音频会议的电话号码

当您为会议设置 **音频** Microsoft Teams，拨入电话号码将自动分配给您的组织。 若要查看分配给音频会议网桥的电话号码，在 Microsoft Teams 管理中心，转到"会议网桥  >  **"。** 有关详细信息，请转到 [查看音频会议号码列表](see-a-list-of-audio-conferencing-numbers-in-teams.md)。
...
当Microsoft Teams用户安排会议时Outlook Outlook Web App，为用户设置的默认音频会议号码将包含在会议邀请中。 如果要为一个或多个用户选择不同的默认号码，可以通过以下方法更改该号码：访问"用户"，选择该用户，然后编辑用户的"音频会议"设置。 请参阅 [设置邀请中包含的电话号码](set-the-phone-numbers-included-on-invites-in-teams.md)。
