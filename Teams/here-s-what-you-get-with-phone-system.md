...
|[保留音乐](music-on-hold.md) | 当来自公共电话交换网或 PSTN 网络的外部呼叫被置于保留状态时， (服务定义或) 自定义音乐。 除了对呼叫队列进行呼叫外，此功能还适用于一对一 PSTN Teams呼叫。 此功能与其他平台提供保留通知奇偶校验。 |
