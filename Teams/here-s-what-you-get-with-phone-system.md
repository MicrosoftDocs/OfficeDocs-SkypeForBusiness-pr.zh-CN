...
|[保留音乐](music-on-hold.md) | 当来自公共电话交换网 (PSTN) 的外部呼叫处于保留状态时，播放由服务定义的默认音乐或租户管理员上传的自定义音乐。 此功能适用于一对一 PSTN 到 Teams呼叫以及呼叫队列的呼叫。 此功能与其他平台提供保留通知奇偶校验。 |
...
|[仅支持 (](direct-routing-plan-media-bypass.md)直接Teams的媒体旁路)   | 为了提高性能，媒体保留在会话边界控制器 (SBC) 与客户端之间，而不是通过 电话系统。 |
