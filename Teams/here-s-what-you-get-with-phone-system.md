...
|保留音乐 | 将于2019年6月推出, 当来自公共交换电话网络 (PSTN) 的外部呼叫处于暂候状态时, 电话系统将播放该服务定义的默认音乐。  除了对呼叫队列拨打电话之外, 此功能适用于一对一的 PSTN 到团队通话。 此功能提供与其他平台的保持状态通知奇偶校验。 (所有其他平台在用户置于保持状态时提供视觉提示, 但 PSTN 呼叫者无法知道。) 第一次发布时, 管理员无法配置此功能。| 
