...
|[云语音邮件](set-up-phone-system-voicemail.md)  | 当用户收到语音邮件时，它作为电子邮件Exchange以语音邮件作为附件发送到其邮箱。 用户可以在经过认证的桌面电话上以及所有客户端或Teams Skype for Business收听消息。 自 2017 年 3 月起已添加对语音邮件转录的支持，默认情况下，所有组织和用户都启用此功能。 <br> 请注意，*用户不需要* 电话系统许可证，也不需要启用语音才能使用云语音邮件功能。    |
