...
-   在团队内Microsoft Teams任何用户都可以加入的公共团队，以提供有关其体验的反馈 (请记住，公共组限制为 5000 名) 。
...
在此旅程中，你将在自己的环境中发现员工的突出表现，他们使用 Microsoft Teams 时展现的创造力会给你带来惊奇和欣喜。 我们建议你广泛地分享这些突出表现。 这将鼓励其他人创新、培训可能更早采用曲线的用户，并奖励那些已花时间思考如何充分利用其Microsoft Teams的用户。 为了保持你的采用推进力，每个季度设定一个用于发现一定数量的突出表现的可衡量目标很有用。
