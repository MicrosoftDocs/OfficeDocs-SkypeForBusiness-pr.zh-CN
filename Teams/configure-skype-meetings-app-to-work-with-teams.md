...
f1.keywords:
- NOCSH
description: 管理员可以使用 Microsoft Teams 管理中心配置Skype会议应用以使用Teams
ms.collection:
- M365-collaboration
appliesto:
- Microsoft Teams
...
- [什么是Skype会议应用 (Skype for Business Web应用) ](https://support.office.microsoft.com/article/what-is-skype-meetings-app-skype-for-business-web-app-1ff3d412-718a-4982-8ff2-a4992608cdb5)
