...
- Teams 导出 API 目前以预览版提供。 它仅对具有 API 所需许可证 [的用户和租户](https://aka.ms/teams-changenotification-licenses) 可用。 将来，Microsoft 可能会要求你或你的客户根据通过 API 访问的数据量支付额外费用。
...
>[!NOTE]
>有关 chatMessage 资源的更多详细信息，请参阅 [chatMessage 资源类型一](https://docs.microsoft.com/graph/api/resources/chatmessage) 文。
