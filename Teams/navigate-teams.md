...
audience: admin
ms.reviewer: ''
description: 本文介绍 Kaizala 用户如何在 Microsoft Teams 中导航。
f1.keywords: ''
...
### <a name="conversations-in-teams-chat-vs-team-channel"></a>Teams 聊天与团队频道中的对话
...
## <a name="moving-your-kaizala-groups-to-microsoft-teams"></a>将 Kaizala 组移动到 Microsoft Teams
...
### <a name="use-teams-and-channels-to-create-a-hierarchical-group-structure"></a>使用 Teams 和频道创建分层组结构
...
![Teams 层次结构图表](media/kaizala-to-teams-image7.png)

![Teams 频道的区域经理和应用商店助理界面](media/kaizala-to-teams-image27.png)

若要了解详细信息，请参阅我们在 [Microsoft Teams 中组织团队的最佳做法](best-practices-organizing.md)。

### <a name="use-teams-and-channels-to-broadcast-important-news"></a>使用 Teams 和频道广播重要新闻
...
![设置 Teams 频道审查](media/kaizala-to-teams-image8.png)

**步骤 2**：设置邮件格式。
创建公告以通知团队成员重要新闻或操作。

   ![Teams 公告](media/kaizala-to-teams-image9.png)
...
![通过 Teams 与你的人员互动](media/kaizala-to-teams-image12.png)

Teams 平台允许你通过集成到 Microsoft Teams 以及现成的 Microsoft 365 应用程序和第三方应用来使用现有的组织工具。 Microsoft Teams 中现在有 800 多个外部应用程序可用。

### <a name="polls-surveys-and-checklists-in-teams"></a>Teams 中的轮询、调查和清单
...
![在 Teams 中轮询应用模板](media/polltemplatecompose.gif)
...
### <a name="jobs-in-teams"></a>Teams 中的作业
...
### <a name="quiz-in-teams"></a>Teams 中的测验
...
![在 Teams 视图中创建测验](media/quiz-app-template-compose-view.gif)  

### <a name="training-in-teams"></a>Teams 中的培训
...
![在 Teams 视图中创建培训](media/training-app-template-compose-view.gif)
...
## <a name="moving-kaizala-custom-solutions-to-microsoft-teams"></a>将 Kaizala 自定义解决方案移动到 Microsoft Teams

![将 Kaizala 移动到 Teams](media/kaizala-to-teams-image1.png)
...
## <a name="kaizala-management-portal-to-teams-admin-center"></a>Kaizala 管理门户到 Teams 管理员 中心
...
## <a name="kaizala-group-dissolution"></a>凯扎拉集团解散
...
### <a name="to-move-a-kaizala-group-to-teams"></a>将 Kaizala 组移到 Teams
...
### <a name="to-switch-to-kaizala-group-to-read-only"></a>切换到 Kaizala 组以 **只读**
...
## <a name="export-kaizala-tenant-data"></a>导出 Kaizala 租户数据
...
## <a name="deleting-a-kaizala-group"></a>删除 Kaizala 组
