...
#### [来宾体验](guest-experience.md)
#### [授予来宾访问权限](teams-dependencies.md)
#### [启用或禁用来宾访问](set-up-guests.md)
...
## [查看应用权限并授予 Microsoft Teams 管理中心的管理员许可](app-permissions-admin-center.md)
...
### [概述](rooms/index.md)
### 套餐
#### [Microsoft Teams 会议室规划概述](rooms/rooms-plan.md)
#### [版本支持](rooms/rooms-lifecycle-support.md)
#### [发行说明](rooms/rooms-release-note.md)
#### [准备环境](rooms/rooms-prep.md)
...
#### [使用 Exchange 内部部署（混合）](rooms/with-exchange-on-premises.md)
#### [配置控制台](rooms/console.md)
#### [配置身份验证](rooms/rooms-authentication.md)
#### [加入第三方会议](rooms/third-party-join.md)
#### [通过使用 Microsoft Endpoint Configuration Manager](rooms/rooms-scale.md)
#### [利用 Azure Monitor 进行管理](rooms/azure-monitor-deploy.md)
#### [迁移 SRS v1 或 LRS](rooms/lrs-migration.md)
#### [内容照相机](rooms/content-camera.md)
### 管理
#### [管理概述](rooms/rooms-manage.md)
#### [维护和操作](rooms/rooms-operations.md)
#### [组织中的支持团队](rooms/known-issues.md)
#### [具有 Azure Monitor 的设备](rooms/azure-monitor-manage.md)
#### [具有 XML 文件的设置](rooms/xml-config-file.md)
#### [使用恢复工具](rooms/recovery-tool.md)
...
## [在 Teams 中使用 NDI® 技术](use-NDI-in-meetings.md)
...
### [音频会议的国家和地区可用性](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
...
### [适用于美国和加拿大的延长拨出分钟数](dial-out-minutes-canada-us.md)
...
#### [用于管理组织的工具](upgrade-to-teams-on-prem-tools.md)
#### [有关 Skype for Business 本地版组织的注意事项](upgrade-to-teams-on-prem-considerations.md)
#### [实现升级](upgrade-to-teams-on-prem-implement.md)
#### [Teams 和 Skype for Business 共存](upgrade-to-teams-on-prem-coexistence.md)
#### [PSTN 注意事项](upgrade-to-teams-on-prem-pstn-considerations.md)
...
### Teams 模板
#### [使用 Teams 医疗保健模板](expand-teams-across-your-org/healthcare/healthcare-templates-admin-console.md)
#### [适用于医疗保健的 Teams 模板](expand-teams-across-your-org/healthcare/healthcare-templates.md)
### [管理列表应用](manage-lists-app.md)
### [管理任务应用](manage-tasks-app.md)
### Teams 中的班次
#### [Teams 中的排班](expand-teams-across-your-org/shifts-for-teams-landing-page.md)
...
### [使用 Microsoft 365 管理中心创建 Microsoft 365 资源帐户](devices/resource-account-ui.md)
...
#### [通过 Exchange 使用邮件流规则](https://docs.microsoft.com/microsoft-365/security/office-365-security/create-safe-sender-lists-in-office-365)
...
### [Teams 显示](devices/teams-displays.md)
### [将 Teams 手机升级至 Teams 显示](devices/upgrade-phones-to-displays.md)
### [使用 Intune 部署 Teams 和 Teams 显示](devices/phones-displays-deploy.md)
...
## [Microsoft Teams 中的公共预览版](public-preview-doc-updates.md)