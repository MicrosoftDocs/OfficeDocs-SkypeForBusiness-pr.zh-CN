...
description: 了解如何从Microsoft Teams中的审核日志检索Microsoft 365 合规中心。
appliesto:
- Microsoft Teams
...
有关已审核Teams活动的完整列表，请参阅"Teams活动"和"Teams[班次"。](#shifts-in-teams-activities) [](#teams-activities)
...
有关分步说明，请参阅在合规性[审核日志搜索。](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance#search-the-audit-log)
...
|已更改组织设置   |TeamsTenantSettingChanged         |TeamsTenantSettingChanged 操作由团队中的全局管理员执行以下活动时Microsoft 365 管理中心。 这些活动会影响组织范围的Teams设置。 有关详细信息，请参阅[管理Teams设置](enable-features-office-365.md)。 <br>对于其中每个活动，更改的设置的说明 (显示在) 搜索结果中的"项"审核日志列中。 <ul><li>为组织Teams启用或禁用 **(Microsoft Teams) 。**</li><li>为组织启用或禁用Microsoft Teams Skype for Business之间的互操作性 (Skype for Business **互操作性**) 。</li><li>启用或禁用组织客户端中的组织结构图Microsoft Teams视图 (**组织结构图) 。**</li><li>启用或禁用团队成员安排私人会议 (**私人会议计划) 。**</li><li>启用或禁用团队成员通过频道会议安排 (**频道会议) 。**</li><li>为会议启用或禁用Teams会议 (**视频Skype会议) 。**</li><li>为组织的会议Microsoft Teams启用或禁用屏幕共享 (会议Skype **屏幕**) 。</li><li>启用或禁用添加名为 Giphys (动画图像) Teams动态 (**动画**) 。</li><li>更改组织的内容分级设置 (**内容分级) 。** 内容分级限制可在对话中显示的动画图像类型。</li><li>启用或禁用团队成员将自定义图像（称为 (meme) 从 Internet 添加到团队对话 (Internet 中的可自定义图像) 。 </li><li>启用或禁用团队成员向团队对话添加可编辑图像 (贴纸) 添加到团队对话 (**可** 编辑) 。</li><li>启用或禁用团队成员在组织范围内聊天Microsoft Teams和频道中 (机器人 **) 。**</li><li>为机器人启用特定Microsoft Teams。 这不包括 T-Bot，Teams为组织启用机器人时可用的帮助机器人， (**机器人**) 。</li><li>启用或禁用团队成员在"扩展"或选项卡 (**扩展或选项卡) 。**</li><li>启用或禁用专有机器人的旁加载Microsoft Teams (**机器人** 的旁加载) 。</li><li>启用或禁用用户向频道电子邮件Microsoft Teams频道 (**发送电子邮件) 。**</li></ul>|
...
对 Teams (的成员身份更改，例如通过 Azure Active Directory (Azure AD) ) 、Microsoft 365 管理门户或 Microsoft 365 组 Graph API 添加或删除的用户Teams 审核消息和"常规"频道中的 ，将属性归属到团队的现有所有者，而不是操作的实际发起者。 在这些情况下，请查阅Azure AD或Microsoft 365[组审核日志](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance)以查看相关信息。
...
你可能希望从业务角度关注一个方案，即将外部用户Teams环境。 如果启用了外部用户，则监视其状态是个不错的主意。  可以使用[云应用安全来](/cloud-app-security/what-is-cloud-app-security)识别潜在威胁。
...
用于监视添加外部用户的此策略的屏幕截图允许您命名策略、根据业务需求设置严重性、将严重性设置为 (（在这种情况下为) 单个活动）并创建参数，以便专门监视非内部用户的添加，然后将此活动限制为 Teams。
...
如屏幕截图所示，可以为此策略设置许多不同的参数来监视 Teams 删除，包括严重性、单一或重复操作，以及限制此策略Teams和站点删除的参数。 可以独立于模板完成此操作，或者根据组织需求创建模板，以基于此策略。
...
我们正在努力将异常Teams集成到异常情况检测策略中。 目前，可以针对其他产品设置异常情况检测Office，并针对符合这些策略的用户采取操作项。
