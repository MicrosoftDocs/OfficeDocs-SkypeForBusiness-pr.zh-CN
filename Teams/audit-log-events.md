...
若要查看在 Microsoft 365 中审核的活动的完整列表，请参阅[在 microsoft 365 合规性中心中搜索审核日志](https://support.office.com/article/0d4d0f35-390b-4518-800e-0c7ec95e946c)。
...
通过此策略的屏幕截图，你可以命名策略，根据你的业务需求设置严重性，将其设置为（在本例中为 "单个活动"），然后建立仅用于专门监视非内部用户添加的参数，并将此活动限制为 Microsoft 团队。
