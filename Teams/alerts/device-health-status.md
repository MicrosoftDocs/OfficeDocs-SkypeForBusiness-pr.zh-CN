...
在启动之前，需要租户中的团队/频道创建权限。 [了解更多](https://docs.microsoft.com/microsoft-365/solutions/manage-creation-of-groups?view=o365-worldwide)。
...
|**条件**   |如果设备脱机，可以监视其运行状况。 [详细了解 Teams](https://docs.microsoft.com/microsoftteams/devices/device-management) 管理中心中的设备管理。 |
