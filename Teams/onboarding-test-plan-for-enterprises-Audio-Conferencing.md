...
---
<a name="define-and-document-your-audio-conferencing-in-teams-test-plan-for-enterprises"></a>在企业的团队测试计划中定义和记录你的音频会议 
===============================================================================

在构思阶段中定义并记录团队业务成功和技术实现计划中的音频会议后, 下一步是验证你的组织的预期和要求是否已通过功能得到满足。功能和可用性。 在生产环境中部署试验或最终部署之前, 应执行此验证步骤。
...
在准备评估音频会议功能时, 创建测试支持风险承担者矩阵以确定支持测试阶段所需的角色。
...
| 指导委员会成员    | <ul><li>对音频会议服务部署的整体方向保持关注并提供指导。<li>通过组织内的推动购买, 帮助宣传的战略洞察力。</li></ul>                                                                        | TBD                                                  |
...
| 服务所有者                 | <ul><li>负责音频会议服务的操作。</li><li>充当音频会议服务的所有者。</li></ul>                                                                                                               | TBD                                                  |
...
| 音频会议测试器     | <ul><li>查看测试计划以了解要执行的测试要求、目标、时间线、问题解决和测试用例。</li><li>查看和开发支持音频会议验收和功能要求的测试案例。</li><li>执行测试用例, 并记录测试结果。</li><li>在出现问题时记录缺陷并将其升级到测试主管, 了解优先级和解决方法。</li><li>在确认缺陷解决后, 测试回归以关闭缺陷。</li></ul>                                                                | TBD                                                  |
...
| 音频会议管理员测试 | <ul><li>查看测试计划以了解要执行的测试要求、目标、时间线、问题解决和测试用例。</li><li>查看和开发支持音频会议管理验收和功能要求的测试案例。</li> <li>执行测试用例, 并记录测试用例结果。</li><li>在出现问题时记录缺陷并将其升级到测试主管, 了解优先级和解决方法。</li><li>在确认缺陷解决后, 测试回归以关闭缺陷。</li></ul>                                                                | TBD                                                  |


<table>
<tr><td><img src="media/audio_conferencing_image7.png" alt=""/> <br/>决策点</td><td><ul><li>确定在你的环境中测试音频会议功能所需的测试支持和利益干系人角色。</li><li>确定你为已确定的测试支持和利益干系人角色分配的资源。</li></ul></td></tr>
...
在针对范围内用户定义音频会议功能要求的过程中, 你应该在构想阶段完成的首先步骤之一是[角色分析](https://docs.microsoft.com/MicrosoftTeams/audio-conferencing#assess-environment-and-evaluate-adoption-readiness), 其中定义了音频会议角色和方案。 确定此基准后, 下一步是评估最新团队的公共路线图, 以确定:

-   你将在范围内为用户部署哪些音频会议功能。

-   如果你的当前 Skype for Business、Exchange 和 SharePoint 部署横向, 则预期的用户音频会议功能要求。

-   是否可以确认最新公共路线图中所述的音频会议功能是否满足你在部署的时间线中的用户、功能和范围要求

> [!TIP]
> 有关在部署范围内识别音频会议功能的最新团队路线图可在<https://aka.ms/O365Roadmap>中找到。

既然已经定义了音频会议角色和功能, 接下来的评估条件将是与团队的互操作性体验。 有关互操作性体验以及可用配置选项的其他信息, 请参阅[Microsoft 团队和 Skype for business 互操作性](https://docs.microsoft.com/microsoftteams/teams-and-skypeforbusiness-coexistence-and-interoperability)。

#### <a name="audio-conferencing-feature-definition"></a>音频会议功能定义

> [!TIP]
> 
> 下面是可用于记录要评估的音频会议管理和用户组功能的音频会议定义模板的示例。

| 企业级   | 协作会议    | 平台和设备   | IT 专业人员  | 其他业务组, 特定于站点  | 最新团队路线图中满足的要求 |
|-------------------------------------------|----------------------------|------------------|------------------------|-------------------|-------------------|
| <ul><li>通过以下方式安排音频会议会议:<ul><li>Outlook 计划外接程序</li><li>Teams 客户端</li></ul></li><li>托管频道和私人会议</li><li>托管会议最多80个与会者</li><li>音频会议功能</li><li>匿名联接</li><li>会议厅支持</li><li>参与者管理</li><li>将其他参与者设为静音</li><li>通过团队客户端进行设备管理</li></ul> |<ul><li>会议生命周期管理在会议期间/期间/发布期间</li><li>桌面共享</li><li>对话</li><li>沉浸式会议体验</li><li>应用程序共享</li><li>在应用程序共享中提供/获取控制权</li></ul> |<ul><li> Windows, Mac 团队客户端会议功能支持</li><li>浏览器团队客户端会议功能支持:<ul><li>样式</li><li>Microsoft Edge</li></ul></li><li>iOS 和 Android 团队客户端会议功能支持</li></ul> | <ul><li>通话质量诊断门户</li><li>租户音频会议策略</li><li>启用呼叫质量分析 (CQD)</li></ul> | <ul><li>基于企业便携式电脑映像验证团队会议功能</li><li>特定语言支持</li><li>为给定用户方案或特定网站应用的 GPO 设置</li></ul> | 是  |
...
#### <a name="audio-conferencing-test-case-status"></a>音频会议测试案例状态
