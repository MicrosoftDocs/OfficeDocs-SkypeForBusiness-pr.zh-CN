...
ms.locfileid: "37931810"
---
# <a name="use-advisor-for-teams-to-help-you-roll-out-microsoft-teams"></a>使用 Advisor for Teams 帮助你推出 Microsoft Teams

[!INCLUDE [preview-feature](includes/preview-feature.md)]

Advisor for Teams（预览版）为你提供 Microsoft Teams 推出的分步指导。 它将评估 Office 365 租户环境并确定更新或修改所需的最常用配置，帮助你成功推出 Teams。 然后，Advisor for Teams 会创建一个服务管理团队（在 Teams 中），你要推出的每个工作负载都有对应的频道。服务管理团队中的每个工作负载都有一个综合 Planner 计划，其中包括每个工作负载的所有推出任务。  使用此 Planner 计划将任务分配给负责推出的每个阶段的人员 - 包括项目经理、Teams 和 Office 365 管理员、支持人员以及你的采用和用户就绪性团队。 每个推出任务包含成功完成任务所需的所有指南和资源。
...
第一次使用 Advisor for Teams 时，它将在 Teams 中为你创建一个服务管理团队。 它为你要推出的每个工作负载添加频道。 
...
Advisor 创建服务管理团队后，Advisor 机器人会传送以下消息。

>**欢迎使用 Microsoft Teams 中的服务管理团队！**
>  
...
>- 转到 Teams 中的服务管理团队。 选择工作负载频道（例如，“聊天”、“团队”、“频道”和“应用”），选择“**Planner**”选项卡以开始使用。
> 
>若要了解有关 Advisor for Teams 的详细信息，请参阅[使用 Advisor for Teams 推出 Microsoft Teams](use-advisor-teams-roll-out.md)。
>
> [!IMPORTANT]
> Advisor for Teams 机器人仅用于向服务管理团队发送欢迎信息。 不会收集额外的数据。
...
### <a name="can-i-delete-the-service-management-team"></a>是否可以删除服务管理团队？
在 Advisor for Teams 创建服务管理团队后，可以像管理任何其他团队那样管理该团队，包括可以删除该团队。 请注意，如果不使用 Teams 管理中心删除该团队，系统将报告该团队存在。

### <a name="can-i-add-or-remove-channels-in-the-service-management-team"></a>我是否可以在服务管理团队中添加或删除频道？
可以，创建服务管理团队后，你将按照管理任何其他团队的方式管理频道。

### <a name="can-i-add-or-remove-project-team-members-in-the-service-management-team"></a>我是否可以在服务管理团队中添加或删除项目团队成员？
可以，创建服务管理团队后，你将按照管理任何其他团队的方式管理它。

### <a name="can-i-modify-the-planner-plans"></a>能否修改 Planner 计划？
可以，Advisor for Teams 创建服务管理团队后，你应更新 Planner 计划，使其可以为你的 Teams 推出提供最佳支持。 可以像任何其他 Planner 计划那样修改任何项 - 存储桶、任务和任务详细信息。


### <a name="can-i-modify-the-forms-survey"></a>能否修改 Forms 调查？
可以，Advisor for Teams 创建服务管理团队后，可以按需修改 Forms 调查。
...
可以，针对希望部署 Teams 的所有客户，FastTrack 会利用 Advisor for Teams。 它们可以协助使用 Advisor for Teams（如果需要）进行的服务管理团队的初始设置，还可在 Teams 推出过程中提供特定主体的所需支持。

### <a name="can-i-use-advisor-for-teams-with-a-partner"></a>能否在与合作伙伴协作的过程中使用 Advisor for Teams？
可以，在使用 Advisor for Teams 时，你也可以使用部署合作伙伴进行 Teams 部署。 如果你的合作伙伴是 CSP 并代表你对你的租户进行管理，则他们可以使用 Advisor for Teams 来创建服务管理团队，并协助你执行整个项目。 此外，你还可以将各合作伙伴作为来宾添加到服务管理团队，允许他们作为整个项目团队的成员参与，从而与其合作。
