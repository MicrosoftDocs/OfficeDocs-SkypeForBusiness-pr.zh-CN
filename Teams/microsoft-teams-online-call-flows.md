...
在显示和部署快速路由的情况下，团队流可以从流4重新路由到流1，从流 4 "重新路由到流 1"。 但是，团队应用程序对通过 internet 进行的其他 Office 365 流的相关性很难，因为流4和 4 ';因此，不能阻止这些流程。 
...
7. 团队用户 A 和团队用户 B 调用 ICE 连接测试并选择流1和3（由 Office 365 中的团队传输中继进行中继）
