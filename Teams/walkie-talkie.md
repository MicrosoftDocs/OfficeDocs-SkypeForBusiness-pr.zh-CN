...
Teams 中的 Walkie Talkie 应用为团队提供即时 (PTT) 通信，现在可在 Android & iOS 上使用。 Walkie Talkie 允许用户使用他们作为其成员的相同基础频道来与团队联系。 只有通过频道连接到 Walkie Talkie 的用户才能成为参与者，并且可以使用推送到交谈来相互通信，一次一个。
