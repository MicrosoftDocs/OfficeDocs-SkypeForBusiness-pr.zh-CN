...
layout: HubPage
ms.topic: hub-page
title: Microsoft 团队粉笔粉笔
ms.reviewer: nsuter
manager: serdars
description: 注册有关推出最常用的 Microsoft 团队功能的最佳做法和实践指南，请注册免费的交互式研讨会。
...
ms.locfileid: "42417597"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Microsoft 团队粉笔粉笔</h1>
为 IT 专业人士和决策者设计的团队提供了一种独特的机会，可在团队中了解一些最常用且最引人注目的方案的最佳做法和实践指导。 通过主题专家主持，这些在线交互式研讨会将向你提供见解以增强你的团队实施，并为最终用户提供其他价值。<br><br><i>单击下面的任何研讨会标题以查看可用日期和时间，并立即注册！</i>
        <ul class="pivots">
            <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>那么 .。。您想要与团队进行通话？</h3>
                        <p>请加入我们，深入了解如何将 PSTN 呼叫功能添加到你的团队部署。 我们将逐步介绍如何调用术语、关键概念和配置。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>对团队中的应用执行更多操作</h3>
                        <p>利用团队中的应用将你的工作流、生产力应用和每天使用的服务集成到单个统一的体验中。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>从 Skype for Business 升级</h3>
                        <p>仍在使用 Skype for Business？ 请加入此交互式研讨会系列，让你能够开始成功地向你的组织的团队推出一切。</p>
                    </div>
                </div>
            </div>
        </div>
