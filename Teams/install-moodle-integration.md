...
*尚未有 Moodle 网站？* 你可能希望查看 Azure 存储库上的 Moodle [](https://github.com/azure/moodle) , 你可以在其中快速部署 azure 上的 Moodle 实例并根据你的需要对其进行自定义。

## <a name="step-2-configure-the-connection-between-the-office-365-plugin-and-azure-active-directory"></a>步骤 2: 配置 Office 365 插件与 Azure Active Directory 之间的连接
...
## <a name="step-3-deploy-the-moodle-assistant-bot-to-azure"></a>步骤 3: 将 Moodle 助理机器人部署到 Azure
...
## <a name="step-4-deploy-your-microsoft-teams-app"></a>步骤 4: 部署 Microsoft 团队应用
