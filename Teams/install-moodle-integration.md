...
1. 接下来，你需要将 Id 和密钥添加到 Moodle 插件。 返回到插件管理页面（网站管理 > 插件 > Microsoft 365 集成）。
...
1. 返回到插件管理页面（网站管理 > 插件 > Microsoft 365 集成），然后选择 "**团队设置**" 页面。 你需要配置一些安全设置以启用团队应用集成。
...
1. 返回到插件管理页面（网站管理 > 插件 > Microsoft 365 集成），然后选择 "**团队设置**" 选项卡。
