...
对于所有Microsoft 365 Office 365工作负荷，建议用于Teams连接方法是尽可能绕过转发代理。 当代理服务器位于客户端与Office 365之间时，媒体可能会通过 TCP 而不是 UDP 强制使用，这会影响媒体质量。 下载示例代理 PAC 文件，这些文件可用于从管理终结点和终结点配置[Microsoft 365 Office 365绕过。](/office365/enterprise/managing-office-365-endpoints)
