...
运营商：
- 在客户的数据中心部署和管理 SBC (客户无需实施 SBC，并且他们从 Teams 客户端客户端服务中的运营商) 。
- 将 SBC 互连到多个租户。
- 为客户提供 PSTN 服务。
- 管理端到端呼叫质量。
- PSTN 服务单独收费。
...
- **AudioCodes：**[直接路由](https://www.audiocodes.com/solutions-products/products/products-for-microsoft-365/direct-routing-for-Microsoft-Teams)配置说明，"将 AudioCodes SBC 连接到 Microsoft Teams直接路由托管模型配置说明"中所述的 SBC 托管方案的配置。 
...
6. 在下一页上， (所有值，除非希望将域名用于 Exchange、SharePoint 或 Teams/Skype for Business) ，请单击"下一步"，然后单击"完成 **"。**  确保新域位于"设置完成"状态。
...
*有关 [在组织或Microsoft 365 Office 365](https://support.office.com/article/Get-help-with-Office-365-domains-28343f3a-dcee-41b6-9b97-5b0f4999b7ef)添加用户的信息，请查看获取有关 Microsoft 365 或 Office 365 的帮助。*
...
-    在客户租户中，运营商只需将派生的中继 FQDN 添加到用户的语音路由策略。 无需为中继运行New-CSOnlinePSTNGateway。
