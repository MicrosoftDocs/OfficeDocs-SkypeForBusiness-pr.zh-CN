...
1.  通过执行[用户体验质量检查](#quality-of-experience-review-guide)来验证质量。
...
许多核心规划元素转到优化，右大小调整和补救网络基础结构，以确保 Microsoft 团队服务的高质量、 高效路径。 在我们[网络准备](3-envision-evaluate-my-environment.md#network-readiness)指南中介绍的规划任务和要求。 网络通常随时间由于升级、 扩展或其他业务需求。 非常重要规划活动网络中解决团队的要求。
...
质量冠军应使用各自团队驱动器修正操作，并向调控委员会进度并打开的任何问题有关的报告。
...
2.  **验证客户端连接：** 连接问题导致团队中的功能或登录问题。 （尤其是对于新的网站或位置） 我们建议您验证到服务的连接。 确保以下[Office 365 Url 和 IP 地址范围](https://aka.ms/o365ips)指南后面的每个网站。 您可以利用[Microsoft 网络评估工具](https://www.microsoft.com/download/details.aspx?id=53885)来执行验证正确已针对云语音功能的打开的媒体端口的连接性测试。 [网络准备](3-envision-evaluate-my-environment.md#network-readiness)指南中提供了有关如何运行连接测试的详细的步骤。
...
您可以利用[PSTN 用法报告](https://docs.microsoft.com/skypeforbusiness/skype-for-business-online-reporting/pstn-usage-report)可帮助您监视的调用规划分钟的使用量和 Communications 字幕式。 根据此活动的结果，您可以调整许可相应。 即将推出，我们将提供[PSTN minute 池](https://docs.microsoft.com/skypeforbusiness/skype-for-business-online-reporting/pstn-minute-pools-report)报表更有效地帮助完成此任务。
...
通过不断地评估和补救指南中所述的区域，您可以减少他们可能会产生负面影响的用户体验。 在部署中遇到的最多的用户体验问题可以分为以下类别：
...
使用作为主要工具，呼叫质量仪表板 (CQD) 联机报告和调查所述，重点音频，以最大限度地应用和影响每个区域重点用户体验质量审阅指南中提供的指南。 对网络以提高音频体验任何优化还直接将翻译视频和桌面共享的改进。
