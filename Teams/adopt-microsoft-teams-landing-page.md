...
ms.locfileid: "58725651"
---
# <a name="adopt-microsoft-teams"></a>采用 Microsoft Teams

> [!NOTE]
> 有关转换到远程学习和资源以帮助你入门的概述，请参阅远程Microsoft Teams[入门](remote-learning-edu.md)。

如果你希望从聊天Teams、teams & 频道和会议开始，请使用我们的规范性入门指南 ，该指南旨在让你快速启动[](get-started-with-teams-quick-start.md)并运行。 如果你是具有混合或本地 Skype for Business 配置的大型组织，或者想要推出语音功能 (（如 Microsoft 365 或 Office 365 呼叫计划或电话系统) ），可以从我们的入门指南开始，但需要下面的其他指南，在"更深入的采用指南"[下。](#deeper-adoption-guidance)
