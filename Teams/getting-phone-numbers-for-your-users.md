...
- **使用 Skype for Business 管理中心。** 对于某些国家/地区, 你可以使用 Skype for Business 管理中心为你的用户获取数字, 请参阅下面的 "为你的用户获取新的电话号码"。
...
> [!NOTE]
> 如果您需要有关为您的组织设置电话号码的帮助, 您可以[联系商业版支持人员-管理员帮助](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)。 
...
- 可以使用 "**电话号码**" 页面查看 "**号码**" 列中可用电话号码的列表, 查看已**分配**列中的电话号码是否已分配, 并在**号码位置查看电话号码的位置**列。
