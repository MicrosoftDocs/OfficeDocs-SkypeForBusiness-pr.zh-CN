...
- **对你可用的语言取决于组织所在的位置**。 例如，如果你的组织位于美国，你可以将默认语言设置为英语或西班牙语。 如果你的组织位于加拿大，你可以在英语和法语之间选择。 有关 Teams 和 Skype for Business 支持的语言的列表，请参阅以下内容：
...
2. 在"Microsoft 365管理中心"中  >  **，设置设置"**  >  **组织配置文件"。**
...
- [电话系统和通话套餐](calling-plan-landing-page.md)
...
- [在企业应用或 Microsoft 365 Office 365 中更改您的显示语言和时区](https://support.office.com/article/Change-your-display-language-and-time-zone-in-Office-365-for-Business-6f238bff-5252-441e-b32b-655d5d85d15b)
