...
> [!NOTE]
> 默认情况下，连接器在 GCC禁用。 如果需要启用它们，请设置 ConnectorsEnabled 或 ConnectorsEnabledForTeams 参数$true [Set-OrganizationConfig](https://docs.microsoft.com/powershell/module/exchange/set-organizationconfig) cmdlet。 以前需要连接到[PowerShell Exchange Online。](https://docs.microsoft.com/powershell/exchange/connect-to-exchange-online-powershell)
