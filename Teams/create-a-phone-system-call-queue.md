...
> [!NOTE]
> 您负责独立清除和保护在 Microsoft Teams 服务中使用任何音乐或音频文件的一切必要权限，其中可能包括来自所有相关权限持有者（包括艺术家）的任何音乐、声音效果、音频、品牌、名称和其他内容中的知识产权和其他权利， 执行者、表演者、表演者、歌曲作者、作曲者、录音标签、音乐发布者、联盟、团体、权利联盟、集体管理组织以及拥有、控制或许可音乐版权、声音效果、音频和其他知识产权的其他任何方。
