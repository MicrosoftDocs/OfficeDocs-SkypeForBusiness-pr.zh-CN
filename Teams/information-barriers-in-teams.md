...
- 若要设置 IB 策略，请参阅 [定义信息屏障的策略](/office365/securitycompliance/information-barriers-policies)。

- 若要编辑或删除 IB 策略，请参阅编辑 ([或删除) 策略](/microsoft-365/compliance/information-barriers-edit-segments-policies)。
