...
---
<a name="manage-microsoft-teams-features-in-your-office-365-organization"></a>管理 Microsoft 小组 Office 365 提供组织中的功能
======================================================
> [!IMPORTANT]
> [!INCLUDE [new-teams-sfb-admin-center-notice](includes/new-teams-sfb-admin-center-notice.md)]

Teams 可以在 Office 365 租户级别启用或关闭多项设置。 启用的团队，与团队还支持任意用户将从组织级别继承设置。
...
<a name="settings-by-userlicense-type"></a>按用户/许可证类型的设置
------------------------
当您设置 Microsoft 小组为您的组织开始时，您可以使用**设置用户/许可证类型**下拉菜单中，选择许可证类型，然后为该类型许可证的所有用户打开团队。

[!INCLUDE [global-switch-expiry-note](includes/global-switch-expiry-note.md)]

 用户/许可证类型的一些示例包括**业务与企业**和**来宾**。 （如果您有一个教育 SKU 许可证，**教育的教员和工作人员**或**教育的学生**有。）![控件集用户许可证](media/enable-microsoft-teams-features-in-your-office-365-organization-image13.png)

您可以拥有多个许可证类型在您的组织，例如，同时**业务与企业**和**来宾**。 Microsoft 的小组只可以区分根据的许可证已经分配给这些用户。 您可以打开或关闭这些用户**团队和渠道**、**联络和会议**，以及**消息**中的选项。 如果您使用一个许可证类型，考虑为租户范围设置的设置。
> [!NOTE]
> 来宾访问有关的更多详细信息，请参阅[启用或禁用来宾访问 Microsoft 小组](set-up-guests.md)。
