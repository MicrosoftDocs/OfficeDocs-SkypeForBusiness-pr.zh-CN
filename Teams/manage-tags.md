...
> [!NOTE]
> 专用通道尚不支持标记。 标记在 DoD GCC或国防部 (中) 提供。 
...
下面将了解如何添加自定义标记，以及如何在 Teams) 中的 Shifts 应用时通过 shift (来设置Teams) 。 若要了解有关详细信息，请查看使用[Teams 中的标记](https://support.office.com/article/using-tags-in-teams-667bd56f-32b8-4118-9a0b-56807c96d91e)。
