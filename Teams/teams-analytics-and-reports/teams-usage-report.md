...
1. 在 Microsoft 团队管理中心的左侧导航中, 单击 "**分析 & 报表**", 然后在 "**报表**" 下, 选择 "**团队使用情况**"。
2. 在“**数据范围**”下，选择一个范围，然后单击“**运行报告**”。

![使用标注的团队管理中心中的 "团队使用情况" 报表的屏幕截图](../media/teams-reports-teams-usage-with-callouts.png "使用标注的团队管理中心中的 \"团队使用情况\" 报表的屏幕截图")
...
|**7**   |你可以将报表导出到 CSV 文件, 以便脱机分析。 单击 "**导出到 Excel**", 然后在 "**下载**" 选项卡上, 单击 "**下载**" 以在准备就绪后下载报告。<br><br>!["下载" 选项卡的屏幕截图, 显示已导出的要下载的报表](../media/teams-reports-export-to-csv.png)|
