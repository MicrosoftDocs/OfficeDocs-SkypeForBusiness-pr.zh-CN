...
1. 在管理中心的左侧导航Microsoft Teams，单击 **"分析&报表** > **""管理报表"**。 在"**查看报表"** 选项卡上的"报表 **"** 下，选择Teams **使用情况"**。
2. 在“**数据范围**”下，选择一个范围，然后单击“**运行报告**”。

    ![屏幕截图：Teams管理中心内具有标注Teams使用情况报表。](../media/teams-reports-teams-usage-with-callouts1.png "屏幕截图：Teams管理中心内具有标注Teams使用情况报表")
