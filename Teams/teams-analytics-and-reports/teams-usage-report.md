...
1. 在管理中心的左侧导航Microsoft Teams，单击 **"分析&报告**  >  **"。** 在"**查看报表"** 选项卡上的"报表 **"** 下，Teams **使用情况"。**
...
|**4**   |可单击图例上的项目筛选要在图表上查看的内容。 例如，单击"活动 **用户总数**"Teams &"频道活动用户、活动频道"或"消息 **"，** 仅查看与每个活动用户有关的信息。  更改此选项不会更改表格中的信息。 |
