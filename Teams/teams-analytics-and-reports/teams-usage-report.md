...
ms.locfileid: "69820327"
---
# <a name="microsoft-teams-usage-report"></a>Microsoft Teams 使用情况报告

Microsoft Teams 管理中心的 Teams 使用情况报告概述了 Teams 中的使用活动，包括活动用户和频道的数量，因此你可以快速查看组织中有多少用户使用特定团队进行通信和协作。 可以查看团队的使用情况信息，包括每个团队中的活动用户和频道、来宾和消息数。
...
若要使 Teams 使用情况报告中的数据匿名，你必须是全局管理员。 全局管理员可以使用 MD5 哈希) （例如报表及其导出中的显示名称、组名称、电子邮件和 AAD ID）隐藏 (可识别信息。
