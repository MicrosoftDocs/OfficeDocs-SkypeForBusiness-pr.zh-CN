...
<sup>1</sup>团队所有者可以创建团队, 除非他们受到限制。 请参阅下面的 "创建团队的权限"。
>
<sup>2</sup>这些项目可以由团队级别的所有者关闭, 在这种情况下, 成员将无权访问它们。

<sup>3</sup>将成员添加到团队后, 所有者还可以将成员提升为所有者状态。 所有者也可以将自己的状态降级为成员。

<sup>4 个</sup>团队成员可以将其他成员添加到公共团队。
