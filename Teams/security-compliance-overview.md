...
然后再启用这些功能，确保您有权安全 & 合规性中心 Microsoft 365 管理中心中。 默认情况下，租户管理员有访问权限。
...
若要查看的区域存储租户数据，转到[Microsoft 365 管理中心](https://portal.office.com/adminportal/home) > **设置** > **组织配置文件**。 向下滚动到“**数据位置**”。 
