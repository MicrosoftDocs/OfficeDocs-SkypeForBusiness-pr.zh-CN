...
请考虑以下示例。 客户已购买 115 个音频会议订阅许可证，在美国有 10 个用户，英国有 100 个用户，在安哥拉有 5 个用户，所有这些用户都分配有音频会议订阅许可证。 所有 115 个用户共享一个 (池，该池的 115 个用户 x 60 分钟 = 每个日历月) 6，900 个会议拨出分钟数，以便向任何区域[A](audio-conferencing-zones.md)国家和地区的非高级号码进行出站呼叫，无论会议组织者是获得许可还是实际位于何处。 例如，在达到分钟池限制之前，一个安哥拉会议组织者能够拨出到任何区域 [A](audio-conferencing-zones.md) 国家和地区。
