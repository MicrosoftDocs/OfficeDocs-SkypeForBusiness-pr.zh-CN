...
使用此表查找有关获取和管理法国 Microsoft Teams 的电话号码的信息。
  
有关详细信息，请参阅[为你的组织管理电话号码](manage-phone-numbers-for-your-organization.md)。
  
|**你要做什么？**|**下载正确的表单并发送给我们**|
|:-----|:-----|
|获取未在 Microsoft Teams 管理中心中列出的新用户或服务电话号码。   <br/> | 下载这些表单之一。 <br/> [法国新电话号码请求 (v.6.0)  (fr-fr) ](https://download.microsoft.com/download/4/e/7/4e7e9da9-f2cc-4e4d-97af-efcb85a51b0d/new-phone-number-request-for-france-(v.6.0)-(fr-fr).pdf) <br/>  [针对法国的新电话号码请求 (v.5.0)  (en-us) ](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-france-(v.5.0)-(en-us).pdf?raw=true)<br/> <br/>   填写此申请并[将其发送给我们](mailto:ptneu@microsoft.com)。  <br/>
|获取转接给我们的电话号码。  <br/> |下载这些表单之一。 <br/><br/> 对于用户电话号码：<br/>[法国的 (LOA)  ()  (v.5.0)  (fr-fr) ](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-france-(geographic-numbers)-(v.5.0)-(fr-fr).pdf?raw=true) <br/><br/>对于免费电话号码： <br/>[法国 (5.0)  (v.5.0)  (免费电话号码的)  (LOA) ](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-france-(freephone-numbers)-(v.5.0)-(fr-fr).pdf?raw=true) <br/> <br/> 填写此申请并[将其发送给我们](mailto:ptneu@microsoft.com)。  <br/> |
