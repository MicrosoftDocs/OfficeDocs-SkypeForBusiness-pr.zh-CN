...
|获取传输给我们的电话号码。  <br/> | 下载此表单。 <br/>[适用于新加坡 ( (用户和服务号码)  (en-sg) v2 的 LOA) 授权书](<https://download.microsoft.com/download/e/9/5/e959053a-4b35-49f9-a23e-7085575c46f2/LOA-SG-GEO-EN.pdf>)<br/> <br/>填写并 [联系 TNS 服务台以获取说明](contact-tns-service-desk.md)。 <br/><br/>传输号码可能需要一到六周才能在此市场完成，具体取决于端口的复杂性。 <br/><br/>地理号码可以移植到服务 (对于呼叫队列&自动助理，因为此时无法将这些号码用于会议。) 或订阅服务器号码类型。 请注意，当前不支持免费端口 (0800) 的移植服务。  |
