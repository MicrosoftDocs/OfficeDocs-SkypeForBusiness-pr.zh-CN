...
> [!IMPORTANT]
> 无法在**比利时、 爱尔兰、 德国和荷兰**，获取使用**业务管理中心的 Skype**; 电话新电话号码您必须下载并填写表单。 在澳大利亚的新电话号码，请参阅[Telstra 语音服务](https://aka.ms/TelstraVoicePlan)。

***
如果您知道要查找的表单类型，请使用下拉列表选择要获取号码的国家/地区。
...
如果是这样，您将需要下载正确 PDF 表单 （每个国家/地区和号码的类型），并将其发送给我们。 我们服务台将从中执行，并将让您了解进度或您的订单。
...
- 服务 （免费）电话号码。
- 您有超过 999 个用户电话号码，你需要得到但不能进入 Skype for Business 管理中心使用  **本地号码移植向导**  。
