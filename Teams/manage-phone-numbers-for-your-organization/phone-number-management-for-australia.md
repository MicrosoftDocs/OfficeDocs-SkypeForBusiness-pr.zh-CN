...
|如果您正在利用 Telstra 调用 for Office 365，您可能获取新的可与云自动助理和队列的澳大利亚呼叫从 Telstra 服务电话号码。 <br/> |请联系 [Telstra  Calling for Office 365](https://aka.ms/TelstraVoicePlan) 获取新电话号码。 稍后将相关号码添加至您所属组织，以便您向您的自动语音和呼叫队列进行分发。 如果您目前未使用 Telstra 调用，您可以联系我们 Microsoft 号码 ManagementService 办公桌前就可以从 Microsoft[请与我们联系](mailto:ptnapac@microsoft.com)获取服务号码。 <br/>|
