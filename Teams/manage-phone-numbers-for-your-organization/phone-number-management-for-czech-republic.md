...
ms.custom:
- Calling Plans
description: 使用此表可查找有关在捷克共和国获取和管理Microsoft Teams电话号码的信息。
ms.openlocfilehash: c37e38ddf4f85c39255a9f30e25c70a67e311a38
ms.sourcegitcommit: 2b1290b763c73f64c84c7568b16962e4ae48acf6
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/01/2022
ms.locfileid: "65823467"
---
# <a name="phone-number-management-for-the-czech-republic"></a>捷克共和国电话号码管理

[!INCLUDE [preview-feature](../includes/preview-feature.md)]

使用此表可查找有关在捷克共和国获取和管理Microsoft Teams电话号码的信息。

有关详细信息，请参阅[为你的组织管理电话号码](manage-phone-numbers-for-your-organization.md)。

|**你要做什么？**|**下载正确的表单**|
|:-----|:-----|
|获取Microsoft Teams管理中心未列出的新用户或服务电话号码。 |在捷克共和国，可以使用Microsoft Teams管理中心获取组织的电话号码。 还可以通过下载表单来提交新的电话号码请求 [，并联系 TNS 服务台以获取说明](contact-tns-service-desk.md)。<br/><br/>`[New phone number request for the Czech Republic (v.1.0) cs-CZ](https://download.microsoft.com/download/2/f/0/2f015d86-3136-4d81-b323-e5b8cac3c272/new-phone-number-request-for-the-czech-republic-(v1.0)-(cs-CZ).pdf )`. <br/><br/> 必须先下载“了解客户”表单，完整完成，然后将其发送给我们，然后才能向你分配电话号码。<br/><br/>新订单可能需要两到三周才能填补这个市场。  |
