...
|**你要做什么？**|**下载正确的表单**|
|:-----|:-----|
|获取业务管理中心 Skype 中未列出的新用户电话号码。   <br/> |下载[英国的新电话号码申请（地理号码）(v.3.0)(en-us)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-the-u.k.-(geographic-numbers)-(v.3.0)-(en-us).pdf?raw=true) 表单，填写此表单并[将其发送给我们](mailto:ptneu@microsoft.com)。  <br/> |
