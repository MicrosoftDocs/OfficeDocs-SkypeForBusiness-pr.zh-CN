...
ms.openlocfilehash: cdfedee4bd63455312df36bd5ed07d6e0a57c12b
...
|获取转接给我们的电话号码。  <br/> | 下载此表单。 <br/>[新西兰 (LOA (授权书)  (v.1.0)  (nz)  (nz) ](https://download.microsoft.com/download/e/6/7/e67f46ef-e1cd-4e70-a5cc-f53fd74285aa/letter-of-authorization-(loa)-for-new-zealand-(all-numbers)-(v1.0)-(en-nz).pdf) <br/> <br/>填写它并 [联系 TNS 服务台，了解说明](contact-tns-service-desk.md)。 <br/><br>转移号码可能需要一到六周才能在此市场中完成，具体取决于端口的复杂性。<br/><br/>这些号码目前不能用于会议。  |
