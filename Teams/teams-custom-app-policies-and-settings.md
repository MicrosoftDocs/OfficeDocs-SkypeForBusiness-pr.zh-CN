...
作为 Teams 管理员，可以使用自定义应用策略和设置来控制组织中的哪些人可以将自定义应用上传到Microsoft Teams。 管理员决定哪些用户可以上传自定义应用，管理员和团队所有者可以确定组织中的特定团队是否允许向其添加自定义应用。 编辑自定义应用的设置策略后，更改需要几个小时才能生效。 必须是全局管理员或 Teams 服务管理员才能管理这些策略。
...
## <a name="app-setup-policy-and-settings-for-custom-apps"></a>自定义应用的应用设置策略和设置

三个设置确定用户是否可以将自定义应用上传到团队。 它使管理员能够精细控制谁可以向团队添加自定义应用，以及可以将自定义应用添加到哪些团队。 这些设置不会影响阻止第三方应用的能力。

* [自定义应用的用户应用设置策略设置](#user-app-setup-policy-settings-for-custom-apps)
* [团队自定义应用设置](#team-custom-app-setting)
* [组织范围内的自定义应用设置](#org-wide-custom-app-setting)

### <a name="user-app-setup-policy-settings-for-custom-apps"></a>自定义应用的用户应用设置策略设置
...
#### <a name="set-an-app-setup-policy-settings-for-custom-apps"></a>为自定义应用设置应用设置策略设置
...
管理员和团队所有者可以控制团队是否允许向该团队添加自定义应用。 **“允许成员上传自定义应用**”设置以及用户的自定义应用设置确定谁可以向特定团队添加自定义应用。

如果此设置已禁用：

* 如果自定义应用的应用设置策略设置允许，团队所有者可以添加自定义应用。
* 非团队所有者的团队成员不能向团队添加自定义应用。

如果此设置已启用：

* 如果自定义应用的设置允许，团队所有者可以添加自定义应用。
* 如果自定义应用的设置允许，则非团队所有者的团队成员可以添加自定义应用。
...
“[管理应用](manage-apps.md)”页面上的“**允许与自定义应用交互**”组织范围内的自定义应用设置适用于组织中的每个人，并控制他们是否可以上传自定义应用或与之交互。 此设置充当用户和团队与自定义应用相关的设置的主打开或关闭开关。 它旨在作为安全事件期间的主开/关开关。 用户和团队自定义应用设置仅在启用组织范围的自定义应用设置后生效。
...
下表汇总了自定义应用设置、它们协同工作的方式，以及它们对控制组织中哪些人可以将自定义应用上传到 Teams 的综合影响。

例如，想要只允许团队所有者将自定义应用上传到特定团队。 将设置以下内容：

* 在 Microsoft Teams 管理中心启用“**允许与自定义应用交互**”。
* 对要限制访问的每个团队，禁用“**允许成员上传自定义应用**”。
* 在启用“上传自定义应用”设置的情况下，在 Microsoft Teams 管理中心中的应用设置策略中创建和分配 **自定义策略**，并将其分配给团队所有者。

|组织范围内的自定义应用设置 |团队自定义应用设置 |用户自定义应用设置 | 效果  |
|---------|---------|---------|---------|
