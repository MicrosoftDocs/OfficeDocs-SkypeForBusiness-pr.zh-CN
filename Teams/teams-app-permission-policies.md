...
例如，假设你希望仅允许组织的人力资源团队使用几个特定应用。 首先，在“[管理应用](https://admin.teams.microsoft.com/policies/manage-apps)”页面上，确保在组织级别允许可供人力资源团队使用的应用。 然后，创建一个自定义策略，将其设置为阻止和允许所需应用，并将策略分配给人力资源团队中的用户。

> [!NOTE]
> 若要了解 Microsoft 365 政府社区云高 (GCCH) 和国防部 (DoD) 环境特有的第三方应用设置，请参阅[管理 Microsoft 365 政府的组织范围应用设置](#manage-org-wide-app-settings-for-microsoft-365-government)。
...
1. 同样，如果选择“**阻止特定的应用并允许其他所有应用**”，则搜索并添加要阻止的应用，然后选择“**阻止**”。
1. 选择“**保存**”。
...
若要允许第三方应用，你可以编辑和使用全局（组织范围默认）策略，也可以创建并分配自定义策略。
