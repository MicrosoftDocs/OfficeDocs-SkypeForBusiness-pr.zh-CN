...
- 录制
- 文件
    - 将文件共享到会议聊天和在会议聊天中查看/下载文件
    - 在会议中展示 PPT（不是通过屏幕共享功能）和在会议中查看 PPT
- 安排会议（仅适用于会议）
...
| 白板 | 是 | 是 |是 |
| 录制 | 不适用 |是 | 是 |
| 文件 - 将文件共享到会议聊天和在会议聊天中查看/下载文件 | 是 | 是 | 是 |
| 文件 - 在会议中展示 PPT（不是通过屏幕共享）和在会议中查看 PPT | 是 | 是 | 是 |
| 安排会议 | 是 | 不适用 | 不适用 |
|||||||
...
| 白板 | 不适用 |
| 录制 | 不适用 |  
| 文件 - 将文件共享到会议聊天和在会议聊天中查看/下载文件 |  |  |  |
| 文件 - 在会议中展示 PPT（不是通过屏幕共享）和在会议中查看 PPT |  |  |  |
| 安排会议 | 不适用 |
|||
