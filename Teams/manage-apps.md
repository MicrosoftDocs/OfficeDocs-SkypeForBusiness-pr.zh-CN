...
有关开发人员在默认情况下如何阻止应用的信息，请参阅启用在 [管理员允许之前阻止应用](/microsoftteams/platform/concepts/design/enable-app-customization#hide-teams-app-until-admin-approves)。
