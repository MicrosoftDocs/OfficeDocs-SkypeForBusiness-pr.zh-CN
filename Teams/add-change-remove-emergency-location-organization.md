...
无论您所在的国家或地区如何，您都可以将一个或多个地点添加到紧急地点，并删除紧急位置。 根据您的组织中的物理位置数，您可以为建筑物、楼层和办事处创建场所。 请参阅[什么是紧急位置、地址和呼叫路由？](/microsoftteams/what-are-emergency-locations-addresses-and-call-routing)。
...
4. 选择国家或地区，然后输入地址。
   ...
   > [!NOTE]
   > 在比利时、法国、德国、爱尔兰、荷兰和西班牙我很重要的一点是，为了成功激活 Office 365 中的电话号码，在紧急位置（用于获取号码的 os）的地址设置必须与电话号码的区域匹配条码.
