...
> | 问题 | 回答 | 备注 |
> |---|---|---|
> | 哪些版本的 Lync 或 for Business 的 Skype 当前 <br>在本地部署？ | <input type="checkbox">Office Communications Server 2007"R1" <br/> <input type="checkbox">Office Communications Server 2007 R2 <br/> <input type="checkbox">Lync Server 2010 <br/> <input type="checkbox">Lync Server 2013 <br/> <input type="checkbox">Skype 业务服务器 2015 <br/> <input type="checkbox">Skype 业务服务器 2019 <br/> <input type="checkbox">Skype 商业云连接器 edition | |
