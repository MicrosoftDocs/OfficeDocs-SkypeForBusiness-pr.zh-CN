...
有关使用耳机的呼叫控制支持Teams，请参阅在 Teams[中使用耳机控制Teams。](https://support.office.com/article/Control-calls-using-a-headset-in-Teams-65d6e104-444d-4013-b8c2-f11317dd69a8)
...
- **认证Microsoft Teams** 在此级别进行认证的设备表示最新设备已认证，无需Teams体验。 这些设备提供之前认证的所有优势，还包括一个专用的 led Teams按钮。 对于大多数外形因素，Teams按钮是一个易于查找的具有徽标的Teams按钮。 随着时间的推移，Microsoft 将继续与设备制造商合作，通过固件更新提供新价值。
...
- 能够激活Teams客户端，或者通过按下按钮响应通知 (例如，加入会议) 。
- 专为扩展性而设计的 (新的设备/客户端功能，可通过固件更新或) 。
