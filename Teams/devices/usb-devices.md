...
- **Skype for Business升级Teams认证** 在此级别认证的设备最初已通过认证Skype for Business。 Microsoft 与设备制造商合作，在不更改原始硬件Teams提供最佳集成体验。 当 *不在调用* 中时Teams挂钩切换按钮充当一个按钮，并且可能会随着时间的推移包含更多函数。  此类别中的设备可能在营销材料Teams认证徽章。
