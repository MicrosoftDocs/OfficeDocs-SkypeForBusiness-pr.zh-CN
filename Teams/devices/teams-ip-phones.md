...
在设备上安装新的固件版本时，可以确定Microsoft Teams应用、公司门户和管理员代理的相应已安装版本。 在 **"包含的产品发布** "列中查找产品版本，然后在前面的 **"应用版本** "表中查找产品版本。
...
在设备上安装新的固件版本时，可以通过在"**已包含的产品发布**"列中查找产品版本来确定安装的相应Microsoft Teams应用、公司门户和管理员代理版本。 然后在上面的 **"应用版本** "表中查找产品版本。
