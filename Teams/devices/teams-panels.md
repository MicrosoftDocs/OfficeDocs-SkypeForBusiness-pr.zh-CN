...
若要为Microsoft 365设置Teams资源帐户，建议购买标准[Microsoft Teams 会议室许可证](#license-requirement)。 若要了解如何创建资源帐户并为其分配许可证，请参阅使用 Microsoft 365 管理中心 创建[资源帐户](resource-account-ui.md)。
