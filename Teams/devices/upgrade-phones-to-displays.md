...
> [!IMPORTANT]
> 升级到 Teams 显示仅在 Lenovo ThinkSmart View 设备上可用。 本文中的信息仅适用于此设备模型。  

本文概述了如何将 Teams 手机升级到 Microsoft Teams 管理中心中的 Teams 显示设备。 这样做可让设备在 Teams 显示设备时为用户提供丰富的体验。

Teams 显示器是一类一体式专用 Teams 设备，具有环境触摸屏和 Cortana 提供的免费免提体验。 Teams 显示是 Teams 手机的演变。 除了 [Teams 手机支持的功能外，Teams](phones-for-teams.md#features-supported-by-teams-phones)显示还包括一些功能，例如始终可用的显示，所有 Teams 活动和协作选项始终可用。 若要详细了解 Teams 显示的独特功能，请参阅 [Microsoft Teams 显示](teams-displays.md)。

## <a name="what-you-need-to-know-about-upgrading-to-teams-displays"></a>有关升级到 Teams 显示器的需知内容

### <a name="which-teams-phones-can-be-upgraded"></a>哪些 Teams 手机可以升级？

Lenovo ThinkSmart View 设备可以升级到 Teams 显示器。

### <a name="how-can-i-prepare-users"></a>如何准备用户？

若要让用户做好准备，请与用户共享 [Teams](https://support.microsoft.com/office/get-started-with-teams-displays-ff299825-7f13-4528-96c2-1d3437e6d4e6) 显示入门，以帮助他们熟悉 Teams 显示。 建议在升级之前做好此操作。

在升级后，告知他们数据或首选项没有更改。 例如，用户可以访问 Teams 显示的所有会议、错过的呼叫和语音邮件。 

### <a name="what-happens-after-the-upgrade"></a>升级后会发生什么情况？

将 Teams 手机升级到 Teams 显示设备后，设备将列在 Microsoft Teams 管理中心的"设备"部分中的 **Teams** 显示页面上。 管理方式与管理任何其他 Teams 设备的方式相同。 有关详细信息，请参阅在 [Teams 中管理设备](device-management.md)。
...
3. 在"**升级到 Teams"显示** 对话框中，选择"计划升级"以设置升级的日期和时间或"**现在升级"。**
...
在升级过程中，设备的固件将更新为 Teams 显示设备，设备将重新启动，并可供使用。 升级完成后，你将在 Microsoft Teams 管理中心的 **Teams** 显示页面上看到列出的设备。
...
Teams 显示器上的深色主题支持将在将来的更新中提供。 使用深色主题的 Teams 手机将在升级到 Teams 后获得默认主题。
...
[Teams 中的 Cortana 语音帮助](../cortana-in-teams.md)