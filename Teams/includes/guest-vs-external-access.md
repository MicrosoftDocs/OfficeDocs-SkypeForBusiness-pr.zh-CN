<span data-ttu-id="a5d21-101">外部访问权限（联合身份验证）与来宾访问权限是不一样的：</span><span class="sxs-lookup"><span data-stu-id="a5d21-101">External access (federation) and guest access are different:</span></span>
