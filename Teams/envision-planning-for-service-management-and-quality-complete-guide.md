...
| | 指定质量支持者 <br/> 质量支持者就绪| [《体验质量评审指南》](https://aka.ms/qerguide) |
...
| | 进行角色-设备映射 <br/> 预配设备并对其进行试点 | [设备目录](http://partnersolutions.skypeforbusiness.com/solutionscatalog/personal-peripherals-pcs) |
