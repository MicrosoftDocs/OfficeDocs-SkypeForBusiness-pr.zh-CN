...
> [!Note]
> 如果管理员删除了团队，则你有一个月在 AAD 门户Azure Active Directory (还原) 还原所有相关的数据。 一个月后，或者如果管理员在回收站中删除此团队，您将丢失所有相关的数据。
...
默认情况下，“审批”应用可用。 可在 Teams 管理中心中禁用该应用。
  ...
  5. 选择切换开关以为你的组织禁用该应用。
     ...
     ![显示"审批"应用的详细信息。](media/approvals-details-new.png)
