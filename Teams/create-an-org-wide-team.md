...
使用组织范围的团队，全局管理员可以轻松创建一个公共团队来将组织中的所有用户包含进来，并在用户加入和离开组织时在 Active Directory 中更新成员身份。 只有全局管理员可以创建组织范围的团队，当前仅限组织范围内的团队，只能为用户数超过 5，000 个用户的组织使用。 每个租户也有五个组织范围的团队的限制。 如果满足这些要求，则当全局管理员在创建团队时选择“**从头开始构建团队**”时，将看到“**组织范围**”选项。 

![用于创建组织范围团队的“组织范围”选项的屏幕截图](media/create-org-wide-team.png "用于创建组织范围团队的“组织范围”选项的屏幕截图")

创建组织范围的团队后，所有全局管理员都将添加为团队所有者，并且所有活动用户都会添加为团队成员。 未经授权的用户也将添加到团队。 首次登录到 Teams 时，会为用户分配 Microsoft Teams 浏览准备许可证。 若要了解有关浏览者许可证的更多信息，请参阅" [管理 Microsoft Teams 探索者"许可证](teams-exploratory.md)。 
...
> [!NOTE]
> - 如果你在创建团队时看不**Org-wide**到组织范围的选项，并且你是全局管理员，则可能已达到五个组织范围的团队限制，或者你的组织的成员可能拥有超过 5，000 个成员的当前大小限制。 我们想要在未来增加此限制。 对于 Teams 教育版，组织范围的团队不可用。
...
即使成员无法离开组织范围的团队，但是团队所有者可以删除不属于的帐户，从而管理团队名单。 **请确保使用 Teams 从组织范围的团队中删除用户**。 如果使用其他方法删除用户（如 Microsoft 365 管理中心或 Outlook 中的组），则该用户可能会添加回组织范围的团队。
...
团队模板不能用于创建组织范围的团队。 针对此功能当前正在进行中。 
