...
<tr><td>![](media/audio_conferencing_image9.png)<br/>后续步骤</td><td><ul><li>你可以执行详细的网络评估来帮助确保你的网络为 Microsoft Teams 部署做好准备。 有关详细信息，请参阅[网络就绪评估](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Offers?pageState=NetworkReadiness)。</li><li>根据针对每个网络段的网络就绪评估结果进行网络补救。</li></ul></td></tr>
</table>
