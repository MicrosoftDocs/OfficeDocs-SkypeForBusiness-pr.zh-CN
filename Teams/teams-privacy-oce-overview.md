...
> [!NOTE]
> 如果你是管理员，请参阅[管理隐私控制](https://docs.microsoft.com/deployoffice/privacy/manage-privacy-controls)一文，了解如何授予或限制用户使用可选连接体验的能力。
...
- [Microsoft 365 企业应用版隐私控制概述](https://docs.microsoft.com/deployoffice/privacy/overview-privacy-controls)
- [Teams 策略控制概述](policy-control-overview.md)
- [隐私和 Microsoft Teams](teams-privacy.md)
- [Office 的必选服务数据](https://docs.microsoft.com/deployoffice/privacy/required-service-data)
