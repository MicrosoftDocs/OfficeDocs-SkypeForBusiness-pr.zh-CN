...
> [!NOTE]
> 如果你是管理员，请参阅[管理隐私控制](/deployoffice/privacy/manage-privacy-controls)一文，了解如何授予或限制用户使用可选连接体验的能力。
...
- [Microsoft 365 企业应用版隐私控制概述](/deployoffice/privacy/overview-privacy-controls)
