...
---
# <a name="powershell-script-sample---create-new-people-manager-teams"></a><span data-ttu-id="3ddfb-103">PowerShell 脚本示例 - 创建新的人员经理团队</span><span class="sxs-lookup"><span data-stu-id="3ddfb-103">PowerShell script sample - Create new people manager teams</span></span>

<span data-ttu-id="3ddfb-104">使用此 PowerShell 脚本为每个经理创建一个团队，其直接下属作为团队成员。</span><span class="sxs-lookup"><span data-stu-id="3ddfb-104">Use this PowerShell script to create a team for each manager with their directs as team members.</span></span> <span data-ttu-id="3ddfb-105">运行此脚本之前，请运行 [导出](powershell-script-create-teams-from-managers-export-managers.md) 管理器脚本 (Active Directory 导出) 组织的经理及其直接人员列表。</span><span class="sxs-lookup"><span data-stu-id="3ddfb-105">Before you run this script, run the [Export managers](powershell-script-create-teams-from-managers-export-managers.md) script to  export (from your Active Directory) a list of managers and their directs for your organization.</span></span>

<span data-ttu-id="3ddfb-106">若要了解此 PowerShell 脚本，请阅读 [创建人员经理团队](../create-manager-directs-teams.md)。</span><span class="sxs-lookup"><span data-stu-id="3ddfb-106">To learn about this PowerShell script, read [Create people manager teams](../create-manager-directs-teams.md).</span></span>

<span data-ttu-id="3ddfb-107">如果你不了解 PowerShell 并需要入门帮助，请参阅 [Azure PowerShell 概述](/powershell/azure/overview?view=azurermps-5.1.1)。</span><span class="sxs-lookup"><span data-stu-id="3ddfb-107">If you're new to PowerShell and need help getting started, see [Overview of Azure PowerShell](/powershell/azure/overview?view=azurermps-5.1.1).</span></span>


## <a name="create-new-people-manager-teams"></a><span data-ttu-id="3ddfb-108">创建新的人员经理团队</span><span class="sxs-lookup"><span data-stu-id="3ddfb-108">Create new people manager teams</span></span> 
