...
1. <span data-ttu-id="a98b9-110">配置用户和 SBC 网站（如本文中所述）。</span><span class="sxs-lookup"><span data-stu-id="a98b9-110">Configure the user and the SBC sites (as described in this article).</span></span>
...
2. <span data-ttu-id="a98b9-117">通过配置网络区域、网络站点和网络子网来[定义网络拓扑](#define-the-network-topology)。</span><span class="sxs-lookup"><span data-stu-id="a98b9-117">[Define the network topology](#define-the-network-topology) by configuring the network regions, network sites, and network subnets.</span></span>
...
|            |  <span data-ttu-id="a98b9-152">SBC SWe</span><span class="sxs-lookup"><span data-stu-id="a98b9-152">SBC SWe</span></span>          | <span data-ttu-id="a98b9-153">8.2</span><span class="sxs-lookup"><span data-stu-id="a98b9-153">8.2</span></span>  |
...
<span data-ttu-id="a98b9-201">请注意以下事项：</span><span class="sxs-lookup"><span data-stu-id="a98b9-201">Note the following:</span></span> 
...
## <a name="call-flows"></a><span data-ttu-id="a98b9-228">通话流程</span><span class="sxs-lookup"><span data-stu-id="a98b9-228">Call flows</span></span> 
...
#### <a name="outbound-calls-and-the-user-is-in-the-same-location-as-the-sbc-with-always-bypass"></a><span data-ttu-id="a98b9-265">出站呼叫，并且用户与具有始终绕过的 SBC 位于同一位置</span><span class="sxs-lookup"><span data-stu-id="a98b9-265">Outbound calls and the user is in the same location as the SBC with Always Bypass</span></span>

| <span data-ttu-id="a98b9-266">众</span><span class="sxs-lookup"><span data-stu-id="a98b9-266">Mode</span></span> |    <span data-ttu-id="a98b9-267">用户</span><span class="sxs-lookup"><span data-stu-id="a98b9-267">User</span></span> |  <span data-ttu-id="a98b9-268">位置</span><span class="sxs-lookup"><span data-stu-id="a98b9-268">Location</span></span> |  <span data-ttu-id="a98b9-269">呼叫方向</span><span class="sxs-lookup"><span data-stu-id="a98b9-269">Call direction</span></span> |
|:------------|:-------|:-------| :-------|
| <span data-ttu-id="a98b9-270">AlwaysBypass</span><span class="sxs-lookup"><span data-stu-id="a98b9-270">AlwaysBypass</span></span> |    <span data-ttu-id="a98b9-271">内部</span><span class="sxs-lookup"><span data-stu-id="a98b9-271">Internal</span></span> |  <span data-ttu-id="a98b9-272">与 SBC 相同的网站</span><span class="sxs-lookup"><span data-stu-id="a98b9-272">The same site as SBC</span></span> |  <span data-ttu-id="a98b9-273">出站</span><span class="sxs-lookup"><span data-stu-id="a98b9-273">Outbound</span></span> |

<span data-ttu-id="a98b9-274">下表显示了最终用户配置和操作：</span><span class="sxs-lookup"><span data-stu-id="a98b9-274">The following table shows the end user configuration and action:</span></span>

| <span data-ttu-id="a98b9-275">用户物理位置</span><span class="sxs-lookup"><span data-stu-id="a98b9-275">User physical location</span></span>| <span data-ttu-id="a98b9-276">用户拨打或接听号码</span><span class="sxs-lookup"><span data-stu-id="a98b9-276">User makes or receives a call to/from number</span></span> | <span data-ttu-id="a98b9-277">用户电话号码</span><span class="sxs-lookup"><span data-stu-id="a98b9-277">User phone number</span></span>  | <span data-ttu-id="a98b9-278">联机语音路由策略</span><span class="sxs-lookup"><span data-stu-id="a98b9-278">Online Voice Routing Policy</span></span> | <span data-ttu-id="a98b9-279">针对 SBC 配置的模式</span><span class="sxs-lookup"><span data-stu-id="a98b9-279">Mode configured for SBC</span></span> |
|:------------|:-------|:-------|:-------|:-------|
| <span data-ttu-id="a98b9-280">越南</span><span class="sxs-lookup"><span data-stu-id="a98b9-280">Vietnam</span></span> | <span data-ttu-id="a98b9-281">+ 84 4 3926 3000</span><span class="sxs-lookup"><span data-stu-id="a98b9-281">+84 4 3926 3000</span></span> | <span data-ttu-id="a98b9-282">+ 84 4 5555 5555</span><span class="sxs-lookup"><span data-stu-id="a98b9-282">+84 4 5555 5555</span></span>   | <span data-ttu-id="a98b9-283">优先级1： ^\+84 （\d{9}） $-VNsbc.contoso.com</span><span class="sxs-lookup"><span data-stu-id="a98b9-283">Priority 1: ^\+84(\d{9})$ -VNsbc.contoso.com</span></span> <br> <span data-ttu-id="a98b9-284">优先级2：. \*-proxysbc.contoso.com</span><span class="sxs-lookup"><span data-stu-id="a98b9-284">Priority 2: .\* - proxysbc.contoso.com</span></span>   | <span data-ttu-id="a98b9-285">VNsbc.contoso.com-始终绕过</span><span class="sxs-lookup"><span data-stu-id="a98b9-285">VNsbc.contoso.com – Always Bypass</span></span> <br> <span data-ttu-id="a98b9-286">proxysbc.contoso.com-始终绕过</span><span class="sxs-lookup"><span data-stu-id="a98b9-286">proxysbc.contoso.com – Always Bypass</span></span>


<span data-ttu-id="a98b9-287">下图显示了具有 "始终绕过" 模式的出站呼叫和用户位于 SBC 所在位置的 SIP 阶梯。</span><span class="sxs-lookup"><span data-stu-id="a98b9-287">The following diagram shows the SIP ladder for an outbound call with Always bypass mode, and the user in the same location as the SBC.</span></span>

<span data-ttu-id="a98b9-288">![显示出站通话的图表](media/direct-routing-media-op-10.png "拨出电话")</span><span class="sxs-lookup"><span data-stu-id="a98b9-288">![Diagram showing outbound calls](media/direct-routing-media-op-10.png "Outbound calls")</span></span>

<span data-ttu-id="a98b9-289">下表显示了直接路由发送的 X-MS 标题：</span><span class="sxs-lookup"><span data-stu-id="a98b9-289">The following table shows the X-MS headers sent by Direct Routing:</span></span>

| <span data-ttu-id="a98b9-290">参数</span><span class="sxs-lookup"><span data-stu-id="a98b9-290">Parameter</span></span> | <span data-ttu-id="a98b9-291">解释</span><span class="sxs-lookup"><span data-stu-id="a98b9-291">Explanation</span></span> |
|:------------|:-------|
| <span data-ttu-id="a98b9-292">邀请 + 8443926300@VNsbc.contoso.com</span><span class="sxs-lookup"><span data-stu-id="a98b9-292">Invite +8443926300@VNsbc.contoso.com</span></span> | <span data-ttu-id="a98b9-293">在联机语音路由策略中定义的 SBC 的目标名称在请求 URI 中发送</span><span class="sxs-lookup"><span data-stu-id="a98b9-293">The target name of the SBC as defined in the Online Voice Routing Policy is sent in the Request URI</span></span> | 
| <span data-ttu-id="a98b9-294">X-MS-UserLocation：内部</span><span class="sxs-lookup"><span data-stu-id="a98b9-294">X-MS-UserLocation: internal</span></span> | <span data-ttu-id="a98b9-295">指示用户位于企业网络内的字段</span><span class="sxs-lookup"><span data-stu-id="a98b9-295">The field indicated that user is located inside the corporate network</span></span> |
| <span data-ttu-id="a98b9-296">X-MS-MediaPath： VNsbc.contoso.com</span><span class="sxs-lookup"><span data-stu-id="a98b9-296">X-MS-MediaPath: VNsbc.contoso.com</span></span> |   <span data-ttu-id="a98b9-297">指定客户端必须遍历到目标 SBC 的 SBC。</span><span class="sxs-lookup"><span data-stu-id="a98b9-297">Specifies which SBC the client must traverse to the target SBC.</span></span> <span data-ttu-id="a98b9-298">在这种情况下，我们始终绕过，并且客户端是以标题中的唯一名称形式发送的目标名称。</span><span class="sxs-lookup"><span data-stu-id="a98b9-298">In this case as we have Always Bypass, and the client is internal the target name sent as the only name in the header.</span></span> | 
|<span data-ttu-id="a98b9-299">X-MS-UserSite：越南</span><span class="sxs-lookup"><span data-stu-id="a98b9-299">X-MS-UserSite: Vietnam</span></span> |   <span data-ttu-id="a98b9-300">用户所在网站内指示的字段。</span><span class="sxs-lookup"><span data-stu-id="a98b9-300">The field indicated within the site the user is located.</span></span> |
...
#### <a name="inbound-calls-and-the-user-is-external-with-always-bypass"></a><span data-ttu-id="a98b9-340">入站呼叫和用户是具有始终绕过的外部呼叫</span><span class="sxs-lookup"><span data-stu-id="a98b9-340">Inbound calls and the user is external with Always Bypass</span></span>
