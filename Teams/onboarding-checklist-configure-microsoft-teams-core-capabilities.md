...
| 7  | 配置团队 SMTP 域的 Exchange | 团队使用 Exchange Online 通过 SMTP 域（email.teams.microsoft.com）向团队成员发送通知（在添加或删除它们时）。 <br/><br/>请确保将此 SMTP 域添加到 Exchange 基础结构中的 "接受的域" 列表。 | | [在 Exchange 中创建安全的发件人列表](https://docs.microsoft.com/microsoft-365/security/office-365-security/create-safe-sender-lists-in-office-365?view=o365-worldwide) |
