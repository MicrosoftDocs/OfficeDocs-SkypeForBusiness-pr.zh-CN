...
| 2  | 验证Teams租户已启用该租户 | Teams默认为所有组织启用。 检查 **&服务加载项**"页Microsoft 365 管理中心验证Teams为组织启用加载项，并根据需要启用它。 | | [在 Microsoft Teams 或 Microsoft 365 中Office 365](office-365-set-up.md) |
...
| 8  | 配置和管理用户对 Teams | 尽管强烈建议为所有用户启用 Teams，但可以通过分配或删除 Teams 产品许可证，基于每个用户允许或禁止访问 Teams。 | | [管理 Microsoft Teams 的用户访问](user-access.md) |
