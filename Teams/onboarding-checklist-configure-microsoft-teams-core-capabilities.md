...
| 2  | 验证是否已为租户启用团队 | 默认情况下, 团队为所有组织启用团队。 检查 Office 365 管理中心中的 "**服务 & 加载项**" 页面, 验证是否已为租户启用团队, 并根据需要启用团队。 | | [在你的 Office 365 组织中设置 Microsoft Teams](office-365-set-up.md) |
...
| 10 | 可选: 使用 PowerShell 管理团队 | 你可以使用 PowerShell cmdlet (而不是 Office 365 管理中心) 管理和管理团队设置。 | | [Microsoft 团队 PowerShell](https://docs.microsoft.com/powershell/module/teams/?view=teams-ps) |
