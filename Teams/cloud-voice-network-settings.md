...
了解网络区域、网络站点、网络子网和受信任的 IP 地址。 这些术语和概念将在整个云语音文档中用于 [直接路由和](location-based-routing-plan.md) 动态紧急呼叫的基于位置的 [路由](configure-dynamic-emergency-calling.md)。 如果要在组织中部署这些云功能，则必须配置网络设置，以与云中的这些功能Microsoft Teams。
