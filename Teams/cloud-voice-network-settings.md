...
本文提供了 Location-Based 路由和动态紧急呼叫的常见网络设置的概述。 你可以配置部分或所有这些设置，具体取决于你部署的云语音功能和功能。 有关如何配置这些设置的步骤，请参阅 [管理团队中的云功能的网络拓扑](manage-your-network-topology.md)。
...
对于直接路由和增强的紧急服务，Location-Based 路由共享相同的网络区域。 如果已为一个功能创建了网络区域，则不必为其他功能创建新的网络区域。
