...
学校或大学是否需要启用远程Microsoft Teams远程学习？ 使用入门单页机和以下[](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/teams-for-education-getting-started-1-pager.pdf?raw=true)任何采用材料快速启动并运行！
...
- 访问[Teams 教育](https://www.microsoft.com/en-us/education/products/teams/default.aspx)版页面，查看培训、视频和交互式演示
- 在 Teams[管理中心Microsoft 365， (](https://portal.office.com/adminportal/home#/Settings/ServicesAndAddIns)管理员Office 365登录) 
...
- [Teams路线图](https://aka.ms/teamsroadmap)
