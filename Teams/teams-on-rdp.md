...
ms.locfileid: "60774362"
---
# <a name="teams-in-remote-desktop-services"></a>Teams桌面服务中的

本文介绍在 RDS Microsoft Teams远程桌面服务 (应用程序) 要求和限制。
...
RDS 提供部署灵活性、成本效益和可扩展性。 RDS 通过各种部署选项提供，包括Windows Server 2016部署、Microsoft Azure部署解决方案以及一系列可靠的合作伙伴解决方案。
...
如果你的组织希望仅使用 Teams 中的聊天和协作功能，你可以设置用户级策略，以在 Teams 中关闭呼叫和Teams。
