...
audience: admin
ms.reviewer: landerl
description: 在升级后定期评估Teams服务的机会，监视Teams感兴趣的功能增强功能的路线图。
...
成功将服务Teams组织，并运行具有质量和可靠性的服务后，下一步是定期评估你是否有机会增强服务。 这是持续服务改进规划的一部分，是云服务管理的现代标准。
...
如果看到了增强服务的机会，请花些时间正确执行。 重新[访问在游戏和](deploy-chat-teams-channels-microsoft-teams-landing-page.md)实现阶段部署聊天、团队、Microsoft Teams和应用，并端到端[](deploy-chat-teams-channels-microsoft-teams-landing-page.md)应用相同的指导。 进行小规模的增量更改时，不太可能需要完整完成所有活动和任务，但应一路评估每个活动和任务，为自己提供成功结果的最佳机会。
