...
如果看到了增强服务的机会，请花些时间正确执行。 重新[访问部署聊天、](deploy-chat-teams-channels-microsoft-teams-landing-page.md)团队、频道Microsoft Teams以及我们的实施[阶段](deploy-chat-teams-channels-microsoft-teams-landing-page.md)，并端到端应用相同的指导。 进行小规模的增量更改时，不太可能需要完整完成所有活动和任务，但应一路评估每个活动和任务，为自己提供成功结果的最佳机会。
