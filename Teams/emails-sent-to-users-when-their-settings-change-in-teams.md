...
- **音频会议许可证分配给他们，或者当你将音频会议提供商更改到 Microsoft 时。**
    ...
    下面是此电子邮件的一个示例：
     ...
     ![Skype for Business验证许可证。](media/teams-emails-sent-to-users-when-settings-change-image1.png)

    若要了解有关许可的更多内容，请参阅Microsoft Teams[附加许可。](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
...
默认情况下，电子邮件将发送给你的用户，但如果你想要阻止他们接收音频会议的电子邮件，你可以Microsoft Teams或Windows PowerShell。 
