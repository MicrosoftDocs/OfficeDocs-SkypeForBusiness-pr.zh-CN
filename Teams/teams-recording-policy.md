...
- 支持 Teams 用户与 Teams、Teams mobile、Skype for Business、PSTN (终结点之间的交互) 
...
交互录制用例可以有效地分为四个主要类别的录制功能 - 便利、功能、组织和拦截，如图所示：
...
<li><p>通过使用情况、质量和可靠性的操作分析，为内部合规主管提供支持。</p></li>
</ul></td>
</tr>
<tr class="odd">
<td>合规性主管</td>
