...
|视频呼叫和会议 | 为了更好经验视频呼叫和联机会议，我们建议使用已 2.0 GHz 处理器和 4.0 GB RAM 的计算机上 （或更高版本）。 可选 blur 我背景视频效果需要具有高级向量扩展 2 (AVX2) 支持的处理器。
...
|视频呼叫和会议 | 为了更好经验视频呼叫和联机会议，我们建议使用已 2.0 GHz 处理器和 4.0 GB RAM 的计算机上 （或更高版本）。 可选 blur 视频效果需要具有高级向量扩展 2 (AVX2) 支持，支持大多数最晚 2013 Mac 设备和更高版本的处理器，我背景。
