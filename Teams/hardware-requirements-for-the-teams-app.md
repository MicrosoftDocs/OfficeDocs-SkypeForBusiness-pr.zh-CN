...
---
# <a name="hardware-requirements-for-microsoft-teams"></a>Microsoft 团队的硬件要求

以下部分中的所有要求均适用于 Microsoft 团队桌面应用和团队 Web 应用。

## <a name="hardware-requirements-for-teams-on-a-windows-pc"></a>适用于 Windows 电脑上的团队的硬件要求
...
|图形硬件 |  最少 128 MB 图形内存
|操作系统  |    在32位和64位中，windows Server 2012 R2 +、Windows 10 或 Windows 8.1。 为获得最佳体验，请使用最新版本的操作系统。|
...
## <a name="hardware-requirements-for-teams-on-a-mac"></a>针对 Mac 的团队的硬件要求
...
## <a name="hardware-requirements-for-teams-on-linux"></a>适用于 Linux 的团队的硬件要求
...
## <a name="hardware-requirements-for-teams-on-mobile-devices"></a>移动设备上的团队的硬件要求
...
## <a name="hardware-requirements-for-teams-in-a-virtual-desktop-infrastructure-vdi-environment"></a>虚拟桌面基础结构（VDI）环境中的团队的硬件要求
