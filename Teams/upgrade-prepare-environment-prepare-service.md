...
本文概述了为组织准备使用云语音服务进行协作和云语音Teams。 通过正确准备，你可以确保已准备好向组织提供这些功能。
...
尽管我们建议按顺序遵循清单，但确切顺序取决于部署范围和环境的配置和复杂性。 组织它们以支持"绿地"部署Teams部署 (之前没有 Skype for Business Online 状态) 或者从 Skype for Business Online 升级到 Teams。 如果要从 Skype for Business Online 升级，则你可能已完成其中一些活动，现在可以忽略这些活动。
