...
- **国内和国际** 呼叫计划：许可用户可以根据用户的位置呼叫位于其 Microsoft 365 或 Office 365 许可证分配给用户的国家/地区中的号码，以及 [196 个国家/](country-and-region-availability-for-audio-conferencing-and-calling-plans/users-can-make-outbound-calls-to-these-countries-and-regions.md)地区的国际号码。
...
> [!IMPORTANT]
> 国家/地区基于"活动用户"中用户许可证Microsoft 365 管理中心位置，而不是"活动用户"中"组织配置文件"下列出的  >  Microsoft 365 管理中心。      
