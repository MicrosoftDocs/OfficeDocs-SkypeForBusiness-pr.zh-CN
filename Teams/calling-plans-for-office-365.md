...
同一国家/地区的所有用户 (同一呼叫计划共享分钟数池，这是在 Microsoft 365 管理中心) 许可区域中定义的用户国家/地区位置。 例如，如果在同一国家/地区有 100 个用户分配了 120 分钟的国内呼叫计划，则他们共享 12，000 分钟的池。 超过这些分钟数的所有呼叫均按分钟计费。
...
> [!IMPORTANT]
> 国家/地区基于"活动用户"**中** 用户许可证Microsoft 365 管理中心位置，而不是"活动用户"中"组织配置文件"下列出的帐单  >  **Microsoft 365 管理中心。**     
...
然后，将Enterprise E5 或电话系统许可证分配给用户。Microsoft 365 管理中心。 若要了解如何，请参阅[分配Microsoft Teams许可证。](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
...
- [以下是使用 电话系统 或 Microsoft 365 Office 365](./here-s-what-you-get-with-phone-system.md)
