...
- **国内呼叫** 计划：获得许可的用户可以拨打位于被分配至国内或Microsoft 365 Office 365。
    
- **国内和国际** 呼叫计划：许可用户可以根据用户的位置呼叫位于其 Microsoft 365 或 Office 365 许可证分配给用户的国家/地区中的号码，以及 [196](country-and-region-availability-for-audio-conferencing-and-calling-plans/users-can-make-outbound-calls-to-these-countries-and-regions.md)个国家/地区的国际号码。

同一国家/地区的所有用户 (Microsoft 365 管理中心) 同一呼叫计划共享分钟数池，这是在相同呼叫计划的许可区域中定义的用户国家/地区位置。 例如，如果在同一国家/地区有 100 个用户分配了 120 分钟的国内呼叫计划，则他们共享 12，000 分钟的池。 超过这些分钟数的所有呼叫均按分钟计费。
...
> [!IMPORTANT]
> 国家/地区基于用户许可证在"活动用户"中的位置Microsoft 365 管理中心而不是"活动用户"中"组织配置文件"下列出的  >  帐单 **Microsoft 365 管理中心。**     
...
1. <strong>必须先购买 **电话系统</strong>附加许可证 <strong>。为此，请 [登录到订阅Microsoft 365 管理中心](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog)并选择"</strong>计费购买服务附加内容订阅立即  >    >    >  **购买"。**
...
你可以购买不同的呼叫计划并将其分配给不同的用户，具体取决于你的组织的需求。 选择所需的呼叫计划后，继续结账。 向用户中的每个用户分配Microsoft 365 管理中心。 若要了解如何使用，请参阅[分配Microsoft Teams许可证。](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
...
然后，将Enterprise E5 电话系统或附加许可证分配给 Microsoft 365 管理中心。 若要了解如何使用，请参阅[分配Microsoft Teams许可证。](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
