...
我们建议在组织准备好后，分阶段、按工作负载的推出Teams。 **不必等到完成了一个步骤后再进入下一个步骤。** 一些企业可能希望一次性推出所有的 Teams 功能，而其他企业可能更喜欢分阶段的方法。以下即是 Teams 在的工作负载，我们建议按顺序推出：
...
如果是从 Skype for Business（在线或本地）转换到 Teams，或者需要混合配置，而你仍然希望按照上面[推荐的路径](#recommended-path-to-teams)进行 Teams 部署，首先你需要做一些额外的规划。首先查看下表中适用于你的组织概况的指导。
