...
使用项目Microsoft 365 Office 365来收集项目反馈。
  
![代表决策点的图标](media/teams-adoption-decision-icon.png) 决策：如果您的组织已在虚拟网络Yammer投资，您可以将它用作早期采用者计划的反馈论坛。 如果没有，并且早期采用者计划的成员少于 5000，请创建一个团队Teams收集反馈并提供培训。
