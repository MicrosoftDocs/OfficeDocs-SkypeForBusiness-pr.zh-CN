...
在查找并获取组织的电话号码时，获取的电话号码会比已分配许可证的电话号码多。 但这取决于你已购买并分配的电话号码类型和许可证类型。 可以单击["呼叫计划](different-kinds-of-phone-numbers-used-for-calling-plans.md)"使用的不同类型的电话号码，了解呼叫计划中使用Microsoft Teams。
