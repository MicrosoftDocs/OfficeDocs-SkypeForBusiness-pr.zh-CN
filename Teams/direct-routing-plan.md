...
有关许可电话系统，请参阅["从计划Office](https://products.office.com/compare-all-microsoft-office-products?tab=2)[和计划选项](/office365/servicedescriptions/office-365-platform-service-description/office-365-plan-options)。 
...
证书需要将 SBC FQDN 作为 CN (的公用) 或 SAN (主题) 名称。 证书应直接从证书颁发机构颁发，而不是从中间提供商颁发。
...
|流量|从|到|源端口|目标端口|
|:--- |:--- |:--- |:--- |:--- |
|SIP/TLS|SIP 代理|SBC|1024 – 65535|在 SBC 服务 (为Office 365 GCC/DoD，只能使用端口 5061) |
...
在会话边界控制器与云媒体处理器 (之间（没有媒体旁路) ）之间或者 Teams 客户端与 SBC (（如果启用了媒体旁路）之间使用直接路由接口) 可以使用以下编解码器：
